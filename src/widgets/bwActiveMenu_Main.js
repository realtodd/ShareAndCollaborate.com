$.widget("bw.bwActiveMenu_Main", {
    ...
    displayAlertDialog: function (errorMessage, displayDialog) {
        try {
            ...
            console.log('');
            console.log('>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<');
            console.log('>>>>>>>>>>>>> In bwActiveMenu_Main.js.displayAlertDialog().');
            console.log('>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<');
            console.log('');
            //alert('In bwActiveMenu_Main.js.displayAlertDialog().');
    ...
    expandOrCollapseAlertsSection: function (rowId, imageId, collapsibleRowId, drawerType, source) {
        try {
            ...
            if (!img) {
                ...
                var urlClose = 'widgets/images/drawer-close.png';
                var urlOpen = 'widgets/images/drawer-open.png';
    ...
    callIpcAndPopulateValues: function () {
        try {
            ...
            ipcRenderer.on('retrieve-current-values-reply', (event, response) => {
                ...
                //
                // We need to get an ip that is recognized on the local network. todd 5-16-2025.
                //
                console.log('xcx2321 ips: ' + JSON.stringify(response));
                //alert('xcx2321 ips: ' + JSON.stringify(response));
                ...
                // webservices
                thiz.options.webservicesUrl = response.websiteUri.url;  //response.webservicesUri.url;
                thiz.options.webservicesPort = response.websiteUri.port;  //response.webservicesUri.port;
                ...
                // fileservices
                thiz.options.fileservicesUrl = response.websiteUri.url;  //response.fileservicesUri.url;
                thiz.options.fileservicesPort = response.websiteUri.port;  //response.fileservicesUri.port;
            ...
            alert('Exception in bwActiveMenu_Main.js.callIpcAndPopulateValues(): ' + e.message + ', ' + e.stack);
        }
    },
    displayStatusOfWebServices: function () {
        try {
            ...
            //var operationUri = thiz.options.fileservicesUrl + ':' + thiz.options.fileservicesPort + "/_bw/getstatusofwebservices";
            $.ajax({
                url: operationUri,
                type: "GET",
                ...
                success: function (data) {
                    ...
                    if (data == 'SUCCESS') {
                        // Green.
                        html += '<span style="color:#009933;margin:"0 0 0 20px;">' + 'RESPONDING' + '</span>';
                    ...
                    $('#spanWebservicesStatus').html(html);
                    $('#spanWebservicesStatus1').html(html);
                ...
                error: function (data, errorCode, errorMessage) {
                    ...
                    var html = '';
                    html += '<span style="font-size:24pt;color:red;">Error in bwActiveMenu_Main.js</span>';
                    html += '<br />';
                    html += '<span style="">Error in bwActiveMenu_Main.js.displayStatusOfWebServices.webservices(): ' + errorCode + ', ' + errorMessage + '</span>';
                    //thiz.element.html(html); // spanError
                    $('#spanError').html(html);
                    //// Red.
                    //var html = '';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#spanFileservicesStatus').html(html);
                    $('#spanFileservicesStatus1').html(html);
                ...
                error: function (data, errorCode, errorMessage) {
                    ...
                    html += '<span style="font-size:24pt;color:red;">Error in bwActiveMenu_Main.js</span>';
                    html += '<br />';
                    html += '<span style="">Error in bwActiveMenu_Main.js.displayStatusOfWebServices.fileservices(): ' + errorCode + ', ' + errorMessage + '</span>';
                    //thiz.element.html(html);
                    $('#spanError').html(html);
...
<span id="spanError" style="color:tomato;"></span>
<br />
    <br />
    ...
    <tbody>
        <tr id="functionalAreaRow_0_1" class="bwFunctionalAreaRow bwNoUserSelect">
            ...
            <td style="padding-left:11px;" class="bwHPNDrillDownLinkCell2 bwNoUserSelect" onclick="$('.bwActiveMenu_Main').bwActiveMenu_Main('expandOrCollapseAlertsSection', 'functionalAreaRow_0_1', 'alertSectionImage_0_1', 'alertSectionRow_0_1', 'PINNED_REQUESTS');">   
                <img title="expand" id="alertSectionImage_0_1" style="cursor:pointer;width:45px;height:45px;vertical-align:middle;float:none;" src="widgets/images/drawer-open.png">           
        ...
        <tr id="functionalAreaRow_0_2" class="bwFunctionalAreaRow bwNoUserSelect">
            ...
            <td style="padding-left:11px;" class="bwHPNDrillDownLinkCell2 bwNoUserSelect" onclick="$('.bwActiveMenu_Main').bwActiveMenu_Main('expandOrCollapseAlertsSection', 'functionalAreaRow_0_2', 'alertSectionImage_0_2', 'alertSectionRow_0_2', 'PINNED_REQUESTS');">   
                <img title="expand" id="alertSectionImage_0_2" style="cursor:pointer;width:45px;height:45px;vertical-align:middle;float:none;" src="widgets/images/drawer-open.png">           
                &nbsp;<input style="transform: scale(2);" type="checkbox">
                &nbsp;<span class="bwNoUserSelect bwAccordionDrawerTitle">Website</span><span id="spanWebsiteStatus1" style="font-weight:bold;color:tomato;">NOT RUNNING</span>       
            </td>   
        </tr>   
        ...
        <tr id="functionalAreaRow_0_3" class="bwFunctionalAreaRow bwNoUserSelect">
            ...
            <td style="padding-left:11px;" class="bwHPNDrillDownLinkCell2 bwNoUserSelect" onclick="$('.bwActiveMenu_Main').bwActiveMenu_Main('expandOrCollapseAlertsSection', 'functionalAreaRow_0_3', 'alertSectionImage_0_3', 'alertSectionRow_0_3', 'PINNED_REQUESTS');">   
                <img title="expand" id="alertSectionImage_0_3" style="cursor:pointer;width:45px;height:45px;vertical-align:middle;float:none;" src="widgets/images/drawer-open.png">           
                &nbsp;<input style="transform: scale(2);" type="checkbox">
                &nbsp;<span class="bwNoUserSelect bwAccordionDrawerTitle">Web services</span><span id="spanWebservicesStatus1" style="font-weight:bold;color:tomato;">NOT RUNNING</span>       
            </td>   
        </tr>   
        ...
        <tr id="functionalAreaRow_0_4" class="bwFunctionalAreaRow bwNoUserSelect">
            ...
            <td style="padding-left:11px;" class="bwHPNDrillDownLinkCell2 bwNoUserSelect" onclick="$('.bwActiveMenu_Main').bwActiveMenu_Main('expandOrCollapseAlertsSection', 'functionalAreaRow_0_4', 'alertSectionImage_0_4', 'alertSectionRow_0_4', 'PINNED_REQUESTS');">   
                <img title="expand" id="alertSectionImage_0_4" style="cursor:pointer;width:45px;height:45px;vertical-align:middle;float:none;" src="widgets/images/drawer-open.png">           
                &nbsp;<input style="transform: scale(2);" type="checkbox">
                &nbsp;<span class="bwNoUserSelect bwAccordionDrawerTitle">File services</span><span id="spanFileservicesStatus1" style="font-weight:bold;color:tomato;">NOT RUNNING</span>        
            </td>   
        </tr>   
        ...
        <tr id="functionalAreaRow_0_5" class="bwFunctionalAreaRow bwNoUserSelect">
            ...
            <td style="padding-left:11px;" class="bwHPNDrillDownLinkCell2 bwNoUserSelect" onclick="$('.bwActiveMenu_Main').bwActiveMenu_Main('expandOrCollapseAlertsSection', 'functionalAreaRow_0_5', 'alertSectionImage_0_5', 'alertSectionRow_0_5', 'PINNED_REQUESTS');">   
                <img title="expand" id="alertSectionImage_0_5" style="cursor:pointer;width:45px;height:45px;vertical-align:middle;float:none;" src="widgets/images/drawer-open.png">           
                &nbsp;<input style="transform: scale(2);" type="checkbox">
        ...
        <tr id="functionalAreaRow_0_6" class="bwFunctionalAreaRow bwNoUserSelect">
            ...
            <td style="padding-left:11px;" class="bwHPNDrillDownLinkCell2 bwNoUserSelect" onclick="$('.bwActiveMenu_Main').bwActiveMenu_Main('expandOrCollapseAlertsSection', 'functionalAreaRow_0_6', 'alertSectionImage_0_6', 'alertSectionRow_0_6', 'PINNED_REQUESTS');">   
                <img title="expand" id="alertSectionImage_0_6" style="cursor:pointer;width:45px;height:45px;vertical-align:middle;float:none;" src="widgets/images/drawer-open.png">           
                &nbsp;<input style="transform: scale(2);" type="checkbox">
...
<span style="font-size:18pt;">Users on your local network may be able to connect to these url(s): 
<pre><span id="spanWebsiteLink"><a href="http://localhost:xcx1" target="_blank">http://localhost:xcx1</a></span></pre>
<br />

<span style="font-size:15pt;font-style:italic;">This is you local endpoint for serving to the outside world. With SSL through NGINX and Varnish, for example. Also, scaling out your servers is coming soon, stay tuned! True peer-to-peer is on the horizon.</span>
...
`;
            ...
            alert('Exception in bwActiveMenu_Main.js.renderMenu(): ' + e.message + ', ' + e.stack);
        }
    },
