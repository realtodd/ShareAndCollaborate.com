$.widget("bw.bwCodeEditor", {
    ...
    _create: function () {
        //alert('In bwCodeEditor._create().');
        this.element.addClass("bwCodeEditor");
        //debugger;
        ...
        try {
            ...
            //
            //
            // THIS IS THE LIBREJS CREATOR STUFF. WE CAN AUTO GENERATE THE WHOLE WORKS... MAYBE? :) 12-18-2023. 
            //
            //

            var html = '';

            //html += `<span style="font-size:50pt;font-weight:bold;color:#9B945F;">THIS IS THE bwCodeEditor WIDGET.</span>
            //        <br /><br />
            //        <input type="button" style="font-size:30pt;" value="Scan javascript files and generate the LibreJS table element." />
            //        <br /><br />
            //        <input type="button" style="font-size:30pt;" value="Replace the existing one with this new one. This is a permanent file copy." />
            //        `;

            //var scripts = $('script');

            //html += '<br />';
            //html += 'scripts.length: ' + scripts.length;


            //var html = '';

            //html += '<table id="jslicense-labels1">';

            //for (var i = 0; i < scripts.length; i++) {

            //    var scriptPath = scripts[i].src.split(this.options.operationUriPrefix)[1];
            //    var scriptFilenameIndex = scriptPath.split('/').length - 1;
            //    var scriptFilename = scriptPath.split('/')[scriptFilenameIndex];

            //    html += '<tr>';
            //    html += '   <td>'
            //    html += '       <a href="' + scriptPath + '">' + scriptFilename + '</a>';
            //    html += '   </td>';
            //    html += '   <td>'
            //    html += '       <a href="http://www.gnu.org/licenses/agpl-3.0.html">AGPL-3.0</a>';
            //    html += '   </td>';
            //    html += '   <td>'
            //    html += '       <a href="' + scriptPath + '">' + scriptFilename + '</a>';
            //    html += '   </td>';
...
<tr><td>&nbsp;</td></tr>
<tr><td>/widgets</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwActiveMenu.js');">bwActiveMenu.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwActivitySpinner_FileUpload.js');">bwActivitySpinner_FileUpload.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwActivitySpinner.js');">bwActivitySpinner.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwAdvancedProductSearch.js');">bwAdvancedProductSearch.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwAppThemeColorPicker.js');">bwAppThemeColorPicker.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwAttachmentDialog.js');">bwAttachmentDialog.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwAuthentication.js');">bwAuthentication.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwChecklistsEditor.js');">bwChecklistsEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwCircleDialog.js');">bwCircleDialog.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwCoreComponent.js');">bwCoreComponent.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwCustomerSummariesCarousel.js');">bwCustomerSummariesCarousel.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwDataGrid.js');">bwDataGrid.js</td></tr>

<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwDocumentation.js');">bwDocumentation.js</td></tr>

<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwDistributorBundling.js');">bwDistributorBundling.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwDonate.js');">bwDonate.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwEmailClient_Haraka.js');">bwEmailClient_Haraka.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwEmailClient.js');">bwEmailClient.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwEmailEditor_DeletedRequest.js');">bwEmailEditor_DeletedRequest.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwEmailEditor_RevertedRequest.js');">bwEmailEditor_RevertedRequest.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwEmailMonitor.js');">bwEmailMonitor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwEmailTemplateEditor.js');">bwEmailTemplateEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwExecutiveSummariesCarousel.js');">bwExecutiveSummariesCarousel.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwExecutiveSummariesCarousel2.js');">bwExecutiveSummariesCarousel2.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwExternallySharedFiles.js');">bwExternallySharedFiles.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwFormsEditor.js');">bwFormsEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwHomePage.js');">bwHomePage.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwHowDoesItWorkCarousel2.js');">bwHowDoesItWorkCarousel2.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwHowDoesItWorkCarousel3.js');">bwHowDoesItWorkCarousel3.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwInvitation.js');">bwInvitation.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwInvitationsAdmin.js');">bwInvitationsAdmin.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwKeypressAndMouseEventHandler.js');">bwKeypressAndMouseEventHandler.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwLibreJs.js');">bwLibreJs.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwLocationEditor.js');">bwLocationEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwMonitoringTools.js');">bwMonitoringTools.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwNewUserBusinessModelEditor.js');">bwNewUserBusinessModelEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwNewUserChecklistsEditor.js');">bwNewUserChecklistsEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwNewUserEmailEditor.js');">bwNewUserEmailEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwNewUserFormsEditor.js');">bwNewUserFormsEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwNewUserRolesEditor.js');">bwNewUserRolesEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwNewUserWorkflowEditor.js');">bwNewUserWorkflowEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwNotificationSound.js');">bwNotificationSound.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwOneTimeRequestReminders.js');">bwOneTimeRequestReminders.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwOperationalHours.js');">bwOperationalHours.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwOrganizationEditor.js');">bwOrganizationEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwOrganizationEditorAdmin.js');">bwOrganizationEditorAdmin.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwOrganizationEvents.js');">bwOrganizationEvents.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwOrganizationPicker.js');">bwOrganizationPicker.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwOrganizationPicker2.js');">bwOrganizationPicker2.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwPageScrollingHandler.js');">bwPageScrollingHandler.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwParticipantsEditor.js');">bwParticipantsEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwPeoplePicker.js');">bwPeoplePicker.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwPersonalErrorAdministration.js');">bwPersonalErrorAdministration.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwPillarTypeEditor.js');">bwPillarTypeEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwPrintButton.js');">bwPrintButton.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwProductCarousel.js');">bwProductCarousel.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwProjectTypeEditor.js');">bwProjectTypeEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwRequest.js');">bwRequest.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwRequest.min.js');">bwRequest.min.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwRequestTitleFormatAdmin.js');">bwRequestTitleFormatAdmin.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwRequestTypeDropDown_NewTenant.js');">bwRequestTypeDropDown_NewTenant.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwRequestTypeEditor.js');">bwRequestTypeEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwResubscribeUserEmailEditor.js');">bwResubscribeUserEmailEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwRolesEditor.js');">bwRolesEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwSharePointFormEditor.js');">bwSharePointFormEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwSharePointWorkflowEditor.js');">bwSharePointWorkflowEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwSpeech.js');">bwSpeech.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwTardyParticipants.js');">bwTardyParticipants.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwTimelineAggregator.js');">bwTimelineAggregator.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwTipsCarousel.js');">bwTipsCarousel.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwTrackSpending.js');">bwTrackSpending.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwUnsubscribeUserEmailEditor.js');">bwUnsubscribeUserEmailEditor.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/widgets/bwWorkflowEditor.js');">bwWorkflowEditor.js</td></tr>

<tr><td>&nbsp;</td></tr>
<tr><td>/formwidgets</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwAttachments.js');">bwAttachments.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwCapitalInternalOrderNumberField.js');">bwCapitalInternalOrderNumberField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwCommentsField_Events.js');">bwCommentsField_Events.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwCommentsField.js');">bwCommentsField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwCostCenterDescriptionField.js');">bwCostCenterDescriptionField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwCostCenterNumberField.js');">bwCostCenterNumberField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwCostsGrid.js');">bwCostsGrid.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwDescriptionDetailsField.js');">bwDescriptionDetailsField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwDocumentScan.js');">bwDocumentScan.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwDurationInMonthsCalculatedField.js');">bwDurationInMonthsCalculatedField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwEndDatePicker.js');">bwEndDatePicker.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwExpenseInternalOrderNumberField.js');">bwExpenseInternalOrderNumberField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwInvoiceGrid.js');">bwInvoiceGrid.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwJustificationDetailsField.js');">bwJustificationDetailsField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwLocationPicker.js');">bwLocationPicker.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwPaybackGrid.js');">bwPaybackGrid.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwPaybackTypeField.js');">bwPaybackTypeField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwPeoplePicker_Customer.js');">bwPeoplePicker_Customer.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwPeoplePicker_EmailRecipients.js');">bwPeoplePicker_EmailRecipients.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwPeoplePicker.js');">bwPeoplePicker.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwPillarTypeCheckboxGroup.js');">bwPillarTypeCheckboxGroup.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwPillarTypeDropDown.js');">bwPillarTypeDropDown.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwProjectClassField.js');">bwProjectClassField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwProjectTypeCheckboxGroup.js');">bwProjectTypeCheckboxGroup.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwProjectTypeDropDown.js');">bwProjectTypeDropDown.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwReasonDetailsField.js');">bwReasonDetailsField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwRecordAudio.js');">bwRecordAudio.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwRequestedCapitalField.js');">bwRequestedCapitalField.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwRequestTypeDropDown.js');">bwRequestTypeDropDown.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwSelectInventoryItems.js');">bwSelectInventoryItems.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwSelectQuoteItems.js');">bwSelectQuoteItems.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwSpendGrid.js');">bwSpendGrid.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwStartDatePicker.js');">bwStartDatePicker.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/bwYearDropDown.js');">bwYearDropDown.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/formwidgets/ProjectTitle.js');">ProjectTitle.js</td></tr>
...
<tr><td>&nbsp;</td></tr>
<tr><td>/scripts</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/scripts/index.js');">index.js</td></tr>
...
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwActiveMenu_Admin.js');">backendwidgets/bwActiveMenu_Admin.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwBackendAdministrationForAllParticipants.js');">backendwidgets/bwBackendAdministrationForAllParticipants.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwCampaign.js');">backendwidgets/bwCampaign.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwChecklistsEditor_Admin.js');">backendwidgets/bwChecklistsEditor_Admin.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwEmailAllowListManager.js');">backendwidgets/bwEmailAllowListManager.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwEmailCampaign.js');">backendwidgets/bwEmailCampaign.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwEmailMonitor_Admin.js');">backendwidgets/bwEmailMonitor_Admin.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwFormsEditor_NewTenant.js');">backendwidgets/bwFormsEditor_NewTenant.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwKeypressAndMouseEventHandler_ForAdmin.js');">backendwidgets/bwKeypressAndMouseEventHandler_ForAdmin.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwMonitoringTools2.js');">backendwidgets/bwMonitoringTools2.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwRequestTypeEditor_NewTenant.js');">backendwidgets/bwRequestTypeEditor_NewTenant.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwSlideSet.js');">backendwidgets/bwSlideSet.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwSlideshowAdmin.js');">backendwidgets/bwSlideshowAdmin.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwStripePurchases.js');">backendwidgets/bwStripePurchases.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwTimerServicesManager.js');">backendwidgets/bwTimerServicesManager.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwVideoAssistant_Admin.js');">backendwidgets/bwVideoAssistant_Admin.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/backendwidgets/bwWorkflowEditor_NewTenant.js');">backendwidgets/bwWorkflowEditor_NewTenant.js</td></tr>
...
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/webservices/budgetworkflow.com.js');">serverstuff/webservices/budgetworkflow.com.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/webservices/routes/commondata.js');">serverstuff/webservices/routes/commondata.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/webservices/routes/start.js');">serverstuff/webservices/routes/start.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/webservices/routes/sharedclientandserverscripts/bwCommonScripts.js');">serverstuff/webservices/routes/sharedclientandserverscripts/bwCommonScripts.js</td></tr>
...
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/fileservices/budgetworkflow.com.js');">serverstuff/fileservices/budgetworkflow.com.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/fileservices/routes/commondata.js');">serverstuff/fileservices/routes/commondata.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/fileservices/routes/start.js');">serverstuff/fileservices/routes/start.js</td></tr>
...
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/mediaconversionservices/budgetworkflow.com.js');">serverstuff/mediaconversionservices/budgetworkflow.com.js</td></tr>
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/mediaconversionservices/routes/start.js');">serverstuff/mediaconversionservices/routes/start.js</td></tr>
...
<tr><td style="border-bottom:2px solid lightgray;text-decoration:underline;cursor:pointer;" onclick="$('.bwCodeEditor').bwCodeEditor('displayCodeFile', '/serverstuff/emailservices/bwHarakaQueueHandler.js');">serverstuff/emailservices/bwHarakaQueueHandler.js</td></tr>
...
`;
            ...
            //
            //
            // end: THIS IS THE LIBREJS CREATOR STUFF. WE CAN AUTO GENERATE THE WHOLE WORKS... MAYBE? :) 12-18-2023.
            //
            //

            this.element.html(html);

            console.log('In bwCodeEditor.js._create(). The widget has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwCodeEditor: CANNOT INITIALIZE widget bwCodeEditor.js.</span>';
            html += '<br />';
            html += '<span style="">Exception in bwCodeEditor.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    _destroy: function () {
        this.element
            .removeClass("bwCodeEditor")
            .text("");
    },

    displayCodeFile: function (filepath) {
        try {
            console.log('In bwCodeEditor.js.displayCodeFile().');
            ...
            $.get(filepath, function (textString) {
                try {
                    ...
                    console.log('Exception in bwCodeEditor.js.displayCodeFile():2: ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwCodeEditor.js.displayCodeFile():2: ' + e.message + ', ' + e.stack);
                }
            });

        } catch (e) {
            console.log('Exception in bwCodeEditor.js.displayCodeFile(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwCodeEditor.js.displayCodeFile(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    renderPrintButton: function () {
        try {
            ...
            if (reportType == 'CurrentYearBudgetRequestsReport') {
                html += '<span title="print" class="printButton" onclick="$(\'.bwCodeEditor\').bwCodeEditor(\'PrintCurrentYearBudgetRequestsReport\');">🖨</span>';
            } else if (reportType == 'MyPendingTasksReport') {
                html += '<span title="print" class="printButton" onclick="$(\'.bwCodeEditor\').bwCodeEditor(\'PrintMyPendingTasksReport\');">🖨</span>';
            } else if (reportType == 'InProcessBudgetRequestsReport') {
                html += '<span title="print" class="printButton" onclick="$(\'.bwCodeEditor\').bwCodeEditor(\'PrintInProcessBudgetRequestsReport\');">🖨</span>';
            } else if (reportType == 'IndividualRequestReport') {
                html += '<span title="print" class="printButton" onclick="$(\'.bwCodeEditor\').bwCodeEditor(\'PrintIndividualRequestReport\');" style="font-size:22pt;">🖨&nbsp;</span>'; // Different size because this one shows up in the dialog draggable top bar header.
            } else {
                                                    ...
                                                    try {
                                                        ...
                                                        var printNow = function () {
                                                            setTimeout(function () { // Only needs to happen for Chrome.
                                                                ...
                                                                //window.frames["printf"].print();
                                                                try {
                                                                    console.log('bwCodeEditor.PrintMyPendingTasksReport(): Try #1.');
                                                                    window.frames["printf"].contentWindow.print(); // Confirmed 5-14-2020. Works in Edge.
                                                                } catch (e) {
                                                                    try {
                                                                        console.log('bwCodeEditor.PrintMyPendingTasksReport(): Try #2.');
                                                                        ...
                                                                        console.log('bwCodeEditor.PrintMyPendingTasksReport(): Try #3.');
                                                                        window.print(); // In Safari on MacBook, and Safari & Chrome on iOS, this is a synchronous call!!! (unlike most other situations where it is asynchronous).
                                                                    }
                                                                ...
                                                                //};
                                                                //var $printbutton = $('#spanArchivePagePrintButton').bwCodeEditor(printButtonOptions);
        ...
        try {
            ...
            window.onafterprint = function (e) {
                try {
                    ...
                    //};
                    //var $printbutton = $('#spanRequestPrintButton').bwCodeEditor(printButtonOptions);
    ...
    expandHomePageNotificationAndRenderAlerts_Printed: function (notificationType, deferredIndex, functionalAreaRowId) {
        ...
        try {
            console.log('In bwCodeEditor.expandHomePageNotificationAndRenderAlerts_Printed(' + notificationType + ', ' + deferredIndex + ', ' + functionalAreaRowId + ').');
            //debugger;
            //displayAlertDialog('type:' + notifications);
            ////displayAlertDialog('text:' + notifications);
            //displayAlertDialog('notifications[2].length:' + notifications.length);
            ...
            //handleExceptionWithAlert('Error in my.js.expandHomePageNotificationAndRenderAlerts()', '2:' + e.message);
            console.log('Exception in bwCodeEditor.expandHomePageNotificationAndRenderAlerts_Printed() 2:' + e.message + ' ' + e.stack + ' This is not necessarily a service unavailable error but we dont want to bother the user!!');
            displayAlertDialog('Exception in bwCodeEditor.expandHomePageNotificationAndRenderAlerts_Printed() 2:' + e.message + ' ' + e.stack + ' This is not necessarily a service unavailable error but we dont want to bother the user!!');
