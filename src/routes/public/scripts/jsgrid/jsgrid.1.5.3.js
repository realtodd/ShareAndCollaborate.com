...
(function (jsGrid, $, undefined) {
    ...
    NumberField.prototype = new TextField({
        ...
        insertValue: function () {
            //alert('bw insertValue xcx1231234');
            return this.insertControl.val()
        ...
        _createTextBox: function () {
            //alert('xcx123234235-2');
            //return $("<input>").attr("type", "number")
            //    .prop("readonly", !!this.readOnly);
            return $("<input>").attr("type", "number")
                .prop("readonly", !!this.readOnly)
                .attr("inputmode", "decimal") // Forces the correct keyboard. xcx3432489
                .attr('step', '0.01')
            //.attr("onfocus", "alert('xcx12312324');")
            //.attr("onblur", "bwUnwidenNumberField();")
        }//,

        //bwWidenNumberField: function (element) {
        //    // Added by Todd 3-23-2023.
        //    console.log('In jsgrid.js.bwWidenNumberField().');

        //    element.style.width = '150px';

        //},
        //bwUnwidenNumberField: function (element) {
        //    // Added by Todd 3-23-2023.
        //    console.log('In jsgrid.js.bwUnwidenNumberField().');
...
// Todd added 3-23-2023 xcx123425 from https://github.com/tabalinas/jsgrid/issues/621
(function (jsGrid, $, undefined) {
