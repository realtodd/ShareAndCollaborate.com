...
function calendarJs(ol, pl, ql) {
    ...
    function dj() {
        ...
        if (b.useLocalStorageForEvents && ea.localStorage) {
            for (var a = ea.localStorage.length, c = 0; c < a; c++) {
                debugger;
                console.log('dj.localStorage.getItem().');
    ...
    function qb() {
        if (b.useLocalStorageForEvents && ea.localStorage) {
            ...
            for (d = 0; d < a; d++) {
                ...
                debugger;
                console.log('qb.localStorage.setItem().');
    ...
    u.updateEvent = function (a, c, d, e) {
        ...
        c["createdBy_ParticipantId"] = participantId;
        c["createdBy_ParticipantEmail"] = participantEmail;
        c["createdBy_ParticipantFriendlyName"] = participantFriendlyName;
