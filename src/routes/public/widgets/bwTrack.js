$.widget("bw.bwTrack", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwTrack.js jQuery Widget. 
        ===========================================================
    ...
    _create: function () {
        this.element.addClass("bwTrack");
        var thiz = this;
        try {
            //alert('In bwTrack.js._create().');
            ...
            html += '    <table id="tableMainMenu2" style="margin-left:-20px;margin-top:-25px;width:100%;border-collapse: collapse;">'; // THIS SETS THE GAP AT THE TOP OF THE INNER MENU. 6-18-2024. xcx231234-3.
            html += '        <tr>';
            ...
            html += '                <div id="divInnerLeftMenuButton_TrackSpending3" weightedheightvalue="40" class="leftButton ' + workflowAppTheme + '" onclick="$(\'.bwActiveMenu\').bwActiveMenu(\'RenderContentForInnerLeftMenuButtons\', this, \'TRACK_SPENDING3\');">';
            html += '                    <div class="leftButtonText2">TRACK SPENDING</div>';
            html += '                </div>';
            html += '';
            html += '                <div class="buttonSpacer" style="width: 100%; float:left; height:10px; background-color:white; "></div>';
            html += '                <div id="divInnerLeftMenuButton_YearlyBudget" class="leftButton ' + workflowAppTheme + '" weightedheightvalue="125" style="display:none;height:125px;" onclick="$(\'.bwActiveMenu\').bwActiveMenu(\'RenderContentForInnerLeftMenuButtons\', this, \'YEARLY_BUDGET\');">';
            html += '                    <div class="leftButtonText2">YEARLY BUDGET</div>';
            html += '                </div>';
            ...
            html += '                    <div class="leftButtonText2"></div>';
            html += '                </div>';
            html += '';
            html += '                <div class="buttonSpacer" style="width: 100%; float:left; height:3px; background-color:white; "></div>';
            ...
            //alert('xcx213123123 preparing to call RenderContentForInnerLeftMenuButtons().');
            $('.bwActiveMenu').bwActiveMenu('RenderContentForInnerLeftMenuButtons', this, 'TRACK_SPENDING3'); 
            ...
            console.log('In bwTrack._create(). The widget has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwTrack: CANNOT INITIALIZE THE WIDGET</span>';
            html += '<br />';
            html += '<span style="">Exception in bwTrack.Create(): ' + e.message + ', ' + e.stack + '</span>';
            thiz.element.html(html);

            var msg = 'Exception in bwTrack.js._create(): ' + e.message + ', ' + e.stack;
    ...
    loadAndRenderEmails: function (bwWorkflowAppId) {
        try {
            console.log('In bwTrack.js.loadAndRenderEmails(). bwWorkflowAppId: ' + bwWorkflowAppId);
            //alert('In bwTrack.js.loadAndRenderEmails(). bwWorkflowAppId: ' + bwWorkflowAppId);
            var thiz = this;
            ...
            html += '   </span>';
            html += '   <br /><br /><br />';
            //html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwTrack\').bwTrack(\'deleteSelectedPendingEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
            ...
            //html += '   </span>';
            //html += '   <br /><br /><br />';
            ////html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwTrack\').bwTrack(\'deleteSelectedSentEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
            ...
            if (developerModeEnabled == true) {
                html += '                               <span class="spanButton" title="Click to send this email now!" onclick="$(\'.bwTrack\').bwTrack(\'sendPendingEmailNow\');">';
                html += '                                   ✉&nbsp;Send Now > xcx1';
                html += '                               </span>';
            }
            ...
            //html += '                   <td xcx="xcx111">';
            ////html += 'xcx111';
            //html += '                       <span class="emailEditor_newMessageButton" onclick="$(\'.bwTrack:first\').bwTrack(\'composeANewEmailMessage\');">'; //
            //html += '                           &nbsp;✉&nbsp;New message&nbsp;';
            //html += '                       </span>';
            //html += '                   </td>';
            html += '                   <td xcx="xcx222">';
            ...
            html += '<span id="" style="float:right;white-space:nowrap;">   Search:    <span id="searchbox">       <input type="text" id="inputBwAuthentication_SearchBox" onkeydown="$(\'.bwTrack\').bwTrack(\'searchBox_OnKeyDown\', event);" style="WIDTH: 60%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 20pt;">       &nbsp;&nbsp;       <span class="emailEditor_newMessageButton" onclick="$(\'.bwTrack\').bwTrack(\'search\');">Search</span>   </span></span>';
            ...
            //if (developerModeEnabled == true) {
            //    html += '               <tr>';
            //    html += '                   <td id="spanDisplayAIConversationButton" class="bwTrack_LeftMenuButton" onclick="$(\'.bwTrack\').bwTrack(\'displayAIConversation\');">';
            //    html += '                       <span><span class="bwTrack_LeftMenuButton_UnicodeImage">🔊</span> AI Conversation</span>';
            //    html += '                       </br>';
            ...
            //// 6-5-2023
            //html += '               <tr>';
            //html += '                   <td id="spanDisplaySentEmailButton" class="bwTrack_LeftMenuButton" onclick="$(\'.bwTrack\').bwTrack(\'displayIncomingEmails\');">';
            //html += '                       <span><span class="bwTrack_LeftMenuButton_UnicodeImage">✉</span> Incoming</span>';
            //html += '                       </br>';
            ...
            //html += '               <tr>';
            //html += '                   <td id="spanDisplaySentEmailButton" class="bwTrack_LeftMenuButton" onclick="$(\'.bwTrack\').bwTrack(\'displaySentEmails\');">';
            //html += '                       <span><span class="bwTrack_LeftMenuButton_UnicodeImage">✉</span> Inbox</span>';
            //html += '                       </br>';
            ...
            //html += '               <tr>';
            //html += '                   <td id="spanDisplayPendingEmailButton" class="bwTrack_LeftMenuButton" onclick="$(\'.bwTrack\').bwTrack(\'displayPendingEmailsxxxx\');" >';
            //html += '                       <span><span class="bwTrack_LeftMenuButton_UnicodeImage">✉</span> Sent</span>';
            //html += '                       </br>';
            ...
            //html += '               <tr>';
            //html += '                   <td id="spanDisplayPendingEmailButton" class="bwTrack_LeftMenuButton" onclick="$(\'.bwTrack\').bwTrack(\'displayPendingEmails\');" >';
            //html += '                       <span><span class="bwTrack_LeftMenuButton_UnicodeImage">✉</span> Pending Inbox</span>';
            //html += '                       </br>';
            ...
            //html += '               <tr>';
            //html += '                   <td id="spanDisplayPendingEmailButton" class="bwTrack_LeftMenuButton" onclick="$(\'.bwTrack\').bwTrack(\'displayPendingEmails\');" >';
            //html += '                       <span><span class="bwTrack_LeftMenuButton_UnicodeImage"><img src="/images/trashbin.png"></span> TrashBin (Inbox)</span>';
            //html += '                       </br>';
            ...
            //html += '               <tr>';
            //html += '                   <td id="spanDisplayPendingEmailButtonxxx" class="bwTrack_LeftMenuButton" onclick="$(\'.bwTrack\').bwTrack(\'displayPendingEmailsxxx\');" >';
            //html += '                       <span><span class="bwTrack_LeftMenuButton_UnicodeImage">☎</span> Sent Text Message(s)</span>';
            //html += '                       </br>';
            ...
            //html += '               <tr>';
            //html += '                   <td id="spanDisplayPendingEmailButtonxxx" class="bwTrack_LeftMenuButton" onclick="$(\'.bwTrack\').bwTrack(\'displayPendingEmailsxxx\');" >';
            //html += '                       <span><span class="bwTrack_LeftMenuButton_UnicodeImage">☎</span> Pending Text Message(s)</span>';
            //html += '                       </br>';
            ...
            html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwTrack\').bwTrack(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
            html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
            html += '                           </span>';
            html += '&nbsp;&nbsp;';
            html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwTrack\').bwTrack(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
            ...
            html = '';
            html += '<input type="checkbox" id="checkboxToggleSentEmailCheckboxes" onchange="$(\'.bwTrack\').bwTrack(\'toggleSentEmailCheckboxes\', this);" />&nbsp;&nbsp;';
            html += '✉ Inbox Items';

            $(thiz.element).find('#spanSelectedEmailType_Title')[0].innerHTML = html; //'Sent Email';

            // Make this button appear selected.
            $(thiz.element).find('#spanDisplaySentEmailButton').removeClass('bwTrack_LeftMenuButton').addClass('bwTrack_LeftMenuButton_Selected');
            $(thiz.element).find('#spanDisplayPendingEmailButton').removeClass('bwTrack_LeftMenuButton_Selected').addClass('bwTrack_LeftMenuButton');
            ...
            console.log('xcx2313555. In bwTrack.js.loadAndRenderEmails(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwTrack.js.loadAndRenderEmails():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwTrack.js.loadAndRenderEmails():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwTrack.js.loadAndRenderEmails():' + errorCode + ', ' + errorMessage);
                    displayAlertDialog('Error in bwTrack.js.loadAndRenderEmails():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    loadAndRenderEmails_Sent: function (bwWorkflowAppId) {
        try {
            ...
            console.log('xcx2313555. In bwTrack.js.loadAndRenderEmails_Sent(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwTrack.js.loadAndRenderEmails_Sent():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwTrack.js.loadAndRenderEmails_Sent():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwTrack.js.loadAndRenderEmails_Sent():' + errorCode + ', ' + errorMessage);
                    displayAlertDialog('Error in bwTrack.js.loadAndRenderEmails_Sent():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    loadAndRenderEmails_Drafts: function (bwWorkflowAppId) {
        try {
            console.log('In bwTrack.js.loadAndRenderEmails_Drafts().');
            alert('In bwTrack.js.loadAndRenderEmails_Drafts().');
            var thiz = this;
            ...
            console.log('xcx2313555. In bwTrack.js.loadAndRenderEmails_Drafts(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwTrack.js.loadAndRenderEmails_Drafts():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwTrack.js.loadAndRenderEmails_Drafts():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwTrack.js.loadAndRenderEmails_Drafts():' + errorCode + ', ' + errorMessage);
                    displayAlertDialog('Error in bwTrack.js.loadAndRenderEmails_Drafts():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    loadAndRenderEmails_Junk: function (bwWorkflowAppId) {
        try {
            console.log('In bwTrack.js.loadAndRenderEmails_Junk().');
            alert('In bwTrack.js.loadAndRenderEmails_Junk().');
            var thiz = this;
            ...
            console.log('xcx2313555. In bwTrack.js.loadAndRenderEmails_Junk(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwTrack.js.loadAndRenderEmails_Junk():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwTrack.js.loadAndRenderEmails_Junk():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwTrack.js.loadAndRenderEmails_Junk():' + errorCode + ', ' + errorMessage);
                    displayAlertDialog('Error in bwTrack.js.loadAndRenderEmails_Junk():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    loadAndRenderEmails_Archived: function (bwWorkflowAppId) {
        try {
            console.log('In bwTrack.js.loadAndRenderEmails_Archived().');
            alert('In bwTrack.js.loadAndRenderEmails_Archived().');
            var thiz = this;
            ...
            console.log('xcx2313555. In bwTrack.js.loadAndRenderEmails_Archived(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwTrack.js.loadAndRenderEmails_Archived():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwTrack.js.loadAndRenderEmails_Archived():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwTrack.js.loadAndRenderEmails_Archived():' + errorCode + ', ' + errorMessage);
                    displayAlertDialog('Error in bwTrack.js.loadAndRenderEmails_Archived():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    loadAndRenderEmails_TrashBin: function (bwWorkflowAppId) {
        try {
            ...
            console.log('xcx2313555. In bwTrack.js.loadAndRenderEmails_TrashBin(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwTrack.js.loadAndRenderEmails_TrashBin():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwTrack.js.loadAndRenderEmails_TrashBin():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwTrack.js.loadAndRenderEmails_TrashBin():' + errorCode + ', ' + errorMessage);
                    displayAlertDialog('Error in bwTrack.js.loadAndRenderEmails_TrashBin():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    viewIndividualEmail_Inbox: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, _id) {
        try {
            console.log('In bwTrack.js.viewIndividualEmail_Inbox(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //displayAlertDialog_Persistent('In bwTrack.js.viewIndividualEmail_Inbox(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            ...
            if (!($(this.element).find('#displayedemaildetails') && $(this.element).find('#displayedemaildetails')[0] && $(this.element).find('#quillConfigureNewUserEmailsDialog_Body') && $(this.element).find('#quillConfigureNewUserEmailsDialog_Body')[0])) {
                ...
                alert('Error in bwTrack.js.viewIndividualEmail_Inbox(). An expected element is missing or not in the correct state. xcx124323643734.');
                ...
                this.loadIndividualEmail_Inbox(_id).then(function () {
                    try {
                        ...
                        $(thiz.element).find('.bwTrack_InnerLeftMenuButton_Selected').removeClass('bwTrack_InnerLeftMenuButton_Selected'); // Reset them all, only 1 can be selected at a time.
                        $('#bwTrack_InnerLeftMenuButton_' + _id).removeClass('bwTrack_InnerLeftMenuButton').addClass('bwTrack_InnerLeftMenuButton_Selected'); // Indicate this one as selected.
                        ...
                        html += '<span class="emailEditor_newMessageButton" onclick="$(\'.bwTrack:first\').bwTrack(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Reply&nbsp;</span>';
                        html += '&nbsp;&nbsp;&nbsp;';
                        html += '<span class="emailEditor_newMessageButton" onclick="$(\'.bwTrack:first\').bwTrack(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Reply All&nbsp;</span>';
                        html += '&nbsp;&nbsp;&nbsp;';
                        html += '<span class="emailEditor_newMessageButton" onclick="$(\'.bwTrack:first\').bwTrack(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Forward&nbsp;</span>';
                        ...
                        //var div = document.getElementById('bwTrack_EmailBodyClassProcessor');
                        //if (!div) {
                        //    div = document.createElement('div');
                        //    div.id = 'bwTrack_EmailBodyClassProcessor';
                        ...
                        console.log('In bwTrack.js.viewIndividualEmail_Inbox(). Turned off this call to bwActiveMenu.js.adjustLeftSideMenu(). DO WE NEED IT BACK????????? 12-24-2022');
                            ...
                            $.ajax({
                                ...
                                success: function (results) {
                                    try {
                                        ...
                                        console.log('Exception in bwTrack.js.viewIndividualEmail_Inbox():2: ' + e.message + ', ' + e.stack);
                                        displayAlertDialog('Exception in bwTrack.js.viewIndividualEmail_Inbox():2: ' + e.message + ', ' + e.stack);
                                    }
                                },
                                error: function (data, errorCode, errorMessage) {
                                    console.log('Error in bwTrack.js.viewIndividualEmail_Inbox():' + errorCode + ', ' + errorMessage);
                                    displayAlertDialog('Error in bwTrack.js.viewIndividualEmail_Inbox():' + errorCode + ', ' + errorMessage);
                                }
                            });
                        ...
                        console.log('Exception in bwTrack.js.viewIndividualEmail_Inbox():4: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwTrack.js.viewIndividualEmail_Inbox():4: ' + e.message + ', ' + e.stack);
                    }

                }).catch(function (e) {

                    console.log('Exception in bwTrack.js.viewIndividualEmail_Inbox():3: ' + JSON.stringify(e));
                    displayAlertDialog('Exception in bwTrack.js.viewIndividualEmail_Inbox():3: ' + JSON.stringify(e));
            ...
            console.log('Exception in bwTrack.js.viewIndividualEmail_Inbox(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwTrack.js.viewIndividualEmail_Inbox(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack);
        }
    },
    ...
    loadIndividualEmail_Inbox: function (_id) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwTrack.js.loadIndividualEmail_Inbox(). _id: ' + _id);
                //displayAlertDialog_Persistent('In bwTrack.js.loadIndividualEmail_Inbox(). _id: ' + _id);
                ...
                if (hasBeenLoaded == true) {
                    ...
                    if (!(workflowAppId && participantId && _id)) {
                        ...
                        var msg = 'Error in bwTrack.js.loadIndividualEmail_Inbox(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id;
                        console.log(msg);
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwTrack.js.loadAndRenderEmails():xcx542: results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        ...
                                        if (!foundIt) {
                                            ...
                                            var msg = 'Error in bwTrack.js.loadAndRenderEmails():xcx231312: Could not find the email.';
                                            console.log(msg);
                                    ...
                                    var msg = 'Exception in bwTrack.js.loadAndRenderEmails():2: ' + e.message + ', ' + e.stack;
                                    console.log(msg);
                            ...
                            error: function (data, errorCode, errorMessage) {
                                ...
                                var msg = 'Error in bwTrack.js.loadAndRenderEmails():' + errorCode + ', ' + errorMessage;
                                console.log(msg);
                ...
                var msg = 'Exception in bwTrack.js.loadIndividualEmail_Inbox():xcx453: ' + e.message + ', ' + e.stack;
    ...
    viewIndividualEmail_TrashBin: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, _id) {
        try {
            console.log('In bwTrack.js.viewIndividualEmail_TrashBin(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //displayAlertDialog_Persistent('In bwTrack.js.viewIndividualEmail_TrashBin(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            ...
            if (!($(this.element).find('#displayedemaildetails') && $(this.element).find('#displayedemaildetails')[0] && $(this.element).find('#quillConfigureNewUserEmailsDialog_Body') && $(this.element).find('#quillConfigureNewUserEmailsDialog_Body')[0])) {
                ...
                alert('Error in bwTrack.js.viewIndividualEmail_TrashBin(). An expected element is missing or not in the correct state. xcx124323643734.');
                ...
                this.loadIndividualEmail_TrashBin(_id).then(function () {
                    try {
                        ...
                        console.log('In bwTrack.js.viewIndividualEmail_TrashBin(). Turned off this call to bwActiveMenu.js.adjustLeftSideMenu(). DO WE NEED IT BACK????????? 12-24-2022');
                        // THIS IS THE FIRST TIME WE ARE USING setTimeout for the call to bwActiveMenu.adjustLeftSideMenu(). 4-25-2022
                        //setTimeout(function () { // Only needs to happen for Chrome.
                        //    // menu should be re-done since the display has probably resized from the display of the email.
                        //    //alert('Calling bwActiveMenu.adjustLeftSideMenu().');
                            ...
                            $.ajax({
                                ...
                                success: function (results) {
                                    try {
                                        ...
                                        console.log('Exception in bwTrack.js.viewIndividualEmail_TrashBin():2: ' + e.message + ', ' + e.stack);
                                        displayAlertDialog('Exception in bwTrack.js.viewIndividualEmail_TrashBin():2: ' + e.message + ', ' + e.stack);
                                    }
                                },
                                error: function (data, errorCode, errorMessage) {
                                    console.log('Error in bwTrack.js.viewIndividualEmail_TrashBin():' + errorCode + ', ' + errorMessage);
                                    displayAlertDialog('Error in bwTrack.js.viewIndividualEmail_TrashBin():' + errorCode + ', ' + errorMessage);
                                }
                            });
                        ...
                        console.log('Exception in bwTrack.js.viewIndividualEmail_TrashBin():4: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwTrack.js.viewIndividualEmail_TrashBin():4: ' + e.message + ', ' + e.stack);
                    }

                }).catch(function (e) {

                    console.log('Exception in bwTrack.js.viewIndividualEmail_TrashBin():3: ' + JSON.stringify(e));
                    displayAlertDialog('Exception in bwTrack.js.viewIndividualEmail_TrashBin():3: ' + JSON.stringify(e));
            ...
            console.log('Exception in bwTrack.js.viewIndividualEmail_TrashBin(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwTrack.js.viewIndividualEmail_TrashBin(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack);
        }
    },
    ...
    loadIndividualEmail_TrashBin: function (_id) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwTrack.js.loadIndividualEmail_TrashBin(). _id: ' + _id);
                //displayAlertDialog_Persistent('In bwTrack.js.loadIndividualEmail_TrashBin(). _id: ' + _id);
                ...
                if (hasBeenLoaded == true) {
                    ...
                    if (!(workflowAppId && participantId && _id)) {
                        ...
                        var msg = 'Error in bwTrack.js.loadIndividualEmail_TrashBin(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id;
                        console.log(msg);
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwTrack.js.loadIndividualEmail_TrashBin():xcx542: results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        ...
                                        if (!foundIt) {
                                            ...
                                            var msg = 'Error in bwTrack.js.loadIndividualEmail_TrashBin():xcx231312: Could not find the email.';
                                            console.log(msg);
                                    ...
                                    var msg = 'Exception in bwTrack.js.loadIndividualEmail_TrashBin():2: ' + e.message + ', ' + e.stack;
                                    console.log(msg);
                            ...
                            error: function (data, errorCode, errorMessage) {
                                ...
                                var msg = 'Error in bwTrack.js.loadIndividualEmail_TrashBin():' + errorCode + ', ' + errorMessage;
                                console.log(msg);
                ...
                var msg = 'Exception in bwTrack.js.loadIndividualEmail_TrashBin():xcx453: ' + e.message + ', ' + e.stack;
    ...
    deleteIndividualEmail: function (_id) {
        try {
            console.log('In bwTrack.js.deleteIndividualEmail(). _id: ' + _id);
            var thiz = this;
            ...
            if (!(workflowAppId && participantId && _id)) {
                ...
                console.log('Error in bwTrack.js.deleteIndividualEmail(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id);
                displayAlertDialog('Error in bwTrack.js.deleteIndividualEmail(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id);
            ...
            var msg = 'Exception in bwTrack.js.deleteIndividualEmail(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    searchBox_OnKeyDown: function (event) {
        try {
            console.log('In bwTrack.js.searchBox_OnKeyDown().');
            ...
            console.log('Exception in bwTrack.js.searchBox_OnKeyDown(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwTrack.js.searchBox_OnKeyDown(): ' + e.message + ', ' + e.stack);
        }
    },
    search: function () {
        try {
            console.log('In bwTrack.js.search().');
            var thiz = this;
            ...
            //        } catch (e) {
            //            HideActivitySpinner();
            //            console.log('Exception in bwTrack.js.search.getsearchresults.success(): ' + e.message + ', ' + e.stack);
            //            displayAlertDialog('Exception in bwTrack.js.search.getsearchresults.success(): ' + e.message + ', ' + e.stack);
            //        }
            //    },
            //    error: function (data, errorCode, errorMessage) {
            //        HideActivitySpinner();
            //        console.log('Error in bwTrack.js.search.getsearchresults.error(): ' + errorCode + ', ' + errorMessage + JSON.stringify(data));
            //        displayAlertDialog('Error in bwTrack.js.search.getsearchresults.error(): ' + errorCode + ', ' + errorMessage + JSON.stringify(data));
            //    }
            //});

        } catch (e) {
            HideActivitySpinner();
            console.log('Exception in bwTrack.js.search(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwTrack.js.search(): ' + e.message + ', ' + e.stack);
        }
    },

    composeANewEmailMessage: function () {
        try {
            console.log('In bwTrack.js.composeANewEmailMessage().');
            //alert('In bwTrack.js.composeANewEmailMessage().');
            ...
            //html += 'In bwTrack.js.composeANewEmailMessage().';
            html += '';
            html += '';
            html += '';
            html += '';
            ...
            html += '<button class="BwSmallButton" onclick="$(\'.bwTrack:first\').bwTrack(\'SendSingleEmailNow\');">SEND NOW >></button>';

            html += '<br />';
            html += 'TO:';
            html += '<br />';
            html += '<input type="text" id="bwTrack_RecipientsList" style="WIDTH: 100%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';

            html += '<br />';
            html += 'FROM:';
            html += '<br />';
            html += '<input type="text" value="' + participantEmail + '" id="bwTrack_From" xcx="xcx2314" readonly="true" style="WIDTH: 100%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';

            html += '<br />';
            html += 'SUBJECT:';
            html += '<br />';
            html += '<input type="text" id="bwTrack_EmailSubject" style="WIDTH: 100%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';

            html += '<br />';
            html += 'BODY:';
            html += '<br />';
            html += '<div id="bwTrack_EmailBody" class="xdTextBoxRequired bwRequestJson" contenteditable="true" bwdatarequired="true" bwfieldname="JustificationDetails" title="" style="height:500px; min-height: 100% !important;WORD-WRAP: break-word; WHITE-SPACE: normal; OVERFLOW-X: auto; OVERFLOW-Y: auto; WIDTH: 100%;BACKGROUND-COLOR: white;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
            html += '</div>';

            $('#spanSelectedEmail').html(html);

        } catch (e) {
            console.log('Exception in bwTrack.js.composeANewEmailMessage(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwTrack.js.composeANewEmailMessage(): ' + e.message + ', ' + e.stack);
        }
    },
    composeANewEmailMessage_Reply: function () {
        try {
            console.log('In bwTrack.js.composeANewEmailMessage_Reply().');
            //alert('In bwTrack.js.composeANewEmailMessage_Reply().');
            ...
            var bwTrack_RecipientsList = $('#bwEmailView_From').find('.EmailAddress_From')[0].innerHTML; // Just picking the first one.
            ...
            //html += 'In bwTrack.js.composeANewEmailMessage_Reply().';
            html += '';
            html += '';
            html += '';
            html += '';
            ...
            html += 'TO:';
            html += '<br />';
            html += '<input type="text" value="' + bwTrack_RecipientsList + '" id="bwTrack_RecipientsList" style="WIDTH: 100%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
            ...
            html += 'SUBJECT:';
            html += '<br />';
            html += '<input type="text" value="' + subject + '" id="bwTrack_EmailSubject" style="WIDTH: 100%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
            ...
            console.log('Exception in bwTrack.js.composeANewEmailMessage_Reply(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwTrack.js.composeANewEmailMessage_Reply(): ' + e.message + ', ' + e.stack);
        }
    },
    SendSingleEmailNow: function () {
        try {
            console.log('In bwTrack.js.SendSingleEmailNow().');

            var to; // = [];
            var singleRecipient = $('#bwTrack_RecipientsList').val(); // 'fred@budgetworkflow.com;betty@budgetworkflow.com;dino@budgetworkflow.com'
            to = singleRecipient;
            ...
            var subject = $('#bwTrack_EmailSubject').val(); //'test subject xcx2131234234';

            var body = $('#bwTrack_EmailBody').html(); //'test body xcx12346u';
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwTrack\').bwTrack(\'displayForestPendingEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwTrack\').bwTrack(\'displayForestPendingEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwTrack\').bwTrack(\'displayPendingEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwTrack\').bwTrack(\'displayPendingEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        try {
                            ...
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwTrack\').bwTrack(\'displaySentEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwTrack\').bwTrack(\'displaySentEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
                            ...
                            console.log('Exception in bwTrack.js.expandOrCollapseSentEmails():1: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwTrack.js.expandOrCollapseSentEmails():1: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (data, errorCode, errorMessage) {
                        console.log('Error in bwTrack.js.expandOrCollapseSentEmails():' + errorCode + ', ' + errorMessage);
                        displayAlertDialog('Error in bwTrack.js.expandOrCollapseSentEmails():' + errorCode + ', ' + errorMessage);
                    }
                });
            }
        } catch (e) {
            console.log('Exception in bwTrack.js.expandOrCollapseSentEmails(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwTrack.js.expandOrCollapseSentEmails(): ' + e.message + ', ' + e.stack);
        }
    },
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwTrack\').bwTrack(\'displayErrorsAndSuggestions\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwTrack\').bwTrack(\'displayErrorsAndSuggestions\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
    ...
    displayForestPendingEmails: function (bwWorkflowAppId) {
        try {
            ...
            try {
                var html = '';
                html += '<input type="checkbox" id="checkboxToggleForestPendingEmailCheckboxes" onchange="$(\'.bwTrack\').bwTrack(\'toggleForestPendingEmailCheckboxes\', this);" />';
                html += '                           <span style="padding: 4px 4px 4px 4px;border:1px solid lightblue;cursor:pointer;" onclick="$(\'.bwTrack\').bwTrack(\'cmdDisplayDeleteForestPendingEmailsDialog\');">';
                ...
                success: function (data) {
                    try {
                        ...
                        if (!data.length || data.length == 0) {
                            ...
                            html = '<table>';
                            for (var i = 0; i < data.length; i++) {
                                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onclick="$(\'.bwTrack\').bwTrack(\'viewForestPendingEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwPendingEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                            ...
                            html = '';
                            html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwTrack\').bwTrack(\'sendForestPendingEmailNow\');">';
    ...
    displayAIConversation: function () {
        try {
            console.log('In bwTrack.js.displayAIConversation().');
            //alert('In bwTrack.js.displayAIConversation().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwTrack.js.displayAIConversation(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwTrack.js.displayAIConversation(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    displayAlertDialog('Error in bwTrack.js.displayAIConversation():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    displayPendingEmails: function () { // Accepts "all" as a value for bwWorkflowAppId. This is for the forest administrator.
        try {
            ...
            //if (!bwWorkflowAppId) {
            //    alert('Error in bwTrack.js.displayPendingEmails(). Invalid value for bwWorkflowAppId: ' + bwWorkflowAppId);
            //} else {
            var participantId = $('.bwAuthentication').bwAuthentication('option', 'participantId');
            //var participantEmail = $('.bwAuthentication').bwAuthentication('option', 'participantEmail');
            //var participantFriendlyName = $('.bwAuthentication').bwAuthentication('option', 'participantFriendlyName');
            ...
            try {
                ...
                // Display the top buttons.
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwTrack\').bwTrack(\'cmdDisplayDeletePendingEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
                html += '                               <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" xcx="664993" >&nbsp;Delete';
                html += '                           </span>';
                html += '&nbsp;&nbsp;';
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwTrack\').bwTrack(\'cmdDisplayDeletePendingEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
                ...
                // Display the radio button and the title.
                html = '';
                html += '<input type="checkbox" id="checkboxTogglePendingEmailCheckboxes" onchange="$(\'.bwTrack\').bwTrack(\'togglePendingEmailCheckboxes\', this);" />&nbsp;&nbsp;';
                html += '✉ Pending Inbox Items';
                $(thiz.element).find('#spanSelectedEmailType_Title')[0].innerHTML = html; //'Pending Email';

                // Make this button appear selected.
                $(thiz.element).find('#spanDisplaySentEmailButton').removeClass('bwTrack_LeftMenuButton_Selected').addClass('bwTrack_LeftMenuButton');
                $(thiz.element).find('#spanDisplayPendingEmailButton').removeClass('bwTrack_LeftMenuButton').addClass('bwTrack_LeftMenuButton_Selected');
                    ...
                    success: function (data) {
                        try {
                            ...
                            if (!data.length || data.length == 0) {
                                ...
                                html = '<table>';
                                for (var i = 0; i < data.length; i++) {
                                    html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onclick="$(\'.bwTrack\').bwTrack(\'viewPendingEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwPendingEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                                    html += '    <td style="vertical-align:top;"><input type="checkbox" class="pendingEmailCheckbox" bwpendingemailid="' + data[i].bwPendingEmailId + '" /></td>';
                                    //var timestamp = getFriendlyDateAndTime(data[i].Timestamp);
                                    html += '    <td colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
                                    html += '<span style="font-weight:bold;color:black;">' + data[i].ToParticipantFriendlyName + '<br />';
                                ...
                                html = '';
                                html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwTrack\').bwTrack(\'sendPendingEmailNow\');">';
    ...
    renderEmails: function (bwWorkflowAppId) {
        try {
            console.log('In bwTrack.js.renderEmails(). bwWorkflowAppId: ' + bwWorkflowAppId);
            //alert('In bwTrack.js.renderEmails(). bwWorkflowAppId: ' + bwWorkflowAppId);
            var thiz = this;
            ...
            console.log('xcx2313555. In bwTrack.js.renderEmails(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
            ...
            if (!thiz.options.Inbox.length || thiz.options.Inbox.length == 0) {
                ...
                for (var i = 0; i < thiz.options.Inbox.length; i++) {
                    ...
                    html += '    <td id="bwTrack_InnerLeftMenuButton_' + thiz.options.Inbox[i].bwSentEmailId + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;max-width:350px;">';
                    ...
                    html += '<td class="bwTrack_Trashbin" style="max-width:40px;" onclick="$(\'.bwTrack\').bwTrack(\'deleteIndividualEmail\', \'' + thiz.options.Inbox[i]._id + '\');event.stopPropagation();">';
                ...
                if ($(thiz.element).find('#spanEmailPicker') && $(thiz.element).find('#spanEmailPicker')[0]) {
                    ...
                    //html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwTrack\').bwTrack(\'sendEmailNow\');">';
                    //html += '                           ✉&nbsp;Send Now > xcx5';
                    //html += '                       </div>';
    ...
    renderEmails_Sent: function (bwWorkflowAppId) {
        try {
            ...
            console.log('xcx2313555. In bwTrack.js.renderEmails_Sent(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
            ...
            if (!thiz.options.Sent.length || thiz.options.Sent.length == 0) {
                ...
                for (var i = 0; i < thiz.options.Sent.length; i++) {
                    //html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'#d8d8d8\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                    html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" _id="' + thiz.options.Sent[i]._id + '" class="bwEmailInboxRow" xcx="xcx2224555-3" onclick="$(\'.bwTrack\').bwTrack(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + thiz.options.Sent[i].bwParticipantId + '\', \'' + thiz.options.Sent[i].bwParticipantId + '\', \'' + thiz.options.Sent[i].bwParticipantFriendlyName + '\', \'' + thiz.options.Sent[i].bwParticipantEmail + '\', \'' + thiz.options.Sent[i]._id + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + thiz.options.Sent[i].bwParticipantId + '\', \'' + thiz.options.Sent[i].bwParticipantId + '\');">';
                    //debugger; // xcx999999
                    ...
                    html += '    <td id="bwTrack_InnerLeftMenuButton_' + thiz.options.Sent[i].bwSentEmailId + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;max-width:350px;">';
                    //debugger; // RelatedRequestId	ad19f2b8-707f-40ad-8228-a07d55a1ddac
                    ...
                    html += '<td class="bwTrack_Trashbin" style="max-width:40px;" onclick="$(\'.bwTrack\').bwTrack(\'deleteIndividualEmail\', \'' + thiz.options.Sent[i]._id + '\');event.stopPropagation();">';
                    html += '<img src="/images/trashbin.png" />';
                    html += '</td>';
    ...
    renderEmails_Drafts: function (bwWorkflowAppId) {
        try {
            ...
            console.log('xcx2313555. In bwTrack.js.renderEmails_Drafts(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    renderEmails_Junk: function (bwWorkflowAppId) {
        try {
            ...
            console.log('xcx2313555. In bwTrack.js.renderEmails_Junk(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    renderEmails_Archived: function (bwWorkflowAppId) {
        try {
            ...
            console.log('xcx2313555. In bwTrack.js.renderEmails_Archived(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    renderEmails_TrashBin: function (bwWorkflowAppId) {
        try {
            ...
            console.log('xcx2313555. In bwTrack.js.renderEmails_TrashBin(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
            ...
            if (!thiz.options.TrashBin.length || thiz.options.TrashBin.length == 0) {
                ...
                for (var i = 0; i < thiz.options.TrashBin.length; i++) {
                    //html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'#d8d8d8\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                    html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" _id="' + thiz.options.TrashBin[i]._id + '" class="bwEmailInboxRow" xcx="xcx2224555-3" onclick="$(\'.bwTrack\').bwTrack(\'viewIndividualEmail_TrashBin\', \'' + 'btnEditRaciRoles_' + thiz.options.TrashBin[i].bwParticipantId + '\', \'' + thiz.options.TrashBin[i].bwParticipantId + '\', \'' + thiz.options.TrashBin[i].bwParticipantFriendlyName + '\', \'' + thiz.options.TrashBin[i].bwParticipantEmail + '\', \'' + thiz.options.TrashBin[i]._id + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + thiz.options.TrashBin[i].bwParticipantId + '\', \'' + thiz.options.TrashBin[i].bwParticipantId + '\');">';
                    //debugger; // xcx999999
                    ...
                    html += '    <td id="bwTrack_InnerLeftMenuButton_' + thiz.options.TrashBin[i].bwSentEmailId + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;max-width:350px;">';
                    //debugger; // RelatedRequestId	ad19f2b8-707f-40ad-8228-a07d55a1ddac
                    ...
                    html += '<td class="bwTrack_Trashbin" style="max-width:40px;" onclick="$(\'.bwTrack\').bwTrack(\'deleteIndividualEmail\', \'' + thiz.options.TrashBin[i]._id + '\');event.stopPropagation();">';
                    html += '<img src="/images/trashbin.png" />';
                    html += '</td>';
    ...
    displayIncomingEmails: function (bwWorkflowAppId) {
        try {
                    ...
                    try {
                        ...
                        if (!data.length || data.length == 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-2" onclick="$(\'.bwTrack\').bwTrack(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
            ...
            //                        for (var i = 0; i < data.length; i++) {
            //                            //html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'#d8d8d8\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
            //                            html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-3" onclick="$(\'.bwTrack\').bwTrack(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
            //                            //debugger; // xcx999999
            //                            html += '    <td style="vertical-align:top;"><input type="checkbox" class="sentEmailCheckbox" bwsentemailid="' + data[i].bwSentEmailId + '" /></td>';
            //                            //debugger;
            //                            //var timestamp = getFriendlyDateAndTime(data[i].Timestamp);
            ...
            //                            //html += '    <td>' + data[i].Subject + '</td>'; // html += '    <td>' + data[i].FromEmailAddress + '</td>';
            //                            //html += '    <td><input type="button" bwpendingemailid="xxpeid"' + data[i].EmailLink + '" value="View" onclick="$(\'.bwMonitoringTools\').bwMonitoringTools(\'viewPendingEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwPendingEmailId + '\');" /></td>';
            //                            html += '    <td id="bwTrack_InnerLeftMenuButton_' + data[i].bwSentEmailId + '" colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
            //                            //debugger; // RelatedRequestId	ad19f2b8-707f-40ad-8228-a07d55a1ddac
            //                            html += '<span style="font-weight:bold;color:black;">' + data[i].ToParticipantFriendlyName + '<br />'; // + '<span style="color:#95b1d3;">'; // (' + data[i].ToParticipantEmail + ')';
            ...
            //            },
            //            error: function (data, errorCode, errorMessage) {
            //                console.log('Error in bwTrack.js.displayIncomingEmails():xcx1: ' + errorCode + ', ' + errorMessage);
            //                //displayAlertDialog('Error in bwTrack.js.displayIncomingEmails():xcx1: ' + errorCode + ', ' + errorMessage); // PUT THIS BACK SOMETIME 5-5-2022
            //            }
            //        });
            ...
            //                        html += '<table>';
            //                        for (var i = 0; i < data.length; i++) {
            //                            html += '<tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-4" onclick="$(\'.bwTrack\').bwTrack(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
            //                            html += '   <td style="vertical-align:top;"><input type="checkbox" class="sentEmailCheckbox" bwsentemailid="' + data[i].bwSentEmailId + '" /></td>';
            //                            html += '   <td colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
            ...
            //            },
            //            error: function (data, errorCode, errorMessage) {
            //                displayAlertDialog('Error in bwTrack.js.displayIncomingEmails():xcx2: ' + errorCode + ', ' + errorMessage);
            //            }
            //        });
            //    }
        ...
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    html = '';
                    html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwTrack\').bwTrack(\'deleteSelectedPendingEmails\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                    html += '       Delete the Pending Emails';
                    html += '   </div>';
                    ...
                    if (selectedEmails.length == 0) {
                        ...
                        html = '';
                        html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwTrack\').bwTrack(\'deleteSelectedPendingEmails\', \'' + bwWorkflowAppId + '\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                        html += '       Delete the Pending Emails';
                        html += '   </div>';
                        document.getElementById('divBwEmailMonitor_DeleteThePendingEmails').outerHTML = html;
        ...
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    html = '';
                    html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwTrack\').bwTrack(\'putInboxFolderIntoTheTrashBin\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                    html += '       Delete the Inbox Emails';
                    html += '   </div>';
                    ...
                    if (selectedEmails.length == 0) {
                        ...
                        html = '';
                        html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwTrack\').bwTrack(\'deleteSelectedSentEmails\', \'' + bwWorkflowAppId + '\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                        html += '       Delete the Sent Emails';
                        html += '   </div>';
                        document.getElementById('divBwEmailMonitor_DeleteTheSentEmails').outerHTML = html;
    ...
    //    try {
    //        console.log('In bwTrack.js.displayInnerLeftActiveMenu().');
