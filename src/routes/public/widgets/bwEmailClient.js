$.widget("bw.bwEmailClient", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwEmailClient.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        this.element.addClass("bwEmailClient");
        var thiz = this;
        try {
            ...
            html += '   </span>';
            html += '   <br /><br /><br />';
            //html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'deleteSelectedPendingEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
            ...
            html += '   </span>';
            html += '   <br /><br /><br />';
            //html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'deleteSelectedSentEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
            ...
            html += '<table style="width:100%;border: 2px solid red;" xcx="xcx232536">';
            html += '   <tr>';
            ...
            if (developerModeEnabled == true) {
                html += '                               <span class="spanButton" title="Click to send this email now!" onclick="$(\'.bwEmailClient\').bwEmailClient(\'sendPendingEmailNow\');">';
                html += '                                   ✉&nbsp;Send Now > xcx1';
                html += '                               </span>';
            }
            ...
            html += '                   <td xcx="xcx111">';
            //html += 'xcx111';
            html += '                       <span class="emailEditor_newMessageButton" onclick="$(\'.bwEmailClient:first\').bwEmailClient(\'composeANewEmailMessage\');">'; // 
            html += '                           &nbsp;✉&nbsp;New message&nbsp;';
            html += '                       </span>';
            html += '                   </td>';
            html += '                   <td xcx="xcx222">';
            ...
            if (developerModeEnabled == true) {
                html += '               <tr>';
                html += '                   <td id="spanDisplayAIConversationButton" class="bwEmailClient_LeftMenuButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayAIConversation\');">';
                html += '                       <span><span class="bwEmailClient_LeftMenuButton_UnicodeImage">🔊</span> AI Conversation</span>';
                html += '                       </br>';
            ...
            // 6-5-2023
            html += '               <tr>';
            html += '                   <td id="spanDisplaySentEmailButton" class="bwEmailClient_LeftMenuButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayIncomingEmails\');">';
            html += '                       <span><span class="bwEmailClient_LeftMenuButton_UnicodeImage">✉</span> Incoming</span>';
            html += '                       </br>';
            ...
            html += '               <tr>';
            html += '                   <td id="spanDisplaySentEmailButton" class="bwEmailClient_LeftMenuButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displaySentEmails\');">';
            html += '                       <span><span class="bwEmailClient_LeftMenuButton_UnicodeImage">✉</span> Inbox</span>';
            html += '                       </br>';
            ...
            html += '               <tr>';
            html += '                   <td id="spanDisplayPendingEmailButton" class="bwEmailClient_LeftMenuButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayPendingEmailsxxxx\');" >';
            html += '                       <span><span class="bwEmailClient_LeftMenuButton_UnicodeImage">✉</span> Sent</span>';
            html += '                       </br>';
            ...
            html += '               <tr>';
            html += '                   <td id="spanDisplayPendingEmailButton" class="bwEmailClient_LeftMenuButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayPendingEmails\');" >';
            html += '                       <span><span class="bwEmailClient_LeftMenuButton_UnicodeImage">✉</span> Pending Inbox</span>';
            html += '                       </br>';
            ...
            html += '               <tr>';
            html += '                   <td id="spanDisplayPendingEmailButtonxxx" class="bwEmailClient_LeftMenuButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayPendingEmailsxxx\');" >';
            html += '                       <span><span class="bwEmailClient_LeftMenuButton_UnicodeImage">☎</span> Sent Text Message(s)</span>';
            html += '                       </br>';
            ...
            html += '               <tr>';
            html += '                   <td id="spanDisplayPendingEmailButtonxxx" class="bwEmailClient_LeftMenuButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayPendingEmailsxxx\');" >';
            html += '                       <span><span class="bwEmailClient_LeftMenuButton_UnicodeImage">☎</span> Pending Text Message(s)</span>';
            html += '                       </br>';
            ...
            html += '   <tr>';
            html += '       <td>';
            html += '           <div style="width:400px;height:600px;overflow-y: scroll;">'; // The width is set here for the email list... 2-9-2022
            ...
            html += '                   </td>';
            html += '                   <td xcx="xcx333" style="vertical-align:top;">';
            ...
            this.displaySentEmails(); // This is a good user experinece, displaying the sent emails first. If the user wants to view pending emails, they can choose to do that.

            console.log('In bwEmailClient._create(). Printing has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwEmailClient: CANNOT INITIALIZE THE WIDGET</span>';
            html += '<br />';
            html += '<span style="">Exception in bwEmailClient.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    _destroy: function () {
        this.element
            .removeClass("bwEmailClient")
            .text("");
    },
    composeANewEmailMessage: function () {
        try {
            console.log('In bwEmailClient.js.composeANewEmailMessage().');
            //alert('In bwEmailClient.js.composeANewEmailMessage().');

            var participantEmail = $('.bwAuthentication').bwAuthentication('option', 'participantEmail');

            var html = '';

            //html += 'In bwEmailClient.js.composeANewEmailMessage().';
            html += '';
            html += '';
            html += '';
            html += '';
            ...
            html += '<button class="BwSmallButton" onclick="$(\'.bwEmailClient:first\').bwEmailClient(\'SendSingleEmailNow\');">SEND NOW >></button>';

            html += '<br />';
            html += 'TO:';
            html += '<br />';
            html += '<input type="text" id="bwEmailClient_RecipientsList" style="WIDTH: 100%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';

            html += '<br />';
            html += 'FROM:';
            html += '<br />';
            html += '<input type="text" value="' + participantEmail + '" id="bwEmailClient_From" xcx="xcx2314" readonly="true" style="WIDTH: 100%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';

            html += '<br />';
            html += 'SUBJECT:';
            html += '<br />';
            html += '<input type="text" id="bwEmailClient_EmailSubject" style="WIDTH: 100%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';

            html += '<br />';
            html += 'BODY:';
            html += '<br />';
            html += '<div id="bwEmailClient_EmailBody" class="xdTextBoxRequired bwRequestJson" contenteditable="true" bwdatarequired="true" bwfieldname="JustificationDetails" title="" style="height:500px; min-height: 100% !important;WORD-WRAP: break-word; WHITE-SPACE: normal; OVERFLOW-X: auto; OVERFLOW-Y: auto; WIDTH: 100%;BACKGROUND-COLOR: white;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
            html += '</div>';

            $('#spanSelectedEmail').html(html);

        } catch (e) {
            console.log('Exception in bwEmailClient.js.composeANewEmailMessage(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient.js.composeANewEmailMessage(): ' + e.message + ', ' + e.stack);
        }
    },
    SendSingleEmailNow: function () {
        try {
            console.log('In SendSingleEmailNow().');

            var to; // = [];
            var singleRecipient = $('#bwEmailClient_RecipientsList').val(); // 'fred@budgetworkflow.com;betty@budgetworkflow.com;dino@budgetworkflow.com'
            to = singleRecipient;
            ...
            var subject = $('#bwEmailClient_EmailSubject').val(); //'test subject xcx2131234234';

            var body = $('#bwEmailClient_EmailBody').html(); //'test body xcx12346u';
            ...
            if (proceed) {
                ...
                //displayAlertDialog_Persistent('xcx234234 CALLING _bw/SendSingleEmailNow(). data: ' + JSON.stringify(data));
                    ...
                    success: function (results) {
                        try {
                            ...
                            if (results.status != 'SUCCESS') {
                                ...
                                displayAlertDialog('The email was sent successfully. ' + results.message);
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayForestPendingEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayForestPendingEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayPendingEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayPendingEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        try {
                            ...
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displaySentEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displaySentEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
                            ...
                            console.log('Exception in bwEmailClient.js.expandOrCollapseSentEmails():1: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwEmailClient.js.expandOrCollapseSentEmails():1: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (data, errorCode, errorMessage) {
                        console.log('Error in bwEmailClient.js.expandOrCollapseSentEmails():' + errorCode + ', ' + errorMessage);
                        displayAlertDialog('Error in bwEmailClient.js.expandOrCollapseSentEmails():' + errorCode + ', ' + errorMessage);
                    }
                });
            }
        } catch (e) {
            console.log('Exception in bwEmailClient.js.expandOrCollapseSentEmails(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient.js.expandOrCollapseSentEmails(): ' + e.message + ', ' + e.stack);
        }
    },
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayErrorsAndSuggestions\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'displayErrorsAndSuggestions\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
    ...
    displayForestPendingEmails: function (bwWorkflowAppId) {
        try {
            ...
            try {
                var html = '';
                html += '<input type="checkbox" id="checkboxToggleForestPendingEmailCheckboxes" onchange="$(\'.bwEmailClient\').bwEmailClient(\'toggleForestPendingEmailCheckboxes\', this);" />';
                html += '                           <span style="padding: 4px 4px 4px 4px;border:1px solid lightblue;cursor:pointer;" onclick="$(\'.bwEmailClient\').bwEmailClient(\'cmdDisplayDeleteForestPendingEmailsDialog\');">';
                ...
                success: function (data) {
                    try {
                        ...
                        if (!data.length || data.length == 0) {
                            ...
                            html = '<table>';
                            for (var i = 0; i < data.length; i++) {
                                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onclick="$(\'.bwEmailClient\').bwEmailClient(\'viewForestPendingEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwPendingEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                            ...
                            html = '';
                            html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwEmailClient\').bwEmailClient(\'sendForestPendingEmailNow\');">';
    ...
    displayAIConversation: function () {
        try {
            console.log('In bwEmailClient.js.displayAIConversation().');
            //alert('In bwEmailClient.js.displayAIConversation().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwEmailClient.js.displayAIConversation(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwEmailClient.js.displayAIConversation(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    displayAlertDialog('Error in bwEmailClient.js.displayAIConversation():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    displayPendingEmails: function () { // Accepts "all" as a value for bwWorkflowAppId. This is for the forest administrator.
        try {
            ...
            //if (!bwWorkflowAppId) {
            //    alert('Error in bwEmailClient.js.displayPendingEmails(). Invalid value for bwWorkflowAppId: ' + bwWorkflowAppId);
            //} else {
            var participantId = $('.bwAuthentication').bwAuthentication('option', 'participantId');
            //var participantEmail = $('.bwAuthentication').bwAuthentication('option', 'participantEmail');
            //var participantFriendlyName = $('.bwAuthentication').bwAuthentication('option', 'participantFriendlyName');
            ...
            try {
                ...
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'cmdDisplayDeletePendingEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
                html += '                               <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" xcx="664993" >&nbsp;Delete';
                html += '                           </span>';
                html += '&nbsp;&nbsp;';
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'cmdDisplayDeletePendingEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
                ...
                html = '';
                html += '<input type="checkbox" id="checkboxTogglePendingEmailCheckboxes" onchange="$(\'.bwEmailClient\').bwEmailClient(\'togglePendingEmailCheckboxes\', this);" />&nbsp;&nbsp;';
                html += '✉ Pending Inbox Items';
                $(thiz.element).find('#spanSelectedEmailType_Title')[0].innerHTML = html; //'Pending Email';

                // Make this button appear selected.
                $(thiz.element).find('#spanDisplaySentEmailButton').removeClass('bwEmailClient_LeftMenuButton_Selected').addClass('bwEmailClient_LeftMenuButton');
                $(thiz.element).find('#spanDisplayPendingEmailButton').removeClass('bwEmailClient_LeftMenuButton').addClass('bwEmailClient_LeftMenuButton_Selected');
                    ...
                    success: function (data) {
                        try {
                            ...
                            if (!data.length || data.length == 0) {
                                ...
                                html = '<table>';
                                for (var i = 0; i < data.length; i++) {
                                    html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onclick="$(\'.bwEmailClient\').bwEmailClient(\'viewPendingEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwPendingEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                                    html += '    <td style="vertical-align:top;"><input type="checkbox" class="pendingEmailCheckbox" bwpendingemailid="' + data[i].bwPendingEmailId + '" /></td>';
                                    //var timestamp = getFriendlyDateAndTime(data[i].Timestamp);
                                    html += '    <td colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
                                    html += '<span style="font-weight:bold;color:black;">' + data[i].ToParticipantFriendlyName + '<br />';
                                ...
                                html = '';
                                html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwEmailClient\').bwEmailClient(\'sendPendingEmailNow\');">';
    ...
    displaySentEmails: function (bwWorkflowAppId) {
        try {
            ...
            try {
                ...
                // Display the top buttons.
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
                html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
                html += '                           </span>';
                html += '&nbsp;&nbsp;';
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
                ...
                // Display the radio button and the title.
                html = '';
                html += '<input type="checkbox" id="checkboxToggleSentEmailCheckboxes" onchange="$(\'.bwEmailClient\').bwEmailClient(\'toggleSentEmailCheckboxes\', this);" />&nbsp;&nbsp;';
                html += '✉ Inbox Items';

                $(thiz.element).find('#spanSelectedEmailType_Title')[0].innerHTML = html; //'Sent Email';

                // Make this button appear selected.
                $(thiz.element).find('#spanDisplaySentEmailButton').removeClass('bwEmailClient_LeftMenuButton').addClass('bwEmailClient_LeftMenuButton_Selected');
                $(thiz.element).find('#spanDisplayPendingEmailButton').removeClass('bwEmailClient_LeftMenuButton_Selected').addClass('bwEmailClient_LeftMenuButton');
            ...
            if (this.options.backendAdministrationMode == true) {
                ...
                alert('Calling POST ' + webserviceurl + '/bwadminsentemail2/ this.options.backendAdministrationMode: ' + this.options.backendAdministrationMode);
                    ...
                    success: function (data) {
                        try {
                            ...
                            if (!data.length || data.length == 0) {
                                ...
                                //html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwEmailClient\').bwEmailClient(\'sendEmailNow\');">';
                                //html += '                           ✉&nbsp;Send Now > xcx4';
                                //html += '                       </div>';
                                html += '<span id="spanSelectedEmailSubject" style="font-size:13pt;font-weight:bold;color:#95b1d3;"></span>';
                                html += '<br /><br />';
                ...
                this.options.OnlyDisplayEmailsForCurrentParticipant = true;

                if (this.options.OnlyDisplayEmailsForCurrentParticipant == true) {

                    console.log('In bwEmailClient.js.displaySentEmails(). Calling GET ' + webserviceurl + '/bwparticipantsentemail/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
                    ...
                    $.ajax({
                            ...
                            try {
                                ...
                                if (!data.length || data.length == 0) {
                                    ...
                                    for (var i = 0; i < data.length; i++) {
                                        ...
                                        html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-3" onclick="$(\'.bwEmailClient\').bwEmailClient(\'viewSentEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                                        //debugger; // xcx999999
                                        html += '    <td style="vertical-align:top;"><input type="checkbox" class="sentEmailCheckbox" bwsentemailid="' + data[i].bwSentEmailId + '" /></td>';
                                        //debugger;
                                        //var timestamp = getFriendlyDateAndTime(data[i].Timestamp);
                                        ...
                                        html += '    <td id="bwEmailClient_InnerLeftMenuButton_' + data[i].bwSentEmailId + '" colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
                                        ...
                                        if (data[i].Subject) {
                                            ...
                                            html += '<span style="font-weight:lighter;color:#95b1d3;">' + '[no subject]' + ' ...</span>';
                                            alert('xcx3453453 data: ' + JSON.stringify(data));
                                        }
                        ...
                        error: function (data, errorCode, errorMessage) {
                            console.log('Error in bwEmailClient.js.displaySentEmails():xcx1: ' + errorCode + ', ' + errorMessage);
                            //displayAlertDialog('Error in bwEmailClient.js.displaySentEmails():xcx1: ' + errorCode + ', ' + errorMessage); // PUT THIS BACK SOMETIME 5-5-2022
                        }
                    });
                    ...
                    alert('Calling DELETE ' + webserviceurl + '/bwwebappsentemail/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            try {
                                ...
                                if (!data.length || data.length == 0) {
                                    ...
                                    html += '<table>';
                                    for (var i = 0; i < data.length; i++) {
                                        html += '<tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-4" onclick="$(\'.bwEmailClient\').bwEmailClient(\'viewSentEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                                        html += '   <td style="vertical-align:top;"><input type="checkbox" class="sentEmailCheckbox" bwsentemailid="' + data[i].bwSentEmailId + '" /></td>';
                                        html += '   <td colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
                        ...
                        error: function (data, errorCode, errorMessage) {
                            displayAlertDialog('Error in bwEmailClient.js.displaySentEmails():xcx2: ' + errorCode + ', ' + errorMessage);
                        }
                    });
                }
    ...
    displayIncomingEmails: function (bwWorkflowAppId) {
        try {
                    ...
                    success: function (data) {
                        try {
                            ...
                            if (!data.length || data.length == 0) {
                                ...
                                thiz.viewSentEmail('btnEditRaciRoles_undefined', 'undefined', 'undefined', 'undefined', data[0].bwIncomingEmailId);
            ...
            //            },
            //            error: function (data, errorCode, errorMessage) {
            //                console.log('Error in bwEmailClient.js.displayIncomingEmails():xcx1: ' + errorCode + ', ' + errorMessage);
            //                //displayAlertDialog('Error in bwEmailClient.js.displayIncomingEmails():xcx1: ' + errorCode + ', ' + errorMessage); // PUT THIS BACK SOMETIME 5-5-2022
            //            }
            //        });
            ...
            //            },
            //            error: function (data, errorCode, errorMessage) {
            //                displayAlertDialog('Error in bwEmailClient.js.displayIncomingEmails():xcx2: ' + errorCode + ', ' + errorMessage);
            //            }
            //        });
            //    }
    ...
    //        try {
    //            var html = '';
    //            html += '<input type="checkbox" id="checkboxToggleErrorsAndSuggestionsCheckboxes" onchange="$(\'.bwEmailClient\').bwEmailClient(\'toggleErrorsAndSuggestionsCheckboxes\', this);" />';
    //            html += '<span style="padding: 4px 4px 4px 4px;border:1px solid lightblue;cursor:pointer;" onclick="$(\'.bwEmailClient\').bwEmailClient(\'cmdDisplayDeleteErrorsAndSuggestionsDialog\');">';
    //            html += '   <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png">&nbsp;Delete';
    //            html += '</span>';
    //            html += '<br />';
    ...
    //                                html += '<span title="Flag this message..." style="font-size:13pt;width:100%;text-align:right;color:red;" onmouseover="this.style.color=\'aqua\';" onmouseout="this.style.color=\'red\';" onclick="$(\'.bwEmailClient\').bwEmailClient(\'flagThisMessage\', \'' + data.result[i].bwErrorOrSuggestionId + '\', true);">⚑</span>';
    //                            } else {
    //                                //debugger;
    //                                html += '<span style="font-weight:bold;color:black;width:100%;">' + data.result[i].CreatedByFriendlyName + '&nbsp;&nbsp;&nbsp;&nbsp;';
    //                                html += '<span title="Flag this message..." style="font-size:13pt;width:100%;text-align:right;" onmouseover="this.style.color=\'aqua\';" onmouseout="this.style.color=\'black\';" onclick="$(\'.bwEmailClient\').bwEmailClient(\'flagThisMessage\', \'' + data.result[i].bwErrorOrSuggestionId + '\', false);">⚐</span>';
    //                            }
    //                            html += '   <br />';
    ...
    viewSentEmail: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, bwEmailId) {
        try {
            ...
            $.ajax({
                ...
                success: function (data) {
                    try {
                        //alert('xcx234253462-2');

                        // This if statement just checks we still have these displayed on the screen/available in the dom.
                        if ($(thiz.element).find('#displayedemaildetails') && $(thiz.element).find('#displayedemaildetails')[0] && $(thiz.element).find('#quillConfigureNewUserEmailsDialog_Body') && $(thiz.element).find('#quillConfigureNewUserEmailsDialog_Body')[0]) {
                            ...
                            //alert('xcx1234234: bwEmailClient_InnerLeftMenuButton_' + bwEmailId);


                            // 04-18-2022
                            // id="bwEmailClient_InnerLeftMenuButton_' + data[i].bwSentEmailId + '"
                            $(thiz.element).find('.bwEmailClient_InnerLeftMenuButton_Selected').removeClass('bwEmailClient_InnerLeftMenuButton_Selected'); // Reset them all, only 1 can be selected at a time.
                            $('#bwEmailClient_InnerLeftMenuButton_' + bwEmailId).removeClass('bwEmailClient_InnerLeftMenuButton').addClass('bwEmailClient_InnerLeftMenuButton_Selected'); // Indicate this one as selected.
                            ...
                            if (data && data[0] && data[0].Subject) {
                                emailTemplateForSubject = data[0].Subject;
                            }
                            var emailTemplate;
                            if (data && data[0] && data[0].Body) {
                                emailTemplate = data[0].Body;
                            }
                            if (emailTemplateForSubject && emailTemplateForSubject != '') {
                                $(thiz.element).find('#quillConfigureNewUserEmailsDialog_Subject')[0].value = emailTemplateForSubject;
                            } else {
                            ...
                            console.log('Turned off this call to bwActiveMenu.js.adjustLeftSideMenu(). DO WE NEED IT BACK????????? 12-24-2022');
                        ...
                        displayAlertDialog('Exception in viewSentEmail(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in xx.js.viewSentEmail():' + errorCode + ', ' + errorMessage);
            ...
            displayAlertDialog('Exception in viewSentEmail(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack);
        }
    },
    ...
    deleteSelectedSentEmails: function (bwWorkflowAppId, instruction) {
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                console.log('Error in deleteSelectedSentEmails(): Invalid value for bwWorkflowAppId: ' + bwWorkflowAppId);
                displayAlertDialog('Error in deleteSelectedSentEmails(): Invalid value for bwWorkflowAppId: ' + bwWorkflowAppId);
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    for (var i = 0; i < checkboxes.length; i++) {
                        if (checkboxes[i].checked == true) {
                            var bwSentEmailId = checkboxes[i].getAttribute('bwsentemailid');
                            selectedSentEmailIdsToDelete.push(bwSentEmailId);
                        } else {
                            // do nothing.
                        }
                    }
                ...
                $.ajax({
                    url: this.options.operationUriPrefix + "_bw/deletesentemails",
                    //dataType: "json",
                    contentType: "application/json",
                    type: "Post",
                    data: JSON.stringify(json)
            ...
            displayAlertDialog('Exception in deleteSelectedSentEmails(): ' + e.message + ', ' + e.stack);
        }
    },
        ...
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    html = '';
                    html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'deleteSelectedPendingEmails\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                    html += '       Delete the Pending Emails';
                    html += '   </div>';
                    ...
                    if (selectedEmails.length == 0) {
                        ...
                        html = '';
                        html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'deleteSelectedPendingEmails\', \'' + bwWorkflowAppId + '\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                        html += '       Delete the Pending Emails';
                        html += '   </div>';
                        document.getElementById('divBwEmailMonitor_DeleteThePendingEmails').outerHTML = html;
        ...
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    html = '';
                    html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'deleteSelectedSentEmails\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                    html += '       Delete the Sent Emails';
                    html += '   </div>';
                    ...
                    if (selectedEmails.length == 0) {
                        ...
                        html = '';
                        html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailClient\').bwEmailClient(\'deleteSelectedSentEmails\', \'' + bwWorkflowAppId + '\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                        html += '       Delete the Sent Emails';
                        html += '   </div>';
                        document.getElementById('divBwEmailMonitor_DeleteTheSentEmails').outerHTML = html;
    ...
    //                        html += '       <span onclick="$(\'.bwEmailClient\').bwEmailClient(\'cmdListPendingEmail3\');" style="font-size:15px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;">✉ Pending</span>';
    ...
    //                        html += '       <span onclick="$(\'.bwEmailClient\').bwEmailClient(\'cmdListSentEmail2\');" style="font-size:15px;white-space:nowrap;cursor:pointer;">✉ Sent</span>';
    //                        html += '       <br />';
    //                        html += '       <span onclick="$(\'.bwEmailClient\').bwEmailClient(\'cmdListErrorsOrSuggestions2\');" style="font-size:15px;white-space:nowrap;cursor:pointer;">✉ Errors & Suggestions</span>';
