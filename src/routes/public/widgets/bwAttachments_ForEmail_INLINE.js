$.widget("bw.bwAttachments_ForEmail_INLINE", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwAttachments_ForEmail_INLINE.js jQuery Widget. 
        ===========================================================
        ...
        */
        ...
        // WHEN WE UPLOAD AN INLINE ATTACHMENT, WE already have the image on the client. Should we use the canvas, resize to 320px, and generate the 64bit string at the same time.!
        INLINE_64bit_AttachmentsArray: [], // Save the 64bit 320px image strings in this property. This will get populated in the following method: xx(). 6-7-2024.
    ...
    _create: function () {
        console.log('In bwAttachments_ForEmail_INLINE.js._create().');
        //alert('In bwAttachments_ForEmail_INLINE.js._create().');
        this.element.addClass("bwAttachments_ForEmail_INLINE");
        ...
        try {
            ...
            console.log('In bwAttachments_ForEmail_INLINE.js._create().option.INLINE == true.');
            this.renderAndPopulateAttachments_INLINE(); // Need to render, not allowing the user to make modifications.

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments_ForEmail_INLINE</span>';
            html += '<br />';
            html += '<span style="">Exception in bwAttachments_ForEmail_INLINE.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    _destroy: function () {
        this.element
            .removeClass("bwAttachments_ForEmail_INLINE")
            .text("");
    },
    getDataType: function () {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.getDataType().');

            return 'attachments';
        } catch (e) {
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.getDataType(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.js.getDataType(): ' + e.message + ', ' + e.stack);
        }
    },
    getData: function () {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.getData().');
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.getData(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.getData(): ' + e.message + ', ' + e.stack);
        }
    },
    isARequiredField: function () {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.isARequiredField().');
            return this.options.renderAsARequiredField;
        } catch (e) {
            console.log('Exception in bwAttachments_ForEmail_INLINE.isARequiredField(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.isARequiredField(): ' + e.message + ', ' + e.stack);
        }
    },
    getfieldTitle: function () {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.getfieldTitle().');
            return this.options.fieldTitle;
        } catch (e) {
            console.log('Exception in bwAttachments_ForEmail_INLINE.getfieldTitle(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.getfieldTitle(): ' + e.message + ', ' + e.stack);
        }
    },

    renderAndPopulateAttachments_INLINE: function () {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_INLINE().');
            //alert('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_INLINE().');
            var thiz = this;
            ...
            if (!bwDraftEmailId) {
                ...
                //alert('Error in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_INLINE(). Unexpected value for bwDraftEmailId: ' + bwDraftEmailId);
                //displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_INLINE(). Unexpected value for bwDraftEmailId: ' + bwDraftEmailId);
            ...
            html += '   <tbody>';
            html += '       <tr xcx="xcx21342526-1" id="xcx21342526-1" class="xdTableOffsetRow" id="toolboxdraggablerow_2" draggable="true" bwwidgetname="bwAttachments_ForEmail_INLINE">';
            ...
            html += '<input type="file" multiple name="multerFileUploadIdentifier_original" id="inputFile_INLINE_' + bwDraftEmailId + '" class="upload" style="visibility:hidden;" onchange="$(\'.bwAttachments_ForEmail_INLINE:first\').bwAttachments_ForEmail_INLINE(\'uploadAttachment\',\'newrequestattachments\', \'' + requestDialogId + '\', \'INLINE\');" />';
            //html += '<input type="file" name="multerFileUploadIdentifier_original" id="inputFile_' + bwBudgetRequestId + '" class="upload" style="visibility:hidden;" onchange="$(\'.bwAttachments_ForEmail_INLINE:first\').bwAttachments_ForEmail_INLINE(\'uploadAttachment\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwDraftEmailId + '\');" />';





            //alert('Rendering onchange .bwAttachments_ForEmail_INLINE:closest uploadAttachment().')
            ...
            html += '           <p id="newrequestattachments_INLINE" xcx="xcx448-1-1-8" style="word-break:break-all;white-space:normal;"></p>';
            ...
            html += '               onclick="$(\'.bwAttachments_ForEmail_INLINE:first\').bwAttachments_ForEmail_INLINE(\'copyAttachments\',\'newrequestattachmentsxcx2334\', \'' + requestDialogId + '\', \'' + bwDraftEmailId + '\', \'' + bwRequestTitle + '\', \'' + bwRequestTypeId + '\');" />';
            ...
            html += '               onclick="$(\'.bwAttachments_ForEmail_INLINE:first\').bwAttachments_ForEmail_INLINE(\'performOCR_MultipleImages\', \'' + requestDialogId + '\', \'' + bwDraftEmailId + '\', \'' + bwRequestTitle + '\', \'' + bwRequestTypeId + '\');" />';
            ...
            if (this.options.inFormsEditor != true) {
                ...
                //debugger;
                //var element = $('.bwAttachments_ForEmail_INLINE:first').find('.xdTableOffsetRow');

                $('.bwAttachments_ForEmail_INLINE:first').find('.xdTableOffsetRow').removeAttr('draggable'); // 4-19-2024. 
                $('.bwAttachments_ForEmail_INLINE:first').find('.xdTableOffsetRow').removeClass('xdTableOffsetRow-editor');
            ...
            var dropzone = document.getElementById('bwAttachments_ForEmail_INLINE_dropzone_INLINE_' + bwDraftEmailId);
                ...
                try {
                    ...
                    if (e.clipboardData) {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwAttachments_ForEmail_INLINE.js.dropzone.drop(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwAttachments_ForEmail_INLINE.js.dropzone.drop(). Could not find a valid DataTransfer object.');
                    }

                } catch (e) {
                    var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.dropzone.drop(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
                ...
                try {
                    ...
                    if (e.clipboardData) {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwAttachments_ForEmail_INLINE.js.dropzone.paste(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwAttachments_ForEmail_INLINE.js.dropzone.paste(). Could not find a valid DataTransfer object.');
                    }

                } catch (e) {
                    var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.dropzone.paste(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            if (this.options.jsonData) {
                ...
                ////alert('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments(). this.options.jsonData.bwBudgetRequestId: ' + this.options.jsonData.bwBudgetRequestId + ', this.options.jsonData: ' + JSON.stringify(this.options.jsonData));
                console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-1');
            ...
            html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments_ForEmail_INLINE</span>';
            html += '<br />';
            html += '<span style="">Exception in bwAttachments_ForEmail_INLINE.renderAndPopulateAttachments_INLINE(): ' + e.message + ', ' + e.stack + '</span>';
            this.element.html(html);
        }
    },
    ...
    dodrop: function (event, bwDraftEmailId) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.dodrop().');
            alert('In bwAttachments_ForEmail_INLINE.js.dodrop().');
            var thiz = this;

            if (event.clipboardData) {

                console.log('In bwAttachments_ForEmail_INLINE.js.dodrop(). THIS IS clipboardData.');
                ...
                console.log('In bwAttachments_ForEmail_INLINE.js.dodrop(). THIS IS dataTransfer.');
                ...
                if ((event.dataTransfer.types.indexOf('Files') > -1) && (event.dataTransfer.types.length == 1)) {
                    ...
                    //
                    // These are files dragged within the browser window. For example, from one request bwAttachments_ForEmail_INLINE widget to another requests bwAttachments_ForEmail_INLINE widget.
                    //
                    ...
                    if ((imageData.indexOf(strUrlWithWorkflowAppId) > -1) && (imageData.indexOf(strActiveStateIdentifierInUrl) > -1)) {
                        ...
                        console.log('In bwAttachments_ForEmail_INLINE.js.dodrop(). Yes the user is dragging and dropping an attachment from one request to another. This is a CUT operation... imageData: ' + imageData);
                        ...
                        console.log('In bwAttachments_ForEmail_INLINE.js.dodrop(). fileNameToCutAndPaste_Thumbnail: ' + fileNameToCutAndPaste_Thumbnail + ', bwBudgetRequestId_Origin: ' + bwBudgetRequestId_Origin + ', bwBudgetRequestId_Destination: ' + bwBudgetRequestId_Destination);
                        //displayAlertDialog('In bwAttachments_ForEmail_INLINE.js.dodrop(). fileNameToCutAndPaste_Thumbnail: ' + fileNameToCutAndPaste_Thumbnail + ', bwBudgetRequestId_Origin: ' + bwBudgetRequestId_Origin + ', bwBudgetRequestId_Destination: ' + bwBudgetRequestId_Destination);
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwAttachments_ForEmail_INLINE.js.dodrop.bwCutAndPaste_Attachment(). ' + results.status + ': ' + results.message;
                                        console.log(msg);
                                    ...
                                    for (var i = 0; i < forms.length; i++) {
                                        ...
                                        if ((bwBudgetRequestId_Temp == bwBudgetRequestId_Origin) || (bwBudgetRequestId_Temp == bwBudgetRequestId_Destination)) {
                                            requestCounter += 1;
                                            $(forms[i]).find('.bwAttachments_ForEmail_INLINE').bwAttachments_ForEmail_INLINE('renderAndPopulateAttachments'); // Call this method for this specific widget. This will re-generate the gold colored drag-and-drop section... etc...
                                        }
                                    }
                                    ...
                                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.dodrop():2: ' + e.message + ', ' + e.stack);
                                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.dodrop():2: ' + e.message + ', ' + e.stack);
                                    $(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.js.dodrop():2: ' + e.message + ', ' + e.stack;
                                }
                            },
                            error: function (data, errorCode, errorMessage) {
                                $('#divWorkingOnItDialog').dialog('close'); // Close the "Working on it..." dialog.
                                console.log('Error in bwAttachments_ForEmail_INLINE.js.dodrop(): ' + errorMessage);
                                debugger;
                                if (errorMessage == 'timeout') {
                                    displayAlertDialog('The file server could not be contacted. Please try again in a few minutes.');
                                } else {
                                    displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.dodrop(): ' + errorMessage);
                                }
                            }
                        });
                            ...
                            .then(function (blob) {
                                try {
                                    ...
                                    if (!fileInput) {
                                        ...
                                        alert('Error in bwAttachments_ForEmail_INLINE.js.dodrop(). Cannot find element: inputFile_' + bwDraftEmailId + ', imgSrc2: ' + imgSrc2);
                                    ...
                                    alert('Exception in bwAttachments_ForEmail_INLINE.js.dodrop(). xcx215343: ' + e.message + ', ' + e.stack);
                ...
                displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.dodrop(). Could not find a valid DataTransfer object.');
            ...
            //alert('In bwAttachments_ForEmail_INLINE.js.dodrop(). dt.types: ' + dt.types);
            ...
            //        console.log('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop(). Yes the user is dragging and dropping an attachment from one request to another. This is a CUT operation... imageData: ' + imageData);
            ...
            //                        var msg = 'Error in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop.bwCutAndPaste_Attachment(). ' + results.status + ': ' + results.message;
            //                        console.log(msg);
            //                        displayAlertDialog_Persistent(msg);
            ...
            //                } catch (e) {
            //                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop():2: ' + e.message + ', ' + e.stack);
            //                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop():2: ' + e.message + ', ' + e.stack);
            //                    $(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop():2: ' + e.message + ', ' + e.stack;
            //                }
            //            },
            //            error: function (data, errorCode, errorMessage) {
            //                $('#divWorkingOnItDialog').dialog('close'); // Close the "Working on it..." dialog.
            //                console.log('Error in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop(): ' + errorMessage);
            //                debugger;
            //                if (errorMessage == 'timeout') {
            //                    displayAlertDialog('The file server could not be contacted. Please try again in a few minutes.');
            //                } else {
            //                    displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop(): ' + errorMessage);
            //                }
            //            }
            //        });
            ...
            //                        alert('Error in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop(). Cannot find element: inputFile_' + bwBudgetRequestId + ', imgSrc2: ' + imgSrc2);
            ...
            //                } catch (e) {
            //                    alert('Exception in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop(). xcx215343: ' + e.message + ', ' + e.stack);
            ...
            //    console.log('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop(). No base64 in the img src or this element. It must be a http reference... imgSrc: ' + imgSrc);
            ...
            //        console.log('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments.dropzone.drop(). Yes the user is dragging and dropping an attachment from one request to another. This is a CUT operation... imgSrc: ' + imgSrc);
    ...
    //    try {
    //        console.log('In bwAttachments_ForEmail_INLINE.js.downloadZippedFiles().');
    //        //alert('In bwAttachments_ForEmail_INLINE.js.downloadZippedFiles().');
    //        var thiz = this;
    ...
    //                        var msg = 'Error in bwAttachments_ForEmail_INLINE.js.downloadZippedFiles(). ' + results.status + ': ' + results.message;
    //                        console.log(msg);
    ...
    //                    var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.downloadZippedFiles.DownloadAllFilesZippedForBudgetRequest(): ' + e.message + ', ' + e.stack;
    //                    console.log(msg);
    //                    displayAlertDialog(msg);
    ...
    //                var msg = 'Error in bwAttachments_ForEmail_INLINE.js.downloadZippedFiles.DownloadAllFilesZippedForBudgetRequest(): ' + errorMessage;
    //                console.log(msg);
    //                displayAlertDialog(msg);
    ...
    //        var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.downloadZippedFiles(): ' + e.message + ', ' + e.stack;
    //        console.log(msg);
    //        alert(msg);
    ...
    ConvertMediaFileToBaselineShareable: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.ConvertMediaFileToBaselineShareable().');
            alert('In bwAttachments_ForEmail_INLINE.js.ConvertMediaFileToBaselineShareable().');
            var thiz = this;
            ...
            //      - subsequently, the bwAttachments_ForEmail_INLINE.js widget gets progress/status updates by calling /_fileconversion/GetMediaFileConversionProgress.
            //
            //
            //
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            displayAlertDialog('In bwAttachments_ForEmail_INLINE.js.ConvertMediaFileToBaselineShareable.success(): ' + results.status + ', ' + results.message);
                        ...
                        console.log('Exception in bwAttachments_ForEmail_INLINE.js.ConvertMediaFileToBaselineShareable.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.ConvertMediaFileToBaselineShareable.success(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    ...
                    console.log('Error in bwAttachments_ForEmail_INLINE.js.ConvertMediaFileToBaselineShareable.error(): ' + errorMessage);
                    displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.ConvertMediaFileToBaselineShareable.error(): ' + errorMessage);
                }
            });
            ...
            var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.ConvertMediaFileToBaselineShareable(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    launchFileConversion: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.launchFileConversion().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (data) {
                    try {
                        ...
                        console.log('Exception in bwAttachments_ForEmail_INLINE.js.launchFileConversion.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.launchFileConversion.success(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwAttachments_ForEmail_INLINE.js.launchFileConversion.error(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.launchFileConversion.error(): bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename + ', errorMessage: ' + errorMessage);
                }
            });

        } catch (e) {
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.launchFileConversion(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.launchFileConversion(): ' + e.message + ', ' + e.stack);
        }
    },
    getExifData: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.getExifData().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwAttachments_ForEmail_INLINE.js.getExifData.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.getExifData.success(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwAttachments_ForEmail_INLINE.js.getExifData.error(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.getExifData.error(): bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename + ', errorMessage: ' + errorMessage);
                }
            });

        } catch (e) {
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.getExifData(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.getExifData(): ' + e.message + ', ' + e.stack);
        }
    },

    performOCR: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.performOCR().');
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.performOCR(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.performOCR(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.js.performOCR(): ' + e.message + ', ' + e.stack);
        }
    },

    performOCR_MultipleImages: function (requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId) { // filename) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.performOCR_MultipleImages().');
            var thiz = this;
            //alert('In bwAttachments_ForEmail_INLINE.js.performOCR_MultipleImages(). bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename);
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            //                console.log('Exception in bwAttachments_ForEmail_INLINE.js.copyAttachments.displayImageThumbnail(): ' + e.message + ', ' + e.stack);
                            //                displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.copyAttachments.displayImageThumbnail(): ' + e.message + ', ' + e.stack);
                            ...
                            //        console.log('Fail in bwAttachments_ForEmail_INLINE.js.copyAttachments.displayImageThumbnail(): ' + JSON.stringify(result));
                            //        displayAlertDialog('Fail in bwAttachments_ForEmail_INLINE.js.copyAttachments.displayImageThumbnail(): ' + JSON.stringify(result));
                            //        document.getElementById(imgId).src = globalUrlPrefix + globalUrl + '/images/mp4.jfif'; // There is no thumbnail, so display the icon.
                            //    });
                            //}
                            ...
                            //            var imgId = 'img_bwAttachments_ForEmail_INLINE_' + thiz.options.elementIdSuffix + '_' + bwBudgetRequestId + '_' + i;
                        ...
                        console.log('Exception in bwAttachments_ForEmail_INLINE.js.copyAttachments.dialog.open.ajax.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.copyAttachments.dialog.open.ajax.success(): ' + e.message + ', ' + e.stack);
                    }

                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwAttachments_ForEmail_INLINE.js.copyAttachments.dialog.open.ajax.error(): ' + errorMessage + ', workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', participantId: ' + participantId);
                    displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.copyAttachments.dialog.open.ajax.error(): ' + errorMessage + ', workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', participantId: ' + participantId);
                }
            });

        } catch (e) {
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.performOCR_MultipleImages(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.performOCR_MultipleImages(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.js.performOCR_MultipleImages(): ' + e.message + ', ' + e.stack);
        }
    },

    repairFileType: function (bwBudgetRequestId, originalFilename) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.repairFileType().');
            var thiz = this;
            ...
            if (!div) {
                ...
                console.log('In bwAttachments_ForEmail_INLINE.js.repairFileType(). adding element to the dom: ' + 'divRepairFileTypeDialog');
                    ...
                    $.ajax({
                        ...
                        success: function (results) {
                            try {
                                ...
                                console.log('Exception in bwAttachments_ForEmail_INLINE.js.repairFileType.post.removeattachment.success(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.repairFileType.post.removeattachment.success(): ' + e.message + ', ' + e.stack);
                            }
                        },
                        error: function (data, errorCode, errorMessage) {
                            console.log('Error in bwAttachments_ForEmail_INLINE.js.repairFileType.post.removeattachment.error(): ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.repairFileType.post.removeattachment.error(): bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename + ', errorMessage: ' + errorMessage);
                        }
                    });
                } catch (e) {
                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.repairFileType.deletebutton.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.repairFileType.deletebutton.click(): ' + e.message + ', ' + e.stack);
                }
            });


        } catch (e) {
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.repairFileType(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.repairFileType(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    copyAttachments: function (attachmentsElementId, requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId) { // bwrequesttitle, bwrequesttypeid
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.copyAttachments().');
            //alert('In bwAttachments_ForEmail_INLINE.js.copyAttachments().');
            var thiz = this;
            ...
            if (!externallyFacingUrlForAttachments) {
                ...
                var dialogId = 'divEmailAttachmentsDialog_bwAttachments_ForEmail_INLINE_' + this.options.elementIdSuffix;
                var div = document.getElementById(dialogId); // 4-1-2020 12-28pm adt.
                if (!div) {
                    //alert('In bwAttachments_ForEmail_INLINE.js.copyAttachments(). Adding ' + dialogId + ' to the DOM.');
                    div = document.createElement('div');
                    div.id = dialogId;
                    div.style.display = 'none';
                ...
                //var divEmailRecipients = 'divEmailAttachmentsDialog_bwAttachments_ForEmail_INLINE_bwPeoplePicker_EmailRecipients_' + this.options.elementIdSuffix;
                ...
                //html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwAttachments_ForEmail_INLINE\').bwAttachments_ForEmail_INLINE(\'emailAttachments\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\', \'' + bwRequestTitle + '\', \'' + bwRequestTypeId + '\');">';

                html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwAttachments_ForEmail_INLINE\').bwAttachments_ForEmail_INLINE(\'copyFiles\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\', \'' + bwRequestTitle + '\', \'' + bwRequestTypeId + '\');">';


                html += 'Copy Selected Files to ' + externallyFacingUrlForAttachments;
                html += '</div>'; // ☑ 
                //html += '&nbsp;&nbsp;';
                //html += '<div class="divSignInButton_Disabled" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwAttachments_ForEmail_INLINE\').bwAttachments_ForEmail_INLINE(\'sendEmail\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\');">';
                //html += 'Send Email';
                //html += '</div>'; // ☑ 
                html += '</div>';
                ...
                $('#' + dialogId).dialog({
                    ...
                    open: function () {
                        try {
                            ...
                            console.log('Exception in bwAttachments_ForEmail_INLINE.js.copyAttachments.dialog.open(): ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.copyAttachments.dialog.open(): ' + e.message + ', ' + e.stack);
                        }
                    }
                });
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.copyAttachments(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.copyAttachments(): ' + e.message + ', ' + e.stack);
        }
    },
    copyFiles: function (attachmentsElementId, requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.copyFiles().');
            var thiz = this;
            ...
            if (checkboxes && checkboxes.length) {
                for (var i = 0; i < checkboxes.length; i++) {
                    if (checkboxes[i].checked) {
                        ...
                        // img_bwAttachments_ForEmail_INLINE_4143c511-8afa-4023-87fc-cac61c765957_8cad99af-1797-4d1b-9b9e-e98bb173b058_0
                        ...
                        if (!img) {
                            ...
                            displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.copyFiles(). Could not locate the img element. xcx21345677');
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            HideActivitySpinner();
                            console.log('Exception in bwAttachments_ForEmail_INLINE.js.copyFiles():1: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.copyFiles():1: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (data, errorCode, errorMessage) {
                        HideActivitySpinner();
                        console.log('Error in bwAttachments_ForEmail_INLINE.js.copyFiles(): ' + errorCode + ' ' + errorMessage + ', data: ' + JSON.stringify(data));
                        displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.copyFiles(): ' + errorCode + ' ' + errorMessage + ', data: ' + JSON.stringify(data));
                    }
                });
            ...
            HideActivitySpinner();
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.copyFiles(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.copyFiles(): ' + e.message + ', ' + e.stack);
        }
    },
    emailAttachments: function (attachmentsElementId, requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId, attachments) { // bwrequesttitle, bwrequesttypeid
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.emailAttachments().');
            //alert('In bwAttachments_ForEmail_INLINE.js.emailAttachments().');
            var thiz = this;
            ...
            if (!externallyFacingUrlForAttachments) {
                ...
                html += '<div style="white-space:nowrap;">';
                //html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwAttachments_ForEmail_INLINE\').bwAttachments_ForEmail_INLINE(\'sendEmail\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\');">';
                ...
                $('#' + dialogId).dialog({
                    ...
                    open: function () {
                        try {
                            ...
                            var divEmailRecipients = 'divEmailAttachmentsDialog_bwAttachments_ForEmail_INLINE_bwPeoplePicker_EmailRecipients_' + thiz.options.elementIdSuffix;
                            ...
                            if (!bwBudgetRequestId) {
                                console.log('ERROR IN bwAttachments_ForEmail_INLINE.js.emailAttachments(). Unexpected value for bwBudgetRequestId: ' + bwBudgetRequestId);
                                displayAlertDialog('ERROR IN bwAttachments_ForEmail_INLINE.js.emailAttachments(). Unexpected value for bwBudgetRequestId: ' + bwBudgetRequestId);
                            } else {
                            ...
                            console.log('Exception in bwAttachments_ForEmail_INLINE.js.emailAttachments():2: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.emailAttachments():2: ' + e.message + ', ' + e.stack);
                        }
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.emailAttachments(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.emailAttachments(): ' + e.message + ', ' + e.stack);
        }
    },
    sendEmail: function (attachmentsElementId, requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId) {
        try {
            ...
            var widgetId = 'divEmailAttachmentsDialog_bwAttachments_ForEmail_INLINE_bwPeoplePicker_EmailRecipients_' + this.options.elementIdSuffix;
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        try {
                            ...
                            HideActivitySpinner();
                            console.log('Exception in bwAttachments_ForEmail_INLINE.js.sendEmail():1: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.sendEmail():1: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (data, errorCode, errorMessage) {
                        HideActivitySpinner();
                        console.log('Error in bwAttachments_ForEmail_INLINE.js.sendEmail(): ' + errorCode + ' ' + errorMessage);
                        displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.sendEmail(): ' + errorCode + ' ' + errorMessage);
                    }
                });
            }
    ...
    //    try {
    //        console.log('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_ReadOnly().');
    //        alert('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_ReadOnly(). This method may need some work. DO NOT USE THIS METHOD!!!!!!!!!!!!!!!!');
    //        var thiz = this;
    ...
    //        html += '<table style="height:100%;vertical-align:top;">';
    //        html += '   <tbody>';
    //        html += '       <tr xcx="xcx21342526-1" id="xcx21342526-1" class="xdTableOffsetRow xdTableOffsetRow-editor" id="toolboxdraggablerow_2" draggable="true" bwwidgetname="bwAttachments_ForEmail_INLINE">';
    ...
    //        //html += '<input type="file" multiple name="multerFileUploadIdentifier" id="inputFile_' + bwBudgetRequestId + '" class="upload" style="visibility:hidden;" onchange="$(\'.bwAttachments_ForEmail_INLINE:first\').bwAttachments_ForEmail_INLINE(\'uploadAttachment\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\');" />';
    ...
    //        //html += '               onclick="$(\'.bwAttachments_ForEmail_INLINE:first\').bwAttachments_ForEmail_INLINE(\'copyAttachments\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\', \'' + bwRequestTitle + '\', \'' + bwRequestTypeId + '\');" />';
    ...
    //            console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-2');
    ...
    //        html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments_ForEmail_INLINE</span>';
    //        html += '<br />';
    //        html += '<span style="">Exception in bwAttachments_ForEmail_INLINE.renderAndPopulateAttachments_ReadOnly(): ' + e.message + ', ' + e.stack + '</span>';
    //        this.element.html(html);
    //    }
    //    //try {
    //    //    console.log('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_ReadOnly().');
    //    //    alert('In bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_ReadOnly().');
    //    //    //var thiz = this;
    //    //    var html = '';

    //    //    html += '<table style="width:100%;">';
    //    //    html += '                        <tbody><tr  xcx="xcx21342526-2" id="xcx21342526-2" class="xdTableOffsetRow xdTableOffsetRow-editor" id="toolboxdraggablerow_2" draggable="true" bwwidgetname="bwAttachments_ForEmail_INLINE">';
    ...
    //    //    //html += '               <input type="file" id="inputFile" class="upload" style="visibility:hidden;" onchange="$(\'.bwAttachments_ForEmail_INLINE\').bwAttachments_ForEmail_INLINE(\'uploadAttachment\',\'newrequestattachments\');" />';
    //    //    //html += '           </div>';
    //    //    //html += '           <!--<br />';
    ...
    //    //} catch (e) {
    //    //    console.log('Exception in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_ReadOnly: ' + e.message + ', ' + e.stack);

    //    //    //renderAndPopulateAttachments
    //    //    //$(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.renderAndPopulateAttachments_ReadOnly: ' + e.message + ', ' + e.stack;
    //    //    var html = '';
    //    //    html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments_ForEmail_INLINE</span>';
    //    //    html += '<br />';
    //    //    html += '<span style="">Exception in bwAttachments_ForEmail_INLINE.js.renderAndPopulateAttachments_ReadOnly(): ' + e.message + ', ' + e.stack + '</span>';
    //    //    thiz.element.html(html);
    //    //}
    //},
    ...
    uploadAttachment: function (displayAttachmentsTagName, requestDialogId, attachmentOrInline, objDataTransfer) {
        try {
            var bwDraftEmailId = $('#displayedemaildetails')[0].getAttribute('bwdraftemailid');

            console.log('In bwAttachments_ForEmail_INLINE.js.uploadAttachment(). bwDraftEmailId: ' + bwDraftEmailId + ', attachmentOrInline: ' + attachmentOrInline + ', elementIdSuffix: ' + this.options.elementIdSuffix + ', displayAttachmentsTagName: ' + displayAttachmentsTagName + ', requestDialogId: ' + requestDialogId + ', attachmentsAreStoredInIndexDb: ' + this.options.attachmentsAreStoredInIndexDb);
            //alert('In bwAttachments_ForEmail_INLINE.js.uploadAttachment(). bwDraftEmailId: ' + bwDraftEmailId + ', attachmentOrInline: ' + attachmentOrInline + ', elementIdSuffix: ' + this.options.elementIdSuffix + ', displayAttachmentsTagName: ' + displayAttachmentsTagName + ', requestDialogId: ' + requestDialogId + ', attachmentsAreStoredInIndexDb: ' + this.options.attachmentsAreStoredInIndexDb);
            ...
            //        this.cmdDisplayMultiFileUploadDialog('INLINE', bwDraftEmailId, objDataTransfer.files); // Changed from cmdDisplayConfirmFileUploadDialog_zip_wasm() <<< DONT FORGET THIS CODE!

            //    } else {

            //        var inputFileAttachmentsElement = $('#inputFile_INLINE_' + bwDraftEmailId)[0];
            ...
            //            console.log('In bwAttachments_ForEmail_INLINE.js.uploadAttachment(). NO FILES ARE ATTACHED. INLINE. bwDraftEmailId: ' + bwDraftEmailId);
            //            alert('In bwAttachments_ForEmail_INLINE.js.uploadAttachment(). NO FILES ARE ATTACHED. INLINE. bwDraftEmailId: ' + bwDraftEmailId);
            ...
            //            //
            //            console.log('In bwAttachments_ForEmail_INLINE.js.uploadAttachment(). THERE ARE MULTIPLE FILES TO UPLOAD. Number of files attached: ' + inputFileAttachmentsElement.files.length);

            //            this.cmdDisplayMultiFileUploadDialog('INLINE', bwDraftEmailId, inputFileAttachmentsElement.files); // Changed from cmdDisplayConfirmFileUploadDialog_zip_wasm() <<< DONT FORGET THIS CODE!
            ...
            if (objDataTransfer) {
                ...
                console.log('In bwAttachments_ForEmail_INLINE.js.uploadAttachment(). Got a DataTransfer object with ' + objDataTransfer.files.length + ' files.');

                this.cmdDisplayMultiFileUploadDialog('ATTACHMENTS', bwDraftEmailId, objDataTransfer.files); // Changed from cmdDisplayConfirmFileUploadDialog_zip_wasm() <<< DONT FORGET THIS CODE!
                ...
                if (!(inputFileAttachmentsElement && inputFileAttachmentsElement.files && inputFileAttachmentsElement.files.length && (inputFileAttachmentsElement.files.length > 0))) {
                    ...
                    console.log('In bwAttachments_ForEmail_INLINE.js.uploadAttachment(). NO FILES ARE ATTACHED.');
                    alert('In bwAttachments_ForEmail_INLINE.js.uploadAttachment(). NO FILES ARE ATTACHED.');
            ...
            console.log('Error in bwAttachments_ForEmail_INLINE.js.uploadAttachment(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.uploadAttachment(): ' + e.message + ', ' + e.stack);
            $(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.uploadAttachment(): ' + e.message + ', ' + e.stack;
        }
    ...
    uploadPastedAttachment: function (imgSrc) {
        try {
            //console.log('In bwAttachments_ForEmail_INLINE.js.uploadPastedAttachment(). attachmentsAreStoredInIndexDb: ' + this.options.attachmentsAreStoredInIndexDb + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            //console.log('In uploadPastedAttachment().  Using .bwAttachments_ForEmail_INLINE:closest.  bwBudgetRequestId: ' + bwBudgetRequestId + ', elementIdSuffix: ' + this.options.elementIdSuffix + ', displayAttachmentsTagName: ' + displayAttachmentsTagName + ', requestDialogId: ' + requestDialogId);
    ...
    cmdDisplayConfirmFileUploadDialog: function (displayAttachmentsTagName, bwBudgetRequestId, requestDialogId, element) { // element is >>> var x = $('#inputFile_' + bwBudgetRequestId)[0]; // $('#' + requestDialogId).find('#inputFile')[0];
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog(). bwBudgetRequestId: ' + bwBudgetRequestId);
            alert('>>>>>>>>>>>>>>> In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog(). WE NEED TO FIGURE OUT IF THIS IS ATTACHMENTS OR INLINE<<<<<<<<<<inputFile_xxx_bwDraftEmailId <<<<<<<<<<<<<  bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            if (!(x && x.files && x.files.length && (x.files.length > 0))) {
                ...
                alert('xcx3124 Fatal error in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog(). NO FILES FOR ELEMENT [' + 'inputFile_' + bwBudgetRequestId + '].')
                ...
                if (!file) { // Don't like doing this but sometimes file is undefined... is this a race condition or a duplicate DOM element?? 6-23-2020
                    ...
                    if (file.size > 100000000) {
                        ...
                        console.log('>>>> In bwAttachments_ForEmail_INLINE.js.uploadAttachment(). Calling .dialog(). bwBudgetRequestId: ' + bwBudgetRequestId + ', file.length: ' + file.length);
                                    ...
                                    if (!uploadButton) {
                                        ...
                                        $(this).ready(function () {
                                            ...
                                            $('#' + dialogId + '_btnUploadTheFileNow').off('click').click(function () { // divConfirmFileUploadDialog_ForAttachments_78ebbdca-32d7-4019-9c53-cdc55e11a775_btnUploadTheFileNow
                                                try {
                                                    console.log('In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
                                                    alert('THIS IS THE ONE... xcx11 In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
                                                    ...
                                                    console.log('In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). Getting ready to call processUpload(). filename: ' + filename + ', file.name: ' + file.name); //              displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
                                                    //alert('In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). Getting ready to call processUpload(). filename: ' + filename + ', file.name: ' + file.name); //              displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);

                                                    thiz.processUpload(displayAttachmentsTagName, bwBudgetRequestId, file, filename, convertToAPdf);

                                                } catch (e) {
                                                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.btnUploadTheFileNow.click(): ' + e.message + ', ' + e.stack);
                                                    alert('Exception in bwAttachments_ForEmail_INLINE.js.btnUploadTheFileNow.click(): ' + e.message + ', ' + e.stack);
                                                }
                                            });
                                        });
            ...
            //            //        console.log('In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            //            //        alert('In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm: async function (displayAttachmentsTagName, bwBudgetRequestId, requestDialogId, element, file) { // element is >>> var x = $('#inputFile_' + bwBudgetRequestId)[0]; // $('#' + requestDialogId).find('#inputFile')[0];
        try {
            ...
            console.log('In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(). bwBudgetRequestId: ' + bwBudgetRequestId);
            alert('In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(). ARE WE USING THIS? IF SO GET inputFile_xxx_bwDraftEmailId  ATTACHMENTS OR INLINE WORKING<<<<<<<<<<<<<<<<< bwBudgetRequestId: ' + bwBudgetRequestId);
            //alert('###########In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(). bwBudgetRequestId: ' + bwBudgetRequestId);
                    ...
                    try {
                        ...
                        if (!uploadButton) {
                            ...
                            $('#' + dialogId + '_btnUploadTheFileNow').off('click').click(function () { // divConfirmFileUploadDialog_ForAttachments_78ebbdca-32d7-4019-9c53-cdc55e11a775_btnUploadTheFileNow
                                ...
                                alert('#>>>>In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.dialog.open(). xcx23123142. file.name: ' + file.name + '. Element id: ' + 'inputFile_' + bwBudgetRequestId);
                                ...
                                //alert('xcx21321312. In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            $('#' + dialogId + '_btnInitializeFfmpegWasm').off('click').click(function (x) {
                try {
                    ...
                    alert('#>>>>In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.xxxxxxxxxx(). x.length: ' + x2.length + '. Element id: ' + 'inputFile_' + bwBudgetRequestId);



                    //alert('#>>>>$$$$$$$$$$$In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.dialog.open(). files.length: ' + files.length + '. Element id: ' + 'inputFile_' + bwBudgetRequestId);



                    //alert('###$$$$$$In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm._btnInitializeFfmpegWasm.click(). files.length: ' + files.length + '. Element id: ' + 'inputFile_' + bwBudgetRequestId);
                    ...
                    if (!(x && x.files && x.files.length && (x.files.length > 0))) {
                        ...
                        alert('xcx3124 Fatal error in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(). NO FILES FOR ELEMENT xcx12345364 [' + 'inputFile_' + bwBudgetRequestId + '].')
                                                    ...
                                                    try {
                                                        ...
                                                        canvas.toBlob(async (blob) => {
                                                            try {
                                                                ...
                                                                console.log('In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). xcx124677'); // displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
                    ...
                    alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.button.click(): ' + e.message + ', ' + e.stack);
                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.button.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.button.click(): ' + e.message + ', ' + e.stack);

                }
            });

        } catch (e) {
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    downloadLargeFile: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.downloadLargeFile().');
            alert('In bwAttachments_ForEmail_INLINE.js.downloadLargeFile().');
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            var msg = 'Error in bwAttachments_ForEmail_INLINE.js.downloadLargeFile(). ' + results.status + ': ' + results.message;
                            console.log(msg);
                            displayAlertDialog(msg);
                        ...
                        var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.downloadLargeFile.download(): ' + e.message + ', ' + e.stack;
                        console.log(msg);
                        displayAlertDialog(msg);
                        //$(this.element).find('#newrequestattachments')[0].innerHTML = msg;
                    }
                ...
                error: function (data, errorCode, errorMessage) {
                    ...
                    var msg = 'Error in bwAttachments_ForEmail_INLINE.js.downloadLargeFile.download(): errorMessage: ' + errorMessage + ', errorCode: ' + errorCode + ', data: ' + JSON.stringify(data) + ', operationUri: ' + operationUri;
                    console.log(msg);
                    displayAlertDialog(msg);
            ...
            var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.downloadLargeFile(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    cmdDisplayConfirmFileUploadDialog_zip_wasm: async function (displayAttachmentsTagName, bwBudgetRequestId, requestDialogId, element) { // element is >>> var x = $('#inputFile_' + bwBudgetRequestId)[0]; // $('#' + requestDialogId).find('#inputFile')[0];
        try {
            ...
            console.log('In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(). bwBudgetRequestId: ' + bwBudgetRequestId);
            alert('In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(). IF WE ARE USING THIS GET inputFile_xxx_bwDraftEmailId  FIGURED OUT FOR ATTACHMENTS OR INLINE. bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            //    } catch (e) {
            //        console.log('Exception in bwAttachments_ForEmail_INLINE.js.uploadZipFile(): ' + e.message + ', ' + e.stack);
            //        alert('Exception in bwAttachments_ForEmail_INLINE.js.uploadZipFile(): ' + e.message + ', ' + e.stack);
            //        displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.uploadZipFile(): ' + e.message + ', ' + e.stack);
            //    }
            //}
            ...
            $('#' + dialogId + '_btnInitializeZipWasm').off('click').click(function (error) {
                try {
                    ...
                    console.log('In bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click(). PREPARING TO ZIP THESE FILES AND UPLOAD TO THE SERVER: ' + JSON.stringify(trackingArray));
                        ...
                        reader.onload = function (event) {
                            try {
                                ...
                                if (trackingArray.length == 0) {
                                    ...
                                    thiz.performUpload2_email(file, archiveFileName, bwDraftEmailId, null, false); // data: Int8Array >>> convert to input type="file" element....

                                }

                            } catch (e) {
                                console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click.reader.load(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click.reader.load(): ' + e.message + ', ' + e.stack);
                                alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click.reader.load(): ' + e.message + ', ' + e.stack);
                            }
                        };
                    ...
                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click(): ' + e.message + ', ' + e.stack);
                    alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click(): ' + e.message + ', ' + e.stack);
                }
            });
                        ...
                        if (!uploadButton) {
                            ...
                            $(this).ready(function () {
                                ...
                                $('#' + dialogId + '_btnUploadTheFileNow').off('click').click(function () { // divConfirmFileUploadDialog_ForAttachments_78ebbdca-32d7-4019-9c53-cdc55e11a775_btnUploadTheFileNow
                                    ...
                                    alert('xcx999994-1. In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(): ' + e.message + ', ' + e.stack);
        }
    },

    ffmpegMultiFileMergeAndUpload: async function (bwBudgetRequestId, inputFileAttachmentsElement) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.ffmpegMultiFileMergeAndUpload(). bwBudgetRequestId: ' + bwBudgetRequestId);
            alert('In bwAttachments_ForEmail_INLINE.js.ffmpegMultiFileMergeAndUpload(). bwBudgetRequestId: ' + bwBudgetRequestId + ', files.length: ' + inputFileAttachmentsElement.files.length);
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.ffmpegMultiFileMergeAndUpload(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.ffmpegMultiFileMergeAndUpload(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.js.ffmpegMultiFileMergeAndUpload(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    FFMPEGConvertAndUploadMultipleVideoFiles_Batch: function (x, bwBudgetRequestId, dialogId) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch().');
                ...
                for (var i = 0; i < thiz.options.smallFileBatchArray[x].length; i++) {
                    ...
                    var promise = thiz.FFMPEGConvertAndUploadVideoFile(thiz.options.smallFileBatchArray[x][i], bwBudgetRequestId, dialogId).then(function (results) {
                        ...
                        alert('Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch(). xcx4567. e.FailedFileName: ' + e.FailedFileName + ', JSON.stringify(e): ' + JSON.stringify(e));
                        var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch():3: e.FailedFileName: ' + e.FailedFileName + ', JSON.stringify(e): ' + JSON.stringify(e);
                ...
                Promise.all(promiseArray)
                    .then(function (results) {
                        ...
                        var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch():2: ' + JSON.stringify(e);
                        alert(msg);
                        var result = {
                            status: 'EXCEPTION',
                            message: msg
                ...
                var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch():1: ' + e.message + ', ' + e.stack;
    ...
    FFMPEGConvertAndUploadVideoFile: function (file, bwBudgetRequestId, dialogId) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile().');
                //alert('In bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile(). file.name: ' + file.name);
                    ...
                    try {
                        ...
                        function load_file(file) {
                            try {
                                ...
                                HideActivitySpinner();
                                var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.load_file(): ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                alert(msg);
                        ...
                        async function print_file(files) {
                            try {
                                ...
                                if (!result) {
                                    ...
                                    displayAlertDialog_Persistent('Error in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file(). files.currentTarget.result: ' + files.currentTarget.result + ', inputFilename: ' + inputFilename + ', bwBudgetRequestId: ' + bwBudgetRequestId);

                                    var msg = 'Error in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file(). FATAL ERROR! NO result in print_file(). result: ' + result;
                                    console.log(msg);
                                    alert(msg);
                                    ...
                                    ffmpeg.writeFile(inputFilename, uint8_view).then(function (data) {
                                        try {
                                            ...
                                            ffmpeg.exec(executionString).then(function (data) {
                                                try {
                                                    ...
                                                    ffmpeg.deleteFile(inputFilename).then(function (data) {
                                                            ...
                                                            if (data != true) {
                                                                ...
                                                                ffmpeg.readFile(outputFilename).then(function (data) {
                                                                    try {
                                                                        ...
                                                                        thiz.performUpload3(outFile, outputFilename, bwBudgetRequestId, null, false, true).then(function (data) {
                                                                            ...
                                                                            ffmpeg.deleteFile(inputFilename).then(function (data) {
                                                                                    ...
                                                                                    if (data != true) {
                                                                                        ...
                                                                                        ffmpeg.deleteFile(outputFilename).then(function (data) {
                                                                                            try {
                                                                                                ...
                                                                                                var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile():2-xcx1: ' + e.message + ', ' + e.stack;
                                                                                                console.log(msg);
                                                                                                alert(msg);
                                                                                            }
                                                                                            ...
                                                                                            var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile.catch():1-2-1-xcx1: ' + JSON.stringify(e);
                                                                                            console.log(msg);
                                                                                            alert(msg);
                                                                                ...
                                                                                var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile.catch():1-2-2-xcx1: ' + JSON.stringify(e);
                                                                                console.log(msg);
                                                                                alert(msg);
                                                                        ...
                                                                        var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile():2: ' + e.message + ', ' + e.stack;
                                                                        console.log(msg);
                                                                        alert(msg);
                                                                    ...
                                                                    var msg = 'WILL THIS BUBBLE TO THE TOP1? Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile.catch():1: FATAL EXCEPTION. PUTTING THE FILE IN THE RETRY LIST1. JSON.stringify(e): ' + JSON.stringify(e);
                                                                    console.log(msg);
                                                                    alert(msg);
                                                                    displayAlertDialog_Persistent(msg);
                                                        ...
                                                        var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile.catch():1-2-2: ' + JSON.stringify(e);
                                                        console.log(msg);
                                                        alert(msg);
                                                    ...
                                                    var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec():2: ' + e.message + ', ' + e.stack;
                                                    console.log(msg);
                                                    alert(msg);
                                                ...
                                                try {
                                                    ...
                                                    var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.catch(): ' + e.message + ', ' + e.stack;
                                                    console.log(msg);
                                                    alert(msg);
                                                    displayAlertDialog_Persistent(msg);
                                            ...
                                            var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile():2: ' + e.message + ', ' + e.stack;
                                            console.log(msg);
                                            alert(msg);
                                        ...
                                        var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile():1: ' + JSON.stringify(e);
                                        console.log(msg);
                                        alert(msg);
                                ...
                                var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file(): ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                alert(msg);
                                displayAlertDialog(msg);
                        ...
                        var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile.transcode(): ' + e.message + ', ' + e.stack;
                        console.log(msg);
                        alert(msg);
                ...
                var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.FFMPEGConvertAndUploadVideoFile(): ' + e.message + ', ' + e.stack;
                console.log(msg);
    ...
    CloseDialog_btnCancelUploadTheFileNow: function (bwBudgetRequestId, dialogId) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.CloseDialog_btnCancelUploadTheFileNow().');
            alert('In bwAttachments_ForEmail_INLINE.js.CloseDialog_btnCancelUploadTheFileNow(). IF WE ARE USING THIS GET UIT SORTED OUT FOR inputFile_xxx_bwDraftEmailId  WITH ATTACMENTS OR INLINE<<<<<<<<<<<<<<<<');
            ...
            var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.CloseDialog_btnCancelUploadTheFileNow(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },

    cmdDisplayMultiFileUploadDialog: function (attachmentOrInline, bwDraftEmailId, files) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog(). bwDraftEmailId: ' + bwDraftEmailId + ', attachmentOrInline: ' + attachmentOrInline);
            //alert('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog(). IF WE ARE USING THIS GET IT SORTED OUT FOR inputFile_xxx_bwDraftEmailId  ATTACHMENTS OR INLINE<<<<<<<<<<<<<<<<<<  bwDraftEmailId: ' + bwDraftEmailId + ', attachmentOrInline: ' + attachmentOrInline);
            var thiz = this;

            var dialogId = 'divConfirmFileUploadDialog_MultiFile_' + bwDraftEmailId;
            ...
            //
            // bwAttachments_ForEmail_INLINE.js.uploadAttachment() has the line which resets/clears the input file element which has the attachments. THIS MAY NEED TO GO SOMEWHERE IN THE NEAR FUTURE S THAT A USER CAN RETRY TO LOAD THE SAME FILE. 11-10-2023.
            //
            //
            ...
            var CompressAndUploadImages = function (files) {
                try {
                    ...
                    console.log('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.button.click(). PREPARING TO ZIP THESE FILES AND UPLOAD TO THE SERVER: ' + JSON.stringify(trackingArray));
                    alert('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.button.click(). PREPARING TO ZIP THESE FILES AND UPLOAD TO THE SERVER: ' + JSON.stringify(trackingArray));
                        ...
                        reader.onload = function (event) {
                            try {
                                ...
                                if (trackingArray.length == 0) {
                                    ...
                                    console.log('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.CompressAndUploadImages(). Calling performUpload2_email(). WE STILL HAVE ACCESS TO THE FILES [files] HERE. Calling performUpload2_email(). xcx1312341-2.');
                                    alert('WE STILL HAVE ACCESS TO THE FILES [files] HERE. Displaying details in a persistent dialog.');
                                    displayAlertDialog_Persistent('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.CompressAndUploadImages(). Calling performUpload2_email(). WE STILL HAVE ACCESS TO THE FILES [files] HERE. Calling performUpload2_email(). xcx1312341-2.');

                                    // WHEN WE UPLOAD AN INLINE ATTACHMENT, WE already have the image on the client. Should we use the canvas, resize to 320px, and generate the 64bit string at the same time.!
                                    //    - options: INLINE_64bit_AttachmentsArray: [], // Save the 64bit 320px image strings in this property. This will get populated in the following method: xx(). 6-7-2024.

                                    thiz.performUpload2_email(file, archiveFileName, bwDraftEmailId, attachmentOrInline, false); // data: Int8Array >>> convert to input type="file" element....

                                }

                            } catch (e) {
                                console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.CompressAndUploadImages(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.CompressAndUploadImages(): ' + e.message + ', ' + e.stack);
                                alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.CompressAndUploadImages(): ' + e.message + ', ' + e.stack);
                            }
                        };
            ...
            var UploadMultipleFiles = async function (files) {
                try {
                    ...
                    for (var i = 0; i < files.length; i++) {
                        ...
                        await thiz.performUpload3(file, file.name, bwDraftEmailId, null, false, true);

                    }

                } catch (e) {
                    alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.UploadMultipleFiles(): ' + e.message + ', ' + e.stack);
                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.UploadMultipleFiles(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.UploadMultipleFiles(): ' + e.message + ', ' + e.stack);
                }
            }
            ...
            if (thereAreVideoFiles == false) {
                ...
                if (!(files && files.length)) {
                    ...
                    alert('xcx3124 Fatal error in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog(). NO FILES. files.length: ' + files.length); // FOR ELEMENT xcx12345364-2 [' + 'inputFile_' + bwBudgetRequestId + '].')
                    ...
                    $('#divConfirmFileUploadDialog_MultiFile_' + bwDraftEmailId).dialog('close'); // Close the dialog window.
                ...
                html += '           <td style="width:9%;"></td>';
                html += '           <td style="width:1%;cursor:pointer;vertical-align:top;">';
                html += '               <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size: 120pt;font-weight:bold;" onclick="$(\'.bwAttachments_ForEmail_INLINE\').bwAttachments_ForEmail_INLINE(\'CloseDialog_btnCancelUploadTheFileNow\', \'' + bwDraftEmailId + '\', \'' + dialogId + '\');">X</span>';
                html += '           </td>';
                html += '       </tr>';
                html += '   </table>';
                html += '   <input type="text" autofocus="true" style="display:none;" /> <!-- This is here to prevent the first visible field from getting the cursor and showing the keyboard. -->';
                ...
                ////html += '   <div id="' + dialogId + '_ffmpegMultiFileMergeAndUpload" class="divDialogButton" title="Click here to initialize ffmpeg.wasm...." >'; // onclick="$(\'bwAttachments_ForEmail_INLINE\').bwAttachments_ForEmail_INLINE(\'ffmpegMultiFileMergeAndUpload\', bwBudgetRequestId, files);">';
                ...
                html += '   <div id="btnCancelUploadTheFileNow" class="divDialogButton" onclick="$(\'.bwAttachments_ForEmail_INLINE\').bwAttachments_ForEmail_INLINE(\'CloseDialog_btnCancelUploadTheFileNow\', \'' + bwDraftEmailId + '\', \'' + dialogId + '\');" >';
                html += '       Close';
                html += '   </div>';
            ...
            var FFMPEGConvertAndUploadMultipleVideoFiles_CreateAndRunBatches = async function (smallFileArray) {
                try {
                    ...
                    for (var i = 0; i < thiz.options.smallFileBatchArray.length; i++) {
                        ...
                        await thiz.FFMPEGConvertAndUploadMultipleVideoFiles_Batch(i, bwDraftEmailId, dialogId);
                    ...
                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.FFMPEGConvertAndUploadMultipleVideoFiles_CreateAndRunBatches(): ' + e.message + ', ' + e.stack);
                    alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.FFMPEGConvertAndUploadMultipleVideoFiles_CreateAndRunBatches(): ' + e.message + ', ' + e.stack);
                }
            }
                ...
                try {
                    ...
                    if (largeFileArray.length > 0) {
                        ...
                        for (var i = 0; i < largeFileArray.length; i++) {
                            var promise = thiz.performUpload3(largeFileArray[i], largeFileArray[i].name, bwDraftEmailId, null, false, true);
                            promiseArray.push(promise);
                        }
                        Promise.all(promiseArray).then(function (results) {
                            try {
                                ...
                                console.log('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.promise.all.catch():1: ' + e.message + ', ' + e.stack);
                                alert('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.promise.all.catch():1: ' + e.message + ', ' + e.stack);
                            }

                        }).catch(function (e) {

                            console.log('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.promise.all.catch(). e: ' + JSON.stringify(e));
                            displayAlertDialog('In bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.promise.all.catch(). e: ' + JSON.stringify(e));
                    ...
                    alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.ConvertAndUploadVideoFiles(): ' + e.message + ', ' + e.stack);
                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.ConvertAndUploadVideoFiles(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.ConvertAndUploadVideoFiles(): ' + e.message + ', ' + e.stack);
                }
            }
            ...
            $('#' + dialogId + '_btnSmartUpload').off('click').click(function (error) {
                try {
                    ...
                    if (!(files && files.length)) {
                        ...
                        alert('xcx3124 Fatal error in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog._btnSmartUpload(). NO FILES. files.length: ' + files.length); // FOR ELEMENT xcx12345364-2 [' + 'inputFile_' + bwBudgetRequestId + '].')
                    ...
                    console.log('Exception in bwAttachments_ForEmail_INLINE.js._btnSmartUpload.button.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js._btnSmartUpload.button.click(): ' + e.message + ', ' + e.stack);
                    alert('Exception in bwAttachments_ForEmail_INLINE.js._btnSmartUpload.button.click(): ' + e.message + ', ' + e.stack);
                }
            });
            ...
            $('#' + dialogId + '_btnUploadNoProcessing').off('click').click(function (error) {
                try {
                    ...
                    if (!(files && files.length)) {
                        ...
                        alert('xcx3124 Fatal error in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog._btnUploadNoProcessing(). NO FILES FOR ELEMENT xcx12345364-2 [' + 'xcx2131inputFile_' + bwDraftEmailId + '].')
                    ...
                    console.log('Exception in bwAttachments_ForEmail_INLINE.js._btnUploadNoProcessing.button.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js._btnUploadNoProcessing.button.click(): ' + e.message + ', ' + e.stack);
                    alert('Exception in bwAttachments_ForEmail_INLINE.js._btnUploadNoProcessing.button.click(): ' + e.message + ', ' + e.stack);
                }
            });
            ...
            $('#' + dialogId).dialog({
                ...
                open: function (event, ui) {
                    try {
                        ...
                        //        //    alert('xcx999994-2. In bwAttachments_ForEmail_INLINE.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    processUpload: function (displayAttachmentsTagName, _budgetRequestId, file, filename, convertToAPdf) { // convertToAPdf means that we will attempt to put the attachment into a pdf and save it as a pdf file.
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.processUpload().');
            //alert('In bwAttachments_ForEmail_INLINE.js.processUpload(). filename: ' + filename);
            var thiz = this;
            ...
            if (!file || file.length == 0) {
                ...
                console.log('In bwAttachments_ForEmail_INLINE.js.processUpload(). filename: ' + filename);
                //alert('In bwAttachments_ForEmail_INLINE.js.processUpload(). filename: ' + filename);
                ...
                if (filename.indexOf('.xml') > 0) {
                    ...
                    console.log('In bwAttachments_ForEmail_INLINE.js.processUpload(). Calling performUpload().');
    ...
    performUpload2_email: function (outFile, fileName, bwDraftEmailId, attachmentOrInline, convertToAPdf) { // convertToAPdf means that we will attempt to put the attachment into a pdf and save it as a pdf file.
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.performUpload2_email(). bwDraftEmailId: ' + bwDraftEmailId + ', fileName: ' + fileName);
            //alert('In bwAttachments_ForEmail_INLINE.js.performUpload2_email(). IF WE ARE USING THIS GET IT SORTED OUT FOR inputFile_xxx_bwDraftEmailId  USING ATTACHMENTS OR INLINE<<<<<<<<<<<<<<<<<<<< attachmentOrInline: ' + attachmentOrInline + ', bwDraftEmailId: ' + bwDraftEmailId + ', fileName: ' + fileName);
            var thiz = this;
            ...
            var elementId;
            if (attachmentOrInline == 'INLINE') {
                elementId = 'uploadForm_INLINE_' + bwDraftEmailId;
            } else if (attachmentOrInline == 'ATTACHMENTS') {
                elementId = 'uploadForm_ATTACHMENTS_' + bwDraftEmailId;
            } else {
            ...
            console.log('In bwAttachments_ForEmail_INLINE.js.performUpload2_email(). formData is an object with a set function.');
            //alert('In bwAttachments_ForEmail_INLINE.js.performUpload2_email(). formData is an object with a set function. bwDraftEmailId: ' + bwDraftEmailId);
            ...
            formData.set('bwAttachmentOrInline', attachmentOrInline); // Added 5-27-2024.
                        ...
                        try {
                            ...
                            xhr.upload.addEventListener("progress", function (evt) {
                                if (evt.lengthComputable) {
                                    ...
                                    if (percentComplete == 100) {
                                        ...
                                        ShowActivitySpinner_FileUpload('Completing the save operations... xcx1-2-2');
                                    }
                            ...
                            xhr.upload.addEventListener("error", function (evt) {
                                try {
                                    ...
                                    var msg = 'Error in bwAttachments_ForEmail_INLINE.js.performUpload.xhr.upload.error():xcx1-2-1: workflowAppId: ' + workflowAppId + ', bwDraftEmailId: ' + bwDraftEmailId + ', evt: ' + JSON.stringify(evt);
                                    ...
                                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.performUpload.xhr.upload.error():xcx1-2: ' + e.message + ', ' + e.stack);
                                    alert('Exception in bwAttachments_ForEmail_INLINE.js.performUpload.xhr.upload.error():xcx1-2: ' + e.message + ', ' + e.stack);
                                }
                            }, false);
                    ...
                    success: function (data) {
                        try {
                            ...
                            if (data.status != 'SUCCESS') {
                                ...
                                console.log('Error in bwAttachments_ForEmail_INLINE.js.performUpload2_email(). Unexpected response. data: ' + JSON.stringify(data));
                                alert('Error in bwAttachments_ForEmail_INLINE.js.performUpload2_email(). Unexpected response. data: ' + JSON.stringify(data));

                            } else {

                                displayAlertDialog_QuickNotice('The file(s) have uploaded successfully.');

                                //var msg = 'In bwAttachments_ForEmail_INLINE.js.performUpload2_email(). The file(s) have uploaded successfully. bwDraftEmailId was: ' + bwDraftEmailId + ' AND HAS BEEN ASSIGNED A NEW VALUE OF ' + data._id;
                                //console.log(msg);
                                //displayAlertDialog(msg);
                                ...
                                var msg = '### In bwAttachments_ForEmail_INLINE.js.performUpload2_email(). The file(s) have uploaded successfully. NOW WE NEED TO FIGURE OUT HOW TO IMPLEMENT INLINE, KEEP IT SYNCHRONIZED, ETC.';
                                console.log(msg);
                                alert(msg);
                                ...
                                $('.bwAttachments_ForEmail_ATTACHMENTS').bwAttachments_ForEmail_ATTACHMENTS('renderAndPopulateAttachments_ATTACHMENTS', '' + bwDraftEmailId + '');
                            ...
                            console.log('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2_email():xcx33: ' + e.message + ', ' + e.stack);
                            alert('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2_email():xcx33: ' + e.message + ', ' + e.stack);
                            //$(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.performUpload2_email:xcx33: ' + e.message + ', ' + e.stack;
                            //displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2_email():xcx33: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (e) {
                        ...
                        if (xhrAbortMessage && xhrAbortMessage != '') {
                            ...
                            displayAlertDialog('POST unexpected error. xcx1242525-2-3 workflowAppId: ' + workflowAppId + ', bwDraftEmailId: ' + bwDraftEmailId + ', Unexpected error: ' + JSON.stringify(e)); //e.responseText)
            ...
            //                        // This resets the file input for uploading, so the onchange/change event fires as expected.
            //                        console.log('In bwAttachments_ForEmail_INLINE.js.xx(). This resets the file input for uploading, so the onchange/change event fires as expected. xcx86984.');
            //                        //alert('render bwAttachments_ForEmail_INLINE and maybe xxxxxx');
            ...
            //                            console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-3');
            ...
            //                            console.log('8-23-2022 FIXED THIS, remove this log entry once the bwAttachments_ForEmail_INLINE.js widget works 100%. xcx1236899 bwDraftEmailId: ' + bwDraftEmailId);
            //                            // 8-23-2022 FIX THIS <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
            ...
            //                                displayAlertDialog('In bwAttachments_ForEmail_INLINE.js.performUpload2_email(). Could not find budgetrequestform with bwDraftEmailId: ' + bwDraftEmailId);
            ...
            //                                            var msg = 'Error in bwAttachments_ForEmail_INLINE.js.performUpload2_email(). xcx21345-1: ' + results.status + ', ' + results.message;
            //                                            displayAlertDialog(msg);

            //                                        } else {

            //                                            console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-4');
            ...
            //                                        console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-5');
            //                                        alert('xcx213234-15 calling populateAttachments().');
            //                                        thiz.populateAttachments(workflowAppId, bwDraftEmailId, displayAttachmentsTagName, true); // This lists the attachments in the <p> tag with id='attachments'.
            //                                        console.log('Exception from Promise in bwAttachments_ForEmail_INLINE.js.performUpload2_email(). xcx21345-2: ' + JSON.stringify(e));
            ...
            //                                console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-6');
            //                                alert('xcx213234-14 calling populateAttachments().');
            //                                thiz.populateAttachments(workflowAppId, bwDraftEmailId, displayAttachmentsTagName, true); // This lists the attachments in the <p> tag with id='attachments'.

            //                            } else {

            //                                var msg = data.status + ' in bwAttachments_ForEmail_INLINE.js.performUpload2_email() xcx02856-1: ' + data.message;
            //                                console.log(msg);
            //                                displayAlertDialog(msg);
            ...
            //                            var msg = data.status + ' in bwAttachments_ForEmail_INLINE.js.performUpload2_email() xcx02856-2-1: ' + data.message;
            //                            console.log(msg);
            //                            displayAlertDialog(msg);

            //                        } else {

            //                            //$('.bwAttachments_ForEmail_INLINE').bwAttachments_ForEmail_INLINE('renderAndPopulateAttachments'); // displayAttachmentsTagName
            ...
            //                        $(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.performUpload2_email:2: ' + e.message + ', ' + e.stack;
            //                    }
            //                },
            //                error: function (data, errorCode, errorMessage) {
            //                    $('#divWorkingOnItDialog').dialog('close'); // Close the "Working on it..." dialog.
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2_email(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2_email(): ' + e.message + ', ' + e.stack);
            $(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.performUpload2_email: ' + e.message + ', ' + e.stack;
        }
    },
    ...
    performUpload3: function (outFile, fileName, bwBudgetRequestId, displayAttachmentsTagName, convertToAPdf) { // convertToAPdf means that we will attempt to put the attachment into a pdf and save it as a pdf file.
        ...
        return new Promise(function (resolve, reject) {
            ...
            //
            try {
                console.log('In bwAttachments_ForEmail_INLINE.js.performUpload3(). fileName: ' + fileName);
                alert('In bwAttachments_ForEmail_INLINE.js.performUpload3(). IF WE ARE USING THIS METHOD GET IT SORTED OUT FOR inputFile_xxx_bwDraftEmailId  ATTACHMENTS OR INLINE<<<<<<<<<<<<<<<  fileName: ' + fileName);
                                ...
                                success: function (data) {
                                    try {
                                        ...
                                        if (data.status == 'SUCCESS') {
                                            ...
                                            console.log('8-23-2022 FIXED THIS, remove this log entry once the bwAttachments_ForEmail_INLINE.js widget works 100%. xcx1236899 bwBudgetRequestId: ' + bwBudgetRequestId);
                                            // 8-23-2022 FIX THIS <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                            ...
                                            if (!budgetrequestform) {
                                                ...
                                                displayAlertDialog('In bwAttachments_ForEmail_INLINE.js.performUpload2(). Could not find budgetrequestform with bwBudgetRequestId: ' + bwBudgetRequestId);
                                                ...
                                                $('.bwRequest').bwRequest('saveAndPublishTheRequest', 'divPageContent1', true, bwBudgetRequestId, bwRequestTypeId) // This saves and publishes the New Request for the first time. 9-8-2022
                                                    .then(function (results) {
                                                        ...
                                                        if (results.status != 'SUCCESS') {
                                                            ...
                                                            var msg = 'Error in bwAttachments_ForEmail_INLINE.js.performUpload2(). xcx21345-1: ' + results.status + ', ' + results.message;
                                                            displayAlertDialog(msg);
                                                        ...
                                                        alert('xcx213234-15 calling populateAttachments().');
                                                        thiz.populateAttachments(workflowAppId, bwBudgetRequestId, displayAttachmentsTagName, true); // This lists the attachments in the <p> tag with id='attachments'.
                                                        console.log('Exception from Promise in bwAttachments_ForEmail_INLINE.js.performUpload2(). xcx21345-2: ' + JSON.stringify(e));
                                            ...
                                            if (data.message.indexOf('gmError: Error: Command failed: identify-im6.q16: no decode delegate for this image format `M4A') > -1) {
                                                ...
                                                var msg = data.status + ' in bwAttachments_ForEmail_INLINE.js.performUpload2() xcx02856-1: ' + data.message;
                                                console.log(msg);
                                                displayAlertDialog(msg);
                                            ...
                                            var msg = data.status + ' in bwAttachments_ForEmail_INLINE.js.performUpload2() xcx02856-2-3: ' + data.message;
                                            console.log(msg);
                                            displayAlertDialog(msg);
                                        ...
                                        $(thiz.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.performUpload2:2: ' + e.message + ', ' + e.stack;
                                    }
                                },
                                error: function (data, errorCode, errorMessage) {
                                    $('#divWorkingOnItDialog').dialog('close'); // Close the "Working on it..." dialog.
                                ...
                                try {
                                    ...
                                    xhr.upload.addEventListener("error", function (evt) {
                                        try {
                                            ...
                                            var msg = 'Error in bwAttachments_ForEmail_INLINE.js.performUpload.xhr.upload.error():xcx1-2-2: workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', evt: ' + JSON.stringify(evt) + ', evt.type: ' + evt.type + ', lengthComputable: ' + evt.lengthComputable + ', loaded: ' + evt.loaded + ', total: ' + evt.total;
                                    ...
                                    console.log('');
                                    console.log('Exception in POST uploadattachment_large_email.ajax.xhr(). workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', ' + e.message + ', ' + e.stack);
                                    console.log('');

                                    alert('Exception in POST uploadattachment_large_email.ajax.xhr(). workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', ' + e.message + ', ' + e.stack);
                            ...
                            success: function (data) {
                                try {
                                    ...
                                    if (data.status == 'SUCCESS') {
                                        ...
                                        var msg = data.status + ' in bwAttachments_ForEmail_INLINE.js.performUpload2() xcx02856-2-4: ' + data.message;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    ...
                                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2():xcx33: ' + e.message + ', ' + e.stack);
                                    alert('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2():xcx33: ' + e.message + ', ' + e.stack);
                                    //$(thiz.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.performUpload2:xcx33: ' + e.message + ', ' + e.stack;
                                    //displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2():xcx33: ' + e.message + ', ' + e.stack);
                                }
                            },
                            error: function (e) {
                                ...
                                if (xhrAbortMessage && xhrAbortMessage != '') {
                                    ...
                                    displayAlertDialog('POST unexpected error. xcx1242525-2-4 workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', Unexpected error: ' + JSON.stringify(e)); //e.responseText)
                ...
                console.log('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2(): ' + e.message + ', ' + e.stack);
                displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.performUpload2(): ' + e.message + ', ' + e.stack);
                $(thiz.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments_ForEmail_INLINE.performUpload2: ' + e.message + ', ' + e.stack;
            }
        });
    },
    ...
    //    try {
    //        console.log('In bwAttachments_ForEmail_INLINE.js.GetStatusUpdateForMediaFileConversion().');
    //        var thiz = this;
    //        var filename = JSON.parse(decodeURI(json)).Display_Filename;

    //        //alert('filename: ' + filename);
    //        //displayAlertDialog_Persistent('In bwAttachments_ForEmail_INLINE.js.GetStatusUpdateForMediaFileConversion(). bwWorkflowAppId: ' + bwWorkflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', json: ' + decodeURI(json));
    ...
    //                        displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.GetStatusUpdateForMediaFileConversion.success(): ' + results.status + ', ' + results.message);
    ...
    //                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.GetStatusUpdateForMediaFileConversion.success(): ' + e.message + ', ' + e.stack);
    //                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.GetStatusUpdateForMediaFileConversion.success(): ' + e.message + ', ' + e.stack);
    //                }
    //            },
    //            error: function (data, errorCode, errorMessage) {
    ...
    //                console.log('Error in bwAttachments_ForEmail_INLINE.js.GetStatusUpdateForMediaFileConversion.error(): ' + errorMessage);
    //                displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.GetStatusUpdateForMediaFileConversion.error(): ' + errorMessage);
    //            }
    //        });

    //    } catch (e) {
    //        var msg = 'Exception in bwAttachments_ForEmail_INLINE.js.GetStatusUpdateForMediaFileConversion(): ' + e.message + ', ' + e.stack;
    //        console.log(msg);
    //        displayAlertDialog(msg);
    //    }
    //},
    ...
    populateAttachments: function (bwWorkflowAppId, bwDraftEmailId, attachmentOrInline, showRemoveAttachmentButton, requestDialogId) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.populateAttachments(). bwDraftEmailId: ' + bwDraftEmailId + ', attachmentOrInline: ' + attachmentOrInline);
            //alert('>>>>>>>>>>>>>>>In bwAttachments_ForEmail_INLINE.js.populateAttachments(). It would be nice to know where this was called from. bwDraftEmailId: ' + bwDraftEmailId + ', attachmentOrInline: ' + attachmentOrInline);
            var thiz = this;
            debugger;
            if (!bwDraftEmailId) {

                var msg = 'Error in bwAttachments_ForEmail_INLINE.js.populateAttachments. Unexpected value for bwDraftEmailId: ' + bwDraftEmailId;
                console.log(msg);
                displayAlertDialog(msg);
                ...
                if (!((attachmentOrInline == 'ATTACHMENTS') || (attachmentOrInline == 'INLINE'))) {
                    ...
                    var msg = 'Error in bwAttachments_ForEmail_INLINE.js.populateAttachments. Unexpected value for attachmentOrInline: ' + attachmentOrInline;
                    console.log(msg);
                    alert(msg);
                    ...
                    //
                    //console.log('This resets the value of the input file element so that if the same file is selected a second time, it behaves as expected. This should only happen in populateAttachments() and in CloseDialog_btnCancelUploadTheFileNow().');
                    //var inputFileAttachmentsElement = $('#inputFile_' + bwDraftEmailId)[0];
                    //if (!inputFileAttachmentsElement) {
                    //    alert('Error in bwAttachments_ForEmail_INLINE.js.populateAttachments(). This error is most likely because this was rendered with renderAndPopulateAttachments_ReadOnly(). It is readonly. DEV: This needs some work. Proceed from here.')
                    //} else {
                    //    inputFileAttachmentsElement.value = '';
                    //}
                    //
                    ...
                    var form;
                    for (var i = 0; i < forms.length; i++) {
                        if (forms[i].getAttribute('bwdraftemailid') == bwDraftEmailId) {
                            console.log('In bwAttachments_ForEmail_INLINE.js.populateAttachments(). FOUND THE FORM');
                            //alert('In bwAttachments_ForEmail_INLINE.js.populateAttachments(). FOUND THE FORM');
                            form = forms[i];
                        }
                    }
                    if (!form) {

                        console.log('Error in bwAttachments_ForEmail_INLINE.js.populateAttachments(). NO FORM FOUND for bwDraftEmailId: ' + bwDraftEmailId);
                        displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.populateAttachments(). NO FORM FOUND for bwDraftEmailId: ' + bwDraftEmailId);

                    } else {

                        //var attachmentWidget = $(form).find('.bwAttachments_ForEmail_INLINE')[0];
                        var attachmentWidget = $('#divBbwEmailClient_Haraka_BwAttachments');

                        if (!attachmentWidget) {

                            console.log('Error in bwAttachments_ForEmail_INLINE.js.populateAttachments(). Could not locate the bwAttachment widget. xcx32425263. bwDraftEmailId: ' + bwDraftEmailId);
                            displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.populateAttachments(). Could not locate the bwAttachment widget. xcx32425263. bwDraftEmailId: ' + bwDraftEmailId);

                        } else {

                            console.log('In bwAttachments_ForEmail_INLINE.js.populateAttachments(). workflowAppId: ' + workflowAppId + ', bwDraftEmailId: ' + bwDraftEmailId + ', attachmentOrInline: ' + attachmentOrInline + ', showRemoveAttachmentButton: ' + showRemoveAttachmentButton + ').');
                            ...
                            var data = {
                                ...
                                bwWorkflowAppId: workflowAppId,
                                bwDraftEmailId: bwDraftEmailId,
                                bwAttachmentOrInline: attachmentOrInline
                            };
                            ...
                            $.ajax({
                                ...
                                success: function (results) {
                                    try {
                                        ...
                                        var html = $('.bwCoreComponent:first').bwCoreComponent('createHtmlToDisplayTheListOfAttachments_ForbwAttachments_ForEmailWidget', attachmentOrInline, workflowAppId, bwDraftEmailId, results);
                                        $(thiz.element).find('#newrequestattachments_INLINE').html(html);
                                        ...
                                        var msg = 'In bwAttachments_ForEmail_INLINE.js.populateAttachments(). RETURNED FILELIST. THIS IS WHERE WE FIGURE OUT HOW TO INCORPORATE THE NEW INLINE ATTACHMENT. results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        displayAlertDialog_Persistent(msg);

                                        //
                                        // Step 1: Iterate through all of the <img /> elements in the draft email body, and check that their "cid" attribute matches all of the inline files.
                                        //          - eg: <img cid="alarmclock2.jpg_320px_.jpg" src="64bit string" />
                                        //          - If any are missing, add an <img /> element to the bottom of the email body.
                                        //            - At some point, we will have to figure out how to do this at the cursor location, add copy-and-paste, etc.
                                        //          - Add a "delete image" button so that an inline image can be deleted.
                                        //

                                        // bwEmailClient_Haraka_EmailBody
                                        //var body = $('#bwEmailClient_Haraka_EmailBody').html();

                                        var imgElements = $('#bwEmailClient_Haraka_EmailBody').find('img');

                                        var foundTheImageElement = false;
                                        if (!(imgElements && imgElements.length && (imgElements > 0))) {

                                            var msg = 'In bwAttachments_ForEmail_INLINE.js.populateAttachments(). NO [img] ELEMENTS WERE FOUND IN THE EMAIL BODY.';
                                            console.log(msg);
                                            alert(msg);

                                        } else {

                                            var msg = 'In bwAttachments_ForEmail_INLINE.js.populateAttachments(). ' + imgElements.length + ' [img] ELEMENTS WERE FOUND IN THE EMAIL BODY.';
                                            console.log(msg);
                                            alert(msg);

                                        }

                                        if (foundTheImageElement != true) {



                                            if (!(results && results.data && results.data[0] && results.data[0].Display_Filename)) {

                                                //var msg = 'Invalid results cant get value for Display_Filename. xcx21312312. results: ' + JSON.stringify(results);
                                                //displayAlertDialog_Persistent(msg);
                                                ...
                                                // The image element doesn't exist. therefore, add it.
                                                var filename = results.data[0].Display_Filename; // Display_Filename: 'alarmclock2.jpg'
                                                ...
                                                //fileUrl = "_files/_draftEmailAttachments/" + participantId + "/" + bwDraftEmailId + "/" + attachmentOrInline + "/" + encodeURI(filename) + '?v=' + preventCachingGuid + '&ActiveStateIdentifier=' + activeStateIdentifier.ActiveStateIdentifier;
                                                //fileUrl_Thumbnail = "_files/_draftEmailAttachments/" + participantId + "/" + bwDraftEmailId + "/" + attachmentOrInline + "/" + encodeURI(filename) + '?v=' + preventCachingGuid + '&ActiveStateIdentifier=' + activeStateIdentifier.ActiveStateIdentifier;
                                                // 7-15-2024.
                                                fileUrl = "_files/_emailAttachments/" + participantId + "/" + bwDraftEmailId + "/" + attachmentOrInline + "/" + encodeURI(filename) + '?v=' + preventCachingGuid + '&ActiveStateIdentifier=' + activeStateIdentifier.ActiveStateIdentifier;
                                                fileUrl_Thumbnail = "_files/_emailAttachments/" + participantId + "/" + bwDraftEmailId + "/" + attachmentOrInline + "/" + encodeURI(filename) + '?v=' + preventCachingGuid + '&ActiveStateIdentifier=' + activeStateIdentifier.ActiveStateIdentifier;
                                                ...
                                                img.src = fileUrl_Thumbnail; // '/images/excelicon.png';
                                                ...
                                                $('#bwEmailClient_Haraka_EmailBody').append(html); // Add it to the end.
                                                ...
                                                //
                                                // end: ONE INTERESTING WAY TO DO IT.
                                                //
                                                ...
                                                // ANOTHER WAY!
                                                //
                                                // SEE: router.get('/_files/getprimaryimageforbudgetrequest_64bitString/:bwWorkflowAppId/:bwBudgetRequestId/:bwAuthorizationPasscode', function (request, response) {
                                                //
                                            ...
                                            // The image element was there. What does that mean? Do nothing?
                                        ...
                                        displayAlertDialog('xcx23123. CAUGHT EXCEPTION: ' + e.message + ', ' + e.stack);

                                        $(attachmentWidget).find('#newrequestattachments')[0].innerHTML = '<span style="color:tomato;">Exception in bwAttachments_ForEmail_INLINE.populateAttachments():1: ' + e.message + ', ' + e.stack + '</span>';
                                        if (e.number) {
                                            console.log('Exception in bwAttachments_ForEmail_INLINE.js.populateAttachments():1: ' + e.message + ', ' + e.stack);
                                            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.populateAttachments():1: ' + e.message + ', ' + e.stack);
                                        } else {
                                ...
                                error: function (data, errorCode, errorMessage) {
                                    ...
                                    if (errorCode === 'timeout' && errorMessage === 'timeout') {
                                        displayAlertDialog('In bwAttachments_ForEmail_INLINE.js.populateAttachments(). SERVICE UNAVAILABLE. File services is not responding. communication timeout is set at ' + ajaxTimeout / 1000 + ' seconds: ' + errorCode + ', ' + errorMessage);
                                        ...
                                        var msg = 'Error in bwAttachments_ForEmail_INLINE.js.populateAttachments(): ' + errorMessage + '.'; // A common error at the moment is "Backend fetch failed". 10-13-2022
                                        ...
                                        //displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.populateAttachments():2:xcx2 ' + errorCode + ', ' + errorMessage + ', ' + JSON.stringify(data));
            ...
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.populateAttachments(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.populateAttachments(): ' + e.message + ', ' + e.stack);

            //renderAndPopulateAttachments
            //$(thiz.element).find('#newrequestattachments')[0].innerHTML = '<span style="color:tomato;">Exception in bwAttachments_ForEmail_INLINE.populateAttachments(): ' + e.message + ', ' + e.stack + '</span>';
            //$(attachmentWidget).find('#newrequestattachments')[0].innerHTML = '<span style="color:tomato;">Exception in bwAttachments_ForEmail_INLINE.populateAttachments(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    cmdDeleteAttachment: function (bwDraftEmailId, filename) {
        try {
            console.log('In bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment(' + bwDraftEmailId + ', ' + filename + ').');
            alert('In bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment(' + bwDraftEmailId + ', ' + filename + ').');
            var thiz = this;
            ...
            $('#divDeleteAnAttachmentOfflineDialogDeleteRequestButton').off('click').click(function (error) {
                try {
                    ...
                    console.log('In bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment.divDeleteAnAttachmentOfflineDialogDeleteRequestButton.click(). bwDraftEmailId: ' + bwDraftEmailId + ', filename: ' + filename);
                        ...
                        success: function (data) {
                            try {
                                ...
                                if (JSON.stringify(data).toUpperCase().indexOf('THE FILE WAS DELETED') > -1) {
                                    ...
                                    console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-9');
                                    ...
                                    console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-10');
                                ...
                                debugger;
                                console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment.post.removeattachment.success(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment.post.removeattachment.success(): ' + e.message + ', ' + e.stack);
                            }
                        },
                        error: function (data, errorCode, errorMessage) {
                            debugger;
                            console.log('Error in bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment.post.removeattachment.error(): ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment.post.removeattachment.error(): bwDraftEmailId: ' + bwDraftEmailId + ', filename: ' + filename + ', errorMessage: ' + errorMessage);
                        }
                    });
                } catch (e) {
                    debugger;
                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment.deletebutton.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment.deletebutton.click(): ' + e.message + ', ' + e.stack);
                }
            });

        } catch (e) {
            debugger;
            console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment():2: ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDeleteAttachment():2: ' + e.message + ', ' + e.stack);
        }
    }
    ...
    //    try {
    //        console.log('In bwAttachments_ForEmail_INLINE.js.cmdSaveAttachmentMetadata().');
    //        var thiz = this;
    ...
    //                            console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-7');
    ...
    //                            console.log('Calling bwAttachments_ForEmail_INLINE.js.populateAttachments(). xcx13124-8');
    ...
    //                } catch (e) {
    //                    console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdSaveAttachmentMetadata(): ' + e.message + ', ' + e.stack);
    //                    displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdSaveAttachmentMetadata(): ' + e.message + ', ' + e.stack);
    //                }
    //            },
    //            error: function (data, errorCode, errorMessage) {
    ...
    //                displayAlertDialog('Error in bwAttachments_ForEmail_INLINE.js.cmdSaveAttachmentMetadata().saveattachmentmetadata: ' + JSON.stringify(data) + ', ' + errorMessage);
    //            }
    //        });
    //    } catch (e) {
    //        console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdSaveAttachmentMetadata():2: ' + e.message + ', ' + e.stack);
    //        displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdSaveAttachmentMetadata():2: ' + e.message + ', ' + e.stack);
    //    }
    //},
    ...
    //    } catch (e) {
    //        console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.button.click.onAllFilesLoaded(): ' + e.message + ', ' + e.stack);
    //        displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.button.click.onAllFilesLoaded(): ' + e.message + ', ' + e.stack);
    //        alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.button.click.onAllFilesLoaded(): ' + e.message + ', ' + e.stack);
    //    }
    //}
    ...
    //        } catch (e) {
    //            console.log('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.button.click.reader.load(): ' + e.message + ', ' + e.stack);
    //            displayAlertDialog('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.button.click.reader.load(): ' + e.message + ', ' + e.stack);
    //            alert('Exception in bwAttachments_ForEmail_INLINE.js.cmdDisplayMultiFileUploadDialog.button.click.reader.load(): ' + e.message + ', ' + e.stack);
    //        }
    //    };
