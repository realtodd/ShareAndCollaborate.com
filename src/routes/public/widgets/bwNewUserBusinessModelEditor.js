$.widget("bw.bwNewUserBusinessModelEditor", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwNewUserBusinessModelEditor.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        this.element.addClass("bwNewUserBusinessModelEditor");
        //debugger;
        //var thiz = this; // Need this because of the asynchronous operations below.
        try {
            console.log('In bwNewUserBusinessModelEditor._create().');
            ...
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwNewUserBusinessModelEditor: CANNOT INITIALIZE HOME PAGE</span>';
            html += '<br />';
            html += '<span style="">Exception in bwNewUserBusinessModelEditor.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    _destroy: function () {
        this.element
            .removeClass("bwNewUserBusinessModelEditor")
            .text("");
    },
    ...
    deployNewUserExperience: function () {
        try {
            ...
            console.log('In bwNewUserBusinessModelEditor.deployNewUserExperience(). appIdAndAppTitle: ' + appIdAndAppTitle);
            ...
            console.log('Exception in bwNewUserBusinessModelEditor.deployNewUserExperience(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    renderBusinessModelEditor: function () {
        try {
            ...
            html += '               <span style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #3f3f3f;font-size:30pt;font-weight:bold;">Configure new tenant "Organization and Roles"...</span>';
            html += '               <br />';
            ...
            html += '   <br />';
            html += '   <span id="spanConfigureBusinessModelNotificationsDialogContent">[spanConfigureBusinessModelNotificationsDialogContent]</span>';
            html += '   <br />';
            html += '   <br />';
            ...
            html += '<div style="display:none;" id="divUndoNewUserBusinessModelActivationDialog5">';
            html += '  <table style="width:100%;">';
            html += '    <tr>';
            html += '      <td style="width:90%;">';
            ...
            //html += '<br />';
            //html += '<span title="Edit email template(s)..." class="spanButton" onclick="$(\'.bwNewUserBusinessModelEditor\').bwNewUserBusinessModelEditor(\'editStepEmails\', \'Create\');"><span style="font-size:15pt;display:inline-block;">✉</span> "New User" Business Model&nbsp;&nbsp;</span>';
    ...
    displayDialog: function (stepName) {
        try {
            ...
            $("#divConfigureBusinessModelNotificationsDialog").dialog({
                ...
                open: function () {
                    try {
                        ...
                        document.getElementById('spanConfigureBusinessModelNotificationsDialogContent').innerHTML = html;
                        ...
                        console.log('Exception in editStepEmails.divConfigureBusinessModelNotificationsDialog.open(): ' + e.message + ', ' + e.stack);
                    }
                },
                close: function () {
                    $('#divConfigureBusinessModelNotificationsDialog').dialog('destroy');
    ...
    //            var html = '';
    //            html += '<input style="padding:5px 10px 5px 10px;width:100px;" id="btnSaveWorkflowConfigurationAndActivate" type="button" value="Publish" onclick="$(\'.bwNewUserBusinessModelEditor\').bwNewUserBusinessModelEditor(\'publishNewUserBusinessModelConfigurationAndActivate\');" />';
    //            html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCancelChangesInDraftWorkflowConfiguration" type="button" value="Cancel Changes" onclick="$(\'.bwNewUserBusinessModelEditor\').bwNewUserBusinessModelEditor(\'cancelChangesInDraftWorkflowConfiguration\');" />';
            ...
            $.ajax({
                ...
                try {
                    if (result.message != 'SUCCESS') {
                        ...
                        $("#divUndoNewUserBusinessModelActivationDialog5").dialog({
                            modal: true,
                            resizable: false,
                            closeOnEscape: false, // Hit the ESC key to hide! Yeah!
                            width: '800',
                            ...
                            open: function () {
                                $('.ui-widget-overlay').bind('click', function () {
                                    $('#divUndoNewUserBusinessModelActivationDialog5').dialog('close');
                                });
                            ...
                            close: function () {
                                $('#divUndoNewUserBusinessModelActivationDialog5').dialog("destroy");
                        ...
                        $('#divUndoNewUserBusinessModelActivationDialog5').dialog().parents('.ui-dialog').find('.ui-dialog-titlebar').remove();
                    }
