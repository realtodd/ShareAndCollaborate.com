$.widget("bw.bwSharePointFormEditor", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwSharePointFormEditor.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        console.log('In bwSharePointFormEditor.js._create().');
        this.element.addClass("bwSharePointFormEditor");
        ...
        try {
            ...
            //        } catch (e) {
            //            console.log('Exception in bwSharePointFormEditor._create().loadWorkflowsAndCurrentWorkflow(): ' + e.message + ', ' + e.stack);
            //        }
            //    });
            //}
            ...
            //html += 'THIS IS THE bwSharePointFormEditor INSTANTIATED. MORE WORK TO DO HERE!!!!!!!!!!!!';
            ...
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwSharePointFormEditor: CANNOT RENDER THE WORKFLOW MATRIX</span>';
            html += '<br />';
            html += '<span style="">Exception in bwSharePointFormEditor.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    renderFormEditor: function () {
        try {
            ...
            console.log('Exception in renderFormEditor(): ' + e.message + ', ' + e.stack);
            alert('Exception in renderFormEditor(): ' + e.message + ', ' + e.stack);
        }
    },
    editEmailTemplate: function (stepFriendlyName, instructionText, stepName) {
        try {
            ...
            //    //} else {
            //    //html += '<select style="padding:5px 5px 5px 5px;" id="selectEditEmailFor" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'selectEditEmailFor_OnChange\', \'editing\');">';
            ...
            // Set the "Save" button.
            var html = '';
            html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveEmailTemplateForStep\', \'' + stepName + '\');">';
                    ...
                    open: function () {
                        try {
                                        ...
                                        if (confirm("This is valid JSON. Are you certain you wish to activate this workflow? THIS ACTION CANNOT BE UNDONE.")) {
                                            ...
                                            $.ajax({
                                                ...
                                                try {
                                                    debugger; // 1-4-2022
                                                    if (result == 'SUCCESS') {
                                                        console.log('In bwSharePointFormEditor.js.displayEditWorkflowJsonDialog().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                                                        alert('In bwSharePointFormEditor.js.displayEditWorkflowJsonDialog().post: Successfully updated DB.');
                                                    } else {
                                                    ...
                                                    console.log('Exception in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + e.message + ', ' + e.stack);
                                                    displayAlertDialog('Exception in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + e.message + ', ' + e.stack);
                                                }
                                                ...
                                                console.log('Fail in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                                                displayAlertDialog('Fail in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                            ...
                            $.ajax({
                                ...
                                displayAlertDialog('Error in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                                console.log('Error in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog().xx.Get: ' + JSON.stringify(data));
                                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                                //var error = JSON.parse(data.responseText)["odata.error"];
                                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                            });
                    ...
                    open: function () {
                        try {
                                        ...
                                        if (confirm("This is valid JSON. Are you certain you wish to activate this workflow? THIS ACTION CANNOT BE UNDONE.")) {
                                            ...
                                            $.ajax({
                                                ...
                                                try {
                                                    debugger; // 1-4-2022
                                                    if (result == 'SUCCESS') {
                                                        console.log('In bwSharePointFormEditor.js.displayEditWorkflowJsonDialog2().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                                                        alert('In bwSharePointFormEditor.js.displayEditWorkflowJsonDialog2().post: Successfully updated DB.');
                                                    } else {
                                                    ...
                                                    console.log('Exception in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + e.message + ', ' + e.stack);
                                                    displayAlertDialog('Exception in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + e.message + ', ' + e.stack);
                                                }
                                            }).error(function (data, errorCode, errorMessage) {
                                                debugger;
                                                //thiz.hideProgress();
                                                ...
                                                console.log('Fail in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                                                displayAlertDialog('Fail in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                                                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                                                //var error = JSON.parse(data.responseText)["odata.error"];
                                                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                                            });
                            ...
                            $.ajax({
                                ...
                                displayAlertDialog('Error in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog2().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                                console.log('Error in bwSharePointFormEditor.js.displayEditWorkflowJsonDialog2().xx.Get: ' + JSON.stringify(data));
                                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                                //var error = JSON.parse(data.responseText)["odata.error"];
                                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                            });
                ...
                $.ajax({
                    ...
                    $.ajax({
                        ...
                        try {
                            ...
                            console.log('Exception in bwSharePointFormEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
                            resolve();
                        }
                    }).fail(function (data) {
                        ...
                        alert('Exception in bwSharePointFormEditor._create().xx.Get:2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                        console.log('Exception in bwSharePointFormEditor._create().xx.Get:2: ' + JSON.stringify(data));
                        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                        //var error = JSON.parse(data.responseText)["odata.error"];
                        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                        resolve();
    ...
    _destroy: function () {
        this.element
            .removeClass("bwSharePointFormEditor")
            .text("");
    },
    ...
    renderWorkflowEditor1: function (assignmentRowChanged_ElementId) {
        try {
            ...
            if (!(bwEnabledRequestTypes && bwEnabledRequestTypes.EnabledItems)) {
                ...
                html += '  <input type="button" value="Create your new role now!" style="height:30pt;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'createANewRole\');" />';
                html += '       </td>';
                html += '     </tr>';
                //html += '     <tr><td>&nbsp;</td></tr>';
                //html += '     <tr>';
                ...
                //html += '  <br /><br />';
                //html += '  <input type="button" value="SAVE" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'roleMultiPickerDialog_RenderResults\');" />';
                //html += '  <br /><br />';
                //html += '</div>';
                ...
                html += '  <br /><br />';
                html += '  <input type="button" value="SAVE" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'orgMultiPickerDialog_RenderResults\');" />';
                html += '  <br /><br />';
                html += '</div>';
                ...
                html += '  <br /><br />';
                html += '  <input type="button" value="SAVE" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'projectTypeMultiPickerDialog_RenderResults\');" />';
                html += '  <br /><br />';
                html += '</div>';
                ...
                html += '  <br /><br />';
                html += '  <input type="button" value="SAVE" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'pillarMultiPickerDialog_RenderResults\');" />';
                html += '  <br /><br />';
                html += '</div>';
                ...
                html += '   <br /><br />';
                // Preview button.
                //html += '   <div class="divSignInButton" style="width: 90%; text-align: center; line-height: 1.1em; font-weight: bold;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayEmailPreviewInDialog\');">';
                ...
                if (thiz.options.displayWorkflowPicker) {
                    if (thiz.options.DisplayAsNewTenantUserConfigurationEditor != true) {
                        ...
                        html += '   <select id="selectRequestTypeDropDown" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'WorkflowRequestTypeDropDown_Onchange\', \'selectWorkflowRequestTypeDropDown\');" class="selectHomePageWorkflowAppDropDown" style=\'display:inline;border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 1em; font-weight: bold; cursor: pointer;  margin-bottom:15px;\'>'; // was .5em
                    ...
                    html += '  </td>';
                    html += '  <td style="text-align:right;">';
                    html += '    <span id="spanThereAreChangesToPublishText" style="font-style:italic;color:tomato;"></span>'; //<input value=" There are unsaved changes. Enter a description here and click Save..." type="text" id="txtNewWorkflowDescription" style="width:450px;color:grey;font-style:italic;padding:5px 5px 5px 5px;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'NewWorkflowDescriptionTextBox_Onkeyup\');" />';
                    html += '  </td>';
                    html += '  <td>';
                    ...
                    //    html += '   <select id="selectWorkflowRequestTypeDropDown" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'WorkflowRequestTypeDropDown_Onchange\', \'selectWorkflowRequestTypeDropDown\');" style=\'border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 14pt; font-weight: bold; cursor: pointer;\'>'; // was .5em
                    ...
                    //} else { // There is more than 1, so we have to display as a drop down.
                    //    html += '<span style="font_weight:bold;color:grey;"><strong>';
                    //    html += '   <select id="selectRequestTypeDropDown" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'WorkflowRequestTypeDropDown_Onchange\', \'selectWorkflowRequestTypeDropDown\');" style=\'display:inline;border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 14pt; font-weight: bold; cursor: pointer;\'>'; // was .5em
                    //    for (var i = 0; i < requestTypes.length; i++) {
                    //        var selected = '';
                    //        //if (requestTypes[i].Abbreviation == bwLastSelectedNewRequestType) { // Selected
                    //        //    selected = 'selected';
                    ...
                    if (thiz.options.MultipleWorkflowsEnabled == false) {
                        html += '&nbsp;&nbsp;<span style="font-weight:normal;font-style:italic;color:grey;white-space:nowrap;"><input id="WorkflowForAllRequestTypesCheckbox" type="checkbox" checked="checked" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'WorkflowForAllRequestTypesCheckbox_Onchange\');" />All request types inherit this workflow</span>';
                    } else {
                    ...
                    html += '<span title="Workflow(s) maintenance..." style="width:200px;padding:5px 10px 5px 10px;margin:0 0 0 10px;white-space:nowrap;vertical-align:middle;border:1px solid lightblue;cursor:pointer;font-weight:normal;font-size:10pt;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayWorkflowsConfigurationDialog\');"><span style="display:inline-block;"> ⚙ </span></span>';
            ...
            console.log('Exception in bwSharePointFormEditor.js.renderWorkflowEditor1(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointFormEditor.js.renderWorkflowEditor1(): ' + e.message + ', ' + e.stack);
        }
    },
        ...
        try {
            ...
            if (!bwRequestTypeId || (bwRequestTypeId == null)) {
                ...
                if (!car) {
                    ...
                    console.log('');
                    console.log('*************************************************************************');
                    console.log('In bwSharePointFormEditor.js.renderWorkflowEditor2(). THIS IS WHERE IF THERE IS NO WORKFLOW SAVED IN THE DATABASE WE SPIT OUT THE DEFAULT.');
                    console.log('*************************************************************************');
                    console.log('');
                ...
                if (weFoundTheWorkflow == true) {
                    ...
                    $.ajax({
                        ...
                        try {
                            debugger;
                            console.log('In bwSharePointFormEditor.js.renderWorkflowEditor2.Get.odata/Roles(). result: ' + JSON.stringify(result));
                            var html = '';
                            var roles;
                            if (result) {
                                roles = result.value;
                            ...
                            if (car == null) {
                                ...
                                html += '                   <span id="spanExpandOrCollapseRightSliderPaneButton" style="cursor:pointer;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'expandOrCollapseSliderPanel\');">';
                                ...
                                //debugger;
                                html += '    <input type="button" style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'addNewWorkflowStep\', \'' + (car.Workflow.Steps.Step.length - 1) + '\');" value="Add a Step" title="bwSharePointFormEditor.addNewWorkflowStep(). Doesn\'t work right yet..." />';
                                //var tooltip = 'Edit email template(s)...';
                                //html += '<span title="' + tooltip + '" style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + 'all' + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> Task Notification Emails&nbsp;&nbsp;</span>';
                                ...
                                for (var i = 0; i < car.Workflow.Steps.Step.length; i++) {
                                    ...
                                    if (false) {
                                        ...
                                        //debugger;
                                        html += '<tr id="stepheaderrow_' + i + '" style="border:0px;cursor:pointer;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'expandOrCollapseWorkflowStep\', \'' + 'stepname_' + i + '\', \'' + 'stepimage_' + i + '\', \'steprow-' + stepName.toLowerCase() + '_' + i + '_' + '0' + '\');">';
                                        ...
                                        if (stepName == 'Collaboration') {
                                            ...
                                            try {
                                                ...
                                                console.log('In bwSharePointFormEditor.js(). Exception trying to get the timeout: ' + e.message + ', ' + e.stack);
                                            }
                                            html += '<span style="white-space:nowrap;font-size:11pt;">';
                                            html += 'Consensus timeout:&nbsp;';
                                            html += '<input type="text" id="textTimeout" style="width:25px;padding:5px 5px 5px 5px;" value="' + timeout + '" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveCollaborationTimeout\', \'' + 'textTimeout' + '\');" />';
                                            html += '&nbsp;';
                                            html += '<select id="selectTimeoutUnits" style="padding:5px 5px 5px 5px;" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveCollaborationTimeout\', \'' + 'textTimeout' + '\');">';
                                        ...
                                        //    html += '<span title="' + tooltip + '" style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> Confirmation Email&nbsp;&nbsp;</span>';
                                        //} else {
                                        //    html += '<span title="' + tooltip + '" style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> &quot;' + stepName + '&quot; Email&nbsp;&nbsp;</span>';
                                        ...
                                        if (stepName.toLowerCase() == 'admin') {
                                            ...
                                            html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                                            html += '          <input type="button" class="buttonAddNewAssignmentRow" style="white-space:nowrap;padding:5px 10px 5px 10px;" value="✚ Add a Role/Participant" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'addARoleParticipant\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" />';

                                            if (!(stepName.toLowerCase() == 'admin' || stepName.toLowerCase() == 'create' || stepName.toLowerCase() == 'revise')) { // Cannot delete these steps.
                                                html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                                                //html += '          <input type="button" class="" style="white-space:nowrap;padding:5px 10px 5px 10px;" value="Delete this Step" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" />';
                                                //html += '<img title="Delete" style="cursor:pointer;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" src="images/trash-can.png">';


                                                //html += '<span class="spanButton" style="height:20px;width:150px;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');">';
                                                //html += '<img style="cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" src="images/trash-can.png">';
                                        ...
                                        if (stepName == 'Create' || stepName == 'Revise' || stepName == 'Admin') {
                                            if (!(car.Workflow.Steps.Step[i].Assign || car.Workflow.Steps.Step[i].Assign[0])) { // changed to || (or) 1-23-2022
                                                ...
                                                console.log('Error in bwSharePointFormEditor.js.renderWorkflowEditor2(). NO ASSIGN STEP FOUND for step: ' + stepName);
                                                displayAlertDialog('Error in bwSharePointFormEditor.js.renderWorkflowEditor2(). NO ASSIGN STEP FOUND for step: ' + stepName);
                                                ...
                                                //html += ' <img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                                                //html += '&nbsp;' + roleName;
                                                html += 'Role: ' + roleName;
                                                ...
                                                if (stepName == 'Create' || stepName == 'Revise') {
                                                    ...
                                                    html += '  <input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'renderEditSteprow\', \'' + xid + '\');" type="button" value="⚙ Edit">';
                                                    html += '</td>';
                                                }
                                                //html += '<td></td>';
                                                //html += '<td></td>';
                                ...
                                for (var j = 0; j < steprows.length; j++) {
                                    ...
                                    workflowAssignmentRow.dblclick(function () {
                                        try {
                                            ...
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveAssignmentRow\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100%;" value="Delete" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deleteRoleCategory\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100%;" value="Cancel" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'cancelStepRowEditing\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100px;white-space:normal;overflow-wrap:break-word;" value="Configure Email Notifications" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayConfigureEmailNotificationsDialog\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  </table>';
                                            ...
                                            //html += '<td class="steprowcell">';
                                            //html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" class="rolecategory-dropdown" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'RoleCategoryDropDown_Onchange\', \'' + this.id + '\');">';
            ...
            $("#divEditStepNameDialog").dialog({
                ...
                open: function () {
                    try {
                        ...
                        var html = '';
                        html += '  <input type="button" value="Save/Update step" style="height:30pt;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepName\', \'' + stepIndex + '\');" />';
    ...
    displayEditEmailInstructionTextDialog: function (stepName) {
        try {
            ...
            var html = '';
            html += '  <input type="button" value="Save/Update step" style="height:30pt;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editEmailInstructionText\', \'' + stepName + '\');" />';
    ...
    addARoleParticipant: function (elementId) {
        try {
            ...
            ////html += '  <tr>';
            ////html += '    <td>';
            ////html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveAssignmentRow\', \'' + elementId + '\', \'' + 'xx' + '\');" />';
            ////html += '    </td>';
            ////html += '  </tr>';
            ////html += '  <tr>';
            ////html += '    <td>';
            ////html += '      <input type="button" style="width:100%;" value="Cancel" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'cancelStepRowEditing\', \'' + elementId + '\', \'' + 'xx' + '\');" />';
            ////html += '    </td>';
            ////html += '  </tr>';
            ////html += '  </table>';
            ...
            //html += '  <tr>';
            //html += '    <td>';
            //html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />';
            //html += '    </td>';
            //html += '  </tr>';
            ////html += '  <tr>';
            ////html += '    <td>';
            ////html += '      <input type="button" style="width:100%;" value="Delete" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deleteRoleCategory\', \'' + elementId + '\');" />';
            ////html += '    </td>';
            ////html += '  </tr>';
            //html += '  <tr>';
            //html += '    <td>';
            //html += '      <input type="button" style="width:100%;" value="Cancel" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'cancelStepRowEditing\', \'' + elementId + '\');" />';
            //html += '    </td>';
            //html += '  </tr>';
            //html += '  <tr>';
            //html += '    <td>';
            //html += '      <input type="button" style="width:100px;white-space:normal;overflow-wrap:break-word;" value="Configure Email Notifications" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayConfigureEmailNotificationsDialog\', \'' + elementId + '\');" />';
            //html += '    </td>';
            //html += '  </tr>';
            //html += '  </table>';
            ...
            $.ajax({
                ...
                try {
                    ...
                    if (thiz.options.displayRoleIdColumn) {
                        ...
                        //html += '<br />';
                        html += '<select id="selectRoleId"  onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleId' + '\');">';
                        html += '  <option value=""></option>';
                        for (var i = 0; i < roles.length; i++) {
                            html += '  <option value="' + roles[i].RoleId + '">' + roles[i].RoleId + '</option>';
                        }
                        html += '</select>';
                        //html += '<br />or create a new role:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        html += '<br /><input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="Create a Role..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayCreateANewRoleDialog\');" />';

                        html += '<br />or select a person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        html += '<br /><input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="Select Person..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayCreateANewRoleDialog\');" />';

                        //html += '<br />or add a new person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        html += '<br /><input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="Add a Person..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayCreateANewRoleDialog\');" />';
                    ...
                    ////html += ' <img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                    ////html == '&nbsp;&nbsp;';
                    //html += '<select id="selectRoleName"  onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleName' + '\');">';
                    //html += '  <option value=""></option>';
                    //for (var i = 0; i < roles.length; i++) {
                    //    html += '  <option value="' + roles[i].RoleId + '">' + roles[i].RoleName + '</option>';
                    //}
                    //html += '</select>';
                    ////html += '<br />or create a new role:'; //<br /><input id="textNewRoleName" type="text" style="width:210pt;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleName' + '\');" />';
                    //html += '<br /><input id="btnCreateRole2" type="button" value="Create a Role..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayCreateANewRoleDialog\');" />';

                    //html += '<br />or select a person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                    //html += '<br /><img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                    //html == '&nbsp;&nbsp;';
                    //html += '<input id="btnCreateRole1" type="button" value="Select Person..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayCreateANewRoleDialog\');" />';

                    ////html += '<br />or add a new person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                    //html += '<br /><input id="btnCreateRole1" type="button" value="Add a Person..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayCreateANewRoleDialog\');" />';
                    ...
                    html += '<td class="steprowcell">';
                    html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" xcx="xcx9934-1" class="rolecategory-dropdown" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'RoleCategoryDropDown_Onchange\', \'' + thiz.id + '\');">';
                    ...
                    html += '  <tr>';
                    html += '    <td>';
                    html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />xcx1671';
                    html += '    </td>';
                    html += '  </tr>';
                    //html += '  <tr>';
                    //html += '    <td>';
        ...
        try {
            ...
            $.ajax({
                ...
                try {
                    ...
                    // The "RoleCategory" dropdown.
                    html += '<td class="steprowcell">';
                    html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" xcx="xcx9934-2" class="rolecategory-dropdown" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'RoleCategoryDropDown_Onchange\', \'' + thiz.id + '\');">';
                    //debugger;
                    ...
                    html += '  <tr>';
                    html += '    <td>';
                    html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />xcx1672';
                    html += '    </td>';
                    html += '  </tr>';
                    //html += '  <tr>';
                    //html += '    <td>';
    ...
    expandOrCollapseSliderPanel: function () {
        ...
        if (document.getElementsByClassName('rightSliderPanel')[0].innerHTML == '') {
            ...
            html += '       </td>';
            html += '       <td>';
            html += '           <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'expandOrCollapseSliderPanel\');">X</span>';
            html += '       </td>';
            html += '   </tr>';
            html += '</table>';
            ...
            html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + 'Overdue' + '\', \'' + 'Overdue Task(s)' + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + 'Overdue Task(s)' + '" &nbsp;&nbsp;</span>';
            html += '           <br />';
            ...
            //html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + 'RequestReceived' + '\', \'' + 'Request Received' + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + 'Request Received' + '" &nbsp;&nbsp;</span>';
            //html += '           <br />';
            //html += '           <div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
            //html += '       </td>';
            //html += '   </tr>';
            ...
            //html += '           <span class="spanButton" title="Edit email template..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\',\'Create\');"><span style="font-size:15pt;display:inline-block;">✉</span> "Your request has been received" &nbsp;</span><br /><span style="font-size:8pt;padding:0 25px 0 25px;">These emails get sent to people when they first create a request.</span>';
            //html += '       </td>';
            //html += '   </tr>';
            ...
            //    //html += '           <span class="spanButton" title="Edit email template(s)..." style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
            //    html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
            //    html += '       </td>';
            //    html += '   </tr>';
            ...
            //html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'all\');"><span style="font-size:15pt;display:inline-block;">✉</span> Task Notification Emails&nbsp;&nbsp;-itworx</span>';
            //html += '       </td>';
            //html += '   </tr>';
            ...
            var html2 = '';
            //html2 += '<input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'addARaciStep\', \'' + 'all' + '\');" type="button" value="Add a Step" />';
            var tooltip = 'Edit email template(s)...';
        ...
        try {
            ...
            for (var i = 0; i < car.DraftWorkflow.Steps.Step.length; i++) {
                ...
                //html += '           <span class="spanButton" title="Edit email template(s)..." style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
                html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + stepName + '\', \'' + stepFriendlyName + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" &nbsp;&nbsp;</span>';
                html += '           <br />';
                html += '           <div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
                html += '       </td>';
                html += '   </tr>';
    ...
    expandOrCollapseAllWorkflowSteps: function () {
        try {
            ...
            for (var i = 0; i < this.options.CurrentWorkflow.DraftWorkflow.Steps.Step.length; i++) {
                // $('.bwSharePointFormEditor').bwSharePointFormEditor('expandOrCollapseWorkflowStep', 'stepname_0', 'stepimage_0', 'steprow-create_0_0');
    ...
    downloadWorkflowJson: function () {
        try {
            ...
            console.log('Exception in bwSharePointFormEditor.js.downloadWorkflowJson(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointFormEditor.js.downloadWorkflowJson(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    renderEditSteprow: function (elementId) {
        try {
            ...
            if (isAdmin) {
                // Render the "RoleCategory" drop-down.
                //html += '<td class="steprowcell">';
                ////html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" class="rolecategory-dropdown" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'RoleCategoryDropDown_Onchange\', \'' + elementId + '\');">';
                ////var rcs = ['Inform', 'Collaborator', 'Approver'];
                ////var rcs2 = ['Inform (Informed)', 'Collaborator (Consulted)', 'Approver (Accountable)'];
                ////for (var rci = 0; rci < rcs.length; rci++) {
                ////    if (rolecategory == rcs[rci]) {
                ...
                // Render the "RoleCategory" drop-down.
                html += '<td class="steprowcell">';
                html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" xcx="xcx9934-3" class="rolecategory-dropdown" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'RoleCategoryDropDown_Onchange\', \'' + elementId + '\');">';
                var rcs = ['Inform', 'Collaborator', 'Approver'];
                var rcs2 = ['Inform (Informed)', 'Collaborator (Consulted)', 'Approver (Accountable)'];
                for (var rci = 0; rci < rcs.length; rci++) {
                    if (rolecategory == rcs[rci]) {
            ...
            html += '  <tr>';
            html += '    <td>';
            html += '      <input type="button" style="padding:5px 10px 5px 10px;width:70px;cursor:pointer;" value="Save" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />';
            html += '    </td>';
            html += '  </tr>';
            if (!isAdmin) { // The ADMIN row/step cannot be deleted.
                html += '  <tr>';
                html += '    <td>';
                html += '      <input type="button" style="padding:5px 10px 5px 10px;width:70px;cursor:pointer;" value="Delete" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deleteRoleCategory\', \'' + elementId + '\');" />';
                html += '    </td>';
                html += '  </tr>';
            }
            html += '  <tr>';
            html += '    <td>';
            html += '      <input type="button" style="padding:5px 10px 5px 10px;width:70px;cursor:pointer;" value="Cancel" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'cancelStepRowEditing\', \'' + elementId + '\');" />';
            html += '    </td>';
            html += '  </tr>';
            //html += '  <tr>';
            //html += '    <td>';
        ...
        try {
            ...
            $.ajax({
                ...
                try {
                    ...
                    html += '    <td></td>';
                    html += '    <td colspan="9">';
                    html += '       <span style="padding: 4px 4px 4px 4px;border:1px solid lightblue;cursor:pointer;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'cmdDisplayDeleteWorkflowsDialog\');">';
                    ...
                    html += '    <td><input type="checkbox" id="checkboxTogglePendingEmailCheckboxes" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'toggleWorkflowConfigurationCheckboxes\', this);" /></td>';
                    ...
                    for (var i = 0; i < workflows.length; i++) {
                        ...
                        if (workflows[i].bwWorkflowJson == 'NEEDS_TO_BE_CREATED') {
                            //html += '   <td></td>'; 
                            html += '   <td colspan="2"><input style="padding:5px 10px 5px 10px;width:200px;color:tomato;" type="button" value="CREATE WORKFLOW" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'createNewWorkflowJson\', \'' + workflows[i].bwRequestType + '\');" /></td>';
                        } else {


                            if (workflows[i].bwWorkflowActive == true) {
                                html += '   <td><input style="padding:5px 10px 5px 10px;width:100px;" id="btnActivateRaciConfiguration" type="button" value="De-activate" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayDeactivateSelectedWorkflowDialog\', \'' + workflows[i].bwWorkflowId + '\');" /></td>';
                            } else {
                                html += '   <td><input style="padding:5px 10px 5px 10px;width:100px;" id="btnActivateRaciConfiguration" type="button" value="Activate" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayActivateSelectedWorkflowDialog\', \'' + workflows[i].bwWorkflowId + '\');" /></td>';
                            }




                            html += '   <td><input style="padding:5px 10px 5px 10px;width:100px;" type="button" value="Edit JSON" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayEditWorkflowJsonDialog\', \'' + workflows[i].bwWorkflowId + '\');" /></td>';
                        }
                    ...
                    html += '   </span>';
                    html += '   <br /><br /><br />';
                    html += '   <div class="divSignInButton" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deleteSelectedWorkflows\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
                ...
                console.log('Exception in bwSharePointFormEditor.js.renderWorkflowsDropDownList().xx.Get: ' + JSON.stringify(data));
                displayAlertDialog('Exception in bwSharePointFormEditor.js.renderWorkflowsDropDownList().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
        ...
        try {
            ...
            $("#divDeleteAWorkflowDialog").dialog({
                ...
                open: function () {
                    ...
                    var html = '';
                    html += '        <div id="divDeleteAWorkflowDialogReassignTasks" class="divSignInButton" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deleteWorkflow\', \'' + bwWorkflowId + '\');" style="width:90%;text-align:center;line-height:0.8em;font-weight:bold;">';
                    html += '            Delete';
                    html += '        </div>';
        ...
        try {
            ...
            $('#divActivateSelectedWorkflowDialog').dialog({
                ...
                open: function () {
                    ...
                    var html = '';
                    html += '        <div id="divActivateSelectedWorkflowDialogReassignTasks" class="divSignInButton" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'activateSelectedWorkflow\', \'' + bwWorkflowId + '\', \'' + bwRequestType + '\');" style="width:90%;text-align:center;line-height:0.8em;font-weight:bold;">';
                    html += '            Activate';
                    html += '        </div>';
        ...
        try {
            ...
            $('#divDeactivateSelectedWorkflowDialog').dialog({
                ...
                open: function () {
                    ...
                    var html = '';
                    html += '        <div id="divDeactivateSelectedWorkflowDialogReassignTasks" class="divSignInButton" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'deactivateSelectedWorkflow\', \'' + bwWorkflowId + '\', \'' + bwRequestType + '\');" style="width:90%;text-align:center;line-height:0.8em;font-weight:bold;">';
            ...
            if (confirm("Are you certain you wish to activate this workflow?")) {
                ...
                if (selectedRequestType == bwRequestType) {
                    ...
                    $.ajax({
                        ...
                        try {
                            //debugger;
                            console.log('In bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                            // Display a dialog with an "Undo" button!!!!
                            $("#divUndoWorkflowActivationDialog").dialog({
                                modal: true,
                                resizable: false,
                            ...
                            console.log('Exception in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                            alert('Exception in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                        }
                    }).error(function (data, errorCode, errorMessage) {
                        debugger;
                        //thiz.hideProgress();
                        ...
                        console.log('Fail in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                        alert('Fail in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                        //var error = JSON.parse(data.responseText)["odata.error"];
                        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                    });
    ...
    publishWorkflowConfigurationAndActivate: function () {
        ...
        debugger; // 1-4-2022
        try {
            console.log('In bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().');
            ...
            if (!bwRequestTypeId || (bwRequestTypeId == null)) {
                ...
                $.ajax({
                    ...
                    try {
                                    ...
                                    try {
                                        ...
                                        promise.then(function (result) {
                                            try {
                                                ...
                                                console.log('Exception in bwSharePointFormEditor._create().loadWorkflowsAndCurrentWorkflow(): ' + e.message + ', ' + e.stack);
                                                displayAlertDialog('Exception in bwSharePointFormEditor._create().loadWorkflowsAndCurrentWorkflow(): ' + e.message + ', ' + e.stack);
                                            }
                                        });
                                    } catch (e) {
                                        console.log('Exception in bwSharePointFormEditor._create().loadWorkflowsAndCurrentWorkflow():xcx56: ' + e.message + ', ' + e.stack);
                                        displayAlertDialog('Exception in bwSharePointFormEditor._create().loadWorkflowsAndCurrentWorkflow():xcx56: ' + e.message + ', ' + e.stack);
                                    }
                                },
                                close: function () {
                                    $('#divUndoWorkflowActivationDialog').dialog("destroy");
                        ...
                        console.log('Exception in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                    }
                    ...
                    console.log('Fail in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                    displayAlertDialog('Fail in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                    //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                    //var error = JSON.parse(data.responseText)["odata.error"];
                    //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                });
            ...
            debugger;
            //thiz.hideProgress();
            console.log('Exception in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointFormEditor.js.publishWorkflowConfigurationAndActivate(): ' + e.message + ', ' + e.stack);
        }
    },
        ...
        try {
            ...
            if (thereHaveBeenChangesToTheWorkflow) {
                ...
                if (this.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                    ...
                    html += '<input style="padding:5px 10px 5px 10px;width:100px;" id="btnSaveWorkflowConfigurationAndActivate" type="button" value="Publish" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'publishWorkflowConfigurationAndActivate\');" />';
                    html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCancelChangesInDraftWorkflowConfiguration" type="button" value="Cancel Changes" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'cancelChangesInDraftWorkflowConfiguration\');" />';
                }
    ...
    saveAssignmentRow: function (elementId) {
        try {
            ...
            if (stepIndex && sourceRoleCategory && roleIndex > -1) {
                ...
                //            thiz._create();
                //        } catch (e) {
                //            console.log('Exception in bwSharePointFormEditor.js.saveAssignmentRow().xx.update: ' + e.message + ', ' + e.stack);
                //            alert('Exception in bwSharePointFormEditor.js.saveAssignmentRow().xx.update: ' + e.message + ', ' + e.stack);
                //        }
                //    }).error(function (data, errorCode, errorMessage) {
                //        //thiz.hideProgress();
                //        var msg;
                ...
                //            msg = JSON.stringify(data) + ', json: ' + JSON.stringify(json);
                //        }
                //        console.log('Fail in bwSharePointFormEditor.js.saveAssignmentRow().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                //        alert('Fail in bwSharePointFormEditor.js.saveAssignmentRow().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                //        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //        //var error = JSON.parse(data.responseText)["odata.error"];
                //        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                //    });
    ...
    //        //
    //        var html = '';
    //        html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveEmailTemplateForOverdueTasks\', \'' + 'stepName' + '\');">';
    //        html += '☑ Save this email template';
    //        html += '</div>';
    //        document.getElementById('spanConfigureEmailNotificationsDialogSaveButton').innerHTML = html;
    //        // Display the email editor.
    ...
    bwSharePointFormEditor_txtLocationPickerFilter_OnMouseup: function () {
        try {
            console.log('In bwSharePointFormEditor_txtLocationPickerFilter_OnMouseup().');
            var thiz = this;
            ...
            var width1 = $('#bwSharePointFormEditor_txtLocationPickerFilter')[0].style.width;
            var width2 = width1.split('px')[0];
            var width3 = Number(width2) + 50;
            var width = width3; // + 'px';

            $("#bwSharePointFormEditor_divLocationPickerDropDown").dialog({
                position: {
                    my: "left top",
                    at: "left bottom",
                    of: $('#bwSharePointFormEditor_txtLocationPickerFilter')
                },
                modal: true,
                resizable: false,
                closeText: "Cancel",
                ...
                open: function (event, ui) {
                    ...
                    $('.ui-widget-overlay').bind('click', function () {
                        $("#bwSharePointFormEditor_divLocationPickerDropDown").dialog('close');
                    });

                    // Hide the title bar.
                    $("#bwSharePointFormEditor_divLocationPickerDropDown").dialog().parents(".ui-dialog").find(".ui-dialog-titlebar").remove();
                },
                close: function () {
                    try {
                        ...
                        $("#bwSharePointFormEditor_divLocationPickerDropDown").dialog('destroy');
                    } catch (e) {
                        console.log('Exception in bwSharePointFormEditor_txtLocationPickerFilter_OnMouseup.dialog.close():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwSharePointFormEditor_txtLocationPickerFilter_OnMouseup.dialog.close():2: ' + e.message + ', ' + e.stack);
                    }
                }
            ...
            console.log('Exception in bwSharePointFormEditor_txtLocationPickerFilter_OnMouseup(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointFormEditor_txtLocationPickerFilter_OnMouseup(): ' + e.message + ', ' + e.stack);
        }
    },
    bwSharePointFormEditor_txtLocationPickerFilter_OnKeyup: function (elementId) {
        try {
            console.log('In bwSharePointFormEditor_txtLocationPickerFilter_OnKeyup(). elementId: ' + elementId);

            if ($('#bwSharePointFormEditor_divLocationPickerDropDown')[0].style.display == 'none') {
                this.bwSharePointFormEditor_txtLocationPickerFilter_OnMouseup();
            }

        } catch (e) {
            console.log('Exception in bwSharePointFormEditor_txtLocationPickerFilter_OnKeyup(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointFormEditor_txtLocationPickerFilter_OnKeyup(): ' + e.message + ', ' + e.stack);
        }
    },
    bwSharePointFormEditor_SelectADataItem: function (element) {
        try {
            console.log('In bwSharePointFormEditor_SelectADataItem().');

            var selectedDataItem = $(element).html();
            $("#bwSharePointFormEditor_divLocationPickerDropDown").dialog('close');
            $('#bwSharePointFormEditor_txtLocationPickerFilter').val(selectedDataItem);

            //alert('In bwSharePointFormEditor_SelectADataItem(). selectedDataItem: ' + selectedDataItem);
            ...
            console.log('Exception in bwSharePointFormEditor_SelectADataItem(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointFormEditor_SelectADataItem(): ' + e.message + ', ' + e.stack);
        }
    },
    displayEmailDataItemPickerDialog: function (emailSection) { // emailSection is either 'subject' or 'body'.
        try {
            ...
            //    html += '   <option value="3" onmouseover="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayDataItemHoverDialog\', this);" >' + dataConversionJson[keys[i]].TemplateText + ' xcx1</option>';
            //}
            ...
            //
            html += '<input id="bwSharePointFormEditor_txtLocationPickerFilter" value="Select a data item..." type="text" style="width:450px;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 20pt;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'bwSharePointFormEditor_txtLocationPickerFilter_OnKeyup\', \'txtLocationPickerFilter\');" onmouseup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'bwSharePointFormEditor_txtLocationPickerFilter_OnMouseup\', \'txtLocationPickerFilter\');" />'; //</input>';
            html += '<br />';
            html += '<div id="bwSharePointFormEditor_divLocationPickerDropDown" style="display:none;background-color:white;overflow-x:hidden;">'; // Scrollable div wrapper for the drop-down. // dark blue border. // position and z-index makes it show up on top and to not move the other elements around.
            //html += '   <div value="3">' + 'Select a data item...' + '</div>';
            var keys = Object.keys(dataConversionJson);
            for (var i = 0; i < keys.length; i++) {
                html += '   <div class="dataItemInDropDown" onmouseover="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'showDataItemHoverDialog\', this);" onmouseout="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'hideDataItemHoverDialog\', this);" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'bwSharePointFormEditor_SelectADataItem\', this);" >' + dataConversionJson[keys[i]].TemplateText + ' </div>';
            }
            ...
            html += '</select>';
            html += '&nbsp;&nbsp;';
            html += '<input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'insertEmailDataItem\', \'' + emailSection + '\');" type="button" value="Insert">';
    ...
    displayWorkflowActionsUnderlyingPropertiesDialog: function (elementId, actionTitle) {
        try {
            ...
            html += '<br />';
            html += '&nbsp;&nbsp;';
            html += '<input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'saveWorkflowActionsUnderlyingProperties\', \'' + elementId + '\', \'' + actionTitle + '\');" type="button" value="Save">';
    ...
    insertEmailDataItem: function (emailSection) { // emailSection is either 'subject' or 'body'.
        try {
            ...
            var selectedDataItem = $('#bwSharePointFormEditor_txtLocationPickerFilter').val(); // 4-5-2022
    ...
    //            //html += '           <span class="spanButton" title="Edit email template(s)..." style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
    //            html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'editStepEmails\', \'' + stepName + '\', \'' + stepFriendlyName + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" &nbsp;&nbsp;</span><br /><div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
    //            html += '       </td>';
    //            html += '   </tr>';
    //            //}
    //        }
    ...
    //                    //debugger;
    //                    var html = '';
    //                    html += '<select style="padding:5px 5px 5px 5px;font-size:8pt;" id="workflowsDropDown" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'WorkflowsDropDown_Onchange\');">';
    ...
    //                    msg = JSON.stringify(data);
    //                }
    //                alert('Exception in bwSharePointFormEditor.js.renderWorkflowsDropDownList().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
    //                console.log('Exception in bwSharePointFormEditor.js.renderWorkflowsDropDownList().xx.Get: ' + JSON.stringify(data));
    //                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
    //                //var error = JSON.parse(data.responseText)["odata.error"];
    //                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
    ...
    renderSelectRoleOrPersonSection: function (elementId) {
        try {
            ...
            if (isAdmin) {
                ...
                //html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleName"  onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleName' + '\');">';
                //html += '  <option value=""></option>';
                //for (var i = 0; i < roles.length; i++) {
                ...
                $.ajax({
                    ...
                    try {
                        ...
                        //html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayPeoplePickerDialog\', \'' + 'txtRoleMembersFriendlyName_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersId_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersEmail_' + stepIndex + '_' + roleIndex + '' + '\');" src="images/addressbook-icon18x18.png">';
                        ...
                        //            roleMembersHtml += '<span style="cursor:pointer;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'DeleteRoleMember\', \'' + elementId + '\', \'' + result[i].bwParticipantId + '\');">&nbsp;&#128465;</span></li>';
                        //        }
                        ...
                        //html += '<br /><img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                        //html == '&nbsp;&nbsp;';
                        //html += '<input id="btnCreateRole1" type="button" value="Select Person..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" />';

                        //html += '<br />or add a new person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        //html += '<br /><input id="btnCreateRole1" type="button" value="Add a Person..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayAddANewPersonDialog\');" />';
                ...
                $.ajax({
                    ...
                    try {
                        ...
                        debugger; // 12-8-2021 <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        html += 'Role:&nbsp;<select test="xcx1001" style="padding:5px 5px 5px 5px;" id="selectRoleName"  onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleName' + '\');">';
                        html += '  <option value=""></option>';
                        for (var i = 0; i < roles.length; i++) {
                            if (rolename == roles[i].RoleName) {
                                html += '  <option value="' + roles[i].RoleId + '" selected >' + roles[i].RoleName + '</option>';
                        ...
                        //html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCreateRole2" type="button" value="New Role..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayCreateANewRoleDialog\');" />';
                        //html += '<br />';
                        //$.ajax({
                        ...
                        //        html += '<input id="txtRoleMembersEmail_' + stepIndex + '_' + roleIndex + '" style="display:none;" />';
                        //        html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayPeoplePickerDialog\', \'' + 'txtRoleMembersFriendlyName_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersId_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersEmail_' + stepIndex + '_' + roleIndex + '' + '\');" src="images/addressbook-icon18x18.png">';
                        //        html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="New Person..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayAddANewPersonDialog\');" />';
                        //        if (participantId) { // Only display when logged in. We need to do more work here!!
                        //            if (result.length > 0) {
                        //                var roleMembersHtml = '';
                        ...
                        //                    roleMembersHtml += '<span style="cursor:pointer;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'DeleteRoleMember\', \'' + elementId + '\', \'' + result[i].bwParticipantId + '\');">&nbsp;&#128465;</span>';
                        //                    roleMembersHtml += '</li>';
                        //                }
                        //                roleMembersHtml += '</ul></span>';
                        //                html += roleMembersHtml;
            ...
            if (selectedRoleCategory == 'Inform') {
                ...
                for (var i = 0; i < actions.length; i++) {
                    ...
                    if (actions[i] == 'Approve' || actions[i] == 'Revise/Hold') {
                        ...
                        html += '  <input type="checkbox" id="' + checkboxId + '" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'toggleChildCheckbox\', \'' + checkboxId + '\', \'' + childCheckboxId + '\');" />&nbsp;' + actions[i];
                    }
                    html += '  &nbsp;';
                    html += '  <input id="' + childCheckboxId + '" type="checkbox" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'toggleParentCheckbox\', \'' + childCheckboxId + '\', \'' + checkboxId + '\');" />&nbsp;require comments';
                    html += '  &nbsp;<span style="cursor:pointer;" title="Select to configure underlying properties..." onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayWorkflowActionsUnderlyingPropertiesDialog\', \'' + elementId + '\', \'' + actions[i] + '\');">&#8230;</span>'
                    html += '</span>';
                    html += '<br />';
                }
                // end: 4-20-2022
    ...
    renderTimeoutSection: function (elementId) {
        try {
            ...
            if (selectedRoleCategory == 'Inform') {
                ...
                html += '<span style="white-space:nowrap;">Timeout:&nbsp;<input type="text" id="textTimeout" style="width:25px;padding:5px 5px 5px 5px;" onkeyup="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'TimeoutTextBox_Onkeyup\', \'' + 'textTimeout' + '\');" />&nbsp;days</span>';
                timeoutCell.html(html);
            } else if (selectedRoleCategory == 'Approver') {
                timeoutCell.html(html);
            } else {
    ...
    renderConditionsSection: function (elementId, conditionString) {
        try {
            ...
            //}
            //if (isExec && isExec == 'True') {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsExec" type="checkbox" checked onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isExecCondition_CheckChanged\');" />&nbsp;' + 'Exec' + '&nbsp;</span>';
            //} else {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsExec" type="checkbox" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isExecCondition_CheckChanged\');" />&nbsp;' + 'Exec' + '&nbsp;</span>';
            //}
            ...
            //}
            //if (isLegal && isLegal == 'True') {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLegal" type="checkbox" checked onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isLegalCondition_CheckChanged\');" />&nbsp;' + 'Legal' + '&nbsp;</span>';
            //} else {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLegal" type="checkbox" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isLegalCondition_CheckChanged\');" />&nbsp;' + 'Legal' + '&nbsp;</span>';
            //}
            //html += '&nbsp;';
            //// Is Lease
            //if (conditionString) {
            ...
            //}
            //if (isLease && isLease == 'True') {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLease" type="checkbox" checked onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isLeaseCondition_CheckChanged\');" />&nbsp;' + 'Lease' + '&nbsp;</span>';
            //} else {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLease" type="checkbox" onchange="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isLeaseCondition_CheckChanged\');" />&nbsp;' + 'Lease' + '&nbsp;</span>';
            //}
            //html += '&nbsp;';
            //// Is IT
            //html += '&nbsp;';
            ...
            //html += '<span style="cursor:pointer;color:red;text-decoration:underline;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayOrgMultiPicker\', \'' + this.id + '\');">Location(s)</span>';
            //html += '&nbsp;&nbsp;&nbsp;&nbsp;';
            //html += '<span style="cursor:pointer;color:red;text-decoration:underline;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayProjectTypeMultiPicker\', \'' + this.id + '\');">Functional area(s)</span>';
            //html += '&nbsp;&nbsp;&nbsp;&nbsp;';
            //html += '<span style="cursor:pointer;color:red;text-decoration:underline;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'displayPillarMultiPicker\', \'' + this.id + '\');">Growth</span>';
                ...
                if (this.options.Checklists) {
                    ...
                    for (var i = 0; i < checklists.length; i++) {
                        ...
                        if (conditionString) {
                            ...
                            if (conditionString.indexOf(checklists[i].bwChecklistTemplatesId) > -1) {
                                html += '<input id="' + checklistCheckboxId + '" checked="" type="checkbox" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isChecklistRequired_CheckChanged\', \'' + checklists[i].bwChecklistTemplatesId + '\', \'' + checklistCheckboxId + '\');" />';
                                //html += '<input id="cbChecklistRequired_' + checklists[i].bwChecklistTemplatesId + '" type="checkbox" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isChecklistRequired_CheckChanged\', this);" />';
                                html += '&nbsp;' + checklists[i].Title + '&nbsp;';
                            } else {
                                html += '<input id="' + checklistCheckboxId + '" type="checkbox" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isChecklistRequired_CheckChanged\', \'' + checklists[i].bwChecklistTemplatesId + '\', \'' + checklistCheckboxId + '\');" />';
                                //html += '<input id="cbChecklistRequired_' + checklists[i].bwChecklistTemplatesId + '" type="checkbox" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'isChecklistRequired_CheckChanged\', this);" />';
                                html += '&nbsp;' + checklists[i].Title + '&nbsp;';
                            }
                        } else {
                        ...
                        //html += '<span style="cursor:pointer;" onclick="$(\'.bwSharePointFormEditor\').bwSharePointFormEditor(\'DeleteChecklist\', \'' + elementId + '\', \'' + checklists[i].bwChecklistTemplatesId + '\');">&nbsp;&#128465;</span>';
    ...
    WorkflowRequestTypeDropDown_Onchange: function (elementId) {
        try {
            ...
            try {
                ...
                console.log('Exception in bwSharePointFormEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
                displayAlertDialog('Exception in bwSharePointFormEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
            }
        } catch (e) {
