$.widget("bw.bwAttachmentDialog", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwAttachmentDialog.js jQuery Widget. 
        ===========================================================
    ...
    _create: function () {
        //alert('In bwAttachmentDialog._create().');
        this.element.addClass("bwAttachmentDialog");
        //debugger;
        ...
        try {
            ...
            <div id="divAttachmentsDialog1Contents" xcx="23123455" class="divDialogAttachment" ondblclick="$('.bwAttachmentDialog').bwAttachmentDialog('zoomAndCenter', 'AttachmentsDialog1');"></div>
            <br /><br />
...
<br /><br />
            ...
            <div id="xxxx" class="divDialogButton" onclick="alert('This functionality allows you to easily copy an attachment to another request. This functionality is incomplete. Coming soon!');">
                Copy to request...[bwAttachmentDialog.js]
            </div>
            ...
            console.log('In bwAttachmentDialog._create(). The widget has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwAttachmentDialog: CANNOT INITIALIZE widget bwAttachmentDialog.js.</span>';
            html += '<br />';
            html += '<span style="">Exception in bwAttachmentDialog.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    _destroy: function () {
        this.element
            .removeClass("bwAttachmentDialog")
            .text("");
    },

    navigateToFirstPage: function () {
        try {
            console.log('In bwAttachmentDialog.js.navigateToFirstPage().');
            //alert('In bwAttachmentDialog.js.navigateToFirstPage().');

            this.options.pageNumber = 1;
            this.renderPdf();

        } catch (e) {
            var msg = 'Exception in bwAttachmentDialog.js.navigateToFirstPage(): ' + e.message + ', ' + e.stack;
            console.log(msg);
    ...
    navigateToPreviousPage: function () {
        try {
            console.log('In bwAttachmentDialog.js.navigateToPreviousPage().');
            //alert('In bwAttachmentDialog.js.navigateToPreviousPage().');

            this.options.pageNumber -= 1;
            this.renderPdf();

        } catch (e) {
            var msg = 'Exception in bwAttachmentDialog.js.navigateToPreviousPage(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    navigateToNextPage: function () {
        try {
            console.log('In bwAttachmentDialog.js.navigateToNextPage().');
            //alert('In bwAttachmentDialog.js.navigateToNextPage().');

            this.options.pageNumber += 1;
            this.renderPdf();

        } catch (e) {
            var msg = 'Exception in bwAttachmentDialog.js.navigateToNextPage(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    navigateToLastPage: function () {
        try {
            console.log('In bwAttachmentDialog.js.navigateToLastPage().');
            //alert('In bwAttachmentDialog.js.navigateToLastPage().');

            this.options.pageNumber = this.options.numPages;
            this.renderPdf();

        } catch (e) {
            var msg = 'Exception in bwAttachmentDialog.js.navigateToLastPage(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    renderPdf: function () {
        try {
            console.log('In bwAttachmentDialog.js.renderPdf().');
            //alert('In bwAttachmentDialog.js.renderPdf().');
            var thiz = this;

            this.options.pdf.getPage(this.options.pageNumber).then(function (page) {

                // Render PDF page into canvas context
                var renderContext = {
                    canvasContext: thiz.options.pdfCanvas_context,
                    viewport: thiz.options.pdfCanvas_viewport
                };
            ...
            var msg = 'Exception in bwAttachmentDialog.js.renderPdf(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    displayAttachmentInDialog: function (fileUrl, filename, description, bwBudgetRequestId) {
        try {
            console.log('In bwAttachmentDialog.js.displayAttachmentInDialog().');
            //alert('In bwAttachmentDialog.js.displayAttachmentDialog(). fileUrl: ' + fileUrl + ', filename: ' + filename + ', description: ' + description);
            var thiz = this;
            ...
            $("#AttachmentsDialog1").dialog({
                ...
                open: function () {
                    try {
                        ...
                        document.getElementById(requestDialogId).setAttribute('bwfileurl', fileUrl);
                        ...
                        if (window.opener) {
                            ...
                            html += '                   <span id="' + requestDialogId + '_spanRequestPrintButton" style="text-align:right;cursor:pointer;font-size:30pt;" onclick="$(\'.bwAttachmentDialog\').bwAttachmentDialog(\'LaunchIntoHomeWindow_AttachmentDialog\', \'' + bwBudgetRequestId + '\');">';
                            html += '                       ☈';
                            html += '                   </span>';

                        } else {

                            html += '           <span id="' + requestDialogId + '_spanRequestPrintButton" style="text-align:right;cursor:pointer;font-size:30pt;" onclick="$(\'.bwAttachmentDialog\').bwAttachmentDialog(\'LaunchIntoSeparateWindow_AttachmentDialog\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\', \'' + 'bwWorkflowTaskItemId' + '\', \'' + fileUrl + '\', \'' + filename + '\', \'' + description + '\');">';
                            html += '               ↸';
                            html += '           </span>';
                        ...
                        //html += '           <span xcx="In bwAttachmentDialog.js.displayAttachmentInDialog.AttachmentsDialog1.dialog.open()" class="dialogXButton" style="font-size:25pt;cursor:pointer;width:100%;font-weight:bold;" onclick="$(\'#' + requestDialogId + '\').dialog(\'close\');">X</span>';
                        ...
                        if (window.opener) {
                            ...
                            html += '           <span xcx="In bwAttachmentDialog.js.displayAttachmentInDialog.AttachmentsDialog1.dialog.open()" class="dialogXButton" style="font-size:25pt;cursor:pointer;width:100%;font-weight:bold;" onclick="window.close();">X</span>';
                        } else {
                            html += '           <span xcx="In bwAttachmentDialog.js.displayAttachmentInDialog.AttachmentsDialog1.dialog.open()" class="dialogXButton" style="font-size:25pt;cursor:pointer;width:100%;font-weight:bold;" onclick="$(\'#' + requestDialogId + '\').dialog(\'close\');">X</span>';
                        }
                        ...
                        $("#slider_" + requestDialogId).slider({
                            ...
                            slide: function (event, ui) {
                                ...
                                $('.bwAttachmentDialog').bwAttachmentDialog('setZoom', ui.value, requestDialogId);
                            }//,
                        ...
                        try {
                            $('.bwAttachmentDialog').bwAttachmentDialog('setZoom', '100', requestDialogId);
                        ...
                        if (['xlsx', 'xls'].indexOf(fileExtension) > -1) {
                            ...
                            // 12-30-2024
                            html += '<img xcx="xcx3243674" src="' + fileUrl + '" style="width:700px;display:block;cursor:pointer;" />';
                            $('#divAttachmentsDialog1Contents').html(html);
                        ...
                        } else if (['mp3', 'm4a', 'm4r', 'aifc'].indexOf(fileExtension) > -1) { // .MP3 (audio), .MP4 (audio), .M4A (audio), .M4V (video), .M4R ("tones"), Added .aifc 8-10-2024.
                            ...
                            //html += '<a onclick="$(\'.bwAttachments:first\').bwAttachments(\'downloadLargeFile\', \'' + bwBudgetRequestId + '\', \'' + filename + '\');" style="cursor:pointer;text-decoration:underline;">Download</a>';
                            html += '<br />';
                        ...
                        html = '';
                        html += '<div id="btnAttachmentsDialog1DeleteAttachment" xcx="xcx2343667" class="divDialogButton" onclick="$(\'.bwAttachments:first\').bwAttachments(\'cmdDeleteAttachment\', \'' + bwBudgetRequestId + '\', \'' + filename + '\');">Delete</div>';
                        ...
                        // 11-30-2023.
                        html = '';
                        html += '<div id="btnAttachmentsDialog1_LaunchFileConversionButton2" class="divDialogButton" onclick="$(\'.bwAttachments:first\').bwAttachments(\'ConvertMediaFileToBaselineShareable\', \'' + bwBudgetRequestId + '\', \'' + filename + '\');">Convert media file to<br />baseline shareable...<br />DEV NOTE: Only 1 per <br />request at 1 time</div>';
            ...
            var msg = 'Exception in bwAttachmentDialog.js.displayAttachmentInDialog():2:' + e.message + ', fileUrl: ' + fileUrl + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    LaunchIntoSeparateWindow_AttachmentDialog: function (requestDialogId, bwBudgetRequestId, bwWorkflowTaskItemId, fileUrl, filename, description) { // See also method displayRequestFormInNewBrowserWindow().
        try {
            console.log('In bwAttachmentDialog.js.LaunchIntoSeparateWindow_AttachmentDialog().');
            //alert('In bwAttachmentDialog.js.LaunchIntoSeparateWindow_AttachmentDialog().');
            ...
            if (!windowObjectReference) {
                ...
                var poppedOutWindow = {
                    windowWidgetType: 'bwAttachmentDialog', // 'bwRequest',
            ...
            console.log('Exception in bwAttachmentDialog.js.LaunchIntoSeparateWindow_AttachmentDialog(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachmentDialog.js.LaunchIntoSeparateWindow_AttachmentDialog(): ' + e.message + ', ' + e.stack);
        }
    },
    LaunchIntoHomeWindow_AttachmentDialog: function (bwBudgetRequestId) {
        try {
            console.log('In bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog(). bwBudgetRequestId: ' + bwBudgetRequestId);
            //alert('In bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog(). bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            //    var msg = 'Unrecoverable error in bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog(). The request window did not exist in the poppedOutAttachmentWindows array. bwBudgetRequestId: ' + bwBudgetRequestId;
            //    console.log(msg);
            //    displayAlertDialog(msg);
            ...
            window.opener.$('.bwAttachmentDialog').bwAttachmentDialog('displayAttachmentInDialog', poppedOutWindow_Json.fileUrl, poppedOutWindow_Json.filename, poppedOutWindow_Json.description, poppedOutWindow_Json.bwBudgetRequestId);
            ...
            //        } catch (e) {
            //            console.log('Caught exception in bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog(): Cannot set bwWorkflowTaskItemId, url param [taskid] is not present.');
            //        }

            //        console.log('In bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog(). Calling displayArInDialog from a popped-out window.... bwBudgetRequestId: ' + bwBudgetRequestId + ', bwWorkflowTaskItemId: ' + bwWorkflowTaskItemId + ', bwRequestJson: ' + JSON.stringify(bwRequestJson));
            ...
            //            var msg = 'Unrecoverable error in bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog(). The request window did not exist in the poppedOutRequestWindows array. bwBudgetRequestId: ' + bwBudgetRequestId;
            //            console.log(msg);
            //            displayAlertDialog(msg);
            ...
            //    } catch (e) {
            //        console.log('Exception in bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog.scrapeBwRequestJson(): ' + e.message + ', ' + e.stack);
            //        displayAlertDialog('Exception in bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog.scrapeBwRequestJson(): ' + e.message + ', ' + e.stack);
            //    }
            //})
            ...
            console.log('Exception in bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachmentDialog.js.LaunchIntoHomeWindow_AttachmentDialog(): ' + e.message + ', ' + e.stack);
        }
    },

    setZoom: function (originalZoom, elementId) {
        try {
            console.log('In bwAttachmentDialog.js.setZoom(' + originalZoom + ', ' + elementId + ')');
            //alert('In bwAttachmentDialog.js.setZoom(' + originalZoom + ', ' + elementId + ')');
            var thiz = this;

            if (window.opener) {
                // This is a popped-out request wndow... we need to handle zoom differently here.
                console.log('In bwAttachmentDialog.js.setZoom(). This is a popped-out request wndow... we need to handle zoom differently here. originalZoom: ' + originalZoom + ', elementId: ' + elementId);
            }
            ...
            if (originalZoom > 20) { // Don't make any smaller than this!
                ...
                if (window.opener) {
                    ...
                    if (rectElement) {
                        ...
                        console.log('xcx21335-2 In bwAttachmentDialog.js.setZoom(' + originalZoom + ', ' + elementId + '). window.resizeTo width: ' + width + ', height: ' + height);
                    }
                    ...
                    if (!el) {
                        alert('xcx12123 invalid el. elementId: ' + elementId);
                    } else {
                        transformOrigin = [0, 0];
            ...
            console.log('Exception in bwAttachmentDialog.js.setZoom(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachmentDialog.js.setZoom(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    zoomAndCenter: function (elementId) {
        try {
            console.log('In bwAttachmentDialog.js.zoomAndCenter(). elementId: ' + elementId);
            ...
            if (transform) {
                ...
                try {
                    ...
                    console.log('xcx23124 bwAttachmentDialog.js.zoomAndCenter() small issue here, it works but maybe improved?......');
                    //alert('xcx23124 bwAttachmentDialog.js.zoomAndCenter() small issue here, it works but maybe improved?......');
                }
            } else {
                var scale = '2';
            }
            ...
            if (scale == '1') {
                ...
                var msg = 'In bwAttachmentDialog.js.zoomAndCenter(). Unexpected value for transform. Expected 1 or 2 or 3. transform: ' + transform + ', scale: ' + scale;
                console.log(msg);
                //displayAlertDialog(msg);
            ...
            console.log('Exception in bwAttachmentDialog.js.zoomAndCenter(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachmentDialog.js.zoomAndCenter(): ' + e.message + ', ' + e.stack);
        }
    },
