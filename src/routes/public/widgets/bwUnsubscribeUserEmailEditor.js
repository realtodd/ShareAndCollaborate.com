$.widget("bw.bwUnsubscribeUserEmailEditor", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwUnsubscribeUserEmailEditor.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        //debugger;
        this.element.addClass("bwUnsubscribeUserEmailEditor");
        var thiz = this; // Need this because of the asynchronous operations below.
        try {
            console.log('In bwUnsubscribeUserEmailEditor._create().');
            ...
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwUnsubscribeUserEmailEditor: CANNOT RENDER</span>';
            html += '<br />';
            html += '<span style="">Exception in bwUnsubscribeUserEmailEditor.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    _destroy: function () {
        this.element
            .removeClass("bwUnsubscribeUserEmailEditor")
            .text("");
    },
    ...
    renderEmailEditor: function () {
        try {
            ...
            html += '   <div style="display:none;" id="divUndoUnsubscribeUserEmailTemplateActivationDialog">';
            html += '       <table style="width:100%;">';
            html += '           <tr>';
            html += '               <td style="width:90%;">';
            html += '                   <span id="spanUndoWorkflowActivationTitle" style="color: #3f3f3f;font-size:30pt;font-weight:bold;">Unsubscribe Email ACTIVATED</span>';
            html += '               </td>';
            html += '               <td style="width:9%;"></td>';
            html += '               <td style="width:1%;cursor:pointer;vertical-align:top;">';
            html += '                   <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'#divUndoUnsubscribeUserEmailTemplateActivationDialog\').dialog(\'close\');">X</span>';
            html += '               </td>';
            html += '           </tr>';
            html += '       </table>';
            html += '       <br /><br />';
            ...
            html += '           You can change the "Active Unsubscribe Email" using the drop-down at the top of this page any time';
            html += '       </span>';
            html += '       </span>';
            html += '       <br /><br />';
            html += '   </div>';
            ...
            html += '<div style="display:none;" id="divConfigureUnsubscribeUserEmailsDialog">';
            html += '   <table style="width:100%;">';
            html += '       <tr>';
            html += '           <td style="width:90%;">';
            html += '               <span style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #3f3f3f;font-size:30pt;font-weight:bold;">Configure "Unsubscribe Email"</span>';
            html += '<span title="Unsubscribe Email maintenance..." style="width:200px;padding:5px 10px 5px 10px;margin:0 0 0 10px;white-space:nowrap;vertical-align:middle;border:1px solid lightblue;cursor:pointer;font-weight:normal;font-size:10pt;" onclick="$(\'.bwUnsubscribeUserEmailEditor\').bwUnsubscribeUserEmailEditor(\'displayWorkflowsConfigurationDialog\');"><span style="display:inline-block;"> ⚙ </span></span>';
            html += '               <br />';
            ...
            html += '           <td style="width:9%;"></td>';
            html += '           <td style="width:1%;cursor:pointer;vertical-align:top;">';
            html += '               <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'#divConfigureUnsubscribeUserEmailsDialog\').dialog(\'close\');">X</span>';
            html += '           </td>';
            html += '       </tr>';
            html += '   </table>';
            html += '   <input type="text" autofocus="true" style="display:none;" /> <!-- This is here to prevent the first visible field from getting the cursor and showing the keyboard. -->';
            ...
            //html += '   <div id="quillConfigureUnsubscribeUserEmailsDialog_Subject" style="height:50px;"></div>'; // Quill.
            html += '<input type="text" id="quillConfigureUnsubscribeUserEmailsDialog_Subject" style="WIDTH: 100%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
            ...
            html += '   </div>';
            html += '   <div id="quillConfigureUnsubscribeUserEmailsDialog_Body" style="height:375px;"></div>'; // Quill.
            // Save button.
            //html += '   <br />';
            //html += '   <span id="spanConfigureEmailNotificationsDialogSaveButton">[spanConfigureEmailNotificationsDialogSaveButton]</span>'; // ☑ 
            html += '   <br /><br />';
            // Preview/Edit button.
            //html += '   <div id="divUnsubscribeUserEmailEditor_PreviewAndEditButton" class="divSignInButton" style="width: 90%; text-align: center; line-height: 1.1em; font-weight: bold;"></div>';
            //html += '   <br /><br />';

            html += '   <div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwUnsubscribeUserEmailEditor\').bwUnsubscribeUserEmailEditor(\'publishEmailTemplateConfigurationAndActivate\');">';
            ...
            //var button = document.getElementById('divUnsubscribeUserEmailEditor_PreviewAndEditButton');
            //button.innerHTML = '       ❐ Edit email HTML';
            //$(button).unbind('click').click(function (error) {
            //    try {
            //        console.log('In renderEmailEditor.divUnsubscribeUserEmailEditor_PreviewAndEditButton.click().');
            //        thiz.editEmail();
            //    } catch (e) {
            //        console.log('Exception in renderEmailEditor.divUnsubscribeUserEmailEditor_PreviewAndEditButton.click(): ' + e.message + ', ' + e.stack);
            //    }
            //});
    ...
    previewEmailHtml: function () {
        try {
            ...
            $(button).unbind('click').click(function (error) {
                try {
                    console.log('In previewEmail.divUnsubscribeUserEmailEditor_PreviewAndEditButton.click().');
                    thiz.editEmailHtml();
                } catch (e) {
                    console.log('Exception in previewEmail.divUnsubscribeUserEmailEditor_PreviewAndEditButton.click(): ' + e.message + ', ' + e.stack);
                }
            });
    ...
    editEmailHtml: function () {
        try {
            ...
            $(button).unbind('click').click(function (error) {
                try {
                    console.log('In editEmailHtml.divUnsubscribeUserEmailEditor_PreviewAndEditButton.click().');
                    thiz.previewEmailHtml();
                } catch (e) {
                    console.log('Exception in editEmailHtml.divUnsubscribeUserEmailEditor_PreviewAndEditButton.click(): ' + e.message + ', ' + e.stack);
                }
            });
    ...
    //displayConfigureUnsubscribeEmailDialog: function () {
    //    try {
    //        console.log('In displayConfigureUnsubscribeEmailDialog().');
    //        debugger;
    //        var thiz = this;
    ...
    //                    $("#divConfigureUnsubscribeUserEmailsDialog").dialog({
    //                        modal: true,
    //                        resizable: false,
    //                        //closeText: "Cancel",
    //                        closeOnEscape: false, // Hit the ESC key to hide! Yeah!
    //                        //title: 'divConfigureUnsubscribeUserEmailsDialog',
    //                        width: '800',
    ...
    //                                    $('#divConfigureUnsubscribeUserEmailsDialog').dialog('close');
    //                                });
    ...
    //                                debugger; // Display the email editor. // 9-5-2021 THIS IS THE ONE THAT WORKS. COPY CODE FROM HERE TO editStepEmails() in bwUnsubscribeUserEmailEditor. <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    //                                thiz.options.quillSubjectEditor = new Quill('#quillConfigureUnsubscribeUserEmailsDialog_Subject', {
    //                                    modules: {
    ...
    //                                });
    //                                //debugger;
    //                                thiz.options.quill = new Quill('#quillConfigureUnsubscribeUserEmailsDialog_Body', {
    //                                    modules: {
    ...
    //        //        } catch (e) {
    //        //            console.log('Exception in displayConfigureUnsubscribeEmailDialog.divConfigureUnsubscribeUserEmailsDialog.open(): ' + e.message + ', ' + e.stack);
    //        //        }
    //        //    },
    //        //    close: function () {
    //        //        $('#divConfigureUnsubscribeUserEmailsDialog').dialog('destroy');
    //        //    }

    //        //});
    //        //$('#divConfigureUnsubscribeUserEmailsDialog').dialog().parents('.ui-dialog').find('.ui-dialog-titlebar').remove();
    ...
    //    } catch (e) {
    //        console.log('Exception in displayConfigureUnsubscribeEmailDialog(): ' + e.message + ', ' + e.stack);
    //    }
    //},
    displayConfigureUnsubscribeEmailDialog: function () {
        try {
            ...
            $.ajax({
                url: this.options.operationUriPrefix + "_bw/UserUnsubscribeEmailSettings/",  // "_bw/NewTenantIntroductoryEmailSettings/", 
                dataType: "json",
                contentType: "application/json",
                type: "Post",
                ...
                try {
                    if (result.message != 'SUCCESS') {
                        ...
                        // Set the dialog sub title.
                        var html = '';
                        html += 'This email gets sent to a User when they unsubscribe from BudgetWorkflow.com.';
                        ...
                        $("#divConfigureUnsubscribeUserEmailsDialog").dialog({
                            ...
                            open: function () {
                                try {
                                    ...
                                    $($('#divConfigureUnsubscribeUserEmailsDialog').find('#quillConfigureUnsubscribeUserEmailsDialog_Body')[0]).summernote({
                                    ...
                                    // Hook up this button event so that the user can insert data items into the email.
                                    var customButton = $('#divConfigureUnsubscribeUserEmailsDialog').find('#btnQuill_InsertADataItem')[0]; //document.querySelector('#btnQuill_InsertADataItem'); //
                                    customButton.addEventListener('click', function () {
                                    ...
                                    if (emailTemplateForSubject && emailTemplateForSubject != '') {
                                        //$('#divConfigureUnsubscribeUserEmailsDialog').find('#quillConfigureUnsubscribeUserEmailsDialog_Subject')[0].value = emailTemplateForSubject;
                                        $('#divConfigureUnsubscribeUserEmailsDialog').find('#quillConfigureUnsubscribeUserEmailsDialog_Subject')[0].value = emailTemplateForSubject;
                                    } else {
                                        //$('#divConfigureUnsubscribeUserEmailsDialog').find('#quillConfigureUnsubscribeUserEmailsDialog_Subject')[0].value = '';
                                        $('#divConfigureUnsubscribeUserEmailsDialog').find('#quillConfigureUnsubscribeUserEmailsDialog_Subject')[0].value = '';
                                    }

                                    //if (emailTemplate && emailTemplate != '') {
                                    //    $($(thiz.element).find('#quillConfigureUnsubscribeUserEmailsDialog_Body')[0]).summernote('reset');
                                    //    $($(thiz.element).find('#quillConfigureUnsubscribeUserEmailsDialog_Body')[0]).summernote('pasteHTML', emailTemplate);
                                    //} else {
                                    //    $($(thiz.element).find('#quillConfigureUnsubscribeUserEmailsDialog_Body')[0]).summernote('reset');
                                    //}
                                    if (emailTemplate && emailTemplate != '') {
                                        ...
                                        debugger;
                                        $($('#divConfigureUnsubscribeUserEmailsDialog').find('#quillConfigureUnsubscribeUserEmailsDialog_Body')[0]).summernote('code', emailTemplate);
                                    } else {
                                        $($('#divConfigureUnsubscribeUserEmailsDialog').find('#quillConfigureUnsubscribeUserEmailsDialog_Body')[0]).summernote('reset');
                                    }
                                    ...
                                    //$('#divConfigureUnsubscribeUserEmailsDialog').find('#spanSelectedEmailSubject')[0].innerHTML = html;
    ...
    publishEmailTemplateConfigurationAndActivate: function () {
        ...
        try {
            ...
            var subject = $('#divConfigureUnsubscribeUserEmailsDialog').find('#quillConfigureUnsubscribeUserEmailsDialog_Subject')[0].value;
            var body = $($('#divConfigureUnsubscribeUserEmailsDialog').find('#quillConfigureUnsubscribeUserEmailsDialog_Body')[0]).summernote("code");
            ...
            $.ajax({
                url: thiz.options.operationUriPrefix + "_bw/PublishUserUnsubscribeEmailTemplate", //PublishOrganizationIntroductoryEmailTemplate",
                type: "Post",
                data: json2,
                headers: {
                ...
                try {
                    if (result.message != 'SUCCESS') {
                        ...
                        $("#divUndoUnsubscribeUserEmailTemplateActivationDialog").dialog({
                            modal: true,
                            resizable: false,
                            //closeText: "Cancel",
                            closeOnEscape: false, // Hit the ESC key to hide! Yeah!
                            ...
                            open: function () {
                                $('.ui-widget-overlay').bind('click', function () {
                                    $('#divUndoUnsubscribeUserEmailTemplateActivationDialog').dialog('close');
                                });
                            ...
                            close: function () {
                                $('#divUndoUnsubscribeUserEmailTemplateActivationDialog').dialog("destroy");
                        ...
                        $('#divUndoUnsubscribeUserEmailTemplateActivationDialog').dialog().parents('.ui-dialog').find('.ui-dialog-titlebar').remove();
                    }
