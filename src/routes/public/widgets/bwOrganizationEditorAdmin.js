$.widget("bw.bwOrganizationEditorAdmin", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwOrganizationEditorAdmin.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        this.element.addClass("bwOrganizationEditorAdmin");
        try {
            console.log('In bwOrganizationEditorAdmin.js._create().');
            ...
            //    // this.options.store is populated, so just render the OrgRoles.
            //    debugger;
            //    this.element.html(this.renderOrgRolesEditor(assignmentRowChanged_ElementId)); // Render the org chart.
            //} else {
            ...
            //        try {
            //            $.ajax({
            //                url: thiz.options.operationUriPrefix + "odata/WorkflowConfiguration/" + tenantId + '/' + workflowAppId + "/true", //?$filter=Active eq true", //('eCarWorkflow')", // Get the eCarWorkflow json/definition from the database.
            //                dataType: "json",
            //                contentType: "application/json",
            //                type: "Get",
            ...
            //                        //debugger;
            //                        //var json = JSON.parse(result.value); //bwOrgRolesJson); // orgRoles = result.value; 
            //                        //if (json.Global) {
            //                        //    //thiz.options.store = json;
            //                        //    thiz.options.store = {
            ...
            //                        //} else {
            //                        //    thiz.options.store = {
            //                        //        DraftGlobal: JSON.parse(JSON.stringify(json)),
            //                        //        Global: json //JSON.parse(result.bwOrgRolesJson)
            //                        //    };
            //                        //}

            //                        var orgRoles = result.value;
            //                        if (!orgRoles.Global) {
            //                            var x = {
            //                                Global: orgRoles
            //                            };
            ...
            //                        alert('Set CurrentWorkflow xcx111774-4');
            //                        //debugger;
            //                        thiz.element.html(thiz.renderOrgRolesEditor()); // Render the org chart.


            //                        // I decided that it is best to display the org roles by default, instead of the workflow... maybe the system should remember which one the user last looked at.?
            //                        // UNDID THIS 3-27-2020
            //                        thiz.renderWorkflowPeoplePicker('spanWorkflowPeoplePicker_right');
            //                        //thiz.renderRolesPeoplePicker('spanWorkflowPeoplePicker_right');

            //                    }
            //                } catch (e) {
            //                    //lpSpinner.Hide();
            //                    console.log('Exception in bwOrganizationEditorAdmin._create().Get.WorkflowConfiguration.done(): ' + e.message + ', ' + e.stack);
            //                }
            //            }).fail(function (data) {
            //                //lpSpinner.Hide();
            //                debugger;
            ...
            //                }
            //                alert('Error in bwOrganizationEditorAdmin._create().Get.WorkflowConfiguration.fail(): ' + msg); //+ error.message.value + ' ' + error.innererror.message);
            //                console.log('Error in bwOrganizationEditorAdmin._create().Get.WorkflowConfiguration.fail ' + JSON.stringify(data));
            ...
            //        } catch (e) {
            //            //lpSpinner.Hide();
            //            console.log('Exception in bwOrganizationEditorAdmin._create().Get.OrgRolesConfiguration.done(): ' + e.message + ', ' + e.stack);
            //        }
            //    }).fail(function (data) {
            //        //lpSpinner.Hide();
            //        debugger;
            ...
            //            msg = JSON.stringify(data);
            //        }
            //        alert('Error in bwOrganizationEditorAdmin._create().Get.OrgRolesConfiguration.fail(): ' + msg); //+ error.message.value + ' ' + error.innererror.message);
            //        console.log('Error in bwOrganizationEditorAdmin._create().Get.OrgRolesConfiguration.fail(): ' + JSON.stringify(data));
            //        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
            //        //var error = JSON.parse(data.responseText)["odata.error"];
            //        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            //    });
            ...
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwOrganizationEditorAdmin: CANNOT RENDER THE WORKFLOW MATRIX</span>';
            html += '<br />';
            html += '<span style="">Exception in bwOrganizationEditorAdmin._create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    loadBusinessModelEditor: function () {
        try {
            console.log('In bwOrganizationEditorAdmin.js.loadBusinessModelEditor().');
            var thiz = this; // Need this because of the asynchronous operations below.
            ...
            $.ajax({
                ...
                success: function (orcResult) {
                    try {
                        ...
                        $.ajax({
                            url: thiz.options.operationUriPrefix + "_bw/workflowconfiguration", //odata/WorkflowConfiguration/" + tenantId + '/' + workflowAppId + "/true",
                            type: "POST",
                            data: data,
                            headers: {
                                "Accept": "application/json; odata=verbose"
                            ...
                            success: function (result2) {
                                try {
                                    ...
                                    console.log('Exception in bwOrganizationEditorAdmin._create().Get.WorkflowConfiguration.done(): ' + e.message + ', ' + e.stack);
                                    displayAlertDialog('Exception in bwOrganizationEditorAdmin._create().Get.WorkflowConfiguration.done(): ' + e.message + ', ' + e.stack);
                                }
                            },
                            error: function (data) {
                                //HideActivitySpinner();
                                ...
                                var msg = 'Error in bwOrganizationEditorAdmin.js.loadBusinessModelEditor.POST.workflowconfiguration(): ' + errorMessage + ', ' + JSON.stringify(data);
                                console.log(msg);
                                alert(msg);
                        ...
                        //HideActivitySpinner();
                        console.log('Exception in bwOrganizationEditorAdmin._create().Get.OrgRolesConfiguration.done(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwOrganizationEditorAdmin._create().Get.OrgRolesConfiguration.done(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {

                    var msg = 'Error in bwOrganizationEditorAdmin.js.loadBusinessModelEditor.POST.OrgRolesConfiguration(): ' + errorMessage + ', ' + JSON.stringify(data);
                    console.log(msg);
                    alert(msg);
            ...
            //HideActivitySpinner();
            //var html = '';
            //html += '<span style="font-size:24pt;color:red;">bwOrganizationEditorAdmin: CANNOT RENDER THE ORGANIZATION</span>';
            //html += '<br />';
            //html += '<span style="">Exception in bwOrganizationEditorAdmin.loadAndRenderBusinessModelEditor(): ' + e.message + ', ' + e.stack + '</span>';
            //thiz.element.html(html);
            console.log('Exception in bwOrganizationEditorAdmin.js.loadBusinessModelEditor(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.loadBusinessModelEditor(): ' + e.message + ', ' + e.stack);
        }
    },

    //_create_old: function (assignmentRowChanged_ElementId) { // replaced 10-19-2022
    //    this.element.addClass("bwOrganizationEditorAdmin");
    //    try {
    //        console.log('In bwOrganizationEditorAdmin.js._create().');
    //        var thiz = this; // Need this because of the asynchronous operations below.
    ...
    //        //    $.ajax({
    //        //        url: thiz.options.operationUriPrefix + "_bw/NewTenantOrganizationSettings",
    //        //        dataType: "json",
    //        //        contentType: "application/json",
    //        //        type: "Get",
    //        //        timeout: thiz.options.ajaxTimeout
    ...
    //        //            } else {
    //        //                //debugger;
    //        //                var json = JSON.parse(result.bwOrgRolesJson);
    //        //                if (json.Global) {
    //        //                    //thiz.options.store = json;
    //        //                    thiz.options.store = {
    //        //                        DraftGlobal: JSON.parse(JSON.stringify(json.Global)),
    ...
    //        //        } catch (e) {
    //        //            //lpSpinner.Hide();
    //        //            console.log('Exception in bwOrganizationEditorAdmin._create().Get.NewTenantOrganizationSettings.done(): ' + e.message + ', ' + e.stack);
    //        //        }
    //        //    }).fail(function (data) {
    //        //        //lpSpinner.Hide();
    //        //        //debugger;
    ...
    //        //            msg = JSON.stringify(data);
    //        //        }
    //        //        alert('Error in bwOrganizationEditorAdmin._create().Get.NewTenantOrganizationSettings.fail(): ' + msg); //+ error.message.value + ' ' + error.innererror.message);
    //        //        console.log('Error in bwOrganizationEditorAdmin._create().Get.NewTenantOrganizationSettings.fail ' + JSON.stringify(data));
    //        //        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
    //        //        //var error = JSON.parse(data.responseText)["odata.error"];
    //        //        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
    //        //    });
    ...
    renderTreeviewWithNewJson: function () {
        try {
            console.log('In renderTreeviewWithNewJson().');
            //debugger;
            //var json = document.getElementById('txtNewUserOrganizationModelJSON').innerHTML;
            var json = $('#divConfigureBusinessModelNotificationsDialog').find('#txtNewUserOrganizationModelJSON')[0].innerHTML;
            ...
            var instance = $('#divConfigureBusinessModelNotificationsDialog').find('.bwOrganizationEditorAdmin')[0]; //.innerHTML;
            ...
            console.log('Exception in renderTreeviewWithNewJson(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    getDatastore: function () {
        try {
            ...
            //                } catch (e) {
            //                    //lpSpinner.Hide();
            //                    console.log('Exception in bwOrganizationEditorAdmin.getDatastore().xx.Get:1: ' + e.message + ', ' + e.stack);
            //                }
            //            }).fail(function (data) {
            //                //lpSpinner.Hide();
            //                debugger;
            ...
            //                    msg = JSON.stringify(data);
            //                }
            //                alert('Exception in bwOrganizationEditorAdmin._create().xx.Get:2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
            //                console.log('Exception in bwOrganizationEditorAdmin._create().xx.Get:2: ' + JSON.stringify(data));
            //                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
            //                //var error = JSON.parse(data.responseText)["odata.error"];
            //                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            //            });
            ...
            //            msg = JSON.stringify(data);
            //        }
            //        alert('Exception in bwOrganizationEditorAdmin.getDatastore().xx.Get:2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
            //        console.log('Exception in bwOrganizationEditorAdmin.getDatastore().xx.Get:2: ' + JSON.stringify(data));
            //        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
            //        //var error = JSON.parse(data.responseText)["odata.error"];
            //        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            //    });
    ...
    renderOrgRolesEditor: function (assignmentRowChanged_ElementId) {
        try {
            ...
            html += '<div style="display:none;" id="divDisplayJsonDialogForBusinessModelEditor">';
            ...
            html += '        <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'#divDisplayJsonDialogForBusinessModelEditor\').dialog(\'close\');">X</span>';
            html += '      </td>';
            html += '    </tr>';
            html += '  </table>';
            html += '  <br /><br />';
            ...
            html += '  <br />';
            html += '  <br />';
            html += '  <div id="btnRunDiagnostics" class="divDialogButton" title="Click here to run diagnostics..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'runJsonDiagnostics\');">';
            ...
            html += '<div style="display:none;" id="divConfigureBusinessModelNotificationsDialog">';
            html += '   <table style="width:100%;">';
            html += '       <tr>';
            html += '           <td style="width:90%;">';
            html += '               <span style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #3f3f3f;font-size:30pt;font-weight:bold;">Edit Organization and Roles JSON</span>';
            html += '               <br />';
            ...
            html += '           <td style="width:9%;"></td>';
            html += '           <td style="width:1%;cursor:pointer;vertical-align:top;">';
            html += '               <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'#divConfigureBusinessModelNotificationsDialog\').dialog(\'close\');">X</span>';
            html += '           </td>';
            html += '       </tr>';
            html += '   </table>';
            html += '   <input type="text" autofocus="true" style="display:none;" /> <!-- This is here to prevent the first visible field from getting the cursor and showing the keyboard. -->';
            ...
            html += '  </td>';
            html += '  <td>';
            html += '    <span onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'renderTreeviewWithNewJson\');" style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;">RE-RENDER</span>';
            html += '  </td>';
            html += '</tr>';
            html += '</table>';
            ...
            html += '   <br />';
            html += '   <span id="spanConfigureOrganizationJsonDialogContent3">[spanConfigureOrganizationJsonDialogContent3]</span>';
            html += '   <br />';
            html += '   <br />';
            ...
            //    html += 'Configure this Organizations 👤Roles and Workflows...&nbsp;<span id="spanBusinessEditorEllipsesContextMenu" class="spanButton context-menu-organizationeditor" style="height:20px;width:150px;"> ... </span>';
            ...
            ////html += '   <select style="padding:5px 5px 5px 5px;" id="selectOrganizationalStructure" onchange="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'selectOrganizationalStructure_OnChange\', \'viewing\');">';
            ...
            ////html += '<br /><span id="dpr1"></span><br />w: <span id="width1"></span><br />h: <span id="height1"></span>';
            ...
            //    html += '  </td>';
            //    html += '  <td>';
            //    html += '    <input style="padding:5px 10px 5px 10px;width:100px;" id="btnActivateOrgRolesConfiguration" type="button" value="  Activatex doesntwork  " onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'activateOrgRolesConfiguration\');" disabled />';
    ...
    expandOrCollapseAllWorkflowSteps: function () {
        try {
            ...
            for (var i = 0; i < this.options.CurrentWorkflow.length; i++) {
                if (this.options.CurrentWorkflow[i].bwRequestType == selectedRequestType && this.options.CurrentWorkflow[i].bwWorkflowActive == true) {
                    //debugger;
    ...
    renderOrgRolesEditor2: function (headerHtml, assignmentRowChanged_ElementId) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.renderOrgRolesEditor2().');
            //alert('In renderOrgRolesEditor2().');
            ...
            html += '                                   <span id="spanOrgX_root" class="orgTreeNode" style="cursor:pointer;white-space:nowrap;" onclick="$(\'.bwCircleDialog\').bwCircleDialog(\'displayOrgRoleEditorInACirclexxx\', true, \'' + 'root' + '\');" >';
            ...
            html += '<td>';
            // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
            html += '                               <span id="spanDivisionsTreeExpandCollapseButton" style="cursor:pointer;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseOrExpandTree\', \'\', \'spanDivisionsTreeExpandCollapseButton\', \'root\');">';
            //html += '                               ⚊ ';
            html += '                               <img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png"> ';
            html += '                               </span>';
            html += '                               <span id="spanOrgX_' + d + '_' + 'GroupsNode' + '" class="orgTreeNode" style="cursor:pointer;font-weight:bold;" title="Collapse..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseTree\', \'\', \'' + '' + '\');" >';
            //html += '                               ◍ Divisions ◍  ';
            html += '                               Divisions &nbsp;&nbsp; ';
            html += '                               </span>';
            html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Add a Division..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'addADivision\', \'' + '' + '\', \'' + '' + '\', \'' + '' + '\', \'' + '' + '\');">';
            html += '                               ✚ New <span style="color:grey;" onmouseover="this.style.color=\'tomato\';" onmouseout="this.style.color=\'grey\';">Division</span>';
            html += '                               </span>';
            ...
            for (var d = 0; d < json.Global.Divisions.Items.length; d++) {
                ...
                html += '<span id="spanDivisionTreeExpandCollapseButton_' + d + '" style="cursor:pointer;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseOrExpandTree\', \'\', \'spanDivisionTreeExpandCollapseButton_' + d + '\', \'' + d + '\');">';
                //html += '⚊';
                html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png">';
                html += '</span>';

                html += ' <span id="spanOrgX_' + d + '" class="orgTreeNode" style="cursor:pointer;" onclick="$(\'.bwCircleDialog\').bwCircleDialog(\'displayOrgRoleEditorInACircle\', true, \'' + d + '\');" >';
                ...
                // added 8-18-2022
                html += '&nbsp;';
                html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Edit Division..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editDivision\', \'' + d + '\');">';
                html += '                               ✎ Edit';// <span style="color:grey;" onmouseover="this.style.color=\'tomato\';" onmouseout="this.style.color=\'grey\';">Division</span>';
                html += '                               </span>';
                ...
                if (json.Global.Divisions.Items[d].Groups.Style == 'display:none;') {
                    html += '                       <tr>';
                    html += '                           <td>';
                    html += '                               <span style="cursor:pointer;font-weight:bold;" title="Collapse..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'expandTree\', \'' + d + '\');">';
                    html += '✚ ✣ Groups ✣  </span>';
                    html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Add a Group..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'addAGroup\', \'' + json.Global.Divisions.Items[d].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');"> ✚ Add</span>';
                    html += '                           </td>';
                    html += '                       </tr>';
                } else {
                    html += '                       <tr>';
                    ...
                    // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    html += '                               <span id="spanGroupsTreeExpandCollapseButton_' + d + '" style="cursor:pointer;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseOrExpandTree\', \'groupsnode\', \'spanGroupsTreeExpandCollapseButton_' + d + '\', \'' + d + '\');">';
                    //html += '                               ⚊ ';
                    html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" />';
                    html += '                               </span>';
                    //html += '                               <span id="spanOrgX_' + d + '_' + 'GroupsNode' + '" class="orgTreeNode" style="cursor:pointer;font-weight:bold;" title="Collapse..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseTree\', \'\', \'' + d + '\');" onmouseout="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'renderOrgRoleConnectorsToWorkflowReset\', \'' + 'spanOrgX_' + d + '_' + 'GroupsNode' + '\', \'' + d + '\', \'' + 'GroupsNode' + '\');" onmouseover="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'renderOrgRoleConnectorsToWorkflow\', true, \'' + d + '\', \'' + 'GroupsNode' + '\');">';
                    html += '                               <span id="spanOrgX_' + d + '_' + 'GroupsNode' + '" class="orgTreeNode" style="cursor:pointer;font-weight:bold;" title="Collapse..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseTree\', \'\', \'' + d + '\');" >';

                    html += 'Groups  &nbsp;&nbsp; ';
                    html += '                               </span>';
                    html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Add a Group..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'addAGroup\', \'' + json.Global.Divisions.Items[d].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                    html += '                               ✚ New <span style="color:grey;" onmouseover="this.style.color=\'tomato\';" onmouseout="this.style.color=\'grey\';">Group</span>';
                    html += '                               </span>';
                    ...
                    for (var g = 0; g < json.Global.Divisions.Items[d].Groups.Items.length; g++) {
                        ...
                        html += '                               <span id="spanGroupTreeExpandCollapseButton_' + d + '_' + g + '" style="cursor:pointer;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseOrExpandTree\', \'\', \'spanGroupTreeExpandCollapseButton_' + d + '_' + g + '\', \'' + d + '\', \'' + g + '\');">';
                        html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" />';
                        html += '                               </span>';
                        ...
                        html += '                                   <span id="spanOrgX_' + d + '_' + g + '" class="orgTreeNode" style="cursor:pointer;" onclick="$(\'.bwCircleDialog\').bwCircleDialog(\'displayOrgRoleEditorInACirclexxx\', true, \'' + d + '\', \'' + g + '\');" >';
                        ...
                        //html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editGroup\', \'' + d + '\', \'' + g + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                        //html == '  <br />';
                        //html += '                                       <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'renderOrgEditorInACircle\', \'' + d + '\', \'' + g + '\');">👤👤🔍';
                        ...
                        // added 8-18-2022
                        html += '&nbsp;';
                        html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Edit Group..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editGroup\', \'' + d + '\', \'' + g + '\');">';
                        html += '                               ✎ Edit';// <span style="color:grey;" onmouseover="this.style.color=\'tomato\';" onmouseout="this.style.color=\'grey\';">Group</span>';
                        html += '                               </span>';
                        ...
                        if (json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Style == 'display:none;') {
                            html += '                               <tr>';
                            html += '                                   <td>';
                            html += '                               <span style="cursor:pointer;font-weight:bold;white-space:nowrap;" title="Collapse..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'expandTree\', \'' + d + '\', \'' + g + '\');">';
                            html += '✚ ⚖ Legal Entities  </span>';
                            html += '                                       <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;font-weight:normal;" title="Add a Legal Entity..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'addALegalEntity\', \'' + json.Global.Divisions.Items[d].Groups.Items[g].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');"> ✚ New <span style="color:grey;" onmouseover="this.style.color=\'tomato\';" onmouseout="this.style.color=\'grey\';">Legal Entity</span></span>';
                            html += '                                   </td>';
                            html += '                               </tr>';
                        } else {
                            html += '                               <tr>';
                            html += '                                   <td style="white-space:nowrap;font-weight:bold;">';
                            html += '                                       <span id="spanLegalEntitiesTreeExpandCollapseButton_' + d + '_' + g + '" style="cursor:pointer;font-weight:bold;white-space:nowrap;" title="Collapse..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseOrExpandTree\', \'legalentitiesnode\', \'spanLegalEntitiesTreeExpandCollapseButton_' + d + '_' + g + '\', \'' + d + '\', \'' + g + '\');">';
                            //html += '                                       ⚊ ';
                            html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png">';
                            html += '                                       </span>';
                            html += 'Legal Entities &nbsp;&nbsp; ';
                            ...
                            for (var e = 0; e < json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items.length; e++) {
                                ...
                                // new 3-7-2020
                                html += '                               <span id="spanGroupsTreeExpandCollapseButton_' + d + '_' + g + '_' + e + '" style="cursor:pointer;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseOrExpandTree\', \'\', \'spanGroupsTreeExpandCollapseButton_' + d + '_' + g + '_' + e + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                                //html += '                               ⚊ ';
                                html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" />';
                                html += '                               </span>';
                                ...
                                html += '   <span id="spanOrgX_' + d + '_' + g + '_' + e + '" class="orgTreeNode" style="cursor:pointer;color:#29685F;white-space:nowrap;" onclick="$(\'.bwCircleDialog\').bwCircleDialog(\'displayOrgRoleEditorInACirclexxx\', true, \'' + d + '\', \'' + g + '\', \'' + e + '\');" >';
                                ...
                                //html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editLegalEntity\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                                //html == '  <br />';
                                //html += '       <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'renderOrgEditorInACircle\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">👤👤🔍</span>';
                                ...
                                // added 8-18-2022
                                html += '&nbsp;';
                                html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Edit Legal Entity..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editLegalEntity\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                                html += '                               ✎ Edit';// <span style="color:grey;" onmouseover="this.style.color=\'tomato\';" onmouseout="this.style.color=\'grey\';">Group</span>';
                                html += '                               </span>';
                                ...
                                if (json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Locations.Style == 'display:none;') {
                                    html += '                                   <tr>';
                                    html += '                                       <td>';
                                    html += '                               <span style="cursor:pointer;font-weight:bold;" title="Expand Locations" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'expandTree\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                                    html += ' ✚ 🏠 Locations </span>';
                                    html += '                                           <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Add a Location..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'addALocation\', \'' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">✚ New <span style="color:grey;" onmouseover="this.style.color=\'tomato\';" onmouseout="this.style.color=\'grey\';">Location</span></span>';
                                    html += '                                       </td>';
                                    html += '                                   </tr>';
                                } else {
                                    html += '                                   <tr>';
                                    html += '                                       <td style="padding-left:45px;white-space:nowrap;">';
                                    html += '                               <span style="cursor:pointer;font-weight:bold;" title="Collapse Locations" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'collapseTree\', \'\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                                    //html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" />';
                                    html += 'Locations &nbsp;&nbsp; </span>';
                                    html += '                                           <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Add a Location..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'addALocation\', \'' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">✚ New <span style="color:grey;" onmouseover="this.style.color=\'tomato\';" onmouseout="this.style.color=\'grey\';">Location</span></span>';
                                    html += '                                       </td>';
                                    ...
                                    for (var l = 0; l < json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Locations.Items.length; l++) {
                                        ...
                                        html += '                                   <span id="spanOrgX_' + d + '_' + g + '_' + e + '_' + l + '" class="orgTreeNode" style="cursor:pointer;white-space:nowrap;" onclick="$(\'.bwCircleDialog\').bwCircleDialog(\'displayOrgRoleEditorInACirclexxx\', true, \'' + d + '\', \'' + g + '\', \'' + e + '\', \'' + l + '\');" >';
                                        ...
                                        // added 8-18-2022
                                        html += '&nbsp;';
                                        html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Edit Location..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editLocation\', \'' + d + '\', \'' + g + '\', \'' + e + '\', \'' + l + '\');">';
                                        html += '                               ✎ Edit';// <span style="color:grey;" onmouseover="this.style.color=\'tomato\';" onmouseout="this.style.color=\'grey\';">Group</span>';
                                        html += '                               </span>';
            ...
            if (developerModeEnabled == true) {
                ...
                html += '    <td id="workflowcontainer1" style="vertical-align:top;display:none;">'; // When not in developer mode, hide this textarea which displays the Organization JSON.
            }
            ...
            if (thiz.options.displayWorkflowPicker) {
                ...
                html += '<span style="font_weight:bold;color:grey;">';
                html += 'Displaying: ';
                //html += '<select id="selectOrganizationWorkflowOrRolesView" onchange="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'selectOrganizationWorkflowOrRolesView_Onchange\');" style="border-color: whitesmoke; color: grey; font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif; font-size: 14pt; font-weight: bold; display: inline; cursor: pointer;" >';
                //html += '   <option value="organizationroles" >Roles and Participants</option>';
                //html += '   <option value="workflow" selected >Workflow</option>';
                //html += '</select>';
                //
                // Changing to radio buttons 4-7-2020.
                html += '<input type="radio" id="selectOrganizationWorkflowOrRolesView_RolesAndParticipants" name="selectOrganizationWorkflowOrRolesView" onchange="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'selectOrganizationWorkflowOrRolesView_Onchange\');" />&nbsp;Roles and Participants';
                html += '&nbsp;&nbsp';
                html += '<input type="radio" id="selectOrganizationWorkflowOrRolesView_Workflow" name="selectOrganizationWorkflowOrRolesView" checked onchange="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'selectOrganizationWorkflowOrRolesView_Onchange\');" />&nbsp;Workflows      ';
                ...
                if (requestTypes.length == 1) { // If there is only one, don't display as a drop down, just as plain text.
                    html += '<span style="font_weight:bold;color:grey;"><strong>' + requestTypes[0][1] + '</strong></span>';
                } else { // There is more than 1, so we have to display as a drop down.
                    html += '<span style="font_weight:bold;color:grey;"><strong>';
                    html += '   <select id="selectWorkflowRequestTypeDropDown" onchange="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'WorkflowRequestTypeDropDown_Onchange\', \'selectWorkflowRequestTypeDropDown\');" style=\'display:inline;border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 14pt; font-weight: bold; cursor: pointer;\'>'; // was .5em
            ...
            if (thiz.options.DisplayAsNewTenantUserConfigurationEditor == true) { // Since we instantiate this widget twice, doing this prevents duplicate DOM object.
                html += '<div style="display:none;" id="divAddAnOrgItemDialog3">';
                html += '   <table style="width:100%;">';
                html += '       <tr>';
                html += '           <td style="width:90%;">';
                ...
                html += '           <td style="width:9%;"></td>';
                html += '           <td style="width:1%;cursor:pointer;vertical-align:top;">';
                html += '               <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size: 30pt;font-weight:bold;" onclick="$(\'#divAddAnOrgItemDialog3\').dialog(\'close\');">X</span>';
                ...
                html += '   <br /><br />';
                html += '   <div class="divSignInButton" style="width: 90%; text-align: center; line-height: 1.1em; font-weight: bold;" onclick="$(\'#divAddAnOrgItemDialog3\').dialog(\'close\');">';
                html += '       Close';
                html += '   </div>';
                html += '   <br /><br />';
                html += '</div>';
            ...
            html += '<div style="display:none;" id="divUndoOrgRolesActivationDialog3_' + thiz.options.elementIdSuffix + '">';
            html += '  <table style="width:100%;">';
            html += '    <tr>';
            html += '      <td style="width:90%;">';
            ...
            html += '      <td style="width:9%;"></td>';
            html += '      <td style="width:1%;cursor:pointer;vertical-align:top;">';
            html += '        <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'#divUndoOrgRolesActivationDialog3_' + thiz.options.elementIdSuffix + '\').dialog(\'close\');">X</span>';
            html += '      </td>';
            html += '    </tr>';
            html += '  </table>';
            html += '  <br /><br />';
            ...
            //displayAlertDialog('xcx12488 In bwOrganizationEditorAdmin.js.renderOrgRolesEditor2(). render the html: ' + html);

            //debugger;
            // Render the html.
            //thiz.element.html(html);
            //$("#spanConfigureOrganizationJsonDialogContent1").html(html); // 8-19-2022
            document.getElementById('bwOrganizationEditor_AdminDialog_DialogContent2').innerHTML = html;
            ...
            if (thiz.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                ...
                //debugger;
                console.log('In bwOrganizationEditorAdmin.js.xx(). DISPLAYING JSON!!!xcx1');
                ...
                // temporary to get uit running 8-19-2022
                // spanConfigureOrganizationJsonDialogContent1
                //$('#spanConfigureOrganizationJsonDialogContent1').find('#workflowcontainer1')[0].innerHTML = html;
                //$('#spanConfigureOrganizationJsonDialogContent1').find('#txtNewUserOrganizationModelJSON')[0].innerHTML = JSON.stringify(thiz.options.store, null, 2);
            ...
            //                                    //console.log('Exception in bwOrganizationEditorAdmin.js.renderOrgRolesEditor(): span tag with id="' + orgsImageFetchingInformation[i].spanOrgId + '" does not exist! ' + e.message + ', ' + e.stack);
            //                                    resolve();
            //                                }

            //                            } catch (e) {
            //                                console.log('Exception in xx().img.onload(): ' + e.message + ', ' + e.stack);
            ...
            //            } else if (key == 'configureorganizationandrolesjson') {
            ...
            //        },
            //        items: {
            //            "configureorganizationandrolesjson": {
            ...
            //            }//,
            //            //"viewtrashbincontents": {
            //            //    name: "View Trashbin contents", icon: "fa-trash"
            //            //}, // images/trash-can.png  // 🗑
            //            //"viewextendedinformation": {
            //            //    name: "View Extended information", icon: "edit"
            //            //}
            ...
            console.log('Exception in renderOrgRolesEditor2(): ' + e.message + ', ' + e.stack);
        }
    },

    displayConfigureOrganizationJsonDialog: function (stepName) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.displayConfigureOrganizationJsonDialog().');
            var thiz = this;
            // Set the dialog sub title.
            var html = '';
            html += 'xcx333-2Editing this JSON may be necessary pre-loading, and troubleshooting ORG ROLES synchronization with the BwWorkflowUserRole table.';
            $('#divConfigureBusinessModelNotificationsDialog').find('#spanConfigureEmailNotificationsDialogSubTitle')[0].innerHTML = html;

            // Display the editor.
            $("#divConfigureBusinessModelNotificationsDialog").dialog({
                modal: false,
                resizable: false,
                closeOnEscape: false, // Hit the ESC key to hide! Yeah!
                //title: 'divConfigureBusinessModelNotificationsDialog',
                width: '1200',
                ...
                open: function () {
                    try {
                        ...
                        //    $('#divConfigureBusinessModelNotificationsDialog').dialog('close');
                        //});
                        ...
                        var $bworgroleseditor = $("#spanConfigureOrganizationJsonDialogContent3").bwOrganizationEditorAdmin(options); // spanConfigureOrganizationJsonDialogContent


                    } catch (e) {
                        console.log('Exception in displayConfigureOrganizationJsonDialog.divConfigureBusinessModelNotificationsDialog.open(): ' + e.message + ', ' + e.stack);
                    }
                },
                close: function () {
                    $('#divConfigureBusinessModelNotificationsDialog').dialog('destroy');
                }

            });
            //$('#divConfigureBusinessModelNotificationsDialog').dialog().parents('.ui-dialog').find('.ui-dialog-titlebar').remove();

        } catch (e) {
            console.log('Exception in bwOrganizationEditorAdmin.js.displayConfigureOrganizationJsonDialog(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    downloadOrganizationJson: function () {
        try {
            console.log('In downloadOrganizationJson().');
            var thiz = this;
    ...
    runJsonDiagnostics: function () {
        try {
            // "Run Diagnostics" button.
            console.log('In runJsonDiagnostics().');
            ...
            $.ajax({
                ...
                try {
                    if (result.message != 'SUCCESS') {
                        ...
                        html += '<br /><br /><span style="font-weight:bold;">DONE</span><br />';
                        $("#divDisplayJsonDialogForBusinessModelEditor").find('#txtDisplayJsonDialogJSON')[0].innerHTML = html; // $("#divDisplayJsonDialogForBusinessModelEditor").find('#txtDisplayJsonDialogJSON')[0].innerHTML = html;
                        //$('#txtDisplayJsonDialogJSON').empty();
                    ...
                    console.log('Exception in bwOrganizationEditorAdmin.runJsonDiagnostics():1: ' + e.message + ', ' + e.stack);
                    thiz.displayAlertDialog('Exception in bwOrganizationEditorAdmin.runJsonDiagnostics():1: ' + e.message + ', ' + e.stack);
                }
            }).fail(function (data) {
                ...
                alert('.fail() in bwOrganizationEditorAdmin.runJsonDiagnostics():2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                console.log('.fail() in bwOrganizationEditorAdmin.runJsonDiagnostics():2: ' + JSON.stringify(data));
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
            ...
            console.log('Exception in bwOrganizationEditorAdmin.runJsonDiagnostics(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    renderWorkflowPeoplePicker: function (tagName) {
        ...
        try {
            ...
            //debugger;
            var thiz = this;
            document.getElementById('selectWorkflowRequestTypeDropDown').style.display = 'inline'; // Only display this when "Workflow" is selected.

            var selectedRequestType = 'budgetrequest';
            // selectWorkflowRequestTypeDropDown


            $.ajax({
                url: this.options.operationUriPrefix + "odata/racirolesandparticipants/" + this.options.bwWorkflowAppId + '/' + selectedRequestType, // Get the eCarWorkflow json/definition from the database.
                dataType: "json",
                contentType: "application/json",
                type: "Get",
                timeout: this.options.ajaxTimeout
                ...
                try {
                    ...
                    //if (thiz.options.LastSelectedNewRequestType == null) thiz.options.LastSelectedNewRequestType = 'budgetrequest'; // The default.
                    ...
                    for (var i = 0; i < thiz.options.CurrentWorkflow.length; i++) {
                        if (thiz.options.CurrentWorkflow[i].bwRequestType == selectedRequestType && thiz.options.CurrentWorkflow[i].bwWorkflowActive == true) {
                            //debugger;
                            // This is the workflow.
                    ...
                    //} else {
                    //    // Error getting the workflow. Should probably reflect this on the screen so the user knows what is going on.
                    //}
                    ...
                    //}
                    //thiz.renderWorkflowEditor(assignmentRowChanged_ElementId); // Render the Workflow Editor. 
                    ...
                    //debugger;
                    // Display the bwWorkflowId guid and request type
                    //document.getElementById('spanWorkflowGuidAndRequestTypeForTesting').innerHTML = car.bwWorkflowId + ' (' + car.bwRequestType + ')';
                    ...
                    if (car == null) {
                        ...
                        if (!car.Workflow) {
                            html += '<tr>';
                            html += '  <td>';
                            html += '    NO WORKFLOW JSON. CANNOT PROCEED. xcx32456-2';
                            html += '  </td>';
                            html += '</tr>';

                        } else {

                            html += '                       <span title="Expand or Collapse ALL..." onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'expandOrCollapseAllWorkflowSteps\');" style="width:200px;padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;font-size:20pt;">';
                            ...
                            for (var i = 0; i < car.Workflow.Steps.Step.length; i++) {
                                ...
                                if (false) {
                                    ...
                                    if (stepName != 'Create' && stepName != 'Revise' && stepName != 'Admin') {
                                        ...
                                        html += '<tr id="stepheaderrow_' + i + '" style="border:0px;cursor:pointer;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'expandOrCollapseWorkflowStep\', \'' + 'stepname_' + i + '\', \'' + 'stepimage_' + i + '\', \'steprow-' + stepName.toLowerCase() + '_' + i + '_' + '0' + '\');">';
                                                ...
                                                if (car.Workflow.Steps.Step[i].OnStart.Inform.length > 0) {
                                                    for (var j = 0; j < car.Workflow.Steps.Step[i].OnStart.Inform.length; j++) {
                                                        ...
                                                        if (bwParticipantFriendlyName) {
                                                            //debugger; // 1
                                                            html += '<span xcx="xcx234566-2" style="cursor:pointer;" onclick="$(\'.bwCircleDialog2\').bwCircleDialog2(\'displayParticipantRoleMultiPickerInACircle\', true, \'\', \'' + bwParticipantId + '\', \'' + bwParticipantFriendlyName + '\', \'' + bwParticipantEmail + '\');">';
                                            ...
                                            if (car.Workflow.Steps.Step[i].Assign) {
                                                if (car.Workflow.Steps.Step[i].Assign.length > 0) {
                                                    for (var j = 0; j < car.Workflow.Steps.Step[i].Assign.length; j++) {
                                                        ...
                                                        if (bwParticipantFriendlyName) {
                                                            //debugger; // 2
                                                            html += '<span test="xcxtest2" style="cursor:pointer;" onclick="$(\'.bwCircleDialog2\').bwCircleDialog2(\'displayParticipantRoleMultiPickerInACircle\', true, \'\', \'' + bwParticipantId + '\', \'' + bwParticipantFriendlyName + '\', \'' + bwParticipantEmail + '\');">';
                                                            html += bwParticipantFriendlyName;
                                                            html += '</span>';
                                                        }
                    ...
                    //debugger;
                    console.log('Exception in renderWorkflowPeoplePicker.get.racirolesandparticipants.success(): ' + e.message + ', ' + e.stack);
                    document.getElementById(tagName).innerHTML = '<span style="color:tomato;">Errorxcx9205: ' + e.message + '</span>';
                }
            }).fail(function (data) {
                //lpSpinner.Hide();
                debugger;
                ...
                alert('Exception in renderWorkflowPeoplePicker.get.racirolesandparticipants.fail(): ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                console.log('Exception in renderWorkflowPeoplePicker.get.racirolesandparticipants.fail(): ' + JSON.stringify(data));
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
            ...
            debugger;
            console.log('renderWorkflowPeoplePicker.get.racirolesandparticipants(): ' + e.message + ', ' + e.stack);
        }
    },

    selectOrganizationWorkflowOrRolesView_Onchange: function () {
        try {
            console.log('In selectOrganizationWorkflowOrRolesView_Onchange().');
            ...
            console.log('Exception in selectOrganizationWorkflowOrRolesView_Onchange(): ' + e.message + ', ' + e.stack);
        }
    },
                ...
                success: function (data1) {
                    ...
                    $.ajax({
                        ...
                        try {
                            ...
                            thiz.options.CurrentWorkflow = workflow;
                            alert('Set CurrentWorkflow xcx111774-5');
                            ...
                            //lpSpinner.Hide();
                            console.log('Exception in bwOrganizationEditorAdmin._create().xx.Get:1: ' + e.message + ', ' + e.stack);
                        }
                    }).fail(function (data) {
                        //lpSpinner.Hide();
                        debugger;
    ...
    renderRolesPeoplePicker: function (tagName) {
        // This is displayed to the right of the treeview when "Roles and Participants" is selected from the drop down. 
        try {
            console.log('In renderRolesPeoplePicker(). This is displayed to the right of the treeview when "Roles and Participants" is selected from the drop down. tagName: ' + tagName);
            var thiz = this;
            document.getElementById('selectWorkflowRequestTypeDropDown').style.display = 'none'; // Only display this when "Workflow" is selected.
            var data = {
                "bwWorkflowAppId": workflowAppId
            ...
            $.ajax({
                ...
                success: function (data1) {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            try {
                                ...
                                for (var i = 0; i < result.data.length; i++) {
                                    if (result.data[i].RoleId != 'ADMIN') { // ADMIN (Workflow Administrator) i sa unique role, and we do not want to display it here.
                                        if (alternatingRow == 'light') {
                                            html += '  <tr class="alternatingRowLight steprow" style="cursor:pointer;" >';
                                            alternatingRow = 'dark';
                                        } else {
                        ...
                        alert('Exception in renderRolesPeoplePicker.bwroles.fail(): ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                        console.log('Exception in renderRolesPeoplePicker.bwroles.fail(): ' + JSON.stringify(data));
                        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                        //var error = JSON.parse(data.responseText)["odata.error"];
                        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                    });
                ...
                error: function (data, errorCode, errorMessage) {
                    //window.waitDialog.close();
                    //handleExceptionWithAlert('Error in index.js.cmdCreateANewTenant()', errorCode + ', ' + errorMessage);
                    displayAlertDialog('Error in renderRolesPeoplePicker.bwroles.error()(' + elementId + '):2:' + errorCode + ', ' + errorMessage);
                }
            });
        } catch (e) {
            //debugger;
    ...
    drawLineFromOrgToWorkflowRoleAndHighlightOrg: function (ctx, originElementIdsAndRoles, lineColor, highlightColor) {
        try {
            ...
            for (var d = 0; d < originElementIdsAndRoles.length; d++) {
                ...
                if (orgElement.offsetParent === null) {
                    ...
                    if (document.getElementById(parentElementId).offsetParent === null) {
                            ...
                            if (elements[x].hasAttributes('bwroleid')) {
                                ...
                                if (roleId2 == roles[i].RoleId) {
                                    ...
                                    if (roles[i].ParticipantFriendlyName == null) {
                                        ...
                                        //debugger;
                                        html += '<span bwtestid="xcx314201" style="color:' + highlightColor + ';cursor:pointer;" onclick="$(\'.bwCircleDialog2\').bwCircleDialog2(\'displayParticipantRoleMultiPickerInACircle\', true, \'\', \'' + roles[i].ParticipantId + '\', \'' + roles[i].ParticipantFriendlyName + '\', \'' + roles[i].ParticipantEmail + '\');">';
                                        //debugger;
    ...
    renderOrgEditorInACircle: function (divisionIndex, groupIndex, entityIndex, locationIndex) {
        try {
            ...
            html += '      <td style="width:9%;"></td>';
            html += '      <td style="width:1%;cursor:pointer;vertical-align:top;">';
            html += '        <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'hideOrgEditorInACircle\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');">X</span>';
            html += '      </td>';
            html += '    </tr>';
            html += '  </table>';
            //html += '  <br /><br />';
            ...
            if (roles && roles.length) {
                for (var r = 0; r < roles.length; r++) {
                    if (roles[r].ParticipantIsDirty == true && roles[r].ParticipantIsDirtyAction == 'REMOVE') {
                        ...
                        var stepIndex = -1;
                        var roleIndex = -1;
                        selectedRolesHtml += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'displayPeoplePickerDialogForJson\', \'' + roles[r].RoleId + '\', \'' + roles[r].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" src="images/addressbook-icon18x18.png">';
                        selectedRolesHtml += '<br />';
                    }
                }
            } else {
            ...
            $.ajax({
                ...
                try {
                    console.log('In bwOrganizationEditorAdmin.js.renderOrgEditorInACircle().Get[odata/Roles].done().');
                    var car = result.workflow;
                    var roles2;
                    if (result) {
                        roles2 = result.userRoles;
                    } else {
                        console.log('In bwOrganizationEditorAdmin.js.renderOrgEditorInACircle().Get[odata/Roles].done: result: bad identifier here, please reword.. ' + JSON.stringify(result));
                    }
                    ...
                    if (workflowRoles.length) {
                        ...
                        for (var w = 0; w < workflowRoles.length; w++) {
                            ...
                            if (isSelected) {
                                html += '<td>xcx51<input id="' + 'orgRoleCheckbox_' + w + '" type="checkbox" checked onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'OrgRoleCheckbox_Onchange\', \'' + 'orgRoleCheckbox_' + w + '\', \'' + workflowRoles[w].RoleId + '\', \'' + workflowRoles[w].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" /></td>';
                            } else {
                                html += '<td>xcx52<input id="' + 'orgRoleCheckbox_' + w + '" type="checkbox" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'OrgRoleCheckbox_Onchange\', \'' + 'orgRoleCheckbox_' + w + '\', \'' + workflowRoles[w].RoleId + '\', \'' + workflowRoles[w].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" /></td>';
                            }
                    ...
                    //
                    if (locationIndex || locationIndex > -1) {
                        html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;white-space:nowrap;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editLocation\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');">✎<span style="text-decoration:underline;white-space:nowrap;">Edit</span></span>';
                    } else if (entityIndex || entityIndex > -1) {
                        html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editLegalEntity\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                    } else if (groupIndex || groupIndex > -1) {
                        html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editGroup\', \'' + divisionIndex + '\', \'' + groupIndex + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                    } else if (divisionIndex || divisionIndex > -1) {
                        if (divisionIndex == 'root') {
                            html += '&nbsp;<span title="Add a Division..." id="divisionsRootNode" style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;text-decoration:underline;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'addADivision\');"> ✚ Add a new Divisionxx</span>';

                            //debugger;
                            //// Add an Edit button here so that the user can rename the root org!
                            //html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'editDivision\', \'' + divisionIndex + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                    ...
                    console.log('Exception in bwOrganizationEditorAdmin.js.renderOrgEditorInACircle().Get[odata/Orgs].done: ' + e.message + ', ' + e.stack);
                }
            }).fail(function (data) {
                var msg;
                if (JSON.stringify(data).indexOf('The specified URL cannot be found.') > -1) {
                ...
                alert('Error in bwOrganizationEditorAdmin.js.renderOrgEditorInACircle().Get[odata/Orgs].fail: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                console.log('Error in bwOrganizationEditorAdmin.js.renderOrgEditorInACircle().Get[odata/Orgs].fail:' + JSON.stringify(data));
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
        } catch (e) {
            console.log('Exception in bwOrganizationEditorAdmin.js.renderOrgEditorInACircle(): ' + e.message + ', ' + e.stack);
        }
    },
            ...
            if (roles && roles.length) {
                for (var r = 0; r < roles.length; r++) {
                    if (roles[r].ParticipantIsDirty == true && roles[r].ParticipantIsDirtyAction == 'REMOVE') {
                        ...
                        var stepIndex = -1;
                        var roleIndex = -1;
                        html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'displayPeoplePickerDialogForJson\', \'' + roles[r].RoleId + '\', \'' + roles[r].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" src="images/addressbook-icon18x18.png">';
                        html += '<br />';
                    }
                }
            } else {
    ...
    collapseOrExpandTree: function (instructions, elementId, divisionIndex, groupIndex, entityIndex) {
        try {
            ...
            if (entityIndex || entityIndex > -1) {
                ...
                if ($(this.element).find('#' + elementId)[0].innerHTML.indexOf('drawer-open.png') > -1) {
                    // Expand all of the divisions.
                    $(this.element).find('#' + elementId)[0].innerHTML = '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" /> ';
                    //var json = this.options.store;
                    //for (var g = 0; g < json.Global.Divisions.Items[divisionIndex].Groups.Items.length; g++) {
                    // expand
                    //debugger;
                    ...
                    //try {
                    $(this.element).find('#' + elementId2)[0].style.display = 'table-row';
                    //} catch (e) { }
                    // change the icon
                    ...
                    $(this.element).find('#' + elementId)[0].innerHTML = '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-open.png" /> '; // This is the root global node.
                    //var json = this.options.store;
                    //for (var g = 0; g < json.Global.Divisions.Items[divisionIndex].Groups.Items.length; g++) {
                    // collapse
                    //debugger;
                    var elementId2 = 'trDivisionGroupsGroupLegalEntitiesLocations_' + divisionIndex + '_' + groupIndex + '_' + entityIndex;
                    //try {
                    $(this.element).find('#' + elementId2)[0].style.display = 'none';
                    //} catch (e) { }
                    // change the icon
                    //document.getElementById('spanDivisionTreeExpandCollapseButton_' + divisionIndex).innerHTML = '✚ '; // This is the division root node
                    //}
                ...
                if (instructions == 'legalentitiesnode') {
                    if ($(this.element).find('#' + elementId)[0].innerHTML.indexOf('drawer-open.png') > -1) {
                        ...
                        for (var e = 0; e < json.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items.length; e++) {
                            ...
                            $(this.element).find('#' + elementId3)[0].style.display = 'table-row';
                        ...
                        for (var e = 0; e < json.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items.length; e++) {
                            ...
                            var elementId3 = 'trDivisionGroupsGroupLegalEntitiesLocations_' + divisionIndex + '_' + groupIndex + '_' + e; // + '_' + l;
                            $(this.element).find('#' + elementId3)[0].style.display = 'none';
                ...
                if (instructions == 'groupsnode') {
                    ...
                    if ($(this.element).find('#' + elementId)[0].innerHTML.indexOf('drawer-open.png') > -1) {
                        ...
                        for (var d = 0; d < json.Global.Divisions.Items.length; d++) {
                            ...
                            $(this.element).find('#' + elementId)[0].style.display = 'table-row';
                            // change the icon
                            $(this.element).find('#' + 'spanDivisionTreeExpandCollapseButton_' + d)[0].innerHTML = '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" /> '; // This is the division root node
                        }
                    } else {
                        // Collapse all of the divisions.
                        $(this.element).find('#' + elementId)[0].innerHTML = '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-open.png" /> '; // This is the root global node.
                        ...
                        for (var d = 0; d < json.Global.Divisions.Items.length; d++) {
                            // collapse
                            var elementId = 'trDivisionGroups_' + d;
                            $(this.element).find('#' + elementId)[0].style.display = 'none';
                            // change the icon
                            $(this.element).find('#' + 'spanDivisionTreeExpandCollapseButton_' + d)[0].innerHTML = '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-open.png" /> '; // This is the division root node
                        }
                    }
                } else {
                    //debugger;
                    if ($(this.element).find('#' + elementId)[0].innerHTML.indexOf('drawer-open.png') > -1) {
                        ...
                        $(this.element).find('#' + elementId)[0].style.display = 'table-row';
                        // change the icon
                        $(this.element).find('#' + 'spanDivisionTreeExpandCollapseButton_' + divisionIndex)[0].innerHTML = '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" /> '; // This is the division root node
                        //}
                    } else {
                        // Collapse all of the divisions.
                        $(this.element).find('#' + elementId)[0].innerHTML = '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-open.png" /> '; // This is the root global node.
                        ...
                        $(this.element).find('#' + elementId)[0].style.display = 'none';
                        // change the icon
                        $(this.element).find('#' + 'spanDivisionTreeExpandCollapseButton_' + divisionIndex)[0].innerHTML = '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-open.png" /> '; // This is the division root node
                        //}
                    }
                }
            } else {
    ...
    manageRaciRoles: function (divisionIndex, groupIndex, entityIndex) {
        try {
            ...
            //$('.bwOrganizationEditorAdmin').bwOrganizationEditorAdmin('displayCreateANewRoleDialog');
    ...
    addADivision: function (elementId, divisionIndex, groupIndex, entityIndex) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.addADivision().');
            var thiz = this;

            $('#divAddAnOrgItemDialog3').dialog({
                modal: true,
                resizable: false,
                ...
                open: function () {
                    try {
                        $('.ui-widget-overlay').bind('click', function () {
                            $("#divAddAnOrgItemDialog3").dialog('close');
                        });
                        $('#divAddAnOrgItemDialog3').find('#spanAddAnOrgItemDialogTitle').html('Add a new Division ◍');
                        $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').html('Add the new Division ◍');
                        $('#divAddAnOrgItemDialog3').find('#txtAddAnOrgItemDialogName').val('');
                        $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogAbbreviation').val();
                        $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogId').val();
                        $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                            try {
                                //debugger;
                                console.log('In bwOrganizationEditorAdmin.js.addADivision.divAddAnOrgItemDialogSubmitButton.click().');
                                ...
                                if (name.length > 4 && abbreviation.length > 1) {
                                    ...
                                    //
                                    // Added these 3 push statements 8-18-2022. This makes more sense.... there should always be at least 1 location at the bottom of the tree.
                                    //
                                    var divisionIndex = thiz.options.store.Global.Divisions.Items.length - 1;
                                    var group = {
                                        Name: name + ' Group 1',
                                        Abbreviation: abbreviation + '_GROUP1',
                                        Id: guid,
                                        Style: 'display:block;',
                                        LegalEntities: {
                                            Style: 'display:block;',
                                    ...
                                    var groupIndex = thiz.options.store.Global.Divisions.Items[divisionIndex].Groups.Items.length - 1;
                                    var legalentity = {
                                        Name: name + ' Entity 1',
                                        Abbreviation: abbreviation + '_ENTITY1',
                                        Id: guid,
                                        Style: 'display:block;',
                                        Locations: {
                                            Style: 'display:block;',
                                    ...
                                    var entityIndex = thiz.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items.length - 1;
                                    var location = {
                                        Name: name + ' Location 1',
                                        Abbreviation: abbreviation + '_LOC1',
                                        Id: guid,
                                        Style: 'display:block;'
                                    };
                                    ...
                                    //
                                    // end: Added these 3 push statements 8-18-2022. This makes more sense.... there should always be at least 1 location at the bottom of the tree.
                                    //

                                    $(thisDialog).find("#divAddAnOrgItemDialog3").dialog('close');
                                    thiz.renderOrgRolesEditor2();
                                } else {
                                    alert('Please enter a name (5 characters or more) and an abbreviation (2 characters or more).');
                                }
                            } catch (e) {
                                console.log('Exception in bwOrganizationEditorAdmin.js.addADivision.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addADivision.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                            }
                        });
                    } catch (e) {
                        console.log('Exception in bwOrganizationEditorAdmin.js.addADivision.divAddAnOrgItemDialog3.open(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addADivision.divAddAnOrgItemDialog3.open(): ' + e.message + ', ' + e.stack);
                    }
                },
                close: function () {
                    //$(this).empty().dialog('destroy'); // 7-5-2020 THIS IS THE PREFFERED SYNTAX FOR THIS FROM NOW ON!!!!!!!!!!!!!!!!!!!!!!!!!!!! REPLACE EVERYWHERE AND TEST!!!!!!!!!!!!!!!!!!!!!!!!!!
                    $('#divAddAnOrgItemDialog3').dialog('destroy');
                }
            });
            //$("#divAddAnOrgItemDialog").dialog().parents(".ui-dialog").find(".ui-dialog-titlebar").remove();

        } catch (e) {
            console.log('Exception in bwOrganizationEditorAdmin.js.addADivision(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addADivision(): ' + e.message + ', ' + e.stack);
        }
    },
    addAGroup: function (elementId, divisionIndex, groupIndex, entityIndex) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.addAGroup(). elementId: ' + elementId);
            var thiz = this;
            $('#divAddAnOrgItemDialog3').dialog({
                modal: true,
                resizable: false,
                ...
                open: function () {
                    try {
                        ...
                        $(this).find('#spanAddAnOrgItemDialogTitle')[0].innerHTML = 'Add a new Group ✣';
                        $(this).find('#divAddAnOrgItemDialogSubmitButton')[0].innerHTML = 'Add the new Group ✣';
                        $(this).find('#txtAddAnOrgItemDialogName')[0].value = '';
                        $(this).find('#txtAddANewPersonDialogAbbreviation')[0].value = '';
                        $(this).find('#txtAddANewPersonDialogId')[0].value = '';
                        ...
                        $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                            try {
                                ...
                                console.log('Exception in bwOrganizationEditorAdmin.js.addAGroup.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addAGroup.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                            }
                        });
                    } catch (e) {
                        console.log('Exception in bwOrganizationEditorAdmin.js.addAGroup.divAddAnOrgItemDialog3.open(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addAGroup.divAddAnOrgItemDialog3.open(): ' + e.message + ', ' + e.stack);
                    }
                },
                close: function () {
                    //$(this).empty().dialog('destroy'); // 7-5-2020 THIS IS THE PREFFERED SYNTAX FOR THIS FROM NOW ON!!!!!!!!!!!!!!!!!!!!!!!!!!!! REPLACE EVERYWHERE AND TEST!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            console.log('Exception in bwOrganizationEditorAdmin.js.addAGroup(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addAGroup(): ' + e.message + ', ' + e.stack);
        }
    },
    addALegalEntity: function (elementId, divisionIndex, groupIndex, entityIndex) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.addALegalEntity(). elementId: ' + elementId);
            var thiz = this;
            $('#divAddAnOrgItemDialog3').dialog({
                modal: true,
                resizable: false,
                ...
                open: function () {
                    try {
                        ...
                        $(this).find('#spanAddAnOrgItemDialogTitle')[0].innerHTML = 'Add a new Legal Entity ⚖';
                        $(this).find('#divAddAnOrgItemDialogSubmitButton')[0].innerHTML = 'Add the new Legal Entity ⚖';
                        $(this).find('#txtAddAnOrgItemDialogName')[0].value = '';
                        $(this).find('#txtAddANewPersonDialogAbbreviation')[0].value = '';
                        $(this).find('#txtAddANewPersonDialogId')[0].value = '';
                        ...
                        $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                            try {
                                ...
                                console.log('Exception in bwOrganizationEditorAdmin.js.ddALegalEntity.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.ddALegalEntity.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                            }
                        });
                    } catch (e) {
                        console.log('Exception in bwOrganizationEditorAdmin.js.addALegalEntity.divAddAnOrgItemDialog3.open(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addALegalEntity.divAddAnOrgItemDialog3.open(): ' + e.message + ', ' + e.stack);
                    }
                },
                close: function () {
                    //$(this).empty().dialog('destroy'); // 7-5-2020 THIS IS THE PREFFERED SYNTAX FOR THIS FROM NOW ON!!!!!!!!!!!!!!!!!!!!!!!!!!!! REPLACE EVERYWHERE AND TEST!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            console.log('Exception in bwOrganizationEditorAdmin.js.addALegalEntity(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addALegalEntity(): ' + e.message + ', ' + e.stack);
        }
    },
    addALocation: function (elementId, divisionIndex, groupIndex, entityIndex) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.addALocation(). elementId: ' + elementId);
            var thiz = this;
            $('#divAddAnOrgItemDialog3').dialog({
                modal: true,
                resizable: false,
                ...
                open: function () {
                    try {
                        ...
                        $(this).find('#spanAddAnOrgItemDialogTitle')[0].innerHTML = 'Add a new Location 🏠';
                        $(this).find('#divAddAnOrgItemDialogSubmitButton')[0].innerHTML = 'Add the new Location 🏠';
                        $(this).find('#txtAddAnOrgItemDialogName')[0].value = '';
                        $(this).find('#txtAddANewPersonDialogAbbreviation')[0].value = '';
                        $(this).find('#txtAddANewPersonDialogId')[0].value = '';
                        ...
                        $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                            try {
                                ...
                                console.log('Exception in bwOrganizationEditorAdmin.js.addALocation.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addALocation.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                            }
                        });
                    } catch (e) {
                        console.log('Exception in bwOrganizationEditorAdmin.js.addALocation.divAddAnOrgItemDialog3.open(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addALocation.divAddAnOrgItemDialog3.open(): ' + e.message + ', ' + e.stack);
                    }
                },
                close: function () {
                    //$(this).empty().dialog('destroy'); // 7-5-2020 THIS IS THE PREFFERED SYNTAX FOR THIS FROM NOW ON!!!!!!!!!!!!!!!!!!!!!!!!!!!! REPLACE EVERYWHERE AND TEST!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            console.log('Exception in bwOrganizationEditorAdmin.js.addALocation(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.addALocation(): ' + e.message + ', ' + e.stack);
        }
    },
    editRootOrg: function () {
        try {
            console.log('In bwOrganizationEditorAdmin.js.editRootOrg().');
    ...
    editDivision: function (divisionIndex, groupIndex, entityIndex) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.editDivision().');
            var thiz = this;

            $('#divAddAnOrgItemDialog3').find('#spanAddAnOrgItemDialogTitle').html('Edit Division');
            $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').html('Save');

            if (divisionIndex == 'root') {
                $('#divAddAnOrgItemDialog3').find('#txtAddAnOrgItemDialogName').val(this.options.store.Global.Name);
                $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogAbbreviation').val(this.options.store.Global.Abbreviation);
                $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogId').val(this.options.store.Global.Id);
            } else {
                $('#divAddAnOrgItemDialog3').find('#txtAddAnOrgItemDialogName').val(this.options.store.Global.Divisions.Items[divisionIndex].Name);
                $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogAbbreviation').val(this.options.store.Global.Divisions.Items[divisionIndex].Abbreviation);
                $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogId').val(this.options.store.Global.Divisions.Items[divisionIndex].Id);
            }
            //
            ...
            $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                try {
                    console.log('In bwOrganizationEditorAdmin.js.editDivision.divAddAnOrgItemDialogSubmitButton.click().');
                    var name = $('#divAddAnOrgItemDialog3').find('#txtAddAnOrgItemDialogName').val().trim(); //.value.trim();
                    var abbreviation = $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogAbbreviation').val().trim(); //.value.trim();
                    if (name.length > 4 && abbreviation.length > 1) {
                        // Save the new org entry.
                        var guid = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function (c) {
                            var r = Math.random() * 16 | 0, v = c == 'x' ? r : (r & 0x3 | 0x8);
                    ...
                    console.log('Exception in bwOrganizationEditorAdmin.js.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.divAddAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                }
            });

            $('#divAddAnOrgItemDialog3').find('#divDeleteAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                try {
                    ...
                    if ((divisionIndex && divisionIndex != 'undefined') || divisionIndex > -1) {
                        ...
                        alert('Error: Unexpected parameter in bwOrganizationEditorAdmin.js.editDivision.divDeleteAnOrgItemDialogSubmitButton.click():1:.');
                    }
                    ...
                    console.log('Exception in bwOrganizationEditorAdmin.js.editDivision.divDeleteAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.editDivision.divDeleteAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                }
            });

        } catch (e) {
            console.log('Exception in bwOrganizationEditorAdmin.js.editDivision(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.editDivision(): ' + e.message + ', ' + e.stack);
        }
    },
    editGroup: function (divisionIndex, groupIndex, entityIndex) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.editGroup().');
            var thiz = this;

            $('#divAddAnOrgItemDialog3').find('#spanAddAnOrgItemDialogTitle').html('Edit Group');
            $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').html('Save');
            //document.getElementById('divDeleteAnOrgItemDialogSubmitButton').innerHTML = 'Delete'; // Delete this Org.

            $('#divAddAnOrgItemDialog3').find('#txtAddAnOrgItemDialogName').val(this.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].Name);
            $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogAbbreviation').val(this.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].Abbreviation);
            $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogId').val(this.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].Id);
            ...
            $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                try {
                    ...
                    var name = $('#divAddAnOrgItemDialog3').find('#txtAddAnOrgItemDialogName').val().trim();
                    var abbreviation = $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogAbbreviation').val().trim();
                    if (name.length > 4 && abbreviation.length > 1) {
                        // Save the new org entry.
                        var guid = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function (c) {
                            var r = Math.random() * 16 | 0, v = c == 'x' ? r : (r & 0x3 | 0x8);
            ...
            $('#divAddAnOrgItemDialog3').find('#divDeleteAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                try {
                    ...
                    console.log('Exception in bwOrganizationEditorAdmin.js.editGroup.divDeleteAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.editGroup.divDeleteAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                }
            });

        } catch (e) {
            console.log('Exception in bwOrganizationEditorAdmin.js.editGroup(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.editGroup(): ' + e.message + ', ' + e.stack);
        }
    },
    editLegalEntity: function (divisionIndex, groupIndex, entityIndex) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.editLegalEntity().');
            var thiz = this;
            $('#divAddAnOrgItemDialog3').find('#spanAddAnOrgItemDialogTitle').html('Edit Legal Entity');
            $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').html('Save');
            //document.getElementById('divDeleteAnOrgItemDialogSubmitButton').innerHTML = 'Delete'; // Delete this Org.

            $('#divAddAnOrgItemDialog3').find('#txtAddAnOrgItemDialogName').val(this.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items[entityIndex].Name);
            $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogAbbreviation').val(this.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items[entityIndex].Abbreviation);
            $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogId').val(this.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items[entityIndex].Id);
            ...
            $('#divAddAnOrgItemDialog3').find('#divDeleteAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                try {
                    ...
                    console.log('Exception in bwOrganizationEditorAdmin.js.editLegalEntity.divDeleteAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.editLegalEntity.divDeleteAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                }
            });

        } catch (e) {
            console.log('Exception in bwOrganizationEditorAdmin.js.editLegalEntity(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.editLegalEntity(): ' + e.message + ', ' + e.stack);
        }
    },
    editLocation: function (divisionIndex, groupIndex, entityIndex, locationIndex1) {
        try {
            console.log('In bwOrganizationEditorAdmin.js.editLocation().');
            var thiz = this;
            $('#divAddAnOrgItemDialog3').find('#spanAddAnOrgItemDialogTitle').html('Edit Location');
            $('#divAddAnOrgItemDialog3').find('#divAddAnOrgItemDialogSubmitButton').html('Save');
            //document.getElementById('divDeleteAnOrgItemDialogSubmitButton').innerHTML = 'Delete'; // Delete this Org.
            //debugger;
            $('#divAddAnOrgItemDialog3').find('#txtAddAnOrgItemDialogName').val(this.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items[entityIndex].Locations.Items[locationIndex1].Name);
            $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogAbbreviation').val(this.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items[entityIndex].Locations.Items[locationIndex1].Abbreviation);
            $('#divAddAnOrgItemDialog3').find('#txtAddANewPersonDialogId').val(this.options.store.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items[entityIndex].Locations.Items[locationIndex1].Id);
            ...
            $('#divAddAnOrgItemDialog3').find('#divDeleteAnOrgItemDialogSubmitButton').off('click').click(function (error) {
                try {
                    ...
                    console.log('Exception in bwOrganizationEditorAdmin.js.editLocation.divDeleteAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.editLocation.divDeleteAnOrgItemDialogSubmitButton.click(): ' + e.message + ', ' + e.stack);
                }
            });

        } catch (e) {
            console.log('Exception in bwOrganizationEditorAdmin.js.editLocation(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.editLocation(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    activateOrgRolesConfiguration: function () {
        try {
            console.log('In activateOrgRolesConfiguration().');
            var thiz = this;
                    ...
                    try {
                        ...
                        if (workflow.length != 1) {
                            ...
                            $.ajax({
                                ...
                                try {
                                    console.log('In bwOrganizationEditorAdmin.js.activateOrgRolesConfiguration.update: Successfully updated DB using (' + JSON.stringify(json) + ').');
                                    ...
                                    $.ajax({
                                        ...
                                        try {
                                            ...
                                            debugger; // xcx2
                                            if ($('#divUndoOrgRolesActivationDialog3_' + thiz.options.elementIdSuffix).is(':visible') != true) { // FIX!!!!!!!!!!!!!!!!! DOING THIS JUST TO GET THINGS WORKING. This gets called too many times here...
                                                $('#divUndoOrgRolesActivationDialog3_' + thiz.options.elementIdSuffix).dialog({
                                                    modal: true,
                                                    resizable: false,
                                                    //closeText: "Cancel",
                                                    closeOnEscape: false, // Hit the ESC key to hide! Yeah!
                                                    ...
                                                    open: function () {
                                                        try {
                                                            $('.ui-widget-overlay').bind('click', function () {
                                                                $('#divUndoOrgRolesActivationDialog3_' + thiz.options.elementIdSuffix).dialog('close');
                                                            });
                                                        } catch (e) {
                                                            console.log('Exception in activateOrgRolesConfiguration().divUndoOrgRolesActivationDialog3.open(): ' + e.message + ', ' + e.stack);
                                                        }
                                                    },
                                                    close: function () {
                                                        location.reload(); // When the user closes this dialog, we regenerate the screen to reflect the newly created and activated workflow.
                                                ...
                                                $('#divUndoOrgRolesActivationDialog3_' + thiz.options.elementIdSuffix).dialog().parents('.ui-dialog').find('.ui-dialog-titlebar').remove();
                                            }
                                        } catch (e) {
    ...
    closePublishDialog: function () {
        $(thiz.element).find('#divUndoOrgRolesActivationDialog3_' + this.options.elementIdSuffix).dialog('close');
    },
    forceUpdateOrgRolesConfiguration: function () {

        try {
            console.log('In forceUpdateOrgRolesConfiguration().');
            var thiz = this;
            ...
            $.ajax({
                ...
                url: this.options.operationUriPrefix + "_bw/SaveBwOrgRoles_With_SynchronizeParticipantOrgRoles", // This also updates the participants when Role.ParticipantIsDirty == true. The web service has to iterate through all nodes and process these. Then mark as false, before saving the json.
                type: "Post",
                data: data,
                headers: {
                    "Accept": "application/json; odata=verbose"
                ...
                success: function (result) {
                    try {
                        ...
                        if (result.message != 'SUCCESS') {
                            ...
                            displayAlertDialog('Error in forceUpdateOrgRolesConfiguration(): ' + JSON.stringify(result));

                        } else {
                            //debugger;
                            //thiz.hideProgress();
                            console.log('In forceUpdateOrgRolesConfiguration().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                            // Display a dialog with an "Undo" button!!!!
                            //alert('Successfully updated the database. THIS WORKFLOW CHANGE WILL TAKE PLACE IMMEDIATELY!');
                            //debugger; // xcx1

                            $('#bwOrganizationEditor_AdminDialog').dialog('close'); // Close the editor dialog.

                            // Re-render the Configuration > Organization screen.
                            $("#divBwOrganizationEditor").bwOrganizationEditor('loadBusinessModelEditor', true); //loadAndRenderBusinessModelEditor'); // This forces the widget to call the webservice and get new OrgRoles data.

                            //$('.bwActiveMenu').bwActiveMenu('RenderContentForInnerLeftMenuButtons', this, 'ORGANIZATION');
                            ...
                            $(thiz.element).find('#divUndoOrgRolesActivationDialog3_' + thiz.options.elementIdSuffix).dialog({
                                modal: true,
                                resizable: false,
                                //closeText: "Cancel",
                                closeOnEscape: false, // Hit the ESC key to hide! Yeah!
                                ...
                                open: function () {
                                    $('.ui-widget-overlay').bind('click', function () {
                                        $(thiz.element).find('#divUndoOrgRolesActivationDialog3_' + thiz.options.elementIdSuffix).dialog('close');
                                    });
                                },
                                close: function () {
                        ...
                        console.log('Exception in forceUpdateOrgRolesConfiguration().xx.update: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in forceUpdateOrgRolesConfiguration().xx.update: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    debugger;
                    ...
                    console.log('Fail in forceUpdateOrgRolesConfiguration().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                    alert('Fail in forceUpdateOrgRolesConfiguration().xx.update: ' + thiz.options.operationUriPrefix + '_bw/SaveBwOrgRoles_Without_SynchronizeParticipantOrgRoles' + ', ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                    //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                    //var error = JSON.parse(data.responseText)["odata.error"];
                    //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                }
            ...
            debugger;
            //thiz.hideProgress();
            displayAlertDialog('Exception in forceUpdateOrgRolesConfiguration(): ' + e.message + ', ' + e.stack);
            console.log('Exception in forceUpdateOrgRolesConfiguration(): ' + e.message + ', ' + e.stack);
        }
    },
    saveOrgRolesConfigurationAndActivateAndUpdateParticipants: function () {
        ...
        try {
            ...
            if (this.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                ...
                // THIS IS WHERE WE PUBLISH TO THE NEW USER/TENANT TABLE 5-31-2020
                //var x = 'test';
                //alert('THIS IS WHERE WE PUBLISH TO THE NEW USER/TENANT TABLE 5-31-2020');
                ...
                $.ajax({
                    ...
                    //url: thiz.options.operationUriPrefix + "_bw/ForceUpdateOrgRolesConfiguration", // This also updates the participants when Role.ParticipantIsDirty == true. The web service has to iterate through all nodes and process these. Then mark as false, before saving the json.
                    type: "Post",
                    timeout: thiz.options.ajaxTimeout,
                    data: json,
                    headers: {
                    ...
                    try {
                        ...
                        if (result != 'SUCCESS') {
                            ...
                            //debugger;
                            //thiz.hideProgress();
                            console.log('In bwOrganizationEditorAdmin.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                            // Display a dialog with an "Undo" button!!!!
                            //alert('Successfully updated the database. THIS WORKFLOW CHANGE WILL TAKE PLACE IMMEDIATELY!');
                            //debugger; // xcx1
                        ...
                        console.log('Exception in bwOrganizationEditorAdmin.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().xx.update: ' + e.message + ', ' + e.stack);
                        alert('Exception in bwOrganizationEditorAdmin.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().xx.update: ' + e.message + ', ' + e.stack);
                    }
                }).error(function (data, errorCode, errorMessage) {
                    debugger;
                    //thiz.hideProgress();
                    ...
                    console.log('Fail in bwOrganizationEditorAdmin.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                    alert('Fail in bwOrganizationEditorAdmin.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                    //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                    //var error = JSON.parse(data.responseText)["odata.error"];
                    //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                });
            ...
            debugger;
            //thiz.hideProgress();
            alert('Exception in bwOrganizationEditorAdmin.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants(): ' + e.message + ', ' + e.stack);
            console.log('Exception in bwOrganizationEditorAdmin.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    checkIfWeHaveToDisplayThePublishChangesButton: function () {
        try {
            console.log('In bwOrganizationEditorAdmin.js.checkIfWeHaveToDisplayThePublishChangesButton().');
            ...
            console.log('Exception in bwOrganizationEditorAdmin.js.checkIfWeHaveToDisplayThePublishChangesButton(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationEditorAdmin.js.checkIfWeHaveToDisplayThePublishChangesButton(): ' + e.message + ', ' + e.stack);
        }
    },
        ...
        try {
            ...
            $.ajax({
                ...
                success: function (data1) {
                    ...
                    var html = '';
                    for (var i = 0; i < data.length; i++) {
                        //html += '<a href="javascript:$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'cmdReturnParticipantIdToFieldForJson\', \'' + friendlyNameSourceField + '\', \'' + idSourceField + '\', \'' + emailSourceField + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantEmail + '\', \'' + buttonToEnable + '\');">' + data[i].bwParticipantFriendlyName + '&nbsp;&nbsp;<i>(' + data[i].bwParticipantEmail + ')</i></a>';
            ...
            if (org.Roles && org.Roles.length) {
                for (var r = 0; r < org.Roles.length; r++) {
                    if (org.Roles[r].ParticipantIsDirty == true && org.Roles[r].ParticipantIsDirtyAction == 'REMOVE') {
                        ...
                        var stepIndex = -1;
                        var roleIndex = -1;
                        html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'displayPeoplePickerDialogForJson\', \'' + org.Roles[r].RoleId + '\', \'' + org.Roles[r].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" src="images/addressbook-icon18x18.png">';
                        html += '<br />';
        ...
        try {
            ...
            $.ajax({
                ...
                try {
                    //debugger;
                    var html = '';
                    html += '<select style="padding:5px 5px 5px 5px;" id="orgRolesDropDown" onchange="$(\'.bwOrganizationEditorAdmin\').bwOrganizationEditorAdmin(\'OrgRolesDropDown_Onchange\');">';
                ...
                alert('Exception in bwOrganizationEditorAdmin.js.renderOrgRolesDropDownList().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                console.log('Exception in bwOrganizationEditorAdmin.js.renderOrgRolesDropDownList().xx.Get: ' + JSON.stringify(data));
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
    ...
    renderTheCondReadOnly: function (cond) {
        try {
            console.log('In bwOrganizationEditorAdmin.renderTheCondReadOnly().');
            // this is a placeholder!!! hardcoded
            var result = '';
            if (true) {
                //result += 'In bwOrganizationEditorAdmin.renderTheCondReadOnly().'; // uncomment this if wanting to put this section back!!
            } else {
                if (cond && cond.trim() != '') {
    ...
    renderConditionsSection: function (elementId, conditionString) {
        try {
            console.log('In bwOrganizationEditorAdmin.renderConditionsSection().');
            // this is a placeholder!!! hardcoded
            var html = '';
            if (true) {
                html += 'In bwOrganizationEditorAdmin.renderConditionsSection().';
            } else {
                var selectedRoleCategory;
                $('#selectRoleCategory').find('option:selected').each(function (index, element) {
                    selectedRoleCategory = element.value;
        ...
        try {
            ...
            $.ajax({
                ...
                try {
                    ...
                    // Step 2: Do the following for this request type.
                    for (var i = 0; i < result.value.length; i++) {
                        if (result.value[i].bwRequestType == selectedRequestType && result.value[i].bwWorkflowActive == true) { // added to this 3-27-2020 2-49pm adt
                            //debugger;
                            // This is the workflow.
                    ...
                    for (var i = 0; i < thiz.options.CurrentWorkflow.length; i++) {
                        if (thiz.options.CurrentWorkflow[i].bwRequestType == selectedRequestType && thiz.options.CurrentWorkflow[i].bwWorkflowActive == true) {
                            //debugger;
                            // This is the workflow.
                            thiz.options.CurrentWorkflow[i] = workflow;
                            break;
                        }
                    }
                    //debugger;
                    //thiz.options.CurrentWorkflow = workflow;
                    thiz.options.LastSelectedNewRequestType = selectedRequestType;
