$.widget("bw.bwPeoplePicker_Customer", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwPeoplePicker_Customer.js jQuery Widget. 
        ===========================================================
    ...
    getDataType: function () {
        try {
            console.log('In bwPeoplePicker_Customer.js.getDataType(). We need to figure out this data type.');
            //alert('In bwPeoplePicker_Customer.js.getDataType(). We need to figure out this data type. It is a string for now.');

            return 'user';
        } catch (e) {
            console.log('Exception in bwPeoplePicker_Customer.js.getDataType(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwPeoplePicker_Customer.js.getDataType(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    addCustomer: function (friendlyNameSourceField, idSourceField, emailSourceField, selectedParticipantFriendlyName, selectedParticipantId, selectedParticipantEmail, bwBudgetRequestId) { //elementIdSuffix will let us find everything!
        try {
            console.log('In bwPeoplePicker_Customer.js.addCustomer().');
            ...
            console.log('Exception in bwPeoplePicker_Customer.js.addCustomer(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwPeoplePicker_Customer.js.addCustomer(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    renderAndPopulatePeoplePicker: function () {
        try {
            ...
            if (!this.options.bwBudgetRequestId) {
                ...
                html += `xcx124312456666 CUSTOMER VIEW LINK.`;
