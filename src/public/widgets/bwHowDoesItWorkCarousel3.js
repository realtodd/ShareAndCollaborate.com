$.widget("bw.bwHowDoesItWorkCarousel3", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwHowDoesItWorkCarousel3.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        this.element.addClass("bwHowDoesItWorkCarousel3");
        ...
        try {
            ...
            //alert('In bwHowDoesItWorkCarousel3._create(). The widget has been initialized.');
            console.log('In bwHowDoesItWorkCarousel3._create(). The widget has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwHowDoesItWorkCarousel3: CANNOT RENDER THE WIDGET</span>';
            html += '<br />';
            html += '<span style="">Exception in bwHowDoesItWorkCarousel3.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    cmdCarouselNavigateLeft: function () {
        try {
            ...
            else this.carouselImageTracker = this.options.PublishedSlideSet.FilesAndFolders.files.length - 1;
    ...
    cmdCarouselNavigateRight: function () {
        try {
            ...
            if (this.carouselImageTracker < ((this.options.PublishedSlideSet.FilesAndFolders.files.length - 1))) this.carouselImageTracker += 1;
    ...
    setCarouselImageTracker: function () {
        try {
            ...
            var slideIndex;
            if (this.options.PublishedSlideSet.FilesAndFolders.files[Number(this.carouselImageTracker)].MasterSlide_FileId) {
            ...
            if ((slideIndex != 0) && !slideIndex) {
                ...
                if (this.options.PublishedSlideSet.FilesAndFolders && this.options.PublishedSlideSet.FilesAndFolders.files) {
                    ...
                    document.getElementById('spanCarouselHeaderText').innerHTML = this.options.PublishedSlideSet.FilesAndFolders.files[Number(this.carouselImageTracker)].headerText; // xcx123124255
                    document.getElementById('spanCarouselDescriptionText').innerHTML = this.options.PublishedSlideSet.FilesAndFolders.files[Number(this.carouselImageTracker)].descriptionText; // xcx123124255
                    ...
                    for (var j = 0; j < subslides.length; j++) {
                        ...
                        var filePath = this.options.operationUriPrefix + '_files/slidesets/' + this.options.PublishedSlideSet.FilesAndFolders.folderName + '/' + subslides[j].fileName;
                        ...
                        html += '               <img xcx="xcx2143887" src="' + filePath + '" style="width:250px;" ';
                ...
                if (this.options.PublishedSlideSet.FilesAndFolders && this.options.PublishedSlideSet.FilesAndFolders.files) {
                    if (this.carouselImageTracker < (this.options.PublishedSlideSet.FilesAndFolders.files.length)) {
                        ...
                        var slideImagePath = this.options.operationUriPrefix + '_files/slidesets/' + folderName + '/' + fileName;
                        ...
                        for (var i = 0; i < (this.options.PublishedSlideSet.FilesAndFolders.files.length); i++) {
                            if (!this.options.PublishedSlideSet.FilesAndFolders.files[i].MasterSlide_FileId) { // Only display the "Main Slides" to begin with. After this loop, we will go through the files again and display the sub-slides.
                                ...
                                var elementId = 'spanCarouselImageIndicator'.concat((Number(index + 1)).toString()); // 12-22-2022
            ...
            console.log('Exception in bwHowDoesItWorkCarousel3.js.setCarouselImageTracker(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel3.js.setCarouselImageTracker(): ' + e.message + ', ' + e.stack);
        }
    },
    startCarouselTimer: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel3.js.startCarouselTimer().');
            //alert('In bwHowDoesItWorkCarousel3.js.startCarouselTimer().');
            var thiz = this;
            ...
            if (thiz.slideTransitionLastSystemTime > 0) {
                ...
                if (slideTransitionTimeElapsed > thiz.slideTransitionTime) {
                    ...
                    document.getElementById('divCarouselPausePlay').innerHTML = '<div id="divCarouselPausePlay2" class="carouselPausePlay" onclick="cmdCarouselImageIndicatorClick(\'' + thiz.carouselImageTracker + '\');" style="cursor:pointer;white-space:nowrap;">pause slideshow<div>';
                ...
                //document.getElementById('spanCarouselPausePlay').innerHTML = '<span onclick="cmdCarouselImageIndicatorClick(\'' + thiz.carouselImageTracker + '\');" style="cursor:pointer;white-space:nowrap;">pause slideshow<span>';
                var html = '<div id="divCarouselPausePlay2" class="carouselPausePlay" onclick="cmdCarouselImageIndicatorClick(\'' + thiz.carouselImageTracker + '\');" style="cursor:pointer;white-space:nowrap;">pause slideshow<div>';
            ...
            console.log('Exception in bwHowDoesItWorkCarousel3.js.startCarouselTimer(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel3.js.startCarouselTimer(): ' + e.message + ', ' + e.stack);
        }
    },
    startCarouselTimer2: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel3.js.startCarouselTimer2().');
            //alert('In bwHowDoesItWorkCarousel3.js.startCarouselTimer2().');
            var thiz = this;
            ...
            console.log('Exception in bwHowDoesItWorkCarousel3.js.startCarouselTimer2(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel3.js.startCarouselTimer2(): ' + e.message + ', ' + e.stack);
        }
    },

    //windowresize: function () {
    //    try {
    //        console.log('In bwHowDoesItWorkCarousel3.js.windowresize().');
    //        //alert('In bwHowDoesItWorkCarousel3.js.windowresize().');
    ...
    //    } catch (e) {
    //        console.log('Exception in bwHowDoesItWorkCarousel3.js.windowresize(): ' + e.message + ', ' + e.stack);
    //        displayAlertDialog('Exception in bwHowDoesItWorkCarousel3.js.windowresize(): ' + e.message + ', ' + e.stack);
    //    }
    //},
    renderSlideSets: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel3.js.renderSlideSets().');
            var thiz = this;
            //
            ...
            //alert('In bwHowDoesItWorkCarousel3.js._create(). Getting ready to display zczcvdsfgdsfhg');
    ...
    loadFoldersAndFiles: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel3.js.loadFoldersAndFiles().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (result) {
                    try {
                        console.log('In bwHowDoesItWorkCarousel3.js.loadFoldersAndFiles(). Got data from _files/slideshowslidesets().'); // ' + JSON.stringify(result));
                        ...
                        if (!result.filesandfolders) {
                            ...
                            if (!(SlideSets.PublishedSlideSet && (SlideSets.FilesAndFolders && SlideSets.FilesAndFolders.length))) {

                                console.log('In bwHowDoesItWorkCarousel3.js._create(). NO SLIDES TO DISPLAY.');

                            } else {

                                // Get the selected slide set.
                                if (SlideSets.PublishedSlideSet) {
                                    for (var i = 0; i < SlideSets.FilesAndFolders.length; i++) {
                                        if (SlideSets.FilesAndFolders[i].folderName) {
                                            if (SlideSets.PublishedSlideSet == SlideSets.FilesAndFolders[i].folderName) {
                                    ...
                                    console.log('xcx21314-1 There is no published slide set.');
                                ...
                                console.log('In bwHowDoesItWorkCarousel3.js._create(). FINISHED DISPLAYING, called startCarouselTimer(). <<<<<<<<<<<<<<<<');
                            }

                        }

                    } catch (e) {
                        console.log('Exception in bwHowDoesItWorkCarousel3.js.loadFoldersAndFiles():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwHowDoesItWorkCarousel3.js.loadFoldersAndFiles():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwHowDoesItWorkCarousel3.js.loadFoldersAndFiles.GetExternallySharedFiles():1: ' + errorCode + ', ' + errorMessage);
                    //displayAlertDialog('Error in bwHowDoesItWorkCarousel3.js.loadFoldersAndFiles.GetExternallySharedFiles():1: ' + errorCode + ', ' + errorMessage); // Don't want this to show up. Most likely caused by files services being unavailable.
                }
            });

        } catch (e) {
            console.log('Exception in bwHowDoesItWorkCarousel3.js.loadFoldersAndFiles(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel3.js.loadFoldersAndFiles(): ' + e.message + ', ' + e.stack);
        }
    },

    displayHowDoesItWorkScreen: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel3.js.displayHowDoesItWorkScreen().');
            //alert('In bwHowDoesItWorkCarousel3.js.displayHowDoesItWorkScreen().');
            ...
            html += '            <table id="tableHowDoesItWorkCarousel1" style="background-color:whitesmoke;padding:0 0 0 0;margin:0 0 0 0;border-width:0 0 0 0;">'; //width:' + x + 'px;">'; // THIS IS WHERE THE WIDTH IS SET.
            html += '                <tr>';
            html += '                    <td></td>';
            ...
            for (var i = 0; i < (this.options.PublishedSlideSet.FilesAndFolders.files.length); i++) {
                if (!this.options.PublishedSlideSet.FilesAndFolders.files[i].MasterSlide_FileId) { // Only display the "Main Slides" to begin with. After this loop, we will go through the files again and display the sub-slides.
                    html += '                           <span id="spanCarouselImageIndicator' + (index + 1) + '" onclick="$(\'.bwHowDoesItWorkCarousel3:first\').bwHowDoesItWorkCarousel3(\'cmdCarouselImageIndicatorClick\', \'' + index + '\');" class="spanCarouselImageIndicatorDisabled" title="Slide #' + (index + 1) + '">&#183;' + (index + 1) + '</span>&nbsp;';
                    index += 1;
                }
            }
            ...
            //
            //html += '                                       <div id="divCarouselPausePlay2" class="carouselPausePlay" onclick="$(\'.bwHowDoesItWorkCarousel3:first\').bwHowDoesItWorkCarousel3(\'startCarouselTimer\');" style="cursor:pointer;white-space:nowrap;">play slideshow<div>';
            html += '                                    </div>';
            html += '                                </td>';
            html += '                            </tr>';
            html += '                        </table>';
            ...
            html += '                        <div id="divLeftNavigationArrow" class="carouselLeftNavigationArrow" onclick="$(\'.bwHowDoesItWorkCarousel3\').bwHowDoesItWorkCarousel3(\'cmdCarouselNavigateLeft\');">&lt;</div>';
            html += '                    </td>';
            ...
            // The header text etc.
            html += '                        <span xcx="xcx123124255" id="spanCarouselHeaderText" style="color: #3f3f3f;font-size:49px;color:black;white-space:nowrap;margin-top:-5px;font-weight:bold;"></span>'; // 8-11-2022 THIS IS THE HEADER TEXT <<<<<<
            html += '<br />';
            html += '                        <span xcx="xcx123124255" id="spanCarouselDescriptionText" style="font-family: SFProDisplay-Regular, Helvetica, Arial, sans-serif;font-size: 38px;font-weight: normal;"></span>'; // 8-11-2022 THIS IS THE HEADER TEXT <<<<<<
            html += '<br /><br /><br />';
            html += '<div class="bwSubSlides" xcx="xcx3458"></div>';
            ...
            html += '                    <td style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;margin:0 0 0 0;border-width:0 0 0 0;vertical-align:top;">';
            html += '                        <div id="divRightNavigationArrow" class="carouselRightNavigationArrow" onclick="$(\'.bwHowDoesItWorkCarousel3\').bwHowDoesItWorkCarousel3(\'cmdCarouselNavigateRight\');">&gt;</div>';
            html += '                    </td>';
            ...
            console.log('Exception in bwHowDoesItWorkCarousel3.js.displayHowDoesItWorkScreen(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel3.js.displayHowDoesItWorkScreen(): ' + e.message + ', ' + e.stack);
        }
    },
            ...
            $('#' + requestDialogId).dialog({
                ...
                open: function () {
                    try {
                        ...
                        html += '    <tr style="padding:0 0 0 0;margin:0 0 0 0;border-width:0 0 0 0;">';
                        html += '        <td style="text-align:center;vertical-align:middle;padding:0 0 0 0;margin:0 0 0 0;border-width:0 0 0 0;">';
                        html += '            <table id="tableHowDoesItWorkCarousel1" style="background-color:whitesmoke;padding:0 0 0 0;margin:0 0 0 0;border-width:0 0 0 0;width:850px;">';
                        html += '                <tr>';
                        html += '                    <td></td>';
                        html += '                    <td style="text-align:center;">';
                        html += '                        <table style="width:100%">';
    ...
    displayAlertDialog: function (errorMessage) {
        try {
            ...
            console.log('Exception in bwHowDoesItWorkCarousel3.displayAlertDialog(): ' + e.message + ', ' + e.stack);
        }
    }
