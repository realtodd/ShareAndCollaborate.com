$.widget("bw.bwExecutiveSummariesCarousel2", {
    ...
    _create: function () {
        ...
        try {
            ...
            console.log('In bwExecutiveSummariesCarousel2._create(). The widget has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwExecutiveSummariesCarousel2</span>';
            html += '<br />';
            html += '<span style="">Exception in bwExecutiveSummariesCarousel2.Create(): ' + e.message + ', ' + e.stack + '</span>';
