$.widget("bw.bwEmailTemplateEditor", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwEmailTemplateEditor.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        console.log('In bwEmailTemplateEditor.js._create().');
        this.element.addClass("bwEmailTemplateEditor");
        ...
        try {
            ...
            //        } catch (e) {
            //            console.log('Exception in bwEmailTemplateEditor._create().loadWorkflowsAndCurrentWorkflow(): ' + e.message + ', ' + e.stack);
            //        }
            //    });
            //}
            ...
            //html += 'THIS IS THE bwEmailTemplateEditor INSTANTIATED. MORE WORK TO DO HERE!!!!!!!!!!!!';

            //this.element.html(html);

            this.renderCustomizeEmailTemplateButtons();

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwEmailTemplateEditor: CANNOT RENDER THE WORKFLOW MATRIX</span>';
            html += '<br />';
            html += '<span style="">Exception in bwEmailTemplateEditor.Create(): ' + e.message + ', ' + e.stack + '</span>';
            thiz.element.html(html);
        }
    },
    renderCustomizeEmailTemplateButtons: function () {
        try {
            console.log('In renderCustomizeEmailTemplateButtons().');
            ...
            html += 'div.ui-widget-header {';
            html += '    border: 1px solid #066B8B;';
            html += '    background: #066B8B;'; // /*url("images/ui-bg_gloss-wave_35_3b678e_500x100.png") 50% 50% repeat-x;*/';
            html += '    color: #ffffff;';
            html += '    font-weight: normal;';
            html += '    font-family: Verdana;';
            html += '    font-size: small;';
            html += '    border-radius: 0 0 0 0;';
            html += '}';
            ...
            //html += '    background: #eeeeee url("images/ui-bg_highlight-soft_100_eeeeee_1x100.png") 50% top repeat-x;';
            html += '    background-color: #eeeeee;'
            html += '    color: #333333;';
            html += '}';

            // ui-dialog ui-widget ui-widget-content ui-corner-all ui-front no-close ui-draggable
            ...
            //html += '    border-width: 1px 0 0 0;';
            //html += '    background-image: none;';
            //html += '    margin-top: .5em;';
            //html += '    padding: .3em 1em .5em .4em;';
            //html += '}';
            ...
            html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editEmailTemplate\', \'' + 'Overdue' + '\', \'' + 'Overdue Task(s)' + '\', \'' + instructionText + '\');">';
            html += '               <span style="font-size:15pt;display:inline-block;">✉</span> "' + 'New Budget Request has been received' + '" &nbsp;&nbsp;';
            html += '           </span>';
            html += '           <br />';
            ...
            console.log('Exception in renderCustomizeEmailTemplateButtons(): ' + e.message + ', ' + e.stack);
            alert('Exception in renderCustomizeEmailTemplateButtons(): ' + e.message + ', ' + e.stack);
        }
    },
    editEmailTemplate: function (stepFriendlyName, instructionText, stepName) {
        try {
            ...
            //    //} else {
            //    //html += '<select style="padding:5px 5px 5px 5px;" id="selectEditEmailFor" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'selectEditEmailFor_OnChange\', \'editing\');">';
            ...
            // Set the "Save" button.
            var html = '';
            html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveEmailTemplateForStep\', \'' + stepName + '\');">';
                        ...
                        try {
                                        ...
                                        if (confirm("This is valid JSON. Are you certain you wish to activate this workflow? THIS ACTION CANNOT BE UNDONE.")) {
                                            ...
                                            $.ajax({
                                                ...
                                                try {
                                                    debugger; // 1-4-2022
                                                    if (result == 'SUCCESS') {
                                                        console.log('In bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                                                        alert('In bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog().post: Successfully updated DB.');
                                                    } else {
                                                    ...
                                                    console.log('Exception in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + e.message + ', ' + e.stack);
                                                    displayAlertDialog('Exception in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + e.message + ', ' + e.stack);
                                                }
                                                ...
                                                console.log('Fail in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                                                displayAlertDialog('Fail in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                            ...
                            $.ajax({
                                ...
                                error: function (data) {
                                    ...
                                    displayAlertDialog('Error in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                                    console.log('Error in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog().xx.Get: ' + JSON.stringify(data));
                                    //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                                    //var error = JSON.parse(data.responseText)["odata.error"];
                                    //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                                }
                        ...
                        try {
                                        ...
                                        if (confirm("This is valid JSON. Are you certain you wish to activate this workflow? THIS ACTION CANNOT BE UNDONE.")) {
                                            ...
                                            $.ajax({
                                                ...
                                                try {
                                                    debugger; // 1-4-2022
                                                    if (result == 'SUCCESS') {
                                                        console.log('In bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog2().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                                                        alert('In bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog2().post: Successfully updated DB.');
                                                    } else {
                                                    ...
                                                    console.log('Exception in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + e.message + ', ' + e.stack);
                                                    displayAlertDialog('Exception in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + e.message + ', ' + e.stack);
                                                }
                                            }).error(function (data, errorCode, errorMessage) {
                                                debugger;
                                                //thiz.hideProgress();
                                                ...
                                                console.log('Fail in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                                                displayAlertDialog('Fail in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                                                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                                                //var error = JSON.parse(data.responseText)["odata.error"];
                                                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                                            });
                            ...
                            $.ajax({
                                ...
                                error: function (data) {
                                    ...
                                    displayAlertDialog('Error in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog2().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                                    console.log('Error in bwEmailTemplateEditor.js.displayEditWorkflowJsonDialog2().xx.Get: ' + JSON.stringify(data));
                                    //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                                    //var error = JSON.parse(data.responseText)["odata.error"];
                                    //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                                }
                ...
                $.ajax({
                    ...
                    $.ajax({
                        ...
                        try {
                            ...
                            console.log('Exception in bwEmailTemplateEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
                            resolve();
                        }
                    }).fail(function (data) {
                        ...
                        alert('Exception in bwEmailTemplateEditor._create().xx.Get:2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                        console.log('Exception in bwEmailTemplateEditor._create().xx.Get:2: ' + JSON.stringify(data));
                        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                        //var error = JSON.parse(data.responseText)["odata.error"];
                        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                        resolve();
    ...
    _destroy: function () {
        this.element
            .removeClass("bwEmailTemplateEditor")
            .text("");
    },
    ...
    renderWorkflowEditor1: function (assignmentRowChanged_ElementId) {
        try {
            ...
            if (!(bwEnabledRequestTypes && bwEnabledRequestTypes.EnabledItems)) {
                ...
                html += '  <input type="button" value="Create your new role now!" style="height:30pt;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'createANewRole\');" />';
                html += '       </td>';
                html += '     </tr>';
                //html += '     <tr><td>&nbsp;</td></tr>';
                //html += '     <tr>';
                ...
                //html += '  <br /><br />';
                //html += '  <input type="button" value="SAVE" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'roleMultiPickerDialog_RenderResults\');" />';
                //html += '  <br /><br />';
                //html += '</div>';
                ...
                html += '  <br /><br />';
                html += '  <input type="button" value="SAVE" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'orgMultiPickerDialog_RenderResults\');" />';
                html += '  <br /><br />';
                html += '</div>';
                ...
                html += '  <br /><br />';
                html += '  <input type="button" value="SAVE" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'projectTypeMultiPickerDialog_RenderResults\');" />';
                html += '  <br /><br />';
                html += '</div>';
                ...
                html += '  <br /><br />';
                html += '  <input type="button" value="SAVE" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'pillarMultiPickerDialog_RenderResults\');" />';
                html += '  <br /><br />';
                html += '</div>';
                ...
                html += '   <br /><br />';
                // Preview button.
                //html += '   <div class="divSignInButton" style="width: 90%; text-align: center; line-height: 1.1em; font-weight: bold;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayEmailPreviewInDialog\');">';
                ...
                if (thiz.options.displayWorkflowPicker) {
                    if (thiz.options.DisplayAsNewTenantUserConfigurationEditor != true) {
                        ...
                        html += '   <select id="selectRequestTypeDropDown" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'WorkflowRequestTypeDropDown_Onchange\', \'selectWorkflowRequestTypeDropDown\');" class="selectHomePageWorkflowAppDropDown" style=\'display:inline;border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 1em; font-weight: bold; cursor: pointer;  margin-bottom:15px;\'>'; // was .5em
                    ...
                    html += '  </td>';
                    html += '  <td style="text-align:right;">';
                    html += '    <span id="spanThereAreChangesToPublishText" style="font-style:italic;color:tomato;"></span>'; //<input value=" There are unsaved changes. Enter a description here and click Save..." type="text" id="txtNewWorkflowDescription" style="width:450px;color:grey;font-style:italic;padding:5px 5px 5px 5px;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'NewWorkflowDescriptionTextBox_Onkeyup\');" />';
                    html += '  </td>';
                    html += '  <td>';
                    ...
                    //    html += '   <select id="selectWorkflowRequestTypeDropDown" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'WorkflowRequestTypeDropDown_Onchange\', \'selectWorkflowRequestTypeDropDown\');" style=\'border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 14pt; font-weight: bold; cursor: pointer;\'>'; // was .5em
                    ...
                    if (thiz.options.MultipleWorkflowsEnabled == false) {
                        html += '&nbsp;&nbsp;<span style="font-weight:normal;font-style:italic;color:grey;white-space:nowrap;"><input id="WorkflowForAllRequestTypesCheckbox" type="checkbox" checked="checked" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'WorkflowForAllRequestTypesCheckbox_Onchange\');" />All request types inherit this workflow</span>';
                    } else {
            ...
            console.log('Exception in bwEmailTemplateEditor.js.renderWorkflowEditor1(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailTemplateEditor.js.renderWorkflowEditor1(): ' + e.message + ', ' + e.stack);
        }
    },
        ...
        try {
            ...
            if (!bwRequestTypeId || (bwRequestTypeId == null)) {
                ...
                if (!car) {
                    ...
                    console.log('');
                    console.log('*************************************************************************');
                    console.log('In bwEmailTemplateEditor.js.renderWorkflowEditor2(). THIS IS WHERE IF THERE IS NO WORKFLOW SAVED IN THE DATABASE WE SPIT OUT THE DEFAULT.');
                    console.log('*************************************************************************');
                    console.log('');
                ...
                if (weFoundTheWorkflow == true) {
                    ...
                    $.ajax({
                        ...
                        try {
                            //debugger;
                            console.log('In bwEmailTemplateEditor.js.renderWorkflowEditor2.Get.odata/Roles(). result: ' + JSON.stringify(result));
                            var html = '';
                            var roles;
                            if (result) {
                                roles = result.value;
                            ...
                            if (car == null) {
                                ...
                                html += '                   <span id="spanExpandOrCollapseRightSliderPaneButton" style="cursor:pointer;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'expandOrCollapseSliderPanel\');">';
                                ...
                                html += '                       <span title="Expand or Collapse ALL..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'expandOrCollapseAllWorkflowSteps\');" style="width:200px;padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;font-size:20pt;">';
                                html += '                           <span style="display:inline-block;">+/-</span>';
                                html += '                       </span>';
                                ...
                                //debugger;
                                html += '    <input type="button" style="padding:5px 10px 5px 10px;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'addNewWorkflowStep\', \'' + (car.Workflow.Steps.Step.length - 1) + '\');" value="Add a Step" title="bwEmailTemplateEditor.addNewWorkflowStep(). Doesn\'t work right yet..." />';
                                //var tooltip = 'Edit email template(s)...';
                                //html += '<span title="' + tooltip + '" style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + 'all' + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> Task Notification Emails&nbsp;&nbsp;</span>';
                                ...
                                for (var i = 0; i < car.Workflow.Steps.Step.length; i++) {
                                    ...
                                    if (false) {
                                        ...
                                        //debugger;
                                        html += '<tr id="stepheaderrow_' + i + '" style="border:0px;cursor:pointer;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'expandOrCollapseWorkflowStep\', \'' + 'stepname_' + i + '\', \'' + 'stepimage_' + i + '\', \'steprow-' + stepName.toLowerCase() + '_' + i + '_' + '0' + '\');">';
                                        ...
                                        if (stepName == 'Collaboration') {
                                            ...
                                            try {
                                                ...
                                                console.log('In bwEmailTemplateEditor.js(). Exception trying to get the timeout: ' + e.message + ', ' + e.stack);
                                            }
                                            html += '<span style="white-space:nowrap;font-size:11pt;">';
                                            html += 'Consensus timeout:&nbsp;';
                                            html += '<input type="text" id="textTimeout" style="width:25px;padding:5px 5px 5px 5px;" value="' + timeout + '" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveCollaborationTimeout\', \'' + 'textTimeout' + '\');" />';
                                            html += '&nbsp;';
                                            html += '<select id="selectTimeoutUnits" style="padding:5px 5px 5px 5px;" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveCollaborationTimeout\', \'' + 'textTimeout' + '\');">';
                                        ...
                                        //    html += '<span title="' + tooltip + '" style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> Confirmation Email&nbsp;&nbsp;</span>';
                                        //} else {
                                        //    html += '<span title="' + tooltip + '" style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> &quot;' + stepName + '&quot; Email&nbsp;&nbsp;</span>';
                                        ...
                                        if (stepName.toLowerCase() == 'admin') {
                                            ...
                                            html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                                            html += '          <input type="button" class="buttonAddNewAssignmentRow" style="white-space:nowrap;padding:5px 10px 5px 10px;" value="✚ Add a Role/Participant" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'addARoleParticipant\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" />';

                                            if (!(stepName.toLowerCase() == 'admin' || stepName.toLowerCase() == 'create' || stepName.toLowerCase() == 'revise')) { // Cannot delete these steps.
                                                html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                                                //html += '          <input type="button" class="" style="white-space:nowrap;padding:5px 10px 5px 10px;" value="Delete this Step" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" />';
                                                //html += '<img title="Delete" style="cursor:pointer;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" src="images/trash-can.png">';


                                                //html += '<span class="spanButton" style="height:20px;width:150px;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');">';
                                                //html += '<img style="cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" src="images/trash-can.png">';
                                        ...
                                        if (stepName == 'Create' || stepName == 'Revise' || stepName == 'Admin') {
                                            if (!(car.Workflow.Steps.Step[i].Assign || car.Workflow.Steps.Step[i].Assign[0])) { // changed to || (or) 1-23-2022
                                                ...
                                                console.log('Error in bwEmailTemplateEditor.js.renderWorkflowEditor2(). NO ASSIGN STEP FOUND for step: ' + stepName);
                                                displayAlertDialog('Error in bwEmailTemplateEditor.js.renderWorkflowEditor2(). NO ASSIGN STEP FOUND for step: ' + stepName);
                                                ...
                                                //html += ' <img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                                                //html += '&nbsp;' + roleName;
                                                html += 'Role: ' + roleName;
                                                ...
                                                if (stepName == 'Create' || stepName == 'Revise') {
                                                    ...
                                                    html += '  <input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'renderEditSteprow\', \'' + xid + '\');" type="button" value="⚙ Edit">';
                                                    html += '</td>';
                                                }
                                                //html += '<td></td>';
                                                //html += '<td></td>';
                                ...
                                for (var j = 0; j < steprows.length; j++) {
                                    ...
                                    workflowAssignmentRow.dblclick(function () {
                                        try {
                                            ...
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveAssignmentRow\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100%;" value="Delete" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deleteRoleCategory\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100%;" value="Cancel" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'cancelStepRowEditing\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100px;white-space:normal;overflow-wrap:break-word;" value="Configure Email Notifications" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayConfigureEmailNotificationsDialog\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  </table>';
                                            ...
                                            //html += '<td class="steprowcell">';
                                            //html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" class="rolecategory-dropdown" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'RoleCategoryDropDown_Onchange\', \'' + this.id + '\');">';
            ...
            $("#divEditStepNameDialog").dialog({
                ...
                open: function () {
                    try {
                        ...
                        var html = '';
                        html += '  <input type="button" value="Save/Update step" style="height:30pt;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepName\', \'' + stepIndex + '\');" />';
    ...
    displayEditEmailInstructionTextDialog: function (stepName) {
        try {
            ...
            var html = '';
            html += '  <input type="button" value="Save/Update step" style="height:30pt;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editEmailInstructionText\', \'' + stepName + '\');" />';
    ...
    addARoleParticipant: function (elementId) {
        try {
            ...
            ////html += '  <tr>';
            ////html += '    <td>';
            ////html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveAssignmentRow\', \'' + elementId + '\', \'' + 'xx' + '\');" />';
            ////html += '    </td>';
            ////html += '  </tr>';
            ////html += '  <tr>';
            ////html += '    <td>';
            ////html += '      <input type="button" style="width:100%;" value="Cancel" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'cancelStepRowEditing\', \'' + elementId + '\', \'' + 'xx' + '\');" />';
            ////html += '    </td>';
            ////html += '  </tr>';
            ////html += '  </table>';
            ...
            //html += '  <tr>';
            //html += '    <td>';
            //html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />';
            //html += '    </td>';
            //html += '  </tr>';
            ////html += '  <tr>';
            ////html += '    <td>';
            ////html += '      <input type="button" style="width:100%;" value="Delete" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deleteRoleCategory\', \'' + elementId + '\');" />';
            ////html += '    </td>';
            ////html += '  </tr>';
            //html += '  <tr>';
            //html += '    <td>';
            //html += '      <input type="button" style="width:100%;" value="Cancel" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'cancelStepRowEditing\', \'' + elementId + '\');" />';
            //html += '    </td>';
            //html += '  </tr>';
            //html += '  <tr>';
            //html += '    <td>';
            //html += '      <input type="button" style="width:100px;white-space:normal;overflow-wrap:break-word;" value="Configure Email Notifications" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayConfigureEmailNotificationsDialog\', \'' + elementId + '\');" />';
            //html += '    </td>';
            //html += '  </tr>';
            //html += '  </table>';
            ...
            $.ajax({
                ...
                try {
                    ...
                    if (thiz.options.displayRoleIdColumn) {
                        ...
                        //html += '<br />';
                        html += '<select id="selectRoleId"  onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleId' + '\');">';
                        html += '  <option value=""></option>';
                        for (var i = 0; i < roles.length; i++) {
                            html += '  <option value="' + roles[i].RoleId + '">' + roles[i].RoleId + '</option>';
                        }
                        html += '</select>';
                        //html += '<br />or create a new role:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        html += '<br /><input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="Create a Role..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayCreateANewRoleDialog\');" />';

                        html += '<br />or select a person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        html += '<br /><input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="Select Person..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayCreateANewRoleDialog\');" />';

                        //html += '<br />or add a new person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        html += '<br /><input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="Add a Person..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayCreateANewRoleDialog\');" />';
                    ...
                    ////html += ' <img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                    ////html == '&nbsp;&nbsp;';
                    //html += '<select id="selectRoleName"  onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleName' + '\');">';
                    //html += '  <option value=""></option>';
                    //for (var i = 0; i < roles.length; i++) {
                    //    html += '  <option value="' + roles[i].RoleId + '">' + roles[i].RoleName + '</option>';
                    //}
                    //html += '</select>';
                    ////html += '<br />or create a new role:'; //<br /><input id="textNewRoleName" type="text" style="width:210pt;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleName' + '\');" />';
                    //html += '<br /><input id="btnCreateRole2" type="button" value="Create a Role..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayCreateANewRoleDialog\');" />';

                    //html += '<br />or select a person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                    //html += '<br /><img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                    //html == '&nbsp;&nbsp;';
                    //html += '<input id="btnCreateRole1" type="button" value="Select Person..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayCreateANewRoleDialog\');" />';

                    ////html += '<br />or add a new person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                    //html += '<br /><input id="btnCreateRole1" type="button" value="Add a Person..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayCreateANewRoleDialog\');" />';
                    ...
                    html += '<td class="steprowcell">';
                    html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" xcx="xcx9934-1" class="rolecategory-dropdown" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'RoleCategoryDropDown_Onchange\', \'' + thiz.id + '\');">';
                    ...
                    html += '  <tr>';
                    html += '    <td>';
                    html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />xcx1671';
                    html += '    </td>';
                    html += '  </tr>';
                    //html += '  <tr>';
                    //html += '    <td>';
        ...
        try {
            ...
            $.ajax({
                ...
                try {
                    ...
                    // The "RoleCategory" dropdown.
                    html += '<td class="steprowcell">';
                    html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" xcx="xcx9934-2" class="rolecategory-dropdown" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'RoleCategoryDropDown_Onchange\', \'' + thiz.id + '\');">';
                    //debugger;
                    ...
                    html += '  <tr>';
                    html += '    <td>';
                    html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />xcx1672';
                    html += '    </td>';
                    html += '  </tr>';
                    //html += '  <tr>';
                    //html += '    <td>';
    ...
    expandOrCollapseSliderPanel: function () {
        ...
        if (document.getElementsByClassName('rightSliderPanel')[0].innerHTML == '') {
            ...
            html += '       </td>';
            html += '       <td>';
            html += '           <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'expandOrCollapseSliderPanel\');">X</span>';
            html += '       </td>';
            html += '   </tr>';
            html += '</table>';
            html += '<span style="font-size:8pt;white-space:normal;">Customize the emails that get sent automatically by the system.</span>';
            ...
            html += '       <td class="stepheadercell workflowEmailTemplateEditButton" style="text-align:center;">';
            var instructionText = 'These emails get sent daily to people with outstanding tasks.<br />Tasks are only active for a single step of the workflow at a time, and it executes from top to bottom, with the bottom step being the last one to be performed.';
            html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + 'Overdue' + '\', \'' + 'Overdue Task(s)' + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + 'Overdue Task(s)' + '" &nbsp;&nbsp;</span>';
            html += '           <br />';
            html += '           <div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
            html += '       </td>';
            html += '   </tr>';
            ...
            //html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + 'RequestReceived' + '\', \'' + 'Request Received' + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + 'Request Received' + '" &nbsp;&nbsp;</span>';
            //html += '           <br />';
            //html += '           <div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
            //html += '       </td>';
            //html += '   </tr>';
            ...
            //html += '           <span class="spanButton" title="Edit email template..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\',\'Create\');"><span style="font-size:15pt;display:inline-block;">✉</span> "Your request has been received" &nbsp;</span><br /><span style="font-size:8pt;padding:0 25px 0 25px;">These emails get sent to people when they first create a request.</span>';
            //html += '       </td>';
            //html += '   </tr>';
            ...
            //    //html += '           <span class="spanButton" title="Edit email template(s)..." style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
            //    html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
            //    html += '       </td>';
            //    html += '   </tr>';
            ...
            //html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'all\');"><span style="font-size:15pt;display:inline-block;">✉</span> Task Notification Emails&nbsp;&nbsp;-itworx</span>';
            //html += '       </td>';
            //html += '   </tr>';
            ...
            var html2 = '';
            //html2 += '<input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'addARaciStep\', \'' + 'all' + '\');" type="button" value="Add a Step" />';
            var tooltip = 'Edit email template(s)...';
        ...
        try {
            ...
            for (var i = 0; i < car.DraftWorkflow.Steps.Step.length; i++) {
                ...
                //html += '           <span class="spanButton" title="Edit email template(s)..." style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
                html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + stepName + '\', \'' + stepFriendlyName + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" &nbsp;&nbsp;</span>';
                html += '           <br />';
                html += '           <div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
                html += '       </td>';
                html += '   </tr>';
    ...
    expandOrCollapseAllWorkflowSteps: function () {
        try {
            ...
            for (var i = 0; i < this.options.CurrentWorkflow.DraftWorkflow.Steps.Step.length; i++) {
                // $('.bwEmailTemplateEditor').bwEmailTemplateEditor('expandOrCollapseWorkflowStep', 'stepname_0', 'stepimage_0', 'steprow-create_0_0');
    ...
    downloadWorkflowJson: function () {
        try {
            ...
            console.log('Exception in bwEmailTemplateEditor.js.downloadWorkflowJson(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailTemplateEditor.js.downloadWorkflowJson(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    renderEditSteprow: function (elementId) {
        try {
            ...
            if (isAdmin) {
                // Render the "RoleCategory" drop-down.
                //html += '<td class="steprowcell">';
                ////html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" class="rolecategory-dropdown" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'RoleCategoryDropDown_Onchange\', \'' + elementId + '\');">';
                ////var rcs = ['Inform', 'Collaborator', 'Approver'];
                ////var rcs2 = ['Inform (Informed)', 'Collaborator (Consulted)', 'Approver (Accountable)'];
                ////for (var rci = 0; rci < rcs.length; rci++) {
                ////    if (rolecategory == rcs[rci]) {
                ...
                // Render the "RoleCategory" drop-down.
                html += '<td class="steprowcell">';
                html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" xcx="xcx9934-3" class="rolecategory-dropdown" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'RoleCategoryDropDown_Onchange\', \'' + elementId + '\');">';
                var rcs = ['Inform', 'Collaborator', 'Approver'];
                var rcs2 = ['Inform (Informed)', 'Collaborator (Consulted)', 'Approver (Accountable)'];
                for (var rci = 0; rci < rcs.length; rci++) {
                    if (rolecategory == rcs[rci]) {
            ...
            html += '  <tr>';
            html += '    <td>';
            html += '      <input type="button" style="padding:5px 10px 5px 10px;width:70px;cursor:pointer;" value="Save" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />';
            html += '    </td>';
            html += '  </tr>';
            if (!isAdmin) { // The ADMIN row/step cannot be deleted.
                html += '  <tr>';
                html += '    <td>';
                html += '      <input type="button" style="padding:5px 10px 5px 10px;width:70px;cursor:pointer;" value="Delete" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deleteRoleCategory\', \'' + elementId + '\');" />';
                html += '    </td>';
                html += '  </tr>';
            }
            html += '  <tr>';
            html += '    <td>';
            html += '      <input type="button" style="padding:5px 10px 5px 10px;width:70px;cursor:pointer;" value="Cancel" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'cancelStepRowEditing\', \'' + elementId + '\');" />';
            html += '    </td>';
            html += '  </tr>';
            //html += '  <tr>';
            //html += '    <td>';
        ...
        try {
            ...
            $.ajax({
                ...
                try {
                    ...
                    html += '    <td></td>';
                    html += '    <td colspan="9">';
                    html += '       <span style="padding: 4px 4px 4px 4px;border:1px solid lightblue;cursor:pointer;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'cmdDisplayDeleteWorkflowsDialog\');">';
                    ...
                    html += '    <td><input type="checkbox" id="checkboxTogglePendingEmailCheckboxes" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'toggleWorkflowConfigurationCheckboxes\', this);" /></td>';
                    ...
                    for (var i = 0; i < workflows.length; i++) {
                        ...
                        if (workflows[i].bwWorkflowJson == 'NEEDS_TO_BE_CREATED') {
                            //html += '   <td></td>'; 
                            html += '   <td colspan="2"><input style="padding:5px 10px 5px 10px;width:200px;color:tomato;" type="button" value="CREATE WORKFLOW" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'createNewWorkflowJson\', \'' + workflows[i].bwRequestType + '\');" /></td>';
                        } else {


                            if (workflows[i].bwWorkflowActive == true) {
                                html += '   <td><input style="padding:5px 10px 5px 10px;width:100px;" id="btnActivateRaciConfiguration" type="button" value="De-activate" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayDeactivateSelectedWorkflowDialog\', \'' + workflows[i].bwWorkflowId + '\');" /></td>';
                            } else {
                                html += '   <td><input style="padding:5px 10px 5px 10px;width:100px;" id="btnActivateRaciConfiguration" type="button" value="Activate" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayActivateSelectedWorkflowDialog\', \'' + workflows[i].bwWorkflowId + '\');" /></td>';
                            }




                            html += '   <td><input style="padding:5px 10px 5px 10px;width:100px;" type="button" value="Edit JSON" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayEditWorkflowJsonDialog\', \'' + workflows[i].bwWorkflowId + '\');" /></td>';
                        }
                    ...
                    html += '   </span>';
                    html += '   <br /><br /><br />';
                    html += '   <div class="divSignInButton" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deleteSelectedWorkflows\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
                ...
                console.log('Exception in bwEmailTemplateEditor.js.renderWorkflowsDropDownList().xx.Get: ' + JSON.stringify(data));
                displayAlertDialog('Exception in bwEmailTemplateEditor.js.renderWorkflowsDropDownList().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
        ...
        try {
            ...
            $("#divDeleteAWorkflowDialog").dialog({
                ...
                open: function () {
                    ...
                    var html = '';
                    html += '        <div id="divDeleteAWorkflowDialogReassignTasks" class="divSignInButton" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deleteWorkflow\', \'' + bwWorkflowId + '\');" style="width:90%;text-align:center;line-height:0.8em;font-weight:bold;">';
                    html += '            Delete';
                    html += '        </div>';
        ...
        try {
            ...
            $('#divActivateSelectedWorkflowDialog').dialog({
                ...
                open: function () {
                    ...
                    var html = '';
                    html += '        <div id="divActivateSelectedWorkflowDialogReassignTasks" class="divSignInButton" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'activateSelectedWorkflow\', \'' + bwWorkflowId + '\', \'' + bwRequestType + '\');" style="width:90%;text-align:center;line-height:0.8em;font-weight:bold;">';
                    html += '            Activate';
                    html += '        </div>';
        ...
        try {
            ...
            $('#divDeactivateSelectedWorkflowDialog').dialog({
                ...
                open: function () {
                    ...
                    var html = '';
                    html += '        <div id="divDeactivateSelectedWorkflowDialogReassignTasks" class="divSignInButton" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'deactivateSelectedWorkflow\', \'' + bwWorkflowId + '\', \'' + bwRequestType + '\');" style="width:90%;text-align:center;line-height:0.8em;font-weight:bold;">';
            ...
            if (confirm("Are you certain you wish to activate this workflow?")) {
                ...
                if (selectedRequestType == bwRequestType) {
                    ...
                    $.ajax({
                        ...
                        try {
                            //debugger;
                            console.log('In bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                            // Display a dialog with an "Undo" button!!!!
                            $("#divUndoWorkflowActivationDialog").dialog({
                                modal: true,
                                resizable: false,
                            ...
                            console.log('Exception in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                            alert('Exception in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                        }
                    }).error(function (data, errorCode, errorMessage) {
                        debugger;
                        //thiz.hideProgress();
                        ...
                        console.log('Fail in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                        alert('Fail in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                        //var error = JSON.parse(data.responseText)["odata.error"];
                        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                    });
    ...
    publishWorkflowConfigurationAndActivate: function () {
        ...
        debugger; // 1-4-2022
        try {
            console.log('In bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().');
            ...
            if (!bwRequestTypeId || (bwRequestTypeId == null)) {
                ...
                $.ajax({
                    ...
                    try {
                                    ...
                                    try {
                                        ...
                                        promise.then(function (result) {
                                            try {
                                                ...
                                                console.log('Exception in bwEmailTemplateEditor._create().loadWorkflowsAndCurrentWorkflow(): ' + e.message + ', ' + e.stack);
                                                displayAlertDialog('Exception in bwEmailTemplateEditor._create().loadWorkflowsAndCurrentWorkflow(): ' + e.message + ', ' + e.stack);
                                            }
                                        });
                                    } catch (e) {
                                        console.log('Exception in bwEmailTemplateEditor._create().loadWorkflowsAndCurrentWorkflow():xcx56: ' + e.message + ', ' + e.stack);
                                        displayAlertDialog('Exception in bwEmailTemplateEditor._create().loadWorkflowsAndCurrentWorkflow():xcx56: ' + e.message + ', ' + e.stack);
                                    }
                                },
                                close: function () {
                                    $('#divUndoWorkflowActivationDialog').dialog("destroy");
                        ...
                        console.log('Exception in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                    }
                    ...
                    console.log('Fail in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                    displayAlertDialog('Fail in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                    //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                    //var error = JSON.parse(data.responseText)["odata.error"];
                    //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                });
            ...
            debugger;
            //thiz.hideProgress();
            console.log('Exception in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailTemplateEditor.js.publishWorkflowConfigurationAndActivate(): ' + e.message + ', ' + e.stack);
        }
    },
        ...
        try {
            ...
            if (thereHaveBeenChangesToTheWorkflow) {
                ...
                if (this.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                    ...
                    html += '<input style="padding:5px 10px 5px 10px;width:100px;" id="btnSaveWorkflowConfigurationAndActivate" type="button" value="Publish" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'publishWorkflowConfigurationAndActivate\');" />';
                    html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCancelChangesInDraftWorkflowConfiguration" type="button" value="Cancel Changes" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'cancelChangesInDraftWorkflowConfiguration\');" />';
                }
    ...
    saveAssignmentRow: function (elementId) {
        try {
            ...
            if (stepIndex && sourceRoleCategory && roleIndex > -1) {
                ...
                //            thiz._create();
                //        } catch (e) {
                //            console.log('Exception in bwEmailTemplateEditor.js.saveAssignmentRow().xx.update: ' + e.message + ', ' + e.stack);
                //            alert('Exception in bwEmailTemplateEditor.js.saveAssignmentRow().xx.update: ' + e.message + ', ' + e.stack);
                //        }
                //    }).error(function (data, errorCode, errorMessage) {
                //        //thiz.hideProgress();
                //        var msg;
                ...
                //            msg = JSON.stringify(data) + ', json: ' + JSON.stringify(json);
                //        }
                //        console.log('Fail in bwEmailTemplateEditor.js.saveAssignmentRow().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                //        alert('Fail in bwEmailTemplateEditor.js.saveAssignmentRow().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                //        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //        //var error = JSON.parse(data.responseText)["odata.error"];
                //        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                //    });
    ...
    //        //
    //        var html = '';
    //        html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveEmailTemplateForOverdueTasks\', \'' + 'stepName' + '\');">';
    //        html += '☑ Save this email template';
    //        html += '</div>';
    //        document.getElementById('spanConfigureEmailNotificationsDialogSaveButton').innerHTML = html;
    //        // Display the email editor.
    ...
    bwEmailTemplateEditor_txtLocationPickerFilter_OnMouseup: function () {
        try {
            console.log('In bwEmailTemplateEditor_txtLocationPickerFilter_OnMouseup().');
            var thiz = this;
            ...
            var width1 = $('#bwEmailTemplateEditor_txtLocationPickerFilter')[0].style.width;
            var width2 = width1.split('px')[0];
            var width3 = Number(width2) + 50;
            var width = width3; // + 'px';

            $("#bwEmailTemplateEditor_divLocationPickerDropDown").dialog({
                position: {
                    my: "left top",
                    at: "left bottom",
                    of: $('#bwEmailTemplateEditor_txtLocationPickerFilter')
                },
                modal: true,
                resizable: false,
                closeText: "Cancel",
                ...
                open: function (event, ui) {
                    ...
                    $('.ui-widget-overlay').bind('click', function () {
                        $("#bwEmailTemplateEditor_divLocationPickerDropDown").dialog('close');
                    });

                    // Hide the title bar.
                    $("#bwEmailTemplateEditor_divLocationPickerDropDown").dialog().parents(".ui-dialog").find(".ui-dialog-titlebar").remove();
                },
                close: function () {
                    try {
                        ...
                        $("#bwEmailTemplateEditor_divLocationPickerDropDown").dialog('destroy');
                    } catch (e) {
                        console.log('Exception in bwEmailTemplateEditor_txtLocationPickerFilter_OnMouseup.dialog.close():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwEmailTemplateEditor_txtLocationPickerFilter_OnMouseup.dialog.close():2: ' + e.message + ', ' + e.stack);
                    }
                }
            ...
            console.log('Exception in bwEmailTemplateEditor_txtLocationPickerFilter_OnMouseup(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailTemplateEditor_txtLocationPickerFilter_OnMouseup(): ' + e.message + ', ' + e.stack);
        }
    },
    bwEmailTemplateEditor_txtLocationPickerFilter_OnKeyup: function (elementId) {
        try {
            console.log('In bwEmailTemplateEditor_txtLocationPickerFilter_OnKeyup(). elementId: ' + elementId);

            if ($('#bwEmailTemplateEditor_divLocationPickerDropDown')[0].style.display == 'none') {
                this.bwEmailTemplateEditor_txtLocationPickerFilter_OnMouseup();
            }

        } catch (e) {
            console.log('Exception in bwEmailTemplateEditor_txtLocationPickerFilter_OnKeyup(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailTemplateEditor_txtLocationPickerFilter_OnKeyup(): ' + e.message + ', ' + e.stack);
        }
    },
    bwEmailTemplateEditor_SelectADataItem: function (element) {
        try {
            console.log('In bwEmailTemplateEditor_SelectADataItem().');

            var selectedDataItem = $(element).html();
            $("#bwEmailTemplateEditor_divLocationPickerDropDown").dialog('close');
            $('#bwEmailTemplateEditor_txtLocationPickerFilter').val(selectedDataItem);

            //alert('In bwEmailTemplateEditor_SelectADataItem(). selectedDataItem: ' + selectedDataItem);
            ...
            console.log('Exception in bwEmailTemplateEditor_SelectADataItem(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailTemplateEditor_SelectADataItem(): ' + e.message + ', ' + e.stack);
        }
    },
    displayEmailDataItemPickerDialog: function (emailSection) { // emailSection is either 'subject' or 'body'.
        try {
            ...
            //    html += '   <option value="3" onmouseover="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayDataItemHoverDialog\', this);" >' + dataConversionJson[keys[i]].TemplateText + ' xcx1</option>';
            //}
            ...
            //
            html += '<input id="bwEmailTemplateEditor_txtLocationPickerFilter" value="Select a data item..." type="text" style="width:450px;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 20pt;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'bwEmailTemplateEditor_txtLocationPickerFilter_OnKeyup\', \'txtLocationPickerFilter\');" onmouseup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'bwEmailTemplateEditor_txtLocationPickerFilter_OnMouseup\', \'txtLocationPickerFilter\');" />'; //</input>';
            html += '<br />';
            html += '<div id="bwEmailTemplateEditor_divLocationPickerDropDown" style="display:none;background-color:white;overflow-x:hidden;">'; // Scrollable div wrapper for the drop-down. // dark blue border. // position and z-index makes it show up on top and to not move the other elements around.
            //html += '   <div value="3">' + 'Select a data item...' + '</div>';
            var keys = Object.keys(dataConversionJson);
            for (var i = 0; i < keys.length; i++) {
                html += '   <div class="dataItemInDropDown" onmouseover="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'showDataItemHoverDialog\', this);" onmouseout="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'hideDataItemHoverDialog\', this);" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'bwEmailTemplateEditor_SelectADataItem\', this);" >' + dataConversionJson[keys[i]].TemplateText + ' </div>';
            }
            ...
            html += '</select>';
            html += '&nbsp;&nbsp;';
            html += '<input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'insertEmailDataItem\', \'' + emailSection + '\');" type="button" value="Insert">';
    ...
    displayWorkflowActionsUnderlyingPropertiesDialog: function (elementId, actionTitle) {
        try {
            ...
            html += '<br />';
            html += '&nbsp;&nbsp;';
            html += '<input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'saveWorkflowActionsUnderlyingProperties\', \'' + elementId + '\', \'' + actionTitle + '\');" type="button" value="Save">';
    ...
    insertEmailDataItem: function (emailSection) { // emailSection is either 'subject' or 'body'.
        try {
            ...
            var selectedDataItem = $('#bwEmailTemplateEditor_txtLocationPickerFilter').val(); // 4-5-2022
    ...
    //            //html += '           <span class="spanButton" title="Edit email template(s)..." style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
    //            html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'editStepEmails\', \'' + stepName + '\', \'' + stepFriendlyName + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" &nbsp;&nbsp;</span><br /><div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
    //            html += '       </td>';
    //            html += '   </tr>';
    //            //}
    //        }
    ...
    //                    //debugger;
    //                    var html = '';
    //                    html += '<select style="padding:5px 5px 5px 5px;font-size:8pt;" id="workflowsDropDown" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'WorkflowsDropDown_Onchange\');">';
    ...
    //                    msg = JSON.stringify(data);
    //                }
    //                alert('Exception in bwEmailTemplateEditor.js.renderWorkflowsDropDownList().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
    //                console.log('Exception in bwEmailTemplateEditor.js.renderWorkflowsDropDownList().xx.Get: ' + JSON.stringify(data));
    //                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
    //                //var error = JSON.parse(data.responseText)["odata.error"];
    //                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
    ...
    renderSelectRoleOrPersonSection: function (elementId) {
        try {
            ...
            if (isAdmin) {
                ...
                //html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleName"  onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleName' + '\');">';
                //html += '  <option value=""></option>';
                //for (var i = 0; i < roles.length; i++) {
                ...
                $.ajax({
                    ...
                    try {
                        ...
                        //html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayPeoplePickerDialog\', \'' + 'txtRoleMembersFriendlyName_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersId_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersEmail_' + stepIndex + '_' + roleIndex + '' + '\');" src="images/addressbook-icon18x18.png">';
                        ...
                        //            roleMembersHtml += '<span style="cursor:pointer;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'DeleteRoleMember\', \'' + elementId + '\', \'' + result[i].bwParticipantId + '\');">&nbsp;&#128465;</span></li>';
                        //        }
                        ...
                        //html += '<br /><img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                        //html == '&nbsp;&nbsp;';
                        //html += '<input id="btnCreateRole1" type="button" value="Select Person..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" />';

                        //html += '<br />or add a new person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        //html += '<br /><input id="btnCreateRole1" type="button" value="Add a Person..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayAddANewPersonDialog\');" />';
                ...
                $.ajax({
                    ...
                    try {
                        ...
                        debugger; // 12-8-2021 <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        html += 'Role:&nbsp;<select test="xcx1001" style="padding:5px 5px 5px 5px;" id="selectRoleName"  onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleName' + '\');">';
                        html += '  <option value=""></option>';
                        for (var i = 0; i < roles.length; i++) {
                            if (rolename == roles[i].RoleName) {
                                html += '  <option value="' + roles[i].RoleId + '" selected >' + roles[i].RoleName + '</option>';
                        ...
                        //html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCreateRole2" type="button" value="New Role..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayCreateANewRoleDialog\');" />';
                        //html += '<br />';
                        //$.ajax({
                        ...
                        //        html += '<input id="txtRoleMembersEmail_' + stepIndex + '_' + roleIndex + '" style="display:none;" />';
                        //        html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayPeoplePickerDialog\', \'' + 'txtRoleMembersFriendlyName_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersId_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersEmail_' + stepIndex + '_' + roleIndex + '' + '\');" src="images/addressbook-icon18x18.png">';
                        //        html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="New Person..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayAddANewPersonDialog\');" />';
                        //        if (participantId) { // Only display when logged in. We need to do more work here!!
                        //            if (result.length > 0) {
                        //                var roleMembersHtml = '';
                        ...
                        //                    roleMembersHtml += '<span style="cursor:pointer;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'DeleteRoleMember\', \'' + elementId + '\', \'' + result[i].bwParticipantId + '\');">&nbsp;&#128465;</span>';
                        //                    roleMembersHtml += '</li>';
                        //                }
                        //                roleMembersHtml += '</ul></span>';
                        //                html += roleMembersHtml;
            ...
            if (selectedRoleCategory == 'Inform') {
                ...
                for (var i = 0; i < actions.length; i++) {
                    ...
                    if (actions[i] == 'Approve' || actions[i] == 'Revise/Hold') {
                        ...
                        html += '  <input type="checkbox" id="' + checkboxId + '" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'toggleChildCheckbox\', \'' + checkboxId + '\', \'' + childCheckboxId + '\');" />&nbsp;' + actions[i];
                    }
                    html += '  &nbsp;';
                    html += '  <input id="' + childCheckboxId + '" type="checkbox" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'toggleParentCheckbox\', \'' + childCheckboxId + '\', \'' + checkboxId + '\');" />&nbsp;require comments';
                    html += '  &nbsp;<span style="cursor:pointer;" title="Select to configure underlying properties..." onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayWorkflowActionsUnderlyingPropertiesDialog\', \'' + elementId + '\', \'' + actions[i] + '\');">&#8230;</span>'
                    html += '</span>';
                    html += '<br />';
                }
                // end: 4-20-2022
    ...
    renderTimeoutSection: function (elementId) {
        try {
            ...
            if (selectedRoleCategory == 'Inform') {
                ...
                html += '<span style="white-space:nowrap;">Timeout:&nbsp;<input type="text" id="textTimeout" style="width:25px;padding:5px 5px 5px 5px;" onkeyup="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'TimeoutTextBox_Onkeyup\', \'' + 'textTimeout' + '\');" />&nbsp;days</span>';
                timeoutCell.html(html);
            } else if (selectedRoleCategory == 'Approver') {
                timeoutCell.html(html);
            } else {
    ...
    renderConditionsSection: function (elementId, conditionString) {
        try {
            ...
            //}
            //if (isExec && isExec == 'True') {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsExec" type="checkbox" checked onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isExecCondition_CheckChanged\');" />&nbsp;' + 'Exec' + '&nbsp;</span>';
            //} else {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsExec" type="checkbox" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isExecCondition_CheckChanged\');" />&nbsp;' + 'Exec' + '&nbsp;</span>';
            //}
            ...
            //}
            //if (isLegal && isLegal == 'True') {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLegal" type="checkbox" checked onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isLegalCondition_CheckChanged\');" />&nbsp;' + 'Legal' + '&nbsp;</span>';
            //} else {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLegal" type="checkbox" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isLegalCondition_CheckChanged\');" />&nbsp;' + 'Legal' + '&nbsp;</span>';
            //}
            //html += '&nbsp;';
            //// Is Lease
            //if (conditionString) {
            ...
            //}
            //if (isLease && isLease == 'True') {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLease" type="checkbox" checked onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isLeaseCondition_CheckChanged\');" />&nbsp;' + 'Lease' + '&nbsp;</span>';
            //} else {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLease" type="checkbox" onchange="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isLeaseCondition_CheckChanged\');" />&nbsp;' + 'Lease' + '&nbsp;</span>';
            //}
            //html += '&nbsp;';
            //// Is IT
            //html += '&nbsp;';
            ...
            //html += '<span style="cursor:pointer;color:red;text-decoration:underline;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayOrgMultiPicker\', \'' + this.id + '\');">Location(s)</span>';
            //html += '&nbsp;&nbsp;&nbsp;&nbsp;';
            //html += '<span style="cursor:pointer;color:red;text-decoration:underline;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayProjectTypeMultiPicker\', \'' + this.id + '\');">Functional area(s)</span>';
            //html += '&nbsp;&nbsp;&nbsp;&nbsp;';
            //html += '<span style="cursor:pointer;color:red;text-decoration:underline;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'displayPillarMultiPicker\', \'' + this.id + '\');">Growth</span>';
                ...
                if (this.options.Checklists) {
                    ...
                    for (var i = 0; i < checklists.length; i++) {
                        ...
                        if (conditionString) {
                            ...
                            if (conditionString.indexOf(checklists[i].bwChecklistTemplatesId) > -1) {
                                html += '<input id="' + checklistCheckboxId + '" checked="" type="checkbox" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isChecklistRequired_CheckChanged\', \'' + checklists[i].bwChecklistTemplatesId + '\', \'' + checklistCheckboxId + '\');" />';
                                //html += '<input id="cbChecklistRequired_' + checklists[i].bwChecklistTemplatesId + '" type="checkbox" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isChecklistRequired_CheckChanged\', this);" />';
                                html += '&nbsp;' + checklists[i].Title + '&nbsp;';
                            } else {
                                html += '<input id="' + checklistCheckboxId + '" type="checkbox" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isChecklistRequired_CheckChanged\', \'' + checklists[i].bwChecklistTemplatesId + '\', \'' + checklistCheckboxId + '\');" />';
                                //html += '<input id="cbChecklistRequired_' + checklists[i].bwChecklistTemplatesId + '" type="checkbox" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'isChecklistRequired_CheckChanged\', this);" />';
                                html += '&nbsp;' + checklists[i].Title + '&nbsp;';
                            }
                        } else {
                        ...
                        //html += '<span style="cursor:pointer;" onclick="$(\'.bwEmailTemplateEditor\').bwEmailTemplateEditor(\'DeleteChecklist\', \'' + elementId + '\', \'' + checklists[i].bwChecklistTemplatesId + '\');">&nbsp;&#128465;</span>';
    ...
    WorkflowRequestTypeDropDown_Onchange: function (elementId) {
        try {
            ...
            try {
                ...
                console.log('Exception in bwEmailTemplateEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
                displayAlertDialog('Exception in bwEmailTemplateEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
            }
        } catch (e) {
