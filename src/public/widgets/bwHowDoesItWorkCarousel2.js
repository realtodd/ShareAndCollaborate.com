$.widget("bw.bwHowDoesItWorkCarousel2", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwHowDoesItWorkCarousel2.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        this.element.addClass("bwHowDoesItWorkCarousel2");
        ...
        try {
            ...
            //alert('In bwHowDoesItWorkCarousel2._create(). The widget has been initialized.');
            console.log('In bwHowDoesItWorkCarousel2._create(). The widget has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwHowDoesItWorkCarousel2: CANNOT RENDER THE WIDGET</span>';
            html += '<br />';
            html += '<span style="">Exception in bwHowDoesItWorkCarousel2.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    setCarouselImageTracker: function () {
        try {
            ...
            if (this.options.PublishedSlideSet.FilesAndFolders && this.options.PublishedSlideSet.FilesAndFolders.files) {
                document.getElementById('spanCarouselHeaderText').innerHTML = this.options.PublishedSlideSet.FilesAndFolders.files[Number(this.carouselImageTracker)].headerText;
            }
                ...
                if (this.carouselImageTracker < (this.options.PublishedSlideSet.FilesAndFolders.files.length)) {
                    ...
                    for (var i = 0; i < (this.options.PublishedSlideSet.FilesAndFolders.files.length) ; i++) {
                        //if (i > 0) {
                            ...
                            var elementId = 'spanCarouselImageIndicator'.concat((Number(i + 1)).toString()); // 12-22-2022
            ...
            console.log('Exception in bwHowDoesItWorkCarousel2.js.setCarouselImageTracker(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel2.js.setCarouselImageTracker(): ' + e.message + ', ' + e.stack);
        }
    },
    startCarouselTimer: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel2.js.startCarouselTimer().');
            //alert('In bwHowDoesItWorkCarousel2.js.startCarouselTimer().');
            var thiz = this;
            ...
            console.log('Exception in bwHowDoesItWorkCarousel2.js.startCarouselTimer(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel2.js.startCarouselTimer(): ' + e.message + ', ' + e.stack);
        }
    },
    startCarouselTimer2: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel2.js.startCarouselTimer2().');
            //alert('In bwHowDoesItWorkCarousel2.js.startCarouselTimer2().');
            var thiz = this;
            ...
            console.log('Exception in bwHowDoesItWorkCarousel2.js.startCarouselTimer2(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel2.js.startCarouselTimer2(): ' + e.message + ', ' + e.stack);
        }
    },

    windowresize: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel2.js.windowresize().');
            //alert('In bwHowDoesItWorkCarousel2.js.windowresize().');
            ...
            console.log('Exception in bwHowDoesItWorkCarousel2.js.windowresize(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel2.js.windowresize(): ' + e.message + ', ' + e.stack);
        }
    },
    renderSlideSets: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel2.js.renderSlideSets().');
            var thiz = this;
            //
            ...
            //alert('In bwHowDoesItWorkCarousel2.js._create(). Getting ready to display zczcvdsfgdsfhg');
    ...
    loadFoldersAndFiles: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel2.js.loadFoldersAndFiles().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (result) {
                    try {
                        console.log('In bwHowDoesItWorkCarousel2.js.loadFoldersAndFiles(). Got data from _files/slideshowslidesets().'); // ' + JSON.stringify(result));
                        ...
                        if (!result.filesandfolders) {
                            ...
                            if (!(SlideSets.FilesAndFolders && SlideSets.FilesAndFolders.length)) {
                                ...
                                console.log('In bwHowDoesItWorkCarousel2.js._create(). NO SLIDES TO DISPLAY.');
                                ...
                                console.log('In bwHowDoesItWorkCarousel2.js._create(). FINISHED DISPLAYING, called startCarouselTimer(). <<<<<<<<<<<<<<<<');
                            }

                        }

                    } catch (e) {
                        console.log('Exception in bwHowDoesItWorkCarousel2.js.loadFoldersAndFiles():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwHowDoesItWorkCarousel2.js.loadFoldersAndFiles():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwHowDoesItWorkCarousel2.js.loadFoldersAndFiles.GetExternallySharedFiles():1: ' + errorCode + ', ' + errorMessage);
                    //displayAlertDialog('Error in bwHowDoesItWorkCarousel2.js.loadFoldersAndFiles.GetExternallySharedFiles():1: ' + errorCode + ', ' + errorMessage); // Don't want this to show up. Most likely caused by files services being unavailable.
                }
            });

        } catch (e) {
            console.log('Exception in bwHowDoesItWorkCarousel2.js.loadFoldersAndFiles(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel2.js.loadFoldersAndFiles(): ' + e.message + ', ' + e.stack);
        }
    },

    displayHowDoesItWorkScreen: function () {
        try {
            console.log('In bwHowDoesItWorkCarousel2.js.displayHowDoesItWorkScreen().');
            //alert('In bwHowDoesItWorkCarousel2.js.displayHowDoesItWorkScreen().');
            ...
            for (var i = 0; i < (this.options.PublishedSlideSet.FilesAndFolders.files.length) ; i++) {
                html += '                                    <span id="spanCarouselImageIndicator' + (i + 1) + '" onclick="$(\'.bwHowDoesItWorkCarousel2:first\').bwHowDoesItWorkCarousel2(\'cmdCarouselImageIndicatorClick\', \'' + i + '\');" class="spanCarouselImageIndicatorDisabled" title="Slide #' + (i + 1) + '">&#183;' + (i + 1) + '</span>&nbsp;';
            }
            ...
            //
            //html += '                                       <div id="divCarouselPausePlay2" class="carouselPausePlay" onclick="$(\'.bwHowDoesItWorkCarousel2:first\').bwHowDoesItWorkCarousel2(\'startCarouselTimer\');" style="cursor:pointer;white-space:nowrap;">play slideshow<div>';
            html += '                                    </div>';
            html += '                                </td>';
            html += '                            </tr>';
            html += '                        </table>';
            ...
            html += '                        <div id="divLeftNavigationArrow" class="carouselLeftNavigationArrow" onclick="$(\'.bwHowDoesItWorkCarousel2\').bwHowDoesItWorkCarousel2(\'cmdCarouselNavigateLeft\');">&lt;</div>';
            html += '                    </td>';
            ...
            html += '                    <td style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;margin:0 0 0 0;border-width:0 0 0 0;vertical-align:top;">';
            html += '                        <div id="divRightNavigationArrow" class="carouselRightNavigationArrow" onclick="$(\'.bwHowDoesItWorkCarousel2\').bwHowDoesItWorkCarousel2(\'cmdCarouselNavigateRight\');">&gt;</div>';
            html += '                    </td>';
            ...
            console.log('Exception in bwHowDoesItWorkCarousel2.js.displayHowDoesItWorkScreen(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwHowDoesItWorkCarousel2.js.displayHowDoesItWorkScreen(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    displayAlertDialog: function (errorMessage) {
        try {
            ...
            console.log('Exception in bwHowDoesItWorkCarousel2.displayAlertDialog(): ' + e.message + ', ' + e.stack);
        }
    }
