$.widget("bw.bwEmailMonitor", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwEmailMonitor.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        this.element.addClass("bwEmailMonitor");
        var thiz = this;
        try {
            ...
            if (this.options.backendAdministrationMode != true) {
                ...
                html += '<div style="display:none;" id="divBwEmailMonitor_DeletePendingEmailsDialog">';
                ...
                html += '   </span>';
                html += '   <br /><br /><br />';
                //html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedPendingEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
                ...
                html += '<div style="display:none;" id="divBwEmailMonitor_DeleteSentEmailsDialog">';
                html += '   <table style="width:100%;">';
                html += '       <tr>';
                html += '           <td style="width:90%;">';
                ...
                html += '   </span>';
                html += '   <br /><br /><br />';
                //html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedSentEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                ...
                html += '<table style="width:100%;" xcx="xcx1234367">';
                html += '   <tr>';
                ...
                if (developerModeEnabled == true) {
                    html += '                               <span class="spanButton" title="Click to send this email now!" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'sendPendingEmailNow\');">';
                    html += '                                   ✉&nbsp;Send Now > xcx1';
                    html += '                               </span>';
                }
                ...
                html += '                       <tr>';
                html += '                           <td id="tdDisplayPendingEmailButton"></td>';

                html += '                           <td colspan="5" style="width:350px;height:50px;text-align:left;background-color:white;margin:10px 20px 10px -3px;"><span id="spanSelectedEmailType_Title" style="height:30px;font-size:15pt;font-weight:bold;">[spanSelectedEmailType_Title]</span></td>';
                ...
                html += '<table xcx="xcx23423464" style="width:100%;">';


                if (developerModeEnabled == true) {
                    // AI Conversation 1-7-2023 
                    html += '   <tr>';
                    html += '       <td id="spanDisplayAIConversationButton" class="bwEmailMonitor_LeftMenuButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayAIConversation\');">';
                    html += '           <span><span class="bwEmailMonitor_LeftMenuButton_UnicodeImage">🔊</span> AI Conversation</span>';
                    html += '           </br>';
                ...
                // 4-16-2022
                html += '   <tr>';
                html += '       <td id="spanDisplaySentEmailButton" class="bwEmailMonitor_LeftMenuButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displaySentEmails\');">';
                html += '           <span><span class="bwEmailMonitor_LeftMenuButton_UnicodeImage">✉</span> Sent email(s)</span>';
                html += '           </br>';
                ...
                html += '   <tr>';
                html += '       <td id="spanDisplayPendingEmailButton" class="bwEmailMonitor_LeftMenuButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayPendingEmails\');" >';
                html += '           <span><span class="bwEmailMonitor_LeftMenuButton_UnicodeImage">✉</span> Pending email(s)</span>';
                html += '           </br>';
                ...
                html += '   <tr>';
                html += '       <td id="spanDisplayPendingEmailButtonxxx" class="bwEmailMonitor_LeftMenuButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayPendingEmailsxxx\');" >';
                html += '           <span><span class="bwEmailMonitor_LeftMenuButton_UnicodeImage">☎</span> Sent Text Message(s)</span>';
                html += '           </br>';
                ...
                html += '   <tr>';
                html += '       <td id="spanDisplayPendingEmailButtonxxx" class="bwEmailMonitor_LeftMenuButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayPendingEmailsxxx\');" >';
                html += '           <span><span class="bwEmailMonitor_LeftMenuButton_UnicodeImage">☎</span> Pending Text Message(s)</span>';
                html += '           </br>';
                ...
                html += '                           <td colspan="5" style="width:350px;vertical-align:top;background-color:white;">';
                ...
                //
                // THIS WIDGET IS USED IN THE REGULAR USER APPLICATION. WE SHOULD NOT BUIOLD IN ADMIN FUNCTIONALITY INTO THIS WIDGET LIKE THIS. 2-18-2022
                //
                ...
                html += '   </span>';
                html += '   <br /><br /><br />';
                html += '   <div class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedForestPendingEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
                ...
                //html += '   </span>';
                //html += '   <br /><br /><br />';
                //html += '   <div id="divDeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedPendingEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
                //html += '       Delete the Pending Emails';
                //html += '   </div>';
                //html += '   <br /><br />';
                //html += '   <div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em; font-weight: bold;" onclick="$(\'#divBwEmailMonitor_DeletePendingEmailsDialog\').dialog(\'close\');">';
                ...
                //html += '   </span>';
                //html += '   <br /><br /><br />';
                //html += '   <div id="divDeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedSentEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                //html += '       Delete the Sent Emails';
                //html += '   </div>';
                //html += '   <br /><br />';
                //html += '   <div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em; font-weight: bold;" onclick="$(\'#divBwEmailMonitor_DeleteSentEmailsDialog\').dialog(\'close\');">';
                ...
                html += '   </span>';
                html += '   <br /><br /><br />';
                html += '   <div class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedErrorsAndSuggestions\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
                ...
                // 8-31-2021
                html += '               <tr>';
                html += '                   <td onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'expandOrCollapseForestPendingEmails\');" style="background-color:lightskyblue;white-space:nowrap;cursor:pointer;" >';
                ...
                html += '               <tr>';
                html += '                   <td onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'expandOrCollapsePendingEmails\');" style="background-color:lightskyblue;white-space:nowrap;cursor:pointer;" >';
                ...
                html += '               </tr>';
                html += '               <tr>';
                html += '                   <td onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'expandOrCollapseSentEmails\');" style="font-size:16px;white-space:nowrap;cursor:pointer;">';
                ...
                html += '               </tr>';
                html += '               <tr>';
                html += '                   <td onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'expandOrCollapseErrorsAndSuggestions\');" style="font-size:16px;white-space:nowrap;cursor:pointer;">';
                ...
                html += '               <tr>';
                html += '                   <td>';
                html += '                       <div class="spanButton" id="divWebServiceTest" style="cursor:pointer;" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'webServiceTest\');">Test the Web Service</div>';
                html += '                   </td>';
                html += '               </tr>';
                ...
                html += '                           <div style="height:600px;overflow-y: scroll;" onscroll="$(\'.bwEmailMonitor\').bwEmailMonitor(\'sentEmail_OnScroll\', this);">';
                html += '                               <span id="spanEmailPicker"></span>';
                html += '                           </div>';
                html += '                       </td>';
                html += '                   </tr>';
                ...
                //html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'sendEmailNow\');">';
                //html += '                           ✉&nbsp;Send Now > xcx2';
                //html += '                       </div>';
                html += '                       <span id="spanSelectedEmail"></span>';
                html += '                   </td>';
            ...
            console.log('In bwEmailMonitor._create(). Printing has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwEmailMonitor: CANNOT INITIALIZE THE WIDGET</span>';
            html += '<br />';
            html += '<span style="">Exception in bwEmailMonitor.Create(): ' + e.message + ', ' + e.stack + '</span>';
            thiz.element.html(html);
        }
    },
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayForestPendingEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayForestPendingEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayPendingEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayPendingEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        try {
                            ...
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displaySentEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displaySentEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
                            ...
                            console.log('Exception in bwEmailMonitor.js.expandOrCollapseSentEmails():1: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwEmailMonitor.js.expandOrCollapseSentEmails():1: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (data, errorCode, errorMessage) {
                        console.log('Error in bwEmailMonitor.js.expandOrCollapseSentEmails():' + errorCode + ', ' + errorMessage);
                        displayAlertDialog('Error in bwEmailMonitor.js.expandOrCollapseSentEmails():' + errorCode + ', ' + errorMessage);
                    }
                });
            }
        } catch (e) {
            console.log('Exception in bwEmailMonitor.js.expandOrCollapseSentEmails(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailMonitor.js.expandOrCollapseSentEmails(): ' + e.message + ', ' + e.stack);
        }
    },
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayErrorsAndSuggestions\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'displayErrorsAndSuggestions\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
    ...
    displayForestPendingEmails: function (bwWorkflowAppId) {
        try {
            ...
            try {
                var html = '';
                html += '<input type="checkbox" id="checkboxToggleForestPendingEmailCheckboxes" onchange="$(\'.bwEmailMonitor\').bwEmailMonitor(\'toggleForestPendingEmailCheckboxes\', this);" />';
                html += '                           <span style="padding: 4px 4px 4px 4px;border:1px solid lightblue;cursor:pointer;" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'cmdDisplayDeleteForestPendingEmailsDialog\');">';
                ...
                success: function (data) {
                    try {
                        ...
                        if (!data.length || data.length == 0) {
                            ...
                            html = '<table>';
                            for (var i = 0; i < data.length; i++) {
                                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'viewForestPendingEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwPendingEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                            ...
                            html = '';
                            html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'sendForestPendingEmailNow\');">';
    ...
    displayAIConversation: function () {
        try {
            console.log('In bwEmailMonitor.js.displayAIConversation().');
            //alert('In bwEmailMonitor.js.displayAIConversation().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwEmailMonitor.js.displayAIConversation(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwEmailMonitor.js.displayAIConversation(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    displayAlertDialog('Error in bwEmailMonitor.js.displayAIConversation():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    displayPendingEmails: function () { // Accepts "all" as a value for bwWorkflowAppId. This is for the forest administrator.
        try {
            ...
            //if (!bwWorkflowAppId) {
            //    alert('Error in bwEmailMonitor.js.displayPendingEmails(). Invalid value for bwWorkflowAppId: ' + bwWorkflowAppId);
            //} else {
            var participantId = $('.bwAuthentication').bwAuthentication('option', 'participantId');
            ...
            try {
                ...
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'cmdDisplayDeletePendingEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
                html += '                               <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" xcx="664993" >&nbsp;Delete';
                html += '                           </span>';
                html += '&nbsp;&nbsp;';
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'cmdDisplayDeletePendingEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
                ...
                html = '';
                html += '<input type="checkbox" id="checkboxTogglePendingEmailCheckboxes" onchange="$(\'.bwEmailMonitor\').bwEmailMonitor(\'togglePendingEmailCheckboxes\', this);" />&nbsp;&nbsp;';
                html += '✉ Pending email(s)';
                $(thiz.element).find('#spanSelectedEmailType_Title')[0].innerHTML = html; //'Pending Email';

                // Make this button appear selected.
                $(thiz.element).find('#spanDisplaySentEmailButton').removeClass('bwEmailMonitor_LeftMenuButton_Selected').addClass('bwEmailMonitor_LeftMenuButton');
                $(thiz.element).find('#spanDisplayPendingEmailButton').removeClass('bwEmailMonitor_LeftMenuButton').addClass('bwEmailMonitor_LeftMenuButton_Selected');
                    ...
                    success: function (data) {
                        try {
                            ...
                            if (!data.length || data.length == 0) {
                                ...
                                html = '<table>';
                                for (var i = 0; i < data.length; i++) {
                                    html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'viewPendingEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwPendingEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                                    html += '    <td style="vertical-align:top;"><input type="checkbox" class="pendingEmailCheckbox" bwpendingemailid="' + data[i].bwPendingEmailId + '" /></td>';
                                    //var timestamp = getFriendlyDateAndTime(data[i].Timestamp);
                                    html += '    <td colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
                                    html += '<span style="font-weight:bold;color:black;">' + data[i].ToParticipantFriendlyName + '<br />';
                                ...
                                html = '';
                                html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'sendPendingEmailNow\');">';
    ...
    displaySentEmails: function (bwWorkflowAppId) {
        try {
            ...
            try {
                ...
                // Display the top buttons.
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
                html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
                html += '                           </span>';
                html += '&nbsp;&nbsp;';
                html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
                ...
                html += '✉ Sent email(s)';
                //html += '✉ Inbox'; // 3-12-2023

                $(thiz.element).find('#spanSelectedEmailType_Title')[0].innerHTML = html; //'Sent Email';

                // Make this button appear selected.
                $(thiz.element).find('#spanDisplaySentEmailButton').removeClass('bwEmailMonitor_LeftMenuButton').addClass('bwEmailMonitor_LeftMenuButton_Selected');
                $(thiz.element).find('#spanDisplayPendingEmailButton').removeClass('bwEmailMonitor_LeftMenuButton_Selected').addClass('bwEmailMonitor_LeftMenuButton');
            ...
            if (this.options.backendAdministrationMode == true) {
                ...
                if (this.options.OnlyDisplayEmailsForCurrentParticipant == true) {
                    ...
                    $.ajax({
                            ...
                            try {
                                ...
                                if (!data.length || data.length == 0) {
                                    ...
                                    for (var i = 0; i < data.length; i++) {
                                        ...
                                        html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-3" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'viewSentEmail\', \'' + 'btnEditRaciRoles_' +data[i].bwParticipantId + '\', \'' +data[i].bwParticipantId + '\', \'' +data[i].bwParticipantFriendlyName + '\', \'' +data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' +data[i].bwParticipantId + '\', \'' +data[i].bwParticipantId + '\');">';
                                        //debugger; // xcx999999
                                        html += '    <td style="vertical-align:top;"><input type="checkbox" class="sentEmailCheckbox" bwsentemailid="' + data[i].bwSentEmailId + '" /></td>';
                                        //debugger;
                                        //var timestamp = getFriendlyDateAndTime(data[i].Timestamp);
                                        ...
                                        html += '    <td id="bwEmailMonitor_InnerLeftMenuButton_' + data[i].bwSentEmailId + '" colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
                        ...
                        error: function (data, errorCode, errorMessage) {
                            console.log('Error in bwEmailMonitor.js.displaySentEmails():xcx1: ' + errorCode + ', ' + errorMessage);
                            //displayAlertDialog('Error in bwEmailMonitor.js.displaySentEmails():xcx1: ' + errorCode + ', ' + errorMessage); // PUT THIS BACK SOMETIME 5-5-2022
                        }
                    });
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            try {
                                ...
                                if (!data.length || data.length == 0) {
                                    ...
                                    html += '<table>';
                                    for (var i = 0; i < data.length; i++) {
                                        html += '<tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-4" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'viewSentEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                                        html += '   <td style="vertical-align:top;"><input type="checkbox" class="sentEmailCheckbox" bwsentemailid="' + data[i].bwSentEmailId + '" /></td>';
                                        html += '   <td colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
                        ...
                        error: function (data, errorCode, errorMessage) {
                            displayAlertDialog('Error in bwEmailMonitor.js.displaySentEmails():xcx2: ' + errorCode + ', ' + errorMessage);
                        }
                    });
                }
    ...
    //        try {
    //            var html = '';
    //            html += '<input type="checkbox" id="checkboxToggleErrorsAndSuggestionsCheckboxes" onchange="$(\'.bwEmailMonitor\').bwEmailMonitor(\'toggleErrorsAndSuggestionsCheckboxes\', this);" />';
    //            html += '<span style="padding: 4px 4px 4px 4px;border:1px solid lightblue;cursor:pointer;" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'cmdDisplayDeleteErrorsAndSuggestionsDialog\');">';
    //            html += '   <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png">&nbsp;Delete';
    //            html += '</span>';
    //            html += '<br />';
    //            html += 'Errors & Suggestions';
    ...
    //                                html += '<span title="Flag this message..." style="font-size:13pt;width:100%;text-align:right;color:red;" onmouseover="this.style.color=\'aqua\';" onmouseout="this.style.color=\'red\';" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'flagThisMessage\', \'' + data.result[i].bwErrorOrSuggestionId + '\', true);">⚑</span>';
    //                            } else {
    //                                //debugger;
    //                                html += '<span style="font-weight:bold;color:black;width:100%;">' + data.result[i].CreatedByFriendlyName + '&nbsp;&nbsp;&nbsp;&nbsp;';
    //                                html += '<span title="Flag this message..." style="font-size:13pt;width:100%;text-align:right;" onmouseover="this.style.color=\'aqua\';" onmouseout="this.style.color=\'black\';" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'flagThisMessage\', \'' + data.result[i].bwErrorOrSuggestionId + '\', false);">⚐</span>';
    //                            }
    //                            html += '   <br />';
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            ...
                            var emailTemplateForSubject = data[0].Subject; 
                            var emailTemplate = data[0].Body; 
                            if (emailTemplateForSubject && emailTemplateForSubject != '') {
                                $(thiz.element).find('#quillConfigureNewUserEmailsDialog_Subject')[0].value = emailTemplateForSubject;
                            } else {
                                $(thiz.element).find('#quillConfigureNewUserEmailsDialog_Subject')[0].value = '';
                            ...
                            var timestamp = getFriendlyDateAndTime(data[0].Timestamp);
                            var html = '';
                            html += '<span style="color:black;" xcx="xcx4499305-3" >To:</span> ' + data[0].ToParticipantFriendlyName + ' (' + data[0].ToParticipantEmail + ')';
                            html += '<br />';
                            var timestamp4 = bwCommonScripts.getBudgetWorkflowStandardizedDate(data[0].Timestamp);
                            html += '<span style="font-weight:normal;font-size:10pt;color:black;">' + timestamp4 + '</span>';
                    ...
                    success: function (data) {
                        try {
                            ...
                            if ($(thiz.element).find('#displayedemaildetails') && $(thiz.element).find('#displayedemaildetails')[0] && $(thiz.element).find('#quillConfigureNewUserEmailsDialog_Body') && $(thiz.element).find('#quillConfigureNewUserEmailsDialog_Body')[0]) {
                                ...
                                //alert('xcx1234234: bwEmailMonitor_InnerLeftMenuButton_' + bwEmailId);


                                // 04-18-2022
                                // id="bwEmailMonitor_InnerLeftMenuButton_' + data[i].bwSentEmailId + '"
                                $(thiz.element).find('.bwEmailMonitor_InnerLeftMenuButton_Selected').removeClass('bwEmailMonitor_InnerLeftMenuButton_Selected'); // Reset them all, only 1 can be selected at a time.
                                $('#bwEmailMonitor_InnerLeftMenuButton_' + bwEmailId).removeClass('bwEmailMonitor_InnerLeftMenuButton').addClass('bwEmailMonitor_InnerLeftMenuButton_Selected'); // Indicate this one as selected.
                                ...
                                var html = '';
                                html += '<span style="color:black;" xcx="xcx4499305-4" >To:</span> ' + data[0].ToParticipantFriendlyName + ' (' + data[0].ToParticipantEmail + ')';
                                html += '<br />';
                                var timestamp4 = bwCommonScripts.getBudgetWorkflowStandardizedDate(data[0].Timestamp);
                                html += '<span style="font-weight:normal;font-size:10pt;color:black;">' + timestamp4 + '</span>';
        ...
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    html = '';
                    html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedPendingEmails\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                    html += '       Delete the Pending Emails';
                    html += '   </div>';
                    ...
                    if (selectedEmails.length == 0) {
                        ...
                        html = '';
                        html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedPendingEmails\', \'' + bwWorkflowAppId + '\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                        html += '       Delete the Pending Emails';
                        html += '   </div>';
                        document.getElementById('divBwEmailMonitor_DeleteThePendingEmails').outerHTML = html;
        ...
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    html = '';
                    html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedSentEmails\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                    html += '       Delete the Sent Emails';
                    html += '   </div>';
                    ...
                    if (selectedEmails.length == 0) {
                        ...
                        html = '';
                        html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'deleteSelectedSentEmails\', \'' + bwWorkflowAppId + '\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                        html += '       Delete the Sent Emails';
                        html += '   </div>';
                        document.getElementById('divBwEmailMonitor_DeleteTheSentEmails').outerHTML = html;
    ...
    //                        html += '       <span onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'cmdListPendingEmail3\');" style="font-size:15px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;">✉ Pending</span>';
    ...
    //                        html += '       <span onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'cmdListSentEmail2\');" style="font-size:15px;white-space:nowrap;cursor:pointer;">✉ Sent</span>';
    //                        html += '       <br />';
    //                        html += '       <span onclick="$(\'.bwEmailMonitor\').bwEmailMonitor(\'cmdListErrorsOrSuggestions2\');" style="font-size:15px;white-space:nowrap;cursor:pointer;">✉ Errors & Suggestions</span>';
