$.widget("bw.bwSharePointWorkflowEditor", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwSharePointWorkflowEditor.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        console.log('In bwSharePointWorkflowEditor.js._create().');
        this.element.addClass("bwSharePointWorkflowEditor");
        ...
        try {
            ...
            //        } catch (e) {
            //            console.log('Exception in bwSharePointWorkflowEditor._create().loadWorkflowsAndCurrentWorkflow(): ' + e.message + ', ' + e.stack);
            //        }
            //    });
            //}
            ...
            //html += 'THIS IS THE bwSharePointWorkflowEditor INSTANTIATED. MORE WORK TO DO HERE!!!!!!!!!!!!';
            ...
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwSharePointWorkflowEditor: CANNOT RENDER THE WORKFLOW MATRIX</span>';
            html += '<br />';
            html += '<span style="">Exception in bwSharePointWorkflowEditor.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    renderWorkflowEditor: function () {
        try {
            ...
            html += '   padding: 8px 13px 7px 9px;';
            html += '   white-space: nowrap;';
            html += '   text-align: center;';
            html += '   vertical-align: middle;';
            html += '}';
            html += '.spanButton:hover {';
            html += '   background-color: lightcyan;';
            html += '   border: 1px solid lightskyblue;';
            html += '   cursor: pointer;';
            html += '}';
            html += '</style>';
            ...
            html += '           Manager must approve new requests:';
            html += '           <br />';
            html += '           <span style="font-size:8pt;white-space:normal;">When this is disabled, New Requests will go straight to the first approver.<br />When it is enabled, the Manager reviews New Requests.</span>';
            html += '       </td>';
            html += '       <td class="bwChartCalculatorLightCurrencyTableCell" style="width:70%;padding-left:15px;">';


            html += 'PUT SWITCHBUTTON HERE';
            ...
            console.log('Exception in renderWorkflowEditor(): ' + e.message + ', ' + e.stack);
            alert('Exception in renderWorkflowEditor(): ' + e.message + ', ' + e.stack);
        }
    },
    editEmailTemplate: function (stepFriendlyName, instructionText, stepName) {
        try {
            console.log('In editEmailTemplate().');
            var thiz = this;
            ...
            //    //} else {
            //    //html += '<select style="padding:5px 5px 5px 5px;" id="selectEditEmailFor" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'selectEditEmailFor_OnChange\', \'editing\');">';
            ...
            // Set the "Save" button.
            var html = '';
            html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveEmailTemplateForStep\', \'' + stepName + '\');">';
            ...
            console.log('Exception in editEmailTemplate(): ' + e.message + ', ' + e.stack);
            alert('Exception in editEmailTemplate(): ' + e.message + ', ' + e.stack);
        }
    },
                    ...
                    open: function () {
                        try {
                                        ...
                                        if (confirm("This is valid JSON. Are you certain you wish to activate this workflow? THIS ACTION CANNOT BE UNDONE.")) {
                                            ...
                                            $.ajax({
                                                ...
                                                try {
                                                    debugger; // 1-4-2022
                                                    if (result == 'SUCCESS') {
                                                        console.log('In bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                                                        alert('In bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog().post: Successfully updated DB.');
                                                    } else {
                                                    ...
                                                    console.log('Exception in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + e.message + ', ' + e.stack);
                                                    displayAlertDialog('Exception in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + e.message + ', ' + e.stack);
                                                }
                                                ...
                                                console.log('Fail in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                                                displayAlertDialog('Fail in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                            ...
                            $.ajax({
                                ...
                                displayAlertDialog('Error in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                                console.log('Error in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog().xx.Get: ' + JSON.stringify(data));
                                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                                //var error = JSON.parse(data.responseText)["odata.error"];
                                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                            });
                    ...
                    open: function () {
                        try {
                                        ...
                                        if (confirm("This is valid JSON. Are you certain you wish to activate this workflow? THIS ACTION CANNOT BE UNDONE.")) {
                                            ...
                                            $.ajax({
                                                ...
                                                try {
                                                    debugger; // 1-4-2022
                                                    if (result == 'SUCCESS') {
                                                        console.log('In bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog2().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                                                        alert('In bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog2().post: Successfully updated DB.');
                                                    } else {
                                                    ...
                                                    console.log('Exception in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + e.message + ', ' + e.stack);
                                                    displayAlertDialog('Exception in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + e.message + ', ' + e.stack);
                                                }
                                            }).error(function (data, errorCode, errorMessage) {
                                                debugger;
                                                //thiz.hideProgress();
                                                ...
                                                console.log('Fail in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                                                displayAlertDialog('Fail in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog2().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                                                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                                                //var error = JSON.parse(data.responseText)["odata.error"];
                                                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                                            });
                            ...
                            $.ajax({
                                ...
                                displayAlertDialog('Error in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog2().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                                console.log('Error in bwSharePointWorkflowEditor.js.displayEditWorkflowJsonDialog2().xx.Get: ' + JSON.stringify(data));
                                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                                //var error = JSON.parse(data.responseText)["odata.error"];
                                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                            });
                ...
                $.ajax({
                    ...
                    $.ajax({
                        ...
                        try {
                            ...
                            console.log('Exception in bwSharePointWorkflowEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
                            resolve();
                        }
                    }).fail(function (data) {
                        ...
                        alert('Exception in bwSharePointWorkflowEditor._create().xx.Get:2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                        console.log('Exception in bwSharePointWorkflowEditor._create().xx.Get:2: ' + JSON.stringify(data));
                        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                        //var error = JSON.parse(data.responseText)["odata.error"];
                        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                        resolve();
    ...
    _destroy: function () {
        this.element
            .removeClass("bwSharePointWorkflowEditor")
            .text("");
    },
    ...
    renderWorkflowEditor1: function (assignmentRowChanged_ElementId) {
        try {
            ...
            if (!(bwEnabledRequestTypes && bwEnabledRequestTypes.EnabledItems)) {
                ...
                html += '  <input type="button" value="Create your new role now!" style="height:30pt;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'createANewRole\');" />';
                html += '       </td>';
                html += '     </tr>';
                //html += '     <tr><td>&nbsp;</td></tr>';
                //html += '     <tr>';
                ...
                //html += '  <br /><br />';
                //html += '  <input type="button" value="SAVE" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'roleMultiPickerDialog_RenderResults\');" />';
                //html += '  <br /><br />';
                //html += '</div>';
                ...
                html += '  <br /><br />';
                html += '  <input type="button" value="SAVE" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'orgMultiPickerDialog_RenderResults\');" />';
                html += '  <br /><br />';
                html += '</div>';
                ...
                html += '  <br /><br />';
                html += '  <input type="button" value="SAVE" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'projectTypeMultiPickerDialog_RenderResults\');" />';
                html += '  <br /><br />';
                html += '</div>';
                ...
                html += '  <br /><br />';
                html += '  <input type="button" value="SAVE" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'pillarMultiPickerDialog_RenderResults\');" />';
                html += '  <br /><br />';
                html += '</div>';
                ...
                //html += '               <span id="spanConfigureEmailNotificationsDialogInstructionText_EditButton" title="Edit email instruction text..." style="width:200px;padding:5px 10px 5px 10px;margin:0 0 0 10px;white-space:nowrap;vertical-align:middle;border:1px solid lightblue;cursor:pointer;font-weight:normal;font-size:10pt;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayEditEmailInstructionTextDialog\');"><span style="display:inline-block;"> ⚙ </span></span>';
                ...
                html += '   <br /><br />';
                // Preview button.
                //html += '   <div class="divSignInButton" style="width: 90%; text-align: center; line-height: 1.1em; font-weight: bold;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayEmailPreviewInDialog\');">';
                ...
                if (thiz.options.displayWorkflowPicker) {
                    if (thiz.options.DisplayAsNewTenantUserConfigurationEditor != true) {
                        ...
                        html += '   <select id="selectRequestTypeDropDown" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'WorkflowRequestTypeDropDown_Onchange\', \'selectWorkflowRequestTypeDropDown\');" class="selectHomePageWorkflowAppDropDown" style=\'display:inline;border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 1em; font-weight: bold; cursor: pointer;  margin-bottom:15px;\'>'; // was .5em
                    ...
                    html += '  </td>';
                    html += '  <td style="text-align:right;">';
                    html += '    <span id="spanThereAreChangesToPublishText" style="font-style:italic;color:tomato;"></span>'; //<input value=" There are unsaved changes. Enter a description here and click Save..." type="text" id="txtNewWorkflowDescription" style="width:450px;color:grey;font-style:italic;padding:5px 5px 5px 5px;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'NewWorkflowDescriptionTextBox_Onkeyup\');" />';
                    html += '  </td>';
                    html += '  <td>';
                    ...
                    //    html += '   <select id="selectWorkflowRequestTypeDropDown" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'WorkflowRequestTypeDropDown_Onchange\', \'selectWorkflowRequestTypeDropDown\');" style=\'border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 14pt; font-weight: bold; cursor: pointer;\'>'; // was .5em
                    ...
                    //} else { // There is more than 1, so we have to display as a drop down.
                    //    html += '<span style="font_weight:bold;color:grey;"><strong>';
                    //    html += '   <select id="selectRequestTypeDropDown" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'WorkflowRequestTypeDropDown_Onchange\', \'selectWorkflowRequestTypeDropDown\');" style=\'display:inline;border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 14pt; font-weight: bold; cursor: pointer;\'>'; // was .5em
                    //    for (var i = 0; i < requestTypes.length; i++) {
                    //        var selected = '';
                    //        //if (requestTypes[i].Abbreviation == bwLastSelectedNewRequestType) { // Selected
                    //        //    selected = 'selected';
                    ...
                    if (thiz.options.MultipleWorkflowsEnabled == false) {
                        html += '&nbsp;&nbsp;<span style="font-weight:normal;font-style:italic;color:grey;white-space:nowrap;"><input id="WorkflowForAllRequestTypesCheckbox" type="checkbox" checked="checked" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'WorkflowForAllRequestTypesCheckbox_Onchange\');" />All request types inherit this workflow</span>';
                    } else {
                    ...
                    html += '<span title="Workflow(s) maintenance..." style="width:200px;padding:5px 10px 5px 10px;margin:0 0 0 10px;white-space:nowrap;vertical-align:middle;border:1px solid lightblue;cursor:pointer;font-weight:normal;font-size:10pt;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayWorkflowsConfigurationDialog\');"><span style="display:inline-block;"> ⚙ </span></span>';
            ...
            console.log('Exception in bwSharePointWorkflowEditor.js.renderWorkflowEditor1(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointWorkflowEditor.js.renderWorkflowEditor1(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    renderWorkflowEditor2: function (assignmentRowChanged_ElementId) {
        try {
            ...
            if (!bwRequestTypeId || (bwRequestTypeId == null)) {
                console.log('xcx44887 Invalid bwRequestTypeId: ' + bwRequestTypeId);
                displayAlertDialog('xcx44887 Invalid bwRequestTypeId: ' + bwRequestTypeId);
            } else {
                var car;
                ...
                if (thiz.options.CurrentWorkflow && thiz.options.CurrentWorkflow.DraftWorkflow) {
                    //car = {
                    //    Workflow: thiz.options.CurrentWorkflow.DraftWorkflow
                    //}
                ...
                if (!car) {
                    ...
                    console.log('');
                    console.log('*************************************************************************');
                    console.log('In bwSharePointWorkflowEditor.js.renderWorkflowEditor2(). THIS IS WHERE IF THERE IS NO WORKFLOW SAVED IN THE DATABASE WE SPIT OUT THE DEFAULT.');
                    console.log('*************************************************************************');
                    console.log('');
                    ...
                    //car = {
                    //    Workflow: JSON.parse(JSON.stringify(bwWorkflowJson))
                    //}
                ...
                if (weFoundTheWorkflow == true) {
                    ...
                    $.ajax({
                        ...
                        try {
                            debugger;
                            console.log('In bwSharePointWorkflowEditor.js.renderWorkflowEditor2.Get.odata/Roles(). result: ' + JSON.stringify(result));
                            var html = '';
                            var roles;
                            if (result) {
                                roles = result.value;
                            ...
                            if (car == null) {
                                ...
                                html += '                   <span id="spanExpandOrCollapseRightSliderPaneButton" style="cursor:pointer;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'expandOrCollapseSliderPanel\');">';
                                ...
                                //debugger;
                                html += '    <input type="button" style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'addNewWorkflowStep\', \'' + (car.Workflow.Steps.Step.length - 1) + '\');" value="Add a Step" title="bwSharePointWorkflowEditor.addNewWorkflowStep(). Doesn\'t work right yet..." />';
                                //var tooltip = 'Edit email template(s)...';
                                //html += '<span title="' + tooltip + '" style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + 'all' + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> Task Notification Emails&nbsp;&nbsp;</span>';
                                ...
                                for (var i = 0; i < car.Workflow.Steps.Step.length; i++) {
                                    ...
                                    if (false) {
                                        ...
                                        //debugger;
                                        html += '<tr id="stepheaderrow_' + i + '" style="border:0px;cursor:pointer;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'expandOrCollapseWorkflowStep\', \'' + 'stepname_' + i + '\', \'' + 'stepimage_' + i + '\', \'steprow-' + stepName.toLowerCase() + '_' + i + '_' + '0' + '\');">';
                                        ...
                                        if (stepName == 'Collaboration') {
                                            ...
                                            try {
                                                ...
                                                console.log('In bwSharePointWorkflowEditor.js(). Exception trying to get the timeout: ' + e.message + ', ' + e.stack);
                                            }
                                            html += '<span style="white-space:nowrap;font-size:11pt;">';
                                            html += 'Consensus timeout:&nbsp;';
                                            html += '<input type="text" id="textTimeout" style="width:25px;padding:5px 5px 5px 5px;" value="' + timeout + '" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveCollaborationTimeout\', \'' + 'textTimeout' + '\');" />';
                                            html += '&nbsp;';
                                            html += '<select id="selectTimeoutUnits" style="padding:5px 5px 5px 5px;" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveCollaborationTimeout\', \'' + 'textTimeout' + '\');">';
                                        ...
                                        //    html += '<span title="' + tooltip + '" style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> Confirmation Email&nbsp;&nbsp;</span>';
                                        //} else {
                                        //    html += '<span title="' + tooltip + '" style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> &quot;' + stepName + '&quot; Email&nbsp;&nbsp;</span>';
                                        ...
                                        if (stepName.toLowerCase() == 'admin') {
                                            ...
                                            html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                                            html += '          <input type="button" class="buttonAddNewAssignmentRow" style="white-space:nowrap;padding:5px 10px 5px 10px;" value="✚ Add a Role/Participant" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'addARoleParticipant\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" />';

                                            if (!(stepName.toLowerCase() == 'admin' || stepName.toLowerCase() == 'create' || stepName.toLowerCase() == 'revise')) { // Cannot delete these steps.
                                                html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                                                //html += '          <input type="button" class="" style="white-space:nowrap;padding:5px 10px 5px 10px;" value="Delete this Step" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" />';
                                                //html += '<img title="Delete" style="cursor:pointer;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" src="images/trash-can.png">';


                                                //html += '<span class="spanButton" style="height:20px;width:150px;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');">';
                                                //html += '<img style="cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deleteStep\', \'' + 'steprow-inform_' + i + '_' + '0' + '\');" src="images/trash-can.png">';
                                        ...
                                        if (stepName == 'Create' || stepName == 'Revise' || stepName == 'Admin') {
                                            if (!(car.Workflow.Steps.Step[i].Assign || car.Workflow.Steps.Step[i].Assign[0])) { // changed to || (or) 1-23-2022
                                                ...
                                                console.log('Error in bwSharePointWorkflowEditor.js.renderWorkflowEditor2(). NO ASSIGN STEP FOUND for step: ' + stepName);
                                                displayAlertDialog('Error in bwSharePointWorkflowEditor.js.renderWorkflowEditor2(). NO ASSIGN STEP FOUND for step: ' + stepName);
                                                ...
                                                //html += ' <img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                                                //html += '&nbsp;' + roleName;
                                                html += 'Role: ' + roleName;
                                                ...
                                                if (stepName == 'Create' || stepName == 'Revise') {
                                                    ...
                                                    html += '  <input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'renderEditSteprow\', \'' + xid + '\');" type="button" value="⚙ Edit">';
                                                    html += '</td>';
                                                }
                                                //html += '<td></td>';
                                                //html += '<td></td>';
                                                ...
                                                //var cond = '';
                                                //html += '<td class="cond steprowcell" bwStepname = "' + car.Workflow.Steps.Step[i]["@Name"] + '" bwRoleId = "' + car.Workflow.Steps.Step[i].Assign["@Role"] + '" bwOldValue = "' + cond + '">' + thiz.renderTheCondReadOnly(cond) + '</td>';
                                                ...
                                                if (car.Workflow.Steps.Step[i].OnStart.Inform.length > 0) {
                                                    for (var j = 0; j < car.Workflow.Steps.Step[i].OnStart.Inform.length; j++) {
                                                        ...
                                                        if (car.Workflow.Steps.Step[i].OnStart.Inform[j]) {
                                                            ...
                                                            allowRequestModifications = car.Workflow.Steps.Step[i].OnStart.Inform[j]["@AllowRequestModifications"];
                                                            instructions = car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Instructions"];
                                                        }
                                                        //for (var r = 0; r < roles.length; r++) {
                                                        //    if (car.Workflow.Steps.Step[i].OnStart.Inform[j]) {
                                                        //        if (car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Role"] == roles[r].RoleId) {
                                                        ...
                                                        //html += '<td style="background-color:' + cellColor + ';" class="rolename steprowcell" bwStepname="' + car.Workflow.Steps.Step[i]["@Name"] + '" bwRoleId="' + car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Role"] + '" bwOldValue="' + roleName + '">';
                                                        html += '<td style="background-color:' + cellColor + ';" class="rolename steprowcell" onMouseOver="this.style.backgroundColor=\'lightgoldenrodyellow\';this.style.color=\'red\';" onMouseOut="this.style.backgroundColor=\'' + cellColor + '\';this.style.color=\'black\';" bwStepname="' + car.Workflow.Steps.Step[i]["@Name"] + '" bwRoleId="' + car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Role"] + '" bwOldValue="' + roleName + '" bwallowrequestmodifications="' + allowRequestModifications + '" bwinstructions="' + instructions + '">';
                                                        ...
                                                        html += '<td class="steprowcell">';
                                                        html += ' <span id="rolecategory-inform_' + i + '_' + j + '" class="rolecategory" bwStepname="' + car.Workflow.Steps.Step[i]["@Name"] + '" bwRoleId="' + car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Role"] + '" bwOldValue="Inform" style="cursor:cell;" title="Double-click to edit the role category...">Informed</span>';
                                                        html += '</td>';
                                                        ...
                                                        if (car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Cond"]) {
                                                            html += '<td class="cond steprowcell" bwStepname = "' + car.Workflow.Steps.Step[i]["@Name"] + '" bwRoleId = "' + car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Role"] + '" bwOldValue = "' + car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Cond"] + '">';
                                                            //html += car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Cond"];
                                                            var cond1 = car.Workflow.Steps.Step[i].OnStart.Inform[j]["@Cond"];
                                                ...
                                                if (car.Workflow.Steps.Step[i].Assign.length > 0) {
                                                    for (var j = 0; j < car.Workflow.Steps.Step[i].Assign.length; j++) {
                                                        ...
                                                        if (car.Workflow.Steps.Step[i].Assign[j]["@Cond"]) {
                                                            cond += car.Workflow.Steps.Step[i].Assign[j]["@Cond"];
                                                        }
                                                        //html += '<td class="cond steprowcell" bwStepname = "' + car.Workflow.Steps.Step[i]["@Name"] + '" bwRoleId = "' + car.Workflow.Steps.Step[i].Assign[j]["@Role"] + '" bwOldValue = "' + cond + '">' + cond + '</td>';
                                                        html += '<td class="cond steprowcell" bwStepname = "' + car.Workflow.Steps.Step[i]["@Name"] + '" bwRoleId = "' + car.Workflow.Steps.Step[i].Assign[j]["@Role"] + '" bwOldValue = "' + cond + '">' + thiz.renderTheCondReadOnly(cond) + '</td>';
                                ...
                                for (var j = 0; j < steprows.length; j++) {
                                    ...
                                    workflowAssignmentRow.dblclick(function () {
                                        try {
                                            ...
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveAssignmentRow\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100%;" value="Delete" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deleteRoleCategory\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100%;" value="Cancel" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'cancelStepRowEditing\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  <tr>';
                                            //html += '    <td>';
                                            //html += '      <input type="button" style="width:100px;white-space:normal;overflow-wrap:break-word;" value="Configure Email Notifications" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayConfigureEmailNotificationsDialog\', \'' + this.id + '\');" />';
                                            //html += '    </td>';
                                            //html += '  </tr>';
                                            //html += '  </table>';
                                            ...
                                            //html += '<td class="steprowcell">';
                                            //html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" class="rolecategory-dropdown" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'RoleCategoryDropDown_Onchange\', \'' + this.id + '\');">';
            ...
            $("#divEditStepNameDialog").dialog({
                ...
                open: function () {
                    try {
                        ...
                        var html = '';
                        html += '  <input type="button" value="Save/Update step" style="height:30pt;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepName\', \'' + stepIndex + '\');" />';
    ...
    displayEditEmailInstructionTextDialog: function (stepName) {
        try {
            ...
            var html = '';
            html += '  <input type="button" value="Save/Update step" style="height:30pt;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editEmailInstructionText\', \'' + stepName + '\');" />';
    ...
    addARoleParticipant: function (elementId) {
        try {
            ...
            ////html += '  <tr>';
            ////html += '    <td>';
            ////html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveAssignmentRow\', \'' + elementId + '\', \'' + 'xx' + '\');" />';
            ////html += '    </td>';
            ////html += '  </tr>';
            ////html += '  <tr>';
            ////html += '    <td>';
            ////html += '      <input type="button" style="width:100%;" value="Cancel" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'cancelStepRowEditing\', \'' + elementId + '\', \'' + 'xx' + '\');" />';
            ////html += '    </td>';
            ////html += '  </tr>';
            ////html += '  </table>';
            ...
            //html += '  <tr>';
            //html += '    <td>';
            //html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />';
            //html += '    </td>';
            //html += '  </tr>';
            ////html += '  <tr>';
            ////html += '    <td>';
            ////html += '      <input type="button" style="width:100%;" value="Delete" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deleteRoleCategory\', \'' + elementId + '\');" />';
            ////html += '    </td>';
            ////html += '  </tr>';
            //html += '  <tr>';
            //html += '    <td>';
            //html += '      <input type="button" style="width:100%;" value="Cancel" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'cancelStepRowEditing\', \'' + elementId + '\');" />';
            //html += '    </td>';
            //html += '  </tr>';
            //html += '  <tr>';
            //html += '    <td>';
            //html += '      <input type="button" style="width:100px;white-space:normal;overflow-wrap:break-word;" value="Configure Email Notifications" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayConfigureEmailNotificationsDialog\', \'' + elementId + '\');" />';
            //html += '    </td>';
            //html += '  </tr>';
            //html += '  </table>';
            ...
            $.ajax({
                ...
                try {
                    ...
                    if (thiz.options.displayRoleIdColumn) {
                        ...
                        //html += '<br />';
                        html += '<select id="selectRoleId"  onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleId' + '\');">';
                        html += '  <option value=""></option>';
                        for (var i = 0; i < roles.length; i++) {
                            html += '  <option value="' + roles[i].RoleId + '">' + roles[i].RoleId + '</option>';
                        }
                        html += '</select>';
                        //html += '<br />or create a new role:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        html += '<br /><input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="Create a Role..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayCreateANewRoleDialog\');" />';

                        html += '<br />or select a person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        html += '<br /><input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="Select Person..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayCreateANewRoleDialog\');" />';

                        //html += '<br />or add a new person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        html += '<br /><input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="Add a Person..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayCreateANewRoleDialog\');" />';
                    ...
                    ////html += ' <img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                    ////html == '&nbsp;&nbsp;';
                    //html += '<select id="selectRoleName"  onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleName' + '\');">';
                    //html += '  <option value=""></option>';
                    //for (var i = 0; i < roles.length; i++) {
                    //    html += '  <option value="' + roles[i].RoleId + '">' + roles[i].RoleName + '</option>';
                    //}
                    //html += '</select>';
                    ////html += '<br />or create a new role:'; //<br /><input id="textNewRoleName" type="text" style="width:210pt;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleName' + '\');" />';
                    //html += '<br /><input id="btnCreateRole2" type="button" value="Create a Role..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayCreateANewRoleDialog\');" />';

                    //html += '<br />or select a person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                    //html += '<br /><img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                    //html == '&nbsp;&nbsp;';
                    //html += '<input id="btnCreateRole1" type="button" value="Select Person..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayCreateANewRoleDialog\');" />';

                    ////html += '<br />or add a new person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                    //html += '<br /><input id="btnCreateRole1" type="button" value="Add a Person..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayCreateANewRoleDialog\');" />';
                    ...
                    html += '<td class="steprowcell">';
                    html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" xcx="xcx9934-1" class="rolecategory-dropdown" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'RoleCategoryDropDown_Onchange\', \'' + thiz.id + '\');">';
                    ...
                    html += '  <tr>';
                    html += '    <td>';
                    html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />xcx1671';
                    html += '    </td>';
                    html += '  </tr>';
                    //html += '  <tr>';
                    //html += '    <td>';
        ...
        try {
            ...
            $.ajax({
                ...
                try {
                    ...
                    // The "RoleCategory" dropdown.
                    html += '<td class="steprowcell">';
                    html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" xcx="xcx9934-2" class="rolecategory-dropdown" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'RoleCategoryDropDown_Onchange\', \'' + thiz.id + '\');">';
                    //debugger;
                    ...
                    html += '  <tr>';
                    html += '    <td>';
                    html += '      <input type="button" style="width:100%;" value="Save" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />xcx1672';
                    html += '    </td>';
                    html += '  </tr>';
                    //html += '  <tr>';
                    //html += '    <td>';
    ...
    expandOrCollapseSliderPanel: function () {
        ...
        if (document.getElementsByClassName('rightSliderPanel')[0].innerHTML == '') {
            ...
            html += '       </td>';
            html += '       <td>';
            html += '           <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'expandOrCollapseSliderPanel\');">X</span>';
            html += '       </td>';
            html += '   </tr>';
            html += '</table>';
            ...
            html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + 'Overdue' + '\', \'' + 'Overdue Task(s)' + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + 'Overdue Task(s)' + '" &nbsp;&nbsp;</span>';
            html += '           <br />';
            ...
            //html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + 'RequestReceived' + '\', \'' + 'Request Received' + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + 'Request Received' + '" &nbsp;&nbsp;</span>';
            //html += '           <br />';
            //html += '           <div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
            //html += '       </td>';
            //html += '   </tr>';
            ...
            //html += '           <span class="spanButton" title="Edit email template..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\',\'Create\');"><span style="font-size:15pt;display:inline-block;">✉</span> "Your request has been received" &nbsp;</span><br /><span style="font-size:8pt;padding:0 25px 0 25px;">These emails get sent to people when they first create a request.</span>';
            //html += '       </td>';
            //html += '   </tr>';
            ...
            //    //html += '           <span class="spanButton" title="Edit email template(s)..." style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
            //    html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
            //    html += '       </td>';
            //    html += '   </tr>';
            ...
            //html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'all\');"><span style="font-size:15pt;display:inline-block;">✉</span> Task Notification Emails&nbsp;&nbsp;-itworx</span>';
            //html += '       </td>';
            //html += '   </tr>';
            ...
            var html2 = '';
            //html2 += '<input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'addARaciStep\', \'' + 'all' + '\');" type="button" value="Add a Step" />';
            var tooltip = 'Edit email template(s)...';
        ...
        try {
            ...
            for (var i = 0; i < car.DraftWorkflow.Steps.Step.length; i++) {
                ...
                //html += '           <span class="spanButton" title="Edit email template(s)..." style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
                html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + stepName + '\', \'' + stepFriendlyName + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" &nbsp;&nbsp;</span>';
                html += '           <br />';
                html += '           <div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
                html += '       </td>';
                html += '   </tr>';
    ...
    expandOrCollapseAllWorkflowSteps: function () {
        try {
            ...
            //debugger;
            //var car = this.options.CurrentWorkflow.DraftWorkflow;
            for (var i = 0; i < this.options.CurrentWorkflow.DraftWorkflow.Steps.Step.length; i++) {
                // $('.bwSharePointWorkflowEditor').bwSharePointWorkflowEditor('expandOrCollapseWorkflowStep', 'stepname_0', 'stepimage_0', 'steprow-create_0_0');
    ...
    downloadWorkflowJson: function () {
        try {
            ...
            console.log('Exception in bwSharePointWorkflowEditor.js.downloadWorkflowJson(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointWorkflowEditor.js.downloadWorkflowJson(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    renderEditSteprow: function (elementId) {
        try {
            ...
            if (isAdmin) {
                // Render the "RoleCategory" drop-down.
                //html += '<td class="steprowcell">';
                ////html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" class="rolecategory-dropdown" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'RoleCategoryDropDown_Onchange\', \'' + elementId + '\');">';
                ////var rcs = ['Inform', 'Collaborator', 'Approver'];
                ////var rcs2 = ['Inform (Informed)', 'Collaborator (Consulted)', 'Approver (Accountable)'];
                ////for (var rci = 0; rci < rcs.length; rci++) {
                ////    if (rolecategory == rcs[rci]) {
                ...
                // Render the "RoleCategory" drop-down.
                html += '<td class="steprowcell">';
                html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleCategory" xcx="xcx9934-3" class="rolecategory-dropdown" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'RoleCategoryDropDown_Onchange\', \'' + elementId + '\');">';
                var rcs = ['Inform', 'Collaborator', 'Approver'];
                var rcs2 = ['Inform (Informed)', 'Collaborator (Consulted)', 'Approver (Accountable)'];
                for (var rci = 0; rci < rcs.length; rci++) {
                    if (rolecategory == rcs[rci]) {
            ...
            html += '  <tr>';
            html += '    <td>';
            html += '      <input type="button" style="padding:5px 10px 5px 10px;width:70px;cursor:pointer;" value="Save" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveAssignmentRow\', \'' + elementId + '\');" />';
            html += '    </td>';
            html += '  </tr>';
            if (!isAdmin) { // The ADMIN row/step cannot be deleted.
                html += '  <tr>';
                html += '    <td>';
                html += '      <input type="button" style="padding:5px 10px 5px 10px;width:70px;cursor:pointer;" value="Delete" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deleteRoleCategory\', \'' + elementId + '\');" />';
                html += '    </td>';
                html += '  </tr>';
            }
            html += '  <tr>';
            html += '    <td>';
            html += '      <input type="button" style="padding:5px 10px 5px 10px;width:70px;cursor:pointer;" value="Cancel" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'cancelStepRowEditing\', \'' + elementId + '\');" />';
            html += '    </td>';
            html += '  </tr>';
            //html += '  <tr>';
            //html += '    <td>';
        ...
        try {
            ...
            $.ajax({
                ...
                try {
                    ...
                    html += '    <td></td>';
                    html += '    <td colspan="9">';
                    html += '       <span style="padding: 4px 4px 4px 4px;border:1px solid lightblue;cursor:pointer;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'cmdDisplayDeleteWorkflowsDialog\');">';
                    ...
                    html += '    <td><input type="checkbox" id="checkboxTogglePendingEmailCheckboxes" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'toggleWorkflowConfigurationCheckboxes\', this);" /></td>';
                    ...
                    for (var i = 0; i < workflows.length; i++) {
                        ...
                        var isTheActiveWorkflow = Boolean(workflows[i].bwWorkflowActive);
                        if (workflows[i].bwWorkflowActive == true) {
                        ...
                        if (workflows[i].bwWorkflowActive == true) {
                            html += '       <td class="roleName" style="color:green;">✔ ' + workflows[i].bwWorkflowActive + '</td>';
                        } else {
                            html += '       <td class="roleName" style="color:gray;">' + workflows[i].bwWorkflowActive + '</td>';
                        }
                        ...
                        if (workflows[i].bwWorkflowJson == 'NEEDS_TO_BE_CREATED') {
                            //html += '   <td></td>'; 
                            html += '   <td colspan="2"><input style="padding:5px 10px 5px 10px;width:200px;color:tomato;" type="button" value="CREATE WORKFLOW" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'createNewWorkflowJson\', \'' + workflows[i].bwRequestType + '\');" /></td>';
                        } else {


                            if (workflows[i].bwWorkflowActive == true) {
                                html += '   <td><input style="padding:5px 10px 5px 10px;width:100px;" id="btnActivateRaciConfiguration" type="button" value="De-activate" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayDeactivateSelectedWorkflowDialog\', \'' + workflows[i].bwWorkflowId + '\');" /></td>';
                            } else {
                                html += '   <td><input style="padding:5px 10px 5px 10px;width:100px;" id="btnActivateRaciConfiguration" type="button" value="Activate" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayActivateSelectedWorkflowDialog\', \'' + workflows[i].bwWorkflowId + '\');" /></td>';
                            }




                            html += '   <td><input style="padding:5px 10px 5px 10px;width:100px;" type="button" value="Edit JSON" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayEditWorkflowJsonDialog\', \'' + workflows[i].bwWorkflowId + '\');" /></td>';
                        }
                    ...
                    html += '   </span>';
                    html += '   <br /><br /><br />';
                    html += '   <div class="divSignInButton" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deleteSelectedWorkflows\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
                ...
                console.log('Exception in bwSharePointWorkflowEditor.js.renderWorkflowsDropDownList().xx.Get: ' + JSON.stringify(data));
                displayAlertDialog('Exception in bwSharePointWorkflowEditor.js.renderWorkflowsDropDownList().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
        ...
        try {
            ...
            $("#divDeleteAWorkflowDialog").dialog({
                ...
                open: function () {
                    ...
                    var html = '';
                    html += '        <div id="divDeleteAWorkflowDialogReassignTasks" class="divSignInButton" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deleteWorkflow\', \'' + bwWorkflowId + '\');" style="width:90%;text-align:center;line-height:0.8em;font-weight:bold;">';
                    html += '            Delete';
                    html += '        </div>';
        ...
        try {
            ...
            $('#divActivateSelectedWorkflowDialog').dialog({
                ...
                open: function () {
                    ...
                    var html = '';
                    html += '        <div id="divActivateSelectedWorkflowDialogReassignTasks" class="divSignInButton" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'activateSelectedWorkflow\', \'' + bwWorkflowId + '\', \'' + bwRequestType + '\');" style="width:90%;text-align:center;line-height:0.8em;font-weight:bold;">';
                    html += '            Activate';
                    html += '        </div>';
        ...
        try {
            ...
            $('#divDeactivateSelectedWorkflowDialog').dialog({
                ...
                open: function () {
                    ...
                    var html = '';
                    html += '        <div id="divDeactivateSelectedWorkflowDialogReassignTasks" class="divSignInButton" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'deactivateSelectedWorkflow\', \'' + bwWorkflowId + '\', \'' + bwRequestType + '\');" style="width:90%;text-align:center;line-height:0.8em;font-weight:bold;">';
            ...
            if (confirm("Are you certain you wish to activate this workflow?")) {
                ...
                if (selectedRequestType == bwRequestType) {
                    ...
                    $.ajax({
                        ...
                        try {
                            //debugger;
                            console.log('In bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                            // Display a dialog with an "Undo" button!!!!
                            $("#divUndoWorkflowActivationDialog").dialog({
                                modal: true,
                                resizable: false,
                            ...
                            console.log('Exception in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                            alert('Exception in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                        }
                    }).error(function (data, errorCode, errorMessage) {
                        debugger;
                        //thiz.hideProgress();
                        ...
                        console.log('Fail in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                        alert('Fail in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                        //var error = JSON.parse(data.responseText)["odata.error"];
                        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                    });
    ...
    publishWorkflowConfigurationAndActivate: function () {
        ...
        debugger; // 1-4-2022
        try {
            console.log('In bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().');
            ...
            if (!bwRequestTypeId || (bwRequestTypeId == null)) {
                ...
                $.ajax({
                    ...
                    try {
                                    ...
                                    try {
                                        ...
                                        promise.then(function (result) {
                                            try {
                                                ...
                                                console.log('Exception in bwSharePointWorkflowEditor._create().loadWorkflowsAndCurrentWorkflow(): ' + e.message + ', ' + e.stack);
                                                displayAlertDialog('Exception in bwSharePointWorkflowEditor._create().loadWorkflowsAndCurrentWorkflow(): ' + e.message + ', ' + e.stack);
                                            }
                                        });
                                    } catch (e) {
                                        console.log('Exception in bwSharePointWorkflowEditor._create().loadWorkflowsAndCurrentWorkflow():xcx56: ' + e.message + ', ' + e.stack);
                                        displayAlertDialog('Exception in bwSharePointWorkflowEditor._create().loadWorkflowsAndCurrentWorkflow():xcx56: ' + e.message + ', ' + e.stack);
                                    }
                                },
                                close: function () {
                                    $('#divUndoWorkflowActivationDialog').dialog("destroy");
                        ...
                        console.log('Exception in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + e.message + ', ' + e.stack);
                    }
                    ...
                    console.log('Fail in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                    displayAlertDialog('Fail in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                    //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                    //var error = JSON.parse(data.responseText)["odata.error"];
                    //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                });
            ...
            debugger;
            //thiz.hideProgress();
            console.log('Exception in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointWorkflowEditor.js.publishWorkflowConfigurationAndActivate(): ' + e.message + ', ' + e.stack);
        }
    },
    cancelChangesInDraftWorkflowConfiguration: function () {
        try {
            console.log('In cancelChangesInDraftWorkflowConfiguration().');
            this.options.CurrentWorkflow["Workflow"] = JSON.parse(JSON.stringify(this.options.CurrentWorkflow["DraftWorkflow"])); // Creating "DraftWorkflow" so we can tell if the workflow has been changed or not, and then inform the user that changes need to be published.
        ...
        try {
            ...
            if (thereHaveBeenChangesToTheWorkflow) {
                ...
                if (this.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                    ...
                    html += '<input style="padding:5px 10px 5px 10px;width:100px;" id="btnSaveWorkflowConfigurationAndActivate" type="button" value="Publish" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'publishWorkflowConfigurationAndActivate\');" />';
                    html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCancelChangesInDraftWorkflowConfiguration" type="button" value="Cancel Changes" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'cancelChangesInDraftWorkflowConfiguration\');" />';
                }
    ...
    saveAssignmentRow: function (elementId) {
        try {
            ...
            if (stepIndex && sourceRoleCategory && roleIndex > -1) {
                ...
                //            thiz._create();
                //        } catch (e) {
                //            console.log('Exception in bwSharePointWorkflowEditor.js.saveAssignmentRow().xx.update: ' + e.message + ', ' + e.stack);
                //            alert('Exception in bwSharePointWorkflowEditor.js.saveAssignmentRow().xx.update: ' + e.message + ', ' + e.stack);
                //        }
                //    }).error(function (data, errorCode, errorMessage) {
                //        //thiz.hideProgress();
                //        var msg;
                ...
                //            msg = JSON.stringify(data) + ', json: ' + JSON.stringify(json);
                //        }
                //        console.log('Fail in bwSharePointWorkflowEditor.js.saveAssignmentRow().xx.update: ' + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                //        alert('Fail in bwSharePointWorkflowEditor.js.saveAssignmentRow().xx.update: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                //        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //        //var error = JSON.parse(data.responseText)["odata.error"];
                //        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                //    });
            ...
            alert('Exception in saveAssignmentRow(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    //        //
    //        var html = '';
    //        html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveEmailTemplateForOverdueTasks\', \'' + 'stepName' + '\');">';
    //        html += '☑ Save this email template';
    //        html += '</div>';
    //        document.getElementById('spanConfigureEmailNotificationsDialogSaveButton').innerHTML = html;
    //        // Display the email editor.
    ...
    bwSharePointWorkflowEditor_txtLocationPickerFilter_OnMouseup: function () {
        try {
            console.log('In bwSharePointWorkflowEditor_txtLocationPickerFilter_OnMouseup().');
            var thiz = this;
            ...
            var width1 = $('#bwSharePointWorkflowEditor_txtLocationPickerFilter')[0].style.width;
            var width2 = width1.split('px')[0];
            var width3 = Number(width2) + 50;
            var width = width3; // + 'px';

            $("#bwSharePointWorkflowEditor_divLocationPickerDropDown").dialog({
                position: {
                    my: "left top",
                    at: "left bottom",
                    of: $('#bwSharePointWorkflowEditor_txtLocationPickerFilter')
                },
                modal: true,
                resizable: false,
                closeText: "Cancel",
                ...
                open: function (event, ui) {
                    ...
                    $('.ui-widget-overlay').bind('click', function () {
                        $("#bwSharePointWorkflowEditor_divLocationPickerDropDown").dialog('close');
                    });

                    // Hide the title bar.
                    $("#bwSharePointWorkflowEditor_divLocationPickerDropDown").dialog().parents(".ui-dialog").find(".ui-dialog-titlebar").remove();
                },
                close: function () {
                    try {
                        ...
                        $("#bwSharePointWorkflowEditor_divLocationPickerDropDown").dialog('destroy');
                    } catch (e) {
                        console.log('Exception in bwSharePointWorkflowEditor_txtLocationPickerFilter_OnMouseup.dialog.close():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwSharePointWorkflowEditor_txtLocationPickerFilter_OnMouseup.dialog.close():2: ' + e.message + ', ' + e.stack);
                    }
                }
            ...
            console.log('Exception in bwSharePointWorkflowEditor_txtLocationPickerFilter_OnMouseup(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointWorkflowEditor_txtLocationPickerFilter_OnMouseup(): ' + e.message + ', ' + e.stack);
        }
    },
    bwSharePointWorkflowEditor_txtLocationPickerFilter_OnKeyup: function (elementId) {
        try {
            console.log('In bwSharePointWorkflowEditor_txtLocationPickerFilter_OnKeyup(). elementId: ' + elementId);

            if ($('#bwSharePointWorkflowEditor_divLocationPickerDropDown')[0].style.display == 'none') {
                this.bwSharePointWorkflowEditor_txtLocationPickerFilter_OnMouseup();
            }

        } catch (e) {
            console.log('Exception in bwSharePointWorkflowEditor_txtLocationPickerFilter_OnKeyup(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointWorkflowEditor_txtLocationPickerFilter_OnKeyup(): ' + e.message + ', ' + e.stack);
        }
    },
    bwSharePointWorkflowEditor_SelectADataItem: function (element) {
        try {
            console.log('In bwSharePointWorkflowEditor_SelectADataItem().');

            var selectedDataItem = $(element).html();
            $("#bwSharePointWorkflowEditor_divLocationPickerDropDown").dialog('close');
            $('#bwSharePointWorkflowEditor_txtLocationPickerFilter').val(selectedDataItem);

            //alert('In bwSharePointWorkflowEditor_SelectADataItem(). selectedDataItem: ' + selectedDataItem);
            ...
            console.log('Exception in bwSharePointWorkflowEditor_SelectADataItem(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwSharePointWorkflowEditor_SelectADataItem(): ' + e.message + ', ' + e.stack);
        }
    },
    displayEmailDataItemPickerDialog: function (emailSection) { // emailSection is either 'subject' or 'body'.
        try {
            ...
            //    html += '   <option value="3" onmouseover="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayDataItemHoverDialog\', this);" >' + dataConversionJson[keys[i]].TemplateText + ' xcx1</option>';
            //}
            ...
            //
            html += '<input id="bwSharePointWorkflowEditor_txtLocationPickerFilter" value="Select a data item..." type="text" style="width:450px;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 20pt;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'bwSharePointWorkflowEditor_txtLocationPickerFilter_OnKeyup\', \'txtLocationPickerFilter\');" onmouseup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'bwSharePointWorkflowEditor_txtLocationPickerFilter_OnMouseup\', \'txtLocationPickerFilter\');" />'; //</input>';
            html += '<br />';
            html += '<div id="bwSharePointWorkflowEditor_divLocationPickerDropDown" style="display:none;background-color:white;overflow-x:hidden;">'; // Scrollable div wrapper for the drop-down. // dark blue border. // position and z-index makes it show up on top and to not move the other elements around.
            //html += '   <div value="3">' + 'Select a data item...' + '</div>';
            var keys = Object.keys(dataConversionJson);
            for (var i = 0; i < keys.length; i++) {
                html += '   <div class="dataItemInDropDown" onmouseover="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'showDataItemHoverDialog\', this);" onmouseout="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'hideDataItemHoverDialog\', this);" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'bwSharePointWorkflowEditor_SelectADataItem\', this);" >' + dataConversionJson[keys[i]].TemplateText + ' </div>';
            }
            ...
            html += '</select>';
            html += '&nbsp;&nbsp;';
            html += '<input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'insertEmailDataItem\', \'' + emailSection + '\');" type="button" value="Insert">';
            ...
            alert('Exception in displayEmailDataItemPickerDialog(): ' + e.message + ', ' + e.stack);
        }
    },
    displayWorkflowActionsUnderlyingPropertiesDialog: function (elementId, actionTitle) {
        try {
            ...
            html += '<br />';
            html += '&nbsp;&nbsp;';
            html += '<input style="padding:5px 10px 5px 10px;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'saveWorkflowActionsUnderlyingProperties\', \'' + elementId + '\', \'' + actionTitle + '\');" type="button" value="Save">';
    ...
    insertEmailDataItem: function (emailSection) { // emailSection is either 'subject' or 'body'.
        try {
            ...
            var selectedDataItem = $('#bwSharePointWorkflowEditor_txtLocationPickerFilter').val(); // 4-5-2022
    ...
    //            //html += '           <span class="spanButton" title="Edit email template(s)..." style="padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + stepName + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" Email&nbsp;&nbsp;</span>';
    //            html += '           <span class="spanButton" title="Edit email template(s)..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'editStepEmails\', \'' + stepName + '\', \'' + stepFriendlyName + '\', \'' + instructionText + '\');"><span style="font-size:15pt;display:inline-block;">✉</span> "' + buttonText + '" &nbsp;&nbsp;</span><br /><div style="font-size:8pt;margin-top:10px;">' + instructionText + '</div>';
    //            html += '       </td>';
    //            html += '   </tr>';
    //            //}
    //        }
    ...
    //                    //debugger;
    //                    var html = '';
    //                    html += '<select style="padding:5px 5px 5px 5px;font-size:8pt;" id="workflowsDropDown" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'WorkflowsDropDown_Onchange\');">';
    ...
    //                    msg = JSON.stringify(data);
    //                }
    //                alert('Exception in bwSharePointWorkflowEditor.js.renderWorkflowsDropDownList().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
    //                console.log('Exception in bwSharePointWorkflowEditor.js.renderWorkflowsDropDownList().xx.Get: ' + JSON.stringify(data));
    //                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
    //                //var error = JSON.parse(data.responseText)["odata.error"];
    //                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
    ...
    renderSelectRoleOrPersonSection: function (elementId) {
        try {
            ...
            if (isAdmin) {
                ...
                //html += '<select style="padding:5px 5px 5px 5px;" id="selectRoleName"  onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleName' + '\');">';
                //html += '  <option value=""></option>';
                //for (var i = 0; i < roles.length; i++) {
                ...
                html += '<br />';
                html += '<br />';
                html += 'Instructions for the user. These appear on the request form next to the buttonsxcx1:';
                html += '<br />';
                ...
                $.ajax({
                    ...
                    try {
                        ...
                        //html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayPeoplePickerDialog\', \'' + 'txtRoleMembersFriendlyName_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersId_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersEmail_' + stepIndex + '_' + roleIndex + '' + '\');" src="images/addressbook-icon18x18.png">';
                        ...
                        //            roleMembersHtml += '<span style="cursor:pointer;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'DeleteRoleMember\', \'' + elementId + '\', \'' + result[i].bwParticipantId + '\');">&nbsp;&#128465;</span></li>';
                        //        }
                        ...
                        //html += '<br /><img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" src="images/addressbook-icon18x18.png">';
                        //html == '&nbsp;&nbsp;';
                        //html += '<input id="btnCreateRole1" type="button" value="Select Person..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayPeoplePickerDialog\', \'' + 'txtApprover2FriendlyName' + '\', \'' + 'txtApprover2Id' + '\', \'' + 'txtApprover2Email' + '\');" />';

                        //html += '<br />or add a new person:'; //<br /><input id="textNewRoleId" type="text" style="width:75pt;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'NewRoleTextBox_Onkeyup\', \'' + 'textNewRoleId' + '\');" />';
                        //html += '<br /><input id="btnCreateRole1" type="button" value="Add a Person..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayAddANewPersonDialog\');" />';
                ...
                $.ajax({
                    ...
                    try {
                        ...
                        debugger; // 12-8-2021 <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                        html += 'Role:&nbsp;<select test="xcx1001" style="padding:5px 5px 5px 5px;" id="selectRoleName"  onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'RoleDropDown_Onchange\', \'' + 'selectRoleName' + '\');">';
                        html += '  <option value=""></option>';
                        for (var i = 0; i < roles.length; i++) {
                            if (rolename == roles[i].RoleName) {
                                html += '  <option value="' + roles[i].RoleId + '" selected >' + roles[i].RoleName + '</option>';
                        ...
                        //var xx = $('#' + elementId).find('.rolename');
                        //alert('xcx6694923-2: ' + xx.outerHTML);
                        //debugger;
                        ...
                        //html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCreateRole2" type="button" value="New Role..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayCreateANewRoleDialog\');" />';
                        //html += '<br />';
                        //$.ajax({
                        ...
                        //        html += '<input id="txtRoleMembersEmail_' + stepIndex + '_' + roleIndex + '" style="display:none;" />';
                        //        html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayPeoplePickerDialog\', \'' + 'txtRoleMembersFriendlyName_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersId_' + stepIndex + '_' + roleIndex + '' + '\', \'' + 'txtRoleMembersEmail_' + stepIndex + '_' + roleIndex + '' + '\');" src="images/addressbook-icon18x18.png">';
                        //        html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCreateRole1" type="button" value="New Person..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayAddANewPersonDialog\');" />';
                        //        if (participantId) { // Only display when logged in. We need to do more work here!!
                        //            if (result.length > 0) {
                        //                var roleMembersHtml = '';
                        ...
                        //                    roleMembersHtml += '<span style="cursor:pointer;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'DeleteRoleMember\', \'' + elementId + '\', \'' + result[i].bwParticipantId + '\');">&nbsp;&#128465;</span>';
                        //                    roleMembersHtml += '</li>';
                        //                }
                        //                roleMembersHtml += '</ul></span>';
                        //                html += roleMembersHtml;
            ...
            if (selectedRoleCategory == 'Inform') {
                ...
                for (var i = 0; i < actions.length; i++) {
                    ...
                    if (actions[i] == 'Approve' || actions[i] == 'Revise/Hold') {
                        ...
                        html += '  <input type="checkbox" id="' + checkboxId + '" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'toggleChildCheckbox\', \'' + checkboxId + '\', \'' + childCheckboxId + '\');" />&nbsp;' + actions[i];
                    }
                    html += '  &nbsp;';
                    html += '  <input id="' + childCheckboxId + '" type="checkbox" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'toggleParentCheckbox\', \'' + childCheckboxId + '\', \'' + checkboxId + '\');" />&nbsp;require comments';
                    html += '  &nbsp;<span style="cursor:pointer;" title="Select to configure underlying properties..." onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayWorkflowActionsUnderlyingPropertiesDialog\', \'' + elementId + '\', \'' + actions[i] + '\');">&#8230;</span>'
                    html += '</span>';
                    html += '<br />';
                }
                // end: 4-20-2022
    ...
    renderTimeoutSection: function (elementId) {
        try {
            ...
            if (selectedRoleCategory == 'Inform') {
                ...
                html += '<span style="white-space:nowrap;">Timeout:&nbsp;<input type="text" id="textTimeout" style="width:25px;padding:5px 5px 5px 5px;" onkeyup="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'TimeoutTextBox_Onkeyup\', \'' + 'textTimeout' + '\');" />&nbsp;days</span>';
                timeoutCell.html(html);
            } else if (selectedRoleCategory == 'Approver') {
                timeoutCell.html(html);
            } else {
    ...
    renderConditionsSection: function (elementId, conditionString) {
        try {
            ...
            //}
            //if (isExec && isExec == 'True') {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsExec" type="checkbox" checked onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isExecCondition_CheckChanged\');" />&nbsp;' + 'Exec' + '&nbsp;</span>';
            //} else {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsExec" type="checkbox" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isExecCondition_CheckChanged\');" />&nbsp;' + 'Exec' + '&nbsp;</span>';
            //}
            ...
            //}
            //if (isLegal && isLegal == 'True') {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLegal" type="checkbox" checked onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isLegalCondition_CheckChanged\');" />&nbsp;' + 'Legal' + '&nbsp;</span>';
            //} else {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLegal" type="checkbox" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isLegalCondition_CheckChanged\');" />&nbsp;' + 'Legal' + '&nbsp;</span>';
            //}
            //html += '&nbsp;';
            //// Is Lease
            //if (conditionString) {
            ...
            //}
            //if (isLease && isLease == 'True') {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLease" type="checkbox" checked onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isLeaseCondition_CheckChanged\');" />&nbsp;' + 'Lease' + '&nbsp;</span>';
            //} else {
            //    html += '<span style="white-space:nowrap;"><input id="cbIsLease" type="checkbox" onchange="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isLeaseCondition_CheckChanged\');" />&nbsp;' + 'Lease' + '&nbsp;</span>';
            //}
            //html += '&nbsp;';
            //// Is IT
            //html += '&nbsp;';
            ...
            //html += '<span style="cursor:pointer;color:red;text-decoration:underline;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayOrgMultiPicker\', \'' + this.id + '\');">Location(s)</span>';
            //html += '&nbsp;&nbsp;&nbsp;&nbsp;';
            //html += '<span style="cursor:pointer;color:red;text-decoration:underline;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayProjectTypeMultiPicker\', \'' + this.id + '\');">Functional area(s)</span>';
            //html += '&nbsp;&nbsp;&nbsp;&nbsp;';
            //html += '<span style="cursor:pointer;color:red;text-decoration:underline;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'displayPillarMultiPicker\', \'' + this.id + '\');">Growth</span>';
                ...
                if (this.options.Checklists) {
                    ...
                    for (var i = 0; i < checklists.length; i++) {
                        ...
                        if (conditionString) {
                            ...
                            if (conditionString.indexOf(checklists[i].bwChecklistTemplatesId) > -1) {
                                html += '<input id="' + checklistCheckboxId + '" checked="" type="checkbox" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isChecklistRequired_CheckChanged\', \'' + checklists[i].bwChecklistTemplatesId + '\', \'' + checklistCheckboxId + '\');" />';
                                //html += '<input id="cbChecklistRequired_' + checklists[i].bwChecklistTemplatesId + '" type="checkbox" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isChecklistRequired_CheckChanged\', this);" />';
                                html += '&nbsp;' + checklists[i].Title + '&nbsp;';
                            } else {
                                html += '<input id="' + checklistCheckboxId + '" type="checkbox" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isChecklistRequired_CheckChanged\', \'' + checklists[i].bwChecklistTemplatesId + '\', \'' + checklistCheckboxId + '\');" />';
                                //html += '<input id="cbChecklistRequired_' + checklists[i].bwChecklistTemplatesId + '" type="checkbox" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'isChecklistRequired_CheckChanged\', this);" />';
                                html += '&nbsp;' + checklists[i].Title + '&nbsp;';
                            }
                        } else {
                        ...
                        //html += '<span style="cursor:pointer;" onclick="$(\'.bwSharePointWorkflowEditor\').bwSharePointWorkflowEditor(\'DeleteChecklist\', \'' + elementId + '\', \'' + checklists[i].bwChecklistTemplatesId + '\');">&nbsp;&#128465;</span>';
    ...
    WorkflowRequestTypeDropDown_Onchange: function (elementId) {
        try {
            ...
            try {
                ...
                //alert('Set CurrentWorkflow xcx111774-9');
                //var bwEnabledRequestTypes = $('.bwAuthentication').bwAuthentication('option', 'bwEnabledRequestTypes');
                ...
                //debugger;
                //console.log('In WorkflowRequestTypeDropDown_Onchange(). bwRequestTypeId: ' + bwRequestTypeId);
                //var workflow;
                //for (var i = 0; i < this.options.Workflows.length; i++) {
                //    if ((this.options.Workflows[i].bwRequestTypeId == bwRequestTypeId) && this.options.Workflows[i].bwWorkflowActive == true) {
                //        this.options.CurrentWorkflow = this.options.Workflows[i];
                //        break;
                //    }
                //}
                ////// IF WE cant find it using the .value of the drop down, then try using the .text. A fudge, we need to decide throughout ho to do this but not right now 11-24-2021
                ////if (!this.options.CurrentWorkflow || (this.options.CurrentWorkflow == null)) {
                ////    for (var i = 0; i < this.options.Workflows.length; i++) {
                ////        if (this.options.Workflows[i].bwRequestTypeId == selectedRequestType_text && this.options.Workflows[i].bwWorkflowActive == true) {
                ////            this.options.CurrentWorkflow = this.options.Workflows[i];
                ////            break;
                ////        }
                ////    }
                ...
                //if (this.options.CurrentWorkflow == null) {
                //    var html = '';
                //    //html += 'ERROR: NO ACTIVE WORKFLOW FOUND.';
                //    html += '<span style="color:tomato;">Error: No workflow exists for this Request Type. Create one by customizing this default workflow, and clicking the Publish button.</span>';
                //    //document.getElementById('spanWorkflowEditor_SelectedWorkflow').innerHTML = html; // No place to display this presently so just using an alert.
                //    displayAlertDialog(html);

                //    this.options.CurrentWorkflow = $('.bwAuthentication').bwAuthentication('option', 'bwWorkflowJson_Default');
                //    console.log('In WorkflowRequestTypeDropDown_Onchange(). No workflow exists for this Request Type. Create one by customizing this default workflow, and clicking the Publish button.');
                //    alert('Set CurrentWorkflow xcx111774-10');

                //    // 1-4-2022
                //    this.options.CurrentWorkflow.Workflow = {};
                //    this.options.CurrentWorkflow.DraftWorkflow = JSON.parse(this.options.CurrentWorkflow.bwWorkflowJson);

                //} else {
                //    try {
                //        this.options.CurrentWorkflow.Workflow = JSON.parse(this.options.CurrentWorkflow.bwWorkflowJson); //.Workflow;
                ...
                //    } catch (e) {
                //        console.log('xcx34345645: ' + e.message + ', ' + e.stack);
                //    }
                //}
                this.renderWorkflowEditor2(); // Render the Workflow Editor. 
            } catch (e) {
                console.log('Exception in bwSharePointWorkflowEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
                displayAlertDialog('Exception in bwSharePointWorkflowEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
            }
        } catch (e) {
