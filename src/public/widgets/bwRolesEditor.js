$.widget("bw.bwRolesEditor", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwRolesEditor.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        this.element.addClass("bwRolesEditor");
        ...
        try {
            ...
            thiz.renderRolesEditor();
            //            } catch (e) {
            //                console.log('Exception in bwRolesEditor._create().xx.Get:1: ' + e.message + ', ' + e.stack);
            //            }
            //        },
            //    }).fail(function (data) {
            //        //lpSpinner.Hide();
            ...
            //        }
            //        alert('Exception in bwRolesEditor._create().xx.Get:2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
            //        console.log('Exception in bwRolesEditor._create().xx.Get:2: ' + JSON.stringify(data));
            ...
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwRolesEditor: CANNOT RENDER</span>';
            html += '<br />';
            html += '<span style="">Exception in bwRolesEditor.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    renderRolesEditor: function () {
        try {
            ...
            if (this.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                ...
                //document.getElementById('spanConfigurationParticipantsBwRoleEditor').innerHTML = '<span style="color:tomato">Error: No UI for DisplayAsNewTenantUserConfigurationEditor = true.</span>';
                // Render the RACI role editor.
                $('.bwNewUserRolesEditor').bwNewUserRolesEditor('renderBwNewTenantRolesSettings', 'spanConfigurationParticipantsBwRoleEditor'); // THIS DISPLAYS the roles that are in the JSON org definition. // BwNewTenantRolesSettings
            } else {
                // Render the RACI role editor.
    ...
    //                html += '        <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'.bwRolesEditor\').bwRolesEditor(\'hideParticipantRoleMultiPickerInACircle\');">X</span>';
    //                html += '      </td>';
    //                html += '    </tr>';
    //                html += '  </table>';
    ...
    //                    console.log('CLEAN UP bwRolesEditor! Figure out where the user clicked and respond accordingly. :D');
    ...
    //                        }
    //                        if (isSelected) {
    //                            html += '<td>xcx55<input id="' + 'orgRoleCheckbox_' + w + '" type="checkbox" checked onclick="$(\'.bwRolesEditor\').bwRolesEditor(\'OrgRoleCheckbox_Onchange\', \'' + 'orgRoleCheckbox_' + w + '\', \'' + workflowRoles[w].RoleId + '\', \'' + workflowRoles[w].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" /></td>';
    //                        } else {
    //                            html += '<td>xcx56<input id="' + 'orgRoleCheckbox_' + w + '" type="checkbox" onclick="$(\'.bwRolesEditor\').bwRolesEditor(\'OrgRoleCheckbox_Onchange\', \'' + 'orgRoleCheckbox_' + w + '\', \'' + workflowRoles[w].RoleId + '\', \'' + workflowRoles[w].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" /></td>';
    //                        }
    ...
    displayADMINParticipantInCircleDialog: function () {
        try {
            ...
            if (this.options.store.BwWorkflowUserRoleAdmin && this.options.store.BwWorkflowUserRoleAdmin.length == 1) {
                $('.bwCircleDialog2').bwCircleDialog2('displayParticipantRoleMultiPickerInACircle', true, '', '' + this.options.store.BwWorkflowUserRoleAdmin[0].bwParticipantId + '', '' + this.options.store.BwWorkflowUserRoleAdmin[0].bwParticipantFriendlyName + '', '' + this.options.store.BwWorkflowUserRoleAdmin[0].bwParticipantEmail + '');
            }
    ...
    OrgRoleCheckbox_Onchange: function (checkboxId, roleId, roleName, divisionIndex, groupIndex, entityIndex, locationIndex, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail) {
        try {
            ...
            var thiz = this;
            //alert('In bwRolesEditor.OrgRoleCheckbox_Onchange(). This functionality is IN PROGRESS. Expect unexpected results until testing is complete.');
    ...
    activateOrgRolesConfiguration: function () {
        try {
            alert('In bwRolesEditor.js.activateOrgRolesConfiguration(). Dev note xcx312123 unfinished code...');
    ...
    renderOrgRolesDropDownList: function () {
        try {
            alert('In bwRolesEditor.js.renderOrgRolesDropDownList(). Dev note xcx312123 unfinished code...');
