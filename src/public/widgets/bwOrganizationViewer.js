$.widget("bw.bwOrganizationViewer", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwOrganizationViewer.js jQuery Widget. 
        ===========================================================
        ...
        */
        ...
        //$('#divBwOrganizationViewer').bwOrganizationViewer({});

        RoleAssignments: null, // 5-4-2024. This is how we get the results.results.changedRoleAssignments.removedRoleAssignments[i].RoleName and results.results.changedRoleAssignments.addedRoleAssignments[i].RoleName in the method renderOrgRolesEditor2().
    ...
    _create: function (assignmentRowChanged_ElementId) {
        this.element.addClass("bwOrganizationViewer");
        var thiz = this; // Need this because of the asynchronous operations below.

        try {
            console.log('In bwOrganizationViewer.js._create().');
            //alert('In bwOrganizationViewer.js._create().');
            ...
            if (this.options.store != null) {
                ...
                // 8-17-2022 removed
                this.loadBusinessModelEditor(true);
            ...
            HideActivitySpinner();
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwOrganizationViewer: CANNOT RENDER THE WORKFLOW MATRIX</span>';
            html += '<br />';
            html += '<span style="">Exception in bwOrganizationViewer._create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    loadBusinessModelEditor: function (renderTheOrganizationEditor) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwOrganizationViewer.js.loadBusinessModelEditor().');
                //alert('In bwOrganizationViewer.js.loadBusinessModelEditor().');
                ...
                $.ajax({
                    ...
                    success: function (orcResult) {
                        try {
                            ...
                            $.ajax({
                                ...
                                success: function (result2) {
                                    try {
                                        ...
                                        console.log('xcx212312312 In bwOrganizationViewer.js.loadBusinessModelEditor().');
                                        debugger;
                                        ...
                                        var msg = 'Exception in bwOrganizationViewer._create().Get.WorkflowConfiguration.done(): ' + e.message + ', ' + e.stack;
                                        var result = {
                                            status: 'EXCEPTION',
                                            message: msg
                                        }
                                ...
                                error: function (data) {
                                    ...
                                    var msg = 'Error in bwOrganizationViewer.js.loadBusinessModelEditor.POST.workflowconfiguration(): ' + errorMessage + ', ' + JSON.stringify(data);
                                    var result = {
                                        status: 'ERROR',
                                        message: msg
                                    }
                            ...
                            var msg = 'Exception in bwOrganizationViewer._create().Get.OrgRolesConfiguration.done(): ' + e.message + ', ' + e.stack;
                            var result = {
                                status: 'EXCEPTION',
                                message: msg
                            }
                    ...
                    error: function (data, errorCode, errorMessage) {
                        ...
                        var msg = 'Error in bwOrganizationViewer.js.loadBusinessModelEditor.POST.OrgRolesConfiguration(): ' + errorMessage + ', ' + JSON.stringify(data);
                        var result = {
                            status: 'ERROR',
                            message: msg
                        }
                ...
                var msg = 'Exception in bwOrganizationViewer.js.loadBusinessModelEditor(): ' + e.message + ', ' + e.stack;
                var result = {
                    status: 'EXCEPTION',
                    message: msg
                }
    ...
    renderBusinessModelEditor: function () {
        try {
            console.log('In bwOrganizationViewer.js.renderBusinessModelEditor().');
            ...
            if (!participantId) {
                ...
                // Render the organization editor.
                console.log('In bwOrganizationViewer.js.renderBusinessModelEditor(). Preparing to render the organization editor.');
            ...
            console.log('Exception in bwOrganizationViewer.js.renderBusinessModelEditor(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationViewer.js.renderBusinessModelEditor(): ' + e.message + ', ' + e.stack);
        }
    },

    displayOrgRoleEditorInACircle: function (resetCachedDisplayValues, divisionIndex, groupIndex, entityIndex, locationIndex) {
        try {
            console.log('In bwOrganizationViewer.js.displayOrgRoleEditorInACircle().');
            //alert('In bwOrganizationViewer.js.displayOrgRoleEditorInACircle().');
            var thiz = this;
            ...
            if ((locationIndex || locationIndex > -1) && locationIndex != 'undefined') {
                ...
                orgPathClickable = '<span style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + 'root' + '\');">' + json.Global.Name + '</span>' + ' > ' + '<span style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + divisionIndex + '\');">' + json.Global.Divisions.Items[divisionIndex].Name + '</span>' + ' > ' + '<span style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + divisionIndex + '\', \'' + groupIndex + '\');">' + json.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].Name + '</span>' + ' > ' + '<span style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\');">' + json.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items[entityIndex].Name + '</span>' + ' > ' + json.Global.Divisions.Items[divisionIndex].Groups.Items[groupIndex].LegalEntities.Items[entityIndex].Locations.Items[locationIndex].Name;
                ...
                if (divisionIndex == 'root') {
                    ...
                    orgPathClickable = '<span style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + 'root' + '\');">' + json.Global.Name + '</span>' + ' > ' + json.Global.Divisions.Items[divisionIndex].Name;
                }
            } else {
            ...
            if (this.options.OnResizeDisplayValues && this.options.OnResizeDisplayValues.Html) {
                ...
                if (json.Global) {
                    ...
                    html += '           <span class="dialogXButton" style="font-size:35pt;cursor:pointer;width:100%;font-weight:bold;" onclick="$(\'.bwCircleDialog\').bwCircleDialog(\'hideCircleDialog\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');">X</span>';
                    html += '       </td>';
                    html += '   </tr>';
                    html += '</table>';
                        ...
                        for (var r = 0; r < roles.length; r++) {
                            if (roles[r].ParticipantIsDirty == true && roles[r].ParticipantIsDirtyAction == 'REMOVE') {
                                ...
                                if (roles[r].RoleId == 'ADMIN') {
                                    ...
                                    var isBusinessModelEditorVisible = $('.bwOrganizationViewer').is(':visible');
                                    if (isBusinessModelEditorVisible) {
                                        // Only show the people picker dialog for the business model editor.
                                        selectedRolesHtml += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayPeoplePickerDialogForJson\', \'' + roles[r].RoleId + '\', \'' + roles[r].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" src="images/addressbook-icon18x18.png">';
                                    }
                    ...
                    $.ajax({
                        ...
                        success: function (result3) {
                            try {
                                ...
                                if (workflowRoles.length) {
                                    ...
                                    for (var w = 0; w < workflowRoles.length; w++) {
                                        ...
                                        if (workflowRoles[w].RoleId == 'ADMIN') {
                                            ...
                                            if (isSelected) {
                                                html += '<td><input id="' + 'orgRoleCheckbox_' + w + '" type="checkbox" checked onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'OrgRoleCheckbox_Onchange\', \'' + 'orgRoleCheckbox_' + w + '\', \'' + workflowRoles[w].RoleId + '\', \'' + workflowRoles[w].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" /></td>';
                                            } else {
                                                html += '<td><input id="' + 'orgRoleCheckbox_' + w + '" type="checkbox" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'OrgRoleCheckbox_Onchange\', \'' + 'orgRoleCheckbox_' + w + '\', \'' + workflowRoles[w].RoleId + '\', \'' + workflowRoles[w].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" /></td>';
                                            }
                                ...
                                console.log('Exception in bwOrganizationViewer.js.displayOrgRoleEditorInACircle().Get[odata/Orgs].done: ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwOrganizationViewer.js.displayOrgRoleEditorInACircle().Get[odata/Orgs].done: ' + e.message + ', ' + e.stack);
                            }
                    ...
                    console.log('Error in bwOrganizationViewer.js.displayOrgRoleEditorInACircle(). Unexpected empty value for this.options.store.');
                    displayAlertDialog('Error in bwOrganizationViewer.js.displayOrgRoleEditorInACircle(). Unexpected empty value for this.options.store.');

                }
            }
        } catch (e) {
            console.log('Exception in bwOrganizationViewer.displayOrgRoleEditorInACircle(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationViewer.displayOrgRoleEditorInACircle(): ' + e.message + ', ' + e.stack);
        }
    },

    renderTreeviewWithNewJson: function () {
        try {
            console.log('In bwOrganizationViewer.js.renderTreeviewWithNewJson().');
            debugger;
            ...
            var instance = $('#divConfigureBusinessModelNotificationsDialog2-1').find('.bwOrganizationViewer')[0]; //.innerHTML;
            ...
            console.log('Exception in bwOrganizationViewer.js.renderTreeviewWithNewJson(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationViewer.js.renderTreeviewWithNewJson(): ' + e.message + ', ' + e.stack);
        }
    },
    getDatastore: function () {
        try {
            console.log('In bwOrganizationViewer.js.getDatastore().');
            //debugger;
            ...
            //                } catch (e) {
            //                    //lpSpinner.Hide();
            //                    console.log('Exception in bwOrganizationViewer.getDatastore().xx.Get:1: ' + e.message + ', ' + e.stack);
            //                }
            //            }).fail(function (data) {
            //                //lpSpinner.Hide();
            //                debugger;
            ...
            //                }
            //                alert('Exception in bwOrganizationViewer._create().xx.Get:2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
            //                console.log('Exception in bwOrganizationViewer._create().xx.Get:2: ' + JSON.stringify(data));
            ...
            //            msg = JSON.stringify(data);
            //        }
            //        alert('Exception in bwOrganizationViewer.getDatastore().xx.Get:2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
            //        console.log('Exception in bwOrganizationViewer.getDatastore().xx.Get:2: ' + JSON.stringify(data));
            //        //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
            //        //var error = JSON.parse(data.responseText)["odata.error"];
            //        //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            //    });
    ...
    renderOrgRolesEditor: function (assignmentRowChanged_ElementId) {
        try {
            console.log('In bwOrganizationViewer.js.renderOrgRolesEditor().');
            ...
            html += '  <br />';
            html += '  <br />';
            html += '  <div id="btnRunDiagnostics" class="divDialogButton" title="Click here to run diagnostics..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'runJsonDiagnostics\');">';
            ...
            //html += '   <select style="padding:5px 5px 5px 5px;" id="selectOrganizationalStructure" onchange="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'selectOrganizationalStructure_OnChange\', \'viewing\');">';
            ...
            //    html += '  </td>';
            //    html += '  <td>';
            //    html += '    <input style="padding:5px 10px 5px 10px;width:100px;" id="btnActivateOrgRolesConfiguration" type="button" value="  Activatex doesntwork  " onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'activateOrgRolesConfiguration\');" disabled />';
    ...
    expandOrCollapseAllWorkflowSteps: function () {
        try {
            console.log('In bwOrganizationViewer.js.expandOrCollapseAllWorkflowSteps().');
    ...
    renderOrgRolesEditor2: function (headerHtml, assignmentRowChanged_ElementId) {
        try {
            console.log('In bwOrganizationViewer.js.renderOrgRolesEditor2().');
            //alert('In bwOrganizationViewer.js.renderOrgRolesEditor2().');
            var thiz = this;
            ...
            var canvas = document.getElementById(thiz.options.canvasElementId);
            if (!canvas) {
                console.log('In bwOrganizationViewer.js.renderOrgRolesEditor2(). Adding the canvas element to the dom.');
            ...
            //html += '<div style="display:none;" id="bwOrganizationViewer_divUndoOrgRolesActivationDialog">';
            //html += '  <table style="width:100%;">';
            //html += '    <tr>';
            //html += '      <td style="width:90%;">';
            ...
            //html += '      <td style="width:9%;"></td>';
            //html += '      <td style="width:1%;cursor:pointer;vertical-align:top;">';
            //html += '        <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'#bwOrganizationViewer_divUndoOrgRolesActivationDialog\').dialog(\'close\');">X</span>';
            //html += '      </td>';
            //html += '    </tr>';
            //html += '  </table>';
            //html += '  <br /><br />';
            ...
            var newOrgId = this.options.RoleAssignments.newOrgId;
            var originalOrgId = this.options.RoleAssignments.originalOrgId;

            var selectedOrgIds = [];
            selectedOrgIds.push(newOrgId);
            selectedOrgIds.push(originalOrgId);

            var msg = 'In bwOrganizationViewer.js. newOrgId: ' + newOrgId + ', originalOrgId: ' + originalOrgId;
            console.log(msg);
            ...
            html += '                                   <span id="spanOrgX_root" class="orgTreeNode" style="cursor:pointer;white-space:nowrap;" onclick="window.scrollTo(0, 0);$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + 'root' + '\');" onmouseover="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflow\', true, \'root\');" onmouseout="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflowReset\', \'' + 'spanOrgX_root\', \'root\');">';
            ...
            //debugger;
            //alert('xcx23123 json.Global.Id: ' + json.Global.Id);
            if (selectedOrgIds.indexOf(json.Global.Id) > -1) {
                html += '&nbsp;&nbsp;</span><span class="selectedOrg" style="font-size:15pt;white-space:nowrap;">' + json.Global.Name + '</span> ';
            } else {
            ...
            html += '<td>';
            // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
            html += '                               <span id="spanDivisionsTreeExpandCollapseButton" style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseOrExpandTree\', \'\', \'spanDivisionsTreeExpandCollapseButton\', \'root\');">';
            //html += '                               ⚊ ';
            html += '                               <img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png"> ';
            html += '                               </span>';
            html += '                               <span id="spanOrgX_' + d + '_' + 'GroupsNode' + '" class="orgTreeNode" style="cursor:pointer;font-weight:bold;" title="Collapse..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseTree\', \'\', \'' + '' + '\');" onmouseout="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflowReset\', \'' + 'spanOrgX_' + d + '_' + 'GroupsNode' + '\', \'' + '' + '\', \'' + 'GroupsNode' + '\');" onmouseover="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflow\', true, \'' + '' + '\', \'' + 'GroupsNode' + '\');">';
            //html += '                               ◍ Divisions ◍  ';
            html += '                               Divisions &nbsp;&nbsp; ';
            html += '                               </span>';
            //html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;text-decoration:underline;" title="Add a Division..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'addADivision\', \'' + '' + '\', \'' + '' + '\', \'' + '' + '\', \'' + '' + '\');">';
            //html += '                               ✚ New';
            //html += '                               </span>';
            html += '</td>';
            html += '</tr>';
            ...
            for (var d = 0; d < json.Global.Divisions.Items.length; d++) {
                ...
                html += '<span id="spanDivisionTreeExpandCollapseButton_' + d + '" style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseOrExpandTree\', \'\', \'spanDivisionTreeExpandCollapseButton_' + d + '\', \'' + d + '\');">';
                //html += '⚊';
                html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png">';
                html += '</span>';

                html += ' <span id="spanOrgX_' + d + '" class="orgTreeNode" style="cursor:pointer;white-space:nowrap;" onclick="window.scrollTo(0, 0);$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + d + '\');" onmouseover="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflow\', true, \'' + d + '\');" onmouseout="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflowReset\', \'' + 'spanOrgX_' + d + '\', \'' + d + '\');">';
                ...
                if (selectedOrgIds.indexOf(json.Global.Divisions.Items[d].Id) > -1) {
                    html += '&nbsp;&nbsp;</span><span class="selectedOrg" style="font-size:15pt;white-space:nowrap;">' + json.Global.Divisions.Items[d].Name + '</span> ';
                } else {
                    html += '&nbsp;&nbsp;</span><span style="font-size:15pt;white-space:nowrap;">' + json.Global.Divisions.Items[d].Name + '</span> ';
                }

                //html += '    ' + json.Global.Divisions.Items[d].Name + '  '; // replaced 5-5-2024.
                html += '</span>';
                ...
                if (json.Global.Divisions.Items[d].Groups.Style == 'display:none;') {
                    html += '                       <tr>';
                    html += '                           <td>';
                    html += '                               <span style="cursor:pointer;font-weight:bold;" title="Collapse..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'expandTree\', \'' + d + '\');">';
                    html += '✚ ✣ Groups ✣  </span>';
                    //html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;text-decoration:underline;" title="Add a Group..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'addAGroup\', \'' + json.Global.Divisions.Items[d].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');"> ✚ Add</span>';
                    html += '                           </td>';
                    html += '                       </tr>';
                } else {
                    html += '                       <tr>';
                    ...
                    // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                    html += '                               <span id="spanGroupsTreeExpandCollapseButton_' + d + '" style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseOrExpandTree\', \'groupsnode\', \'spanGroupsTreeExpandCollapseButton_' + d + '\', \'' + d + '\');">';
                    //html += '                               ⚊ ';
                    html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" />';
                    html += '                               </span>';
                    //html += '                               <span id="spanOrgX_' + d + '_' + 'GroupsNode' + '" class="orgTreeNode" style="cursor:pointer;font-weight:bold;" title="Collapse..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseTree\', \'\', \'' + d + '\');" onmouseout="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflowReset\', \'' + 'spanOrgX_' + d + '_' + 'GroupsNode' + '\', \'' + d + '\', \'' + 'GroupsNode' + '\');" onmouseover="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflow\', true, \'' + d + '\', \'' + 'GroupsNode' + '\');">';
                    html += '                               <span id="spanOrgX_' + d + '_' + 'GroupsNode' + '" class="orgTreeNode" style="cursor:pointer;font-weight:bold;" title="Collapse..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseTree\', \'\', \'' + d + '\');" >';

                    html += 'Groups  &nbsp;&nbsp; ';
                    html += '                               </span>';
                    //html += '                               <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;text-decoration:underline;" title="Add a Group..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'addAGroup\', \'' + json.Global.Divisions.Items[d].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                    //html += '                               ✚ New';
                    //html += '                               </span>';
                    ...
                    for (var g = 0; g < json.Global.Divisions.Items[d].Groups.Items.length; g++) {
                        ...
                        html += '                               <span id="spanGroupTreeExpandCollapseButton_' + d + '_' + g + '" style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseOrExpandTree\', \'\', \'spanGroupTreeExpandCollapseButton_' + d + '_' + g + '\', \'' + d + '\', \'' + g + '\');">';
                        html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" />';
                        html += '                               </span>';
                        ...
                        html += '                                   <span id="spanOrgX_' + d + '_' + g + '" class="orgTreeNode" style="cursor:pointer;" onclick="window.scrollTo(0, 0);$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + d + '\', \'' + g + '\');" onmouseover="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflow\', true, \'' + d + '\', \'' + g + '\');" onmouseout="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflowReset\', \'' + 'spanOrgX_' + d + '_' + g + '\', \'' + d + '\', \'' + g + '\');">';
                        ...
                        if (selectedOrgIds.indexOf(json.Global.Divisions.Items[d].Groups.Items[g].Id) > -1) {
                            html += '&nbsp;&nbsp;</span><span class="selectedOrg" style="font-size:15pt;white-space:nowrap;">' + json.Global.Divisions.Items[d].Groups.Items[g].Name + '</span> ';
                        } else {
                            html += '&nbsp;&nbsp;</span><span style="font-size:15pt;white-space:nowrap;">' + json.Global.Divisions.Items[d].Groups.Items[g].Name + '</span> ';
                        }

                        //html += '&nbsp;' + json.Global.Divisions.Items[d].Groups.Items[g].Name + ''; // Replaced 5-5-2024.





                        //html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'editGroup\', \'' + d + '\', \'' + g + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                        //html == '  <br />';
                        //html += '                                       <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgEditorInACircle\', \'' + d + '\', \'' + g + '\');">👤👤🔍';
                        ...
                        if (json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Style == 'display:none;') {
                            html += '                               <tr>';
                            html += '                                   <td>';
                            html += '                               <span style="cursor:pointer;font-weight:bold;white-space:nowrap;" title="Collapse..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'expandTree\', \'' + d + '\', \'' + g + '\');">';
                            html += '✚ ⚖ Legal Entities  </span>';
                            //html += '                                       <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;text-decoration:underline;" title="Add a Legal Entity..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'addALegalEntity\', \'' + json.Global.Divisions.Items[d].Groups.Items[g].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');"> ✚ New</span>';
                            html += '                                   </td>';
                            html += '                               </tr>';
                        } else {
                            html += '                               <tr>';
                            html += '                                   <td style="white-space:nowrap;font-weight:bold;">';
                            html += '                                       <span id="spanLegalEntitiesTreeExpandCollapseButton_' + d + '_' + g + '" style="cursor:pointer;font-weight:bold;white-space:nowrap;" title="Collapse..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseOrExpandTree\', \'legalentitiesnode\', \'spanLegalEntitiesTreeExpandCollapseButton_' + d + '_' + g + '\', \'' + d + '\', \'' + g + '\');">';
                            //html += '                                       ⚊ ';
                            html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png">';
                            html += '                                       </span>';
                            html += 'Legal Entities &nbsp;&nbsp; ';
                            ...
                            for (var e = 0; e < json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items.length; e++) {
                                ...
                                // new 3-7-2020
                                html += '                               <span id="spanGroupsTreeExpandCollapseButton_' + d + '_' + g + '_' + e + '" style="cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseOrExpandTree\', \'\', \'spanGroupsTreeExpandCollapseButton_' + d + '_' + g + '_' + e + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                                //html += '                               ⚊ ';
                                html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" />';
                                html += '                               </span>';
                                ...
                                html += '   <span id="spanOrgX_' + d + '_' + g + '_' + e + '" class="orgTreeNode" style="cursor:pointer;color:#29685F;white-space:nowrap;" onclick="window.scrollTo(0, 0);$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + d + '\', \'' + g + '\', \'' + e + '\');" onmouseover="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflow\', true, \'' + d + '\', \'' + g + '\', \'' + e + '\');" onmouseout="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflowReset\', \'' + 'spanOrgX_' + d + '_' + g + '_' + e + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                                ...
                                if (selectedOrgIds.indexOf(json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Id) > -1) {
                                    html += '&nbsp;&nbsp;</span><span class="selectedOrg" style="font-size:15pt;white-space:nowrap;">' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Name + '</span> ';
                                } else {
                                    html += '&nbsp;&nbsp;</span><span style="font-size:15pt;white-space:nowrap;">' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Name + '</span> ';
                                }

                                //html += '&nbsp;' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Name + ''; // Replaced 5-5-2024.

                                //html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'editLegalEntity\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                                //html == '  <br />';
                                //html += '       <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgEditorInACircle\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">👤👤🔍</span>';
                                ...
                                if (json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Locations.Style == 'display:none;') {
                                    html += '                                   <tr>';
                                    html += '                                       <td>';
                                    html += '                               <span style="cursor:pointer;font-weight:bold;" title="Expand Locations" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'expandTree\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                                    html += ' ✚ 🏠 Locations </span>';
                                    //html += '                                           <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Add a Location..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'addALocation\', \'' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">✚ New</span>';
                                    html += '                                       </td>';
                                    html += '                                   </tr>';
                                } else {
                                    html += '                                   <tr>';
                                    html += '                                       <td style="padding-left:45px;white-space:nowrap;">';
                                    html += '                               <span style="cursor:pointer;font-weight:bold;" title="Collapse Locations" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'collapseTree\', \'\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">';
                                    //html += '<img title="collapse" style="cursor:pointer;width:23px;height:23px;vertical-align:middle;" src="images/drawer-close.png" />';
                                    html += 'Locations &nbsp;&nbsp; </span>';
                                    //html += '                                           <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" title="Add a Location..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'addALocation\', \'' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Id + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\');">✚ New</span>';
                                    html += '                                       </td>';
                                    ...
                                    for (var l = 0; l < json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Locations.Items.length; l++) {
                                        ...
                                        html += '                                   <span id="spanOrgX_' + d + '_' + g + '_' + e + '_' + l + '" class="orgTreeNode" style="cursor:pointer;white-space:nowrap;" onclick="window.scrollTo(0, 0);$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayOrgRoleEditorInACircle\', true, \'' + d + '\', \'' + g + '\', \'' + e + '\', \'' + l + '\');" onmouseover="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflow\', true, \'' + d + '\', \'' + g + '\', \'' + e + '\', \'' + l + '\');" onmouseout="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderOrgRoleConnectorsToWorkflowReset\', \'' + 'spanOrgX_' + d + '_' + g + '_' + e + '_' + l + '\', \'' + d + '\', \'' + g + '\', \'' + e + '\', \'' + l + '\');">';
                                        ...
                                        if (selectedOrgIds.indexOf(json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Locations.Items[l].Id) > -1) {
                                            html += '&nbsp;&nbsp;</span><span class="selectedOrg" style="font-size:15pt;white-space:nowrap;">' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Locations.Items[l].Name + '</span> ';
                                        } else {
                                            html += '&nbsp;&nbsp;</span><span style="font-size:15pt;white-space:nowrap;">' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Locations.Items[l].Name + '</span> ';
                                        }

                                        //html += '&nbsp;' + json.Global.Divisions.Items[d].Groups.Items[g].LegalEntities.Items[e].Locations.Items[l].Name; // Replaced 5-5-2024.
                                        //html += ' 🏠 ';
            ...
            if (thiz.options.displayWorkflowPicker) {
                ...
                html += '   <input type="radio" id="selectOrganizationWorkflowOrRolesView_RolesAndParticipants" name="selectOrganizationWorkflowOrRolesView" onchange="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'selectOrganizationWorkflowOrRolesView_Onchange\');" />&nbsp;Roles and Participants';
                html += '   &nbsp;&nbsp';
                html += '   <input type="radio" id="selectOrganizationWorkflowOrRolesView_Workflow" name="selectOrganizationWorkflowOrRolesView" checked onchange="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'selectOrganizationWorkflowOrRolesView_Onchange\');" />&nbsp;Workflows      ';
                ...
                //    html += '   <select id="selectRequestTypeDropDown" onchange="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'WorkflowRequestTypeDropDown_Onchange\');" style=\'display:inline;border-color: whitesmoke; color: grey; font-family: "Segoe UI Light","Segoe UI","Segoe",Tahoma,Helvetica,Arial,sans-serif; font-size: 14pt; font-weight: bold; cursor: pointer;\'>'; // was .5em
            ...
            if (thiz.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                ...
                //debugger;
                console.log('In bwOrganizationViewer.js.xx(). DISPLAYING JSON!!!xcx1');
                                    ...
                                    img.onload = function (e) {
                                        try {
                                            ...
                                            try {
                                                ...
                                                //console.log('Exception in bwOrganizationViewer.js.renderOrgRolesEditor(): span tag with id="' + orgsImageFetchingInformation[i].spanOrgId + '" does not exist! ' + e.message + ', ' + e.stack);
                                                resolve();
                                            }

                                        } catch (e) {
                                            console.log('Exception in bwOrganizationViewer.js.xx-1().img.onload(): ' + e.message + ', ' + e.stack);
            ...
            if (thiz.options.DisplayAsNewTenantUserConfigurationEditor != true) {
                ...
                try {
                    ...
                    console.log('Caught Exception in bwOrganizationViewer.js.renderOrgRolesEditor2(). bwLocationPicker.js may not have loaded yet.. race condition perhaps. ');
                    alert('Caught Exception in bwOrganizationViewer.js.renderOrgRolesEditor2(). bwLocationPicker.js may not have loaded yet.. race condition perhaps. ');
                }
            }
                    ...
                    $.contextMenu({
                        ...
                        callback: function (key, options) {
                            ...
                            if (key == 'viewtrashbincontents') {
                                ...
                                // 8-19-2022
                                //$('.bwOrganizationViewerAdmin').bwOrganizationViewerAdmin('displayConfigureOrganizationJsonDialog');
            ...
            console.log('Exception in bwOrganizationViewer.js.renderOrgRolesEditor2(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationViewer.js.renderOrgRolesEditor2(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    cmdCreateJsonFromSqlServerData: function (orgs) {
        try {
            console.log('In bwOrganizationViewer.js.cmdCreateJsonFromSqlServerData().');
    ...
    cmdImportOrganizationFromSqlServer: function () {
        try {
            console.log('In bwOrganizationViewer.js.cmdConnectToSqlServer().');
            var thiz = this;
            //debugger;
            var data = [];
            data = {
    ...
    displayConfigureOrganizationJsonDialog: function (stepName) {
        try {
            console.log('In bwOrganizationViewer.js.displayConfigureOrganizationJsonDialog().');
            var thiz = this;
            ...
            html += '           <td style="width:9%;"></td>';
            html += '           <td style="width:1%;cursor:pointer;vertical-align:top;">';
            html += '               <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'#bwOrganizationViewer_AdminDialog\').dialog(\'close\');">X</span>';
            html += '           </td>';
            html += '       </tr>';
            html += '   </table>';
            html += '   <input type="text" autofocus="true" style="display:none;" /> <!-- This is here to prevent the first visible field from getting the cursor and showing the keyboard. -->';
            ...
            if (developerModeEnabled == true) {
                ...
                html += '       <input type="button" id="btnConnectToSqlServer" value="Step 1: Import Your Organization from Sql Server" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'cmdImportOrganizationFromSqlServer\');" style="cursor:pointer;padding:5px 10px 5px 10px;" />';
                html += '    </td>';
                html += '  </tr>';
                html += '</table>';
                ...
                html += '  <tr>';
                html += '    <td class="bwChartCalculatorLightCurrencyTableCell">';
                html += '       <input type="button" id="btnConnectToSqlServer" value="Step 2: Import Your Org Roles/Participants from Sql Server" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'cmdImportOrgRolesParticipantsFromSqlServer\');" style="cursor:pointer;padding:5px 10px 5px 10px;" />';
                html += '    </td>';
                html += '  </tr>';
                html += '</table>';
            ...
            html += '  </td>';
            html += '  <td>';
            //html += '    <span onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'renderTreeviewWithNewJson\');" style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;">RE-RENDER</span>';
            html += '  </td>';
            html += '</tr>';
            html += '</table>';

            html += '   <br />';
            html += '   <span id="bwOrganizationViewer_AdminDialog_DialogContent2">[bwOrganizationViewer_AdminDialog_DialogContent2]</span>';
            html += '   <br />';
            html += '   <br />';
            //html += '</div>';


            // 8-19-2022 Rename divConfigureBusinessModelNotificationsDialog2-1 to bwOrganizationViewer_AdminDialog

            var div = document.getElementById('bwOrganizationViewer_AdminDialog');
            if (!div) { // for some reason this gets added twice to the DOM. Figure this out someday, but for now this seems to fix it and is a good safety I suppose.
                div = document.createElement('div');
                div.id = 'bwOrganizationViewer_AdminDialog';
                div.style.display = 'none';
                document.body.appendChild(div); // to place at end of document
            }
            div.innerHTML = html;

            $("#bwOrganizationViewer_AdminDialog").dialog({
                modal: false,
                resizable: false,
                ...
                open: function () {
                    try {
                        ...
                        console.log('xcx123488 Instantiating widget bwOrganizationViewerAdmin.js in element [bwOrganizationViewer_AdminDialog_DialogContent2]');
                        ...
                        var $bworgroleseditor = $("#bwOrganizationViewer_AdminDialog_DialogContent2").bwOrganizationViewerAdmin(options); // spanConfigureOrganizationJsonDialogContent

                    } catch (e) {
                        console.log('Exception in bwOrganizationViewer.js.displayConfigureOrganizationJsonDialog.bwOrganizationViewer_AdminDialog.open(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwOrganizationViewer.js.displayConfigureOrganizationJsonDialog.bwOrganizationViewer_AdminDialog.open(): ' + e.message + ', ' + e.stack);
                    }
                },
                close: function () {
                    $('#bwOrganizationViewer_AdminDialog').dialog('destroy');
                }
            ...
            console.log('Exception in bwOrganizationViewer.js.displayConfigureOrganizationJsonDialog(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationViewer.js.displayConfigureOrganizationJsonDialog(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    downloadOrganizationJson: function () {
        try {
            console.log('In bwOrganizationViewer.js.downloadOrganizationJson().');
            var thiz = this;
    ...
    editOrganizationJson: function () {
        try {
            console.log('In bwOrganizationViewer.js.editOrganizationJson().');
            var thiz = this;
            ...
            $('#divDisplayJsonDialogForBusinessModelEditor_' + this.options.elementIdSuffix).dialog({
                ...
                open: function (event, ui) {
                    try {
                        console.log('In bwOrganizationViewer.js.editOrganizationJson.divDisplayJsonDialogForBusinessModelEditor_' + thiz.options.elementIdSuffix + '.dialog.open().');
                        ...
                        //                        //$("#divbwOrganizationViewer").bwOrganizationViewer('loadAndRenderBusinessModelEditor'); // This forces the widget to call the webservice and get new OrgRoles data.
            ...
            console.log('Exception in bwOrganizationViewer.js.editOrganizationJson(): ' + e.message + ', ' + e.stack);
            this.displayAlertDialog('Exception in bwOrganizationViewer.js.editOrganizationJson(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    runJsonDiagnostics: function () {
        try {
            // "Run Diagnostics" button.
            console.log('In bwOrganizationViewer.js.runJsonDiagnostics().');
            var thiz = this;
            ...
            $.ajax({
                ...
                try {
                    ...
                    console.log('Exception in bwOrganizationViewer.runJsonDiagnostics():1: ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwOrganizationViewer.runJsonDiagnostics():1: ' + e.message + ', ' + e.stack);
                }
            }).fail(function (data) {
                ...
                alert('.fail() in bwOrganizationViewer.runJsonDiagnostics():2: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                console.log('.fail() in bwOrganizationViewer.runJsonDiagnostics():2: ' + JSON.stringify(data));
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
            ...
            console.log('Exception in bwOrganizationViewer.runJsonDiagnostics(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    expandOrCollapseWorkflowStep: function (rowId, imageId, collapsibleRowId) { // collapsibleRowId = steprow-' + stepName.toLowerCase() + '_' + i + '_' + '0'
        try {
            console.log('In bwOrganizationViewer.js.expandOrCollapseWorkflowStep(' + rowId + ', ' + imageId + ', ' + collapsibleRowId + ').');
    ...
    renderWorkflowPeoplePicker: function (tagName) {
        ...
        try {
            console.log('In bwOrganizationViewer.js.renderWorkflowPeoplePicker().');
            var thiz = this;
            ...
            if (!thiz.options.CurrentWorkflow) {
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            if (results.status != 'SUCCESS') {
                                ...
                                var msg = 'Error in bwOrganizationViewer.js.renderWorkflowPeoplePicker(). ' + results.status + ', ' + results.message;
                                console.log(msg);
                                displayAlertDialog(msg);
                                ...
                                if (car == null) {
                                    ...
                                    if (!car.Workflow) {
                                        ...
                                        html += '                       <span title="Expand or Collapse ALL..." onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'expandOrCollapseAllWorkflowSteps\');" style="width:200px;padding:5px 10px 5px 10px;margin:0 0 0 20px;white-space:nowrap;vertical-align:top;border:1px solid lightblue;cursor:pointer;font-weight:normal;font-size:20pt;">';
                                        ...
                                        for (var i = 0; i < car.Workflow.Steps.Step.length; i++) {
                                            ...
                                            if (false) {
                                                ...
                                                if (stepName != 'Create' && stepName != 'Revise' && stepName != 'Admin') {
                                                    ...
                                                    html += '<tr id="stepheaderrow_' + i + '" style="border:0px;cursor:pointer;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'expandOrCollapseWorkflowStep\', \'' + 'stepname_' + i + '\', \'' + 'stepimage_' + i + '\', \'steprow-' + stepName.toLowerCase() + '_' + i + '_' + '0' + '\');">';
                            ...
                            HideActivitySpinner();
                            var msg = 'Exception in bwOrganizationViewer.js.renderWorkflowPeoplePicker.get.racirolesandparticipants.success(): ' + e.message + ', ' + e.stack;
                            console.log(msg);
                            displayAlertDialog(msg);
                    ...
                    error: function (data, errorCode, errorMessage) {
                        HideActivitySpinner();
                        var msg = 'Error in bwOrganizationViewer.js.renderWorkflowPeoplePicker.racirolesandparticipants.error(): ' + errorMessage + ', data: ' + JSON.stringify(data);
                        console.log(msg);
                        displayAlertDialog(msg);
                    }
                });
            ...
            HideActivitySpinner();
            var msg = 'Exception in bwOrganizationViewer.js.renderWorkflowPeoplePicker(): ' + e.mesage + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    selectOrganizationWorkflowOrRolesView_Onchange: function () {
        try {
            console.log('In bwOrganizationViewer.js.selectOrganizationWorkflowOrRolesView_Onchange().');
            ...
            if (document.getElementById('selectOrganizationWorkflowOrRolesView_Workflow').checked == true) {
                ...
                alert('In bwOrganizationViewer.js.selectOrganizationWorkflowOrRolesView_Onchange(). Unexpected value for radio buttons.');

            }

        } catch (e) {
            console.log('Exception in bwOrganizationViewer.js.selectOrganizationWorkflowOrRolesView_Onchange(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationViewer.js.selectOrganizationWorkflowOrRolesView_Onchange(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    //                    } catch (e) {
    //                        //lpSpinner.Hide();
    //                        console.log('Exception in bwOrganizationViewer._create().xx.Get:1: ' + e.message + ', ' + e.stack);
    //                    }
    //                }).fail(function (data) {
    //                    //lpSpinner.Hide();
    //                    debugger;
    ...
    renderRolesPeoplePicker: function (tagName) {
        try {
            console.log('In bwOrganizationViewer.js.renderRolesPeoplePicker(). This is displayed to the right of the treeview when "Roles and Participants" is selected from the drop down. tagName: ' + tagName);
            //alert('In bwOrganizationViewer.js.renderRolesPeoplePicker(). This is displayed to the right of the treeview when "Roles and Participants" is selected from the drop down. tagName: ' + tagName);
            var thiz = this;
                    ...
                    try {
                        ...
                        if (result.status != 'SUCCESS') {
                            ...
                            $.ajax({
                                ...
                                error: function (data, errorCode, errorMessage) {
                                    console.log('Error in bwOrganizationViewer.js.renderRolesPeoplePicker(). ' + errorCode + ', ' + errorMessage + ', ' + JSON.stringify(data));
                                    displayAlertDialog('Error in bwOrganizationViewer.js.renderRolesPeoplePicker(). ' + errorCode + ', ' + errorMessage + ', ' + JSON.stringify(data));
                                }
                        ...
                        console.log('Exception in bwOrganizationViewer.js.renderRolesPeoplePicker(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwOrganizationViewer.js.renderRolesPeoplePicker(): ' + e.message + ', ' + e.stack);
                    }
                        ...
                        for (var i = 0; i < roles.length; i++) {
                            ...
                            if (!drewALineForThisRole) {
                                ...
                                if (roles[i].RoleId != 'ADMIN') {
                                    ...
                                    console.log('Error in bwOrganizationViewer.drawLineFromOrgToWorkflowRoleAndHighlightOrg(). Could not draw a line for this role: ' + roles[i].RoleId + ' (' + roles[i].RoleName + ')');
                                }
                            }
                        }
                    }
    ...
    renderOrgEditorInACircle: function (divisionIndex, groupIndex, entityIndex, locationIndex) {
        try {
            ...
            html += '      <td style="width:9%;"></td>';
            html += '      <td style="width:1%;cursor:pointer;vertical-align:top;">';
            html += '        <span class="dialogXButton" style="font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;font-size:30pt;font-weight:bold;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'hideOrgEditorInACircle\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');">X</span>';
            html += '      </td>';
            html += '    </tr>';
            html += '  </table>';
            //html += '  <br /><br />';
            ...
            $.ajax({
                ...
                try {
                    console.log('In bwOrganizationViewer.js.renderOrgEditorInACircle().Get[odata/Roles].done().');
                    var car = result.workflow;
                    var roles2;
                    if (result) {
                        roles2 = result.userRoles;
                    } else {
                        console.log('In bwOrganizationViewer.js.renderOrgEditorInACircle().Get[odata/Roles].done: result: bad identifier here, please reword.. ' + JSON.stringify(result));
                    }
                    ...
                    if (workflowRoles.length) {
                        ...
                        for (var w = 0; w < workflowRoles.length; w++) {
                            ...
                            if (isSelected) {
                                html += '<td>xcx51<input id="' + 'orgRoleCheckbox_' + w + '" type="checkbox" checked onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'OrgRoleCheckbox_Onchange\', \'' + 'orgRoleCheckbox_' + w + '\', \'' + workflowRoles[w].RoleId + '\', \'' + workflowRoles[w].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" /></td>';
                            } else {
                                html += '<td>xcx52<input id="' + 'orgRoleCheckbox_' + w + '" type="checkbox" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'OrgRoleCheckbox_Onchange\', \'' + 'orgRoleCheckbox_' + w + '\', \'' + workflowRoles[w].RoleId + '\', \'' + workflowRoles[w].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" /></td>';
                            }
                            html += '<td class="roleId">' + workflowRoles[w].RoleId + '</td>';
                            html += '<td>&nbsp;</td>';
                            html += '<td class="roleName">' + workflowRoles[w].RoleName + '</td>';
                    ...
                    //
                    if (locationIndex || locationIndex > -1) {
                        html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;white-space:nowrap;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'editLocation\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');">✎<span style="text-decoration:underline;white-space:nowrap;">Edit</span></span>';
                    } else if (entityIndex || entityIndex > -1) {
                        html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'editLegalEntity\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                    } else if (groupIndex || groupIndex > -1) {
                        html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'editGroup\', \'' + divisionIndex + '\', \'' + groupIndex + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                    } else if (divisionIndex || divisionIndex > -1) {
                        if (divisionIndex == 'root') {
                            //html += '&nbsp;<span title="Add a Division..." id="divisionsRootNode" style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;text-decoration:underline;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'addADivision\');"> ✚ Add a new Divisionxx</span>';

                            //debugger;
                            //// Add an Edit button here so that the user can rename the root org!
                            //html += '  <span style="cursor:pointer;color:tomato;font-size:smaller;border:1px solid goldenrod;padding:3px 13px 5px 13px;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'editDivision\', \'' + divisionIndex + '\');">✎<span style="text-decoration:underline;">Edit</span></span>';
                    ...
                    console.log('Exception in bwOrganizationViewer.js.renderOrgEditorInACircle().Get[odata/Orgs].done: ' + e.message + ', ' + e.stack);
                }
            }).fail(function (data) {
                var msg;
                if (JSON.stringify(data).indexOf('The specified URL cannot be found.') > -1) {
                ...
                alert('Error in bwOrganizationViewer.js.renderOrgEditorInACircle().Get[odata/Orgs].fail: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                console.log('Error in bwOrganizationViewer.js.renderOrgEditorInACircle().Get[odata/Orgs].fail:' + JSON.stringify(data));
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
        } catch (e) {
            console.log('Exception in bwOrganizationViewer.js.renderOrgEditorInACircle(): ' + e.message + ', ' + e.stack);
        }
    },
            ...
            if (roles && roles.length) {
                for (var r = 0; r < roles.length; r++) {
                    if (roles[r].ParticipantIsDirty == true && roles[r].ParticipantIsDirtyAction == 'REMOVE') {
                        ...
                        var stepIndex = -1;
                        var roleIndex = -1;
                        html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayPeoplePickerDialogForJson\', \'' + roles[r].RoleId + '\', \'' + roles[r].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" src="images/addressbook-icon18x18.png">';
                        html += '<br />';
                    }
                }
            } else {
    ...
    manageRaciRoles: function (divisionIndex, groupIndex, entityIndex) {
        try {
            ...
            //$('.bwOrganizationViewer').bwOrganizationViewer('displayCreateANewRoleDialog');
                    ...
                    try {
                        ...
                        if (workflow.length != 1) {
                            ...
                            $.ajax({
                                ...
                                try {
                                    console.log('In bwOrganizationViewer.js.activateOrgRolesConfiguration.update: Successfully updated DB using (' + JSON.stringify(json) + ').');
                                    ...
                                    $.ajax({
                                        ...
                                        try {
                                            ...
                                            //alert('Successfully updated the database. THIS WORKFLOW CHANGE WILL TAKE PLACE IMMEDIATELY!');
                                            debugger; // xcx2
                                            if ($('#bwOrganizationViewer_divUndoOrgRolesActivationDialog').is(':visible') != true) { // FIX!!!!!!!!!!!!!!!!! DOING THIS JUST TO GET THINGS WORKING. This gets called too many times here...



                                                alert('xcx11223-1');

                                                $("#bwOrganizationViewer_divUndoOrgRolesActivationDialog").dialog({
                                                    modal: true,
                                                    resizable: false,
                                                    //closeText: "Cancel",
                                                    closeOnEscape: false, // Hit the ESC key to hide! Yeah!
                                                    ...
                                                    open: function () {
                                                        try {
                                                            $('.ui-widget-overlay').bind('click', function () {
                                                                $('#bwOrganizationViewer_divUndoOrgRolesActivationDialog').dialog('close');
                                                            });
                                                        } catch (e) {
                                                            console.log('Exception in activateOrgRolesConfiguration().bwOrganizationViewer_divUndoOrgRolesActivationDialog.open(): ' + e.message + ', ' + e.stack);
                                                        }
                                                    },
                                                    close: function () {
                                                        $('#bwOrganizationViewer_divUndoOrgRolesActivationDialog').dialog('destroy');
                                                        //location.reload(); // When the user closes this dialog, we regenerate the screen to reflect the newly created and activated workflow.
                                                    }
                                                });
                                                $('#bwOrganizationViewer_divUndoOrgRolesActivationDialog').dialog().parents('.ui-dialog').find('.ui-dialog-titlebar').remove();
                                            }
                                        } catch (e) {
        ...
        try {
            ...
            if (this.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                ...
                $.ajax({
                    ...
                    try {
                        console.log('In xx. Returned from POST SaveBwOrgRoles_With_SynchronizeParticipantOrgRoles(): ' + JSON.stringify(result));
                        //alert(result);

                        //var result = JSON.parse(result);
                        if (result.message != 'SUCCESS') {

                            displayAlertDialog('Error in saveOrgRolesConfigurationAndActivateAndUpdateParticipants(): ' + JSON.stringify(result));

                        } else {

                            console.log('In bwOrganizationViewer.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().post: Successfully updated DB. result: ' + JSON.stringify(result)); // using (' + JSON.stringify(json) + ').');
                            ...
                            console.log(JSON.stringify(result.bwOrgRolesJson));
                        ...
                        console.log('Exception in bwOrganizationViewer.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().xx.update: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwOrganizationViewer.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().xx.update: ' + e.message + ', ' + e.stack);
                    ...
                    console.log('Fail in bwOrganizationViewer.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().xx.update: ' + ', url: ' + thiz.options.operationUriPrefix + "_bw/SaveBwOrgRoles_With_SynchronizeParticipantOrgRoles, data: " + JSON.stringify(data) + ', json: ' + JSON.stringify(json));
                    displayAlertDialog('Fail in bwOrganizationViewer.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants().xx.update: ' + ', url: ' + thiz.options.operationUriPrefix + "_bw/SaveBwOrgRoles_With_SynchronizeParticipantOrgRoles, data: " + JSON.stringify(data) + ', json: ' + JSON.stringify(json)); //+ error.message.value + ' ' + error.innererror.message);
                    //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                    //var error = JSON.parse(data.responseText)["odata.error"];
                    //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
                });
            ...
            displayAlertDialog('Exception in bwOrganizationViewer.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants(): ' + e.message + ', ' + e.stack);
            console.log('Exception in bwOrganizationViewer.js.saveOrgRolesConfigurationAndActivateAndUpdateParticipants(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    checkIfWeHaveToDisplayThePublishChangesButton: function () {
        try {
            //debugger;
            console.log('In bwOrganizationViewer.js.checkIfWeHaveToDisplayThePublishChangesButton().');
            ...
            if (this.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                if (thereHaveBeenChangesToTheOrgRoles == true) {
                    ...
                    var html = '';
                    html += '<input style="padding:5px 10px 5px 10px;width:100px;" id="btnSaveWorkflowConfigurationAndActivate" type="button" value="Publish" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'saveOrgRolesConfigurationAndActivateAndUpdateParticipants\');" />'; // was > publishNewUserBusinessModelConfigurationAndActivate
                    html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCancelChangesInDraftWorkflowConfiguration" type="button" value="Cancel Changes" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'cancelChangesInDraftOrgRolesConfiguration\');" />'; // WAS >> cancelChangesInDraftWorkflowConfiguration
                ...
                if (thereHaveBeenChangesToTheOrgRoles) {
                    ...
                    var html = '';
                    html += '<input style="padding:5px 10px 5px 10px;width:100px;" id="btnsaveOrgRolesConfigurationAndActivateAndUpdateParticipants" type="button" value="Publish" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'saveOrgRolesConfigurationAndActivateAndUpdateParticipants\');" />';
                    html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btncancelChangesInDraftOrgRolesConfiguration" type="button" value="Cancel Changes" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'cancelChangesInDraftOrgRolesConfiguration\');" />';
            ...
            console.log('Exception in bwOrganizationViewer.js.checkIfWeHaveToDisplayThePublishChangesButton(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationViewer.js.checkIfWeHaveToDisplayThePublishChangesButton(): ' + e.message + ', ' + e.stack);
        }
    },
        ...
        try {
            ...
            if (this.options.DisplayAsNewTenantUserConfigurationEditor == true) {
                if (thereHaveBeenChangesToTheOrgRoles == true) {
                    ...
                    document.getElementById('spanThereAreChangesToPublishText51').innerHTML = 'You have changes that won\'t be available until you publish: ';
                    var html = '';
                    html += '<input style="padding:5px 10px 5px 10px;width:100px;" id="btnSaveWorkflowConfigurationAndActivate" type="button" value="Publish" onclick="$(\'.bwOrganizationViewerAdmin\').bwOrganizationViewerAdmin(\'forceUpdateOrgRolesConfiguration\');" />'; // was > publishNewUserBusinessModelConfigurationAndActivate
                    html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btnCancelChangesInDraftWorkflowConfiguration" type="button" value="Cancel Changes" onclick="$(\'.bwOrganizationViewerAdmin\').bwOrganizationViewerAdmin(\'cancelChangesInDraftOrgRolesConfiguration\');" />'; // WAS >> cancelChangesInDraftWorkflowConfiguration
                    document.getElementById('spanThereAreChangesToPublishButton51').innerHTML = html;
                } else {
                    // Do nothing because the user has made no changes to the workflow.
                    document.getElementById('spanThereAreChangesToPublishText51').innerHTML = '';
                ...
                if (thereHaveBeenChangesToTheOrgRoles) {
                    ...
                    document.getElementById('spanThereAreChangesToPublishText').innerHTML = 'You have changes that won\'t be available until you publish: ';
                    var html = '';
                    html += '<input style="padding:5px 10px 5px 10px;width:100px;" id="btnsaveOrgRolesConfigurationAndActivateAndUpdateParticipants" type="button" value="Publish" onclick="$(\'.bwOrganizationViewerAdmin\').bwOrganizationViewerAdmin(\'saveOrgRolesConfigurationAndActivateAndUpdateParticipants\');" />';
                    html += '&nbsp;<input style="padding:5px 10px 5px 10px;" id="btncancelChangesInDraftOrgRolesConfiguration" type="button" value="Cancel Changes" onclick="$(\'.bwOrganizationViewerAdmin\').bwOrganizationViewerAdmin(\'cancelChangesInDraftOrgRolesConfiguration\');" />';
                    document.getElementById('spanThereAreChangesToPublishButton').innerHTML = html; //'<input style="padding:5px 10px 5px 10px;" id="btnSaveWorkflowConfigurationAndActivate" type="button" value="  Publish  " onclick="$(\'.bwWorkflowEditor\').bwWorkflowEditor(\'saveWorkflowConfigurationAndActivate\');" />';
                } else {
                    try {
                        // Do nothing because the user has made no changes to the workflow.
            ...
            $.ajax({
                ...
                success: function (result) {
                    try {
                        ...
                        if (result.status != 'SUCCESS') {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                if (data[i].bwParticipantRole == 'emailrecipient') {
                                    ...
                                    //html += '<a href="javascript:$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'cmdReturnParticipantIdToFieldForJson\', \'' + friendlyNameSourceField + '\', \'' + idSourceField + '\', \'' + emailSourceField + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantEmail + '\', \'' + buttonToEnable + '\');">' + data[i].bwParticipantFriendlyName + '&nbsp;&nbsp;<i>(' + data[i].bwParticipantEmail + ')</i></a>';
                        ...
                        console.log('Exception in bwOrganizationViewer.js.renderAllParticipantsInThePeoplePickerForJson():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwOrganizationViewer.js.renderAllParticipantsInThePeoplePickerForJson():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwOrganizationViewer.js.renderAllParticipantsInThePeoplePickerForJson():' + errorCode + ', ' + errorMessage);
                    displayAlertDialog('Error in bwOrganizationViewer.js.renderAllParticipantsInThePeoplePickerForJson():' + errorCode + ', ' + errorMessage);
                }
            });
        } catch (e) {
            console.log('Exception in bwOrganizationViewer.js.renderAllParticipantsInThePeoplePickerForJson(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwOrganizationViewer.js.renderAllParticipantsInThePeoplePickerForJson(): ' + e.message + ', ' + e.stack);
        }
    },
            ...
            if (org.Roles && org.Roles.length) {
                for (var r = 0; r < org.Roles.length; r++) {
                    if (org.Roles[r].ParticipantIsDirty == true && org.Roles[r].ParticipantIsDirtyAction == 'REMOVE') {
                        ...
                        var stepIndex = -1;
                        var roleIndex = -1;
                        html += '&nbsp;<img style="width:18px;height:18px;cursor:pointer;vertical-align:text-bottom;" onclick="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'displayPeoplePickerDialogForJson\', \'' + org.Roles[r].RoleId + '\', \'' + org.Roles[r].RoleName + '\', \'' + divisionIndex + '\', \'' + groupIndex + '\', \'' + entityIndex + '\', \'' + locationIndex + '\');" src="images/addressbook-icon18x18.png">';
                        html += '<br />';
        ...
        try {
            ...
            $.ajax({
                ...
                try {
                    //debugger;
                    var html = '';
                    html += '<select style="padding:5px 5px 5px 5px;" id="orgRolesDropDown" onchange="$(\'.bwOrganizationViewer\').bwOrganizationViewer(\'OrgRolesDropDown_Onchange\');">';
                ...
                alert('Exception in bwOrganizationViewer.js.renderOrgRolesDropDownList().xx.Get: ' + msg); //+ error.message.value + ' ' + error.innererror.message);
                console.log('Exception in bwOrganizationViewer.js.renderOrgRolesDropDownList().xx.Get: ' + JSON.stringify(data));
                //console.log('Fail in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + JSON.stringify(data));
                //var error = JSON.parse(data.responseText)["odata.error"];
                //alert('Exception in CarForm3.aspx.populateSpendForecastNotReadOnly().spendForecastItems.update: ' + error.message.value + ' ' + error.innererror.message); // + ', EntityValidationErrors: ' + data.EntityValidationErrors);
            });
    ...
    renderTheCondReadOnly: function (cond) {
        try {
            console.log('In bwOrganizationViewer.renderTheCondReadOnly().');
            // this is a placeholder!!! hardcoded
            var result = '';
            if (true) {
                //result += 'In bwOrganizationViewer.renderTheCondReadOnly().'; // uncomment this if wanting to put this section back!!
            } else {
                if (cond && cond.trim() != '') {
    ...
    renderConditionsSection: function (elementId, conditionString) {
        try {
            console.log('In bwOrganizationViewer.renderConditionsSection().');
            // this is a placeholder!!! hardcoded
            var html = '';
            if (true) {
                html += 'In bwOrganizationViewer.renderConditionsSection().';
            } else {
                var selectedRoleCategory;
                $('#selectRoleCategory').find('option:selected').each(function (index, element) {
                    selectedRoleCategory = element.value;
    ...
    WorkflowRequestTypeDropDown_Onchange: function (elementId) {
        try {
            console.log('In bwOrganizationViewer.js.WorkflowRequestTypeDropDown_Onchange().');
