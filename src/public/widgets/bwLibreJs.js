$.widget("bw.bwLibreJs", {
    ...
    _create: function () {
        //alert('In bwLibreJs._create().');
        this.element.addClass("bwLibreJs");
        //debugger;
        ...
        try {
            ...
            html += `<span style="font-size:50pt;font-weight:bold;color:#9B945F;">THIS IS THE bwLibreJs WIDGET.</span>
                    <br /><br />
            ...
            console.log('In bwLibreJs.js._create(). The widget has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwLibreJs: CANNOT INITIALIZE widget bwLibreJs.js.</span>';
            html += '<br />';
            html += '<span style="">Exception in bwLibreJs.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    renderPrintButton: function () {
        try {
            ...
            if (reportType == 'CurrentYearBudgetRequestsReport') {
                html += '<span title="print" class="printButton" onclick="$(\'.bwLibreJs\').bwLibreJs(\'PrintCurrentYearBudgetRequestsReport\');">🖨</span>';
            } else if (reportType == 'MyPendingTasksReport') {
                html += '<span title="print" class="printButton" onclick="$(\'.bwLibreJs\').bwLibreJs(\'PrintMyPendingTasksReport\');">🖨</span>';
            } else if (reportType == 'InProcessBudgetRequestsReport') {
                html += '<span title="print" class="printButton" onclick="$(\'.bwLibreJs\').bwLibreJs(\'PrintInProcessBudgetRequestsReport\');">🖨</span>';
            } else if (reportType == 'IndividualRequestReport') {
                html += '<span title="print" class="printButton" onclick="$(\'.bwLibreJs\').bwLibreJs(\'PrintIndividualRequestReport\');" style="font-size:22pt;">🖨&nbsp;</span>'; // Different size because this one shows up in the dialog draggable top bar header.
            } else {
                                                    ...
                                                    try {
                                                        ...
                                                        var printNow = function () {
                                                            setTimeout(function () { // Only needs to happen for Chrome.
                                                                ...
                                                                //window.frames["printf"].print();
                                                                try {
                                                                    console.log('bwLibreJs.PrintMyPendingTasksReport(): Try #1.');
                                                                    window.frames["printf"].contentWindow.print(); // Confirmed 5-14-2020. Works in Edge.
                                                                } catch (e) {
                                                                    try {
                                                                        console.log('bwLibreJs.PrintMyPendingTasksReport(): Try #2.');
                                                                        ...
                                                                        console.log('bwLibreJs.PrintMyPendingTasksReport(): Try #3.');
                                                                        window.print(); // In Safari on MacBook, and Safari & Chrome on iOS, this is a synchronous call!!! (unlike most other situations where it is asynchronous).
                                                                    }
                                                                ...
                                                                //};
                                                                //var $printbutton = $('#spanArchivePagePrintButton').bwLibreJs(printButtonOptions);
        ...
        try {
            ...
            window.onafterprint = function (e) {
                try {
                    ...
                    //};
                    //var $printbutton = $('#spanRequestPrintButton').bwLibreJs(printButtonOptions);
    ...
    expandHomePageNotificationAndRenderAlerts_Printed: function (notificationType, deferredIndex, functionalAreaRowId) {
        ...
        try {
            console.log('In bwLibreJs.expandHomePageNotificationAndRenderAlerts_Printed(' + notificationType + ', ' + deferredIndex + ', ' + functionalAreaRowId + ').');
            //debugger;
            //displayAlertDialog('type:' + notifications);
            ////displayAlertDialog('text:' + notifications);
            //displayAlertDialog('notifications[2].length:' + notifications.length);
            ...
            //handleExceptionWithAlert('Error in my.js.expandHomePageNotificationAndRenderAlerts()', '2:' + e.message);
            console.log('Exception in bwLibreJs.expandHomePageNotificationAndRenderAlerts_Printed() 2:' + e.message + ' ' + e.stack + ' This is not necessarily a service unavailable error but we dont want to bother the user!!');
            displayAlertDialog('Exception in bwLibreJs.expandHomePageNotificationAndRenderAlerts_Printed() 2:' + e.message + ' ' + e.stack + ' This is not necessarily a service unavailable error but we dont want to bother the user!!');
