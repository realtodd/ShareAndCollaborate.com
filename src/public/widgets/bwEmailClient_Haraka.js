$.widget("bw.bwEmailClient_Haraka", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwEmailClient_Haraka.js jQuery Widget. 
        ===========================================================
            ...
            Instantiate bwEmailClient_Haraka.js:
                |-- _create()
       ...
       */
        ...
        Archived: null, // Initialize these as null, so we can tell later on if they have been loaded yet or not. We will check if they are an array, and that will indicate that they were loaded already.
    ...
    _create: function () { // assignmentRowChanged_ElementId) {
        this.element.addClass("bwEmailClient_Haraka");
        var thiz = this;
        try {
            ...
            html += '   </span>';
            html += '   <br /><br /><br />';
            //html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteSelectedPendingEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;">';
            ...
            html += '                <div xcx="xcx53466667" id="divInnerLeftMenuHeader" class="' + workflowAppTheme + '_noanimation noanimation" style="border-radius:20px 0 0 0;width:100%; float:left; height:85px; background-color:gray; "></div>';
            html += '            </td>';
            ...
            html += '                <div id="divInnerLeftMenuButton_NewMessage" class="leftButton ' + workflowAppTheme + '" weightedheightvalue="125" style="display:none;height:125px;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage\');">';
            html += '                    <div class="leftButtonText2">&nbsp;&nbsp;NEW MESSAGE</div>';
            html += '                </div>';

            html += '                <div class="buttonSpacer" style="width: 100%; float:left; height:10px; background-color:white; "></div>';
            html += '                <div allow="clipboard-read;clipboard-write;" id="divInnerLeftMenuButton_Inbox" class="leftButton ' + workflowAppTheme + '" weightedheightvalue="125" style="display:none;height:125px;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'loadAndRenderEmails_Inbox\');">';
            html += '                    <div class="leftButtonText2">INBOX</div>';
            html += '                </div>';

            html += '                <div class="buttonSpacer" style="width: 100%; float:left; height:10px; background-color:white; "></div>';
            html += '                <div id="divInnerLeftMenuButton_Sent" class="leftButton ' + workflowAppTheme + '" weightedheightvalue="40" style="display:none;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'loadAndRenderEmails_Sent\');">';
            ...
            html += '                <div id="divInnerLeftMenuButton_Drafts" class="leftButton ' + workflowAppTheme + '" weightedheightvalue="30" style="display:none;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'loadAndRenderEmails_Drafts\');">';
            html += '                    <div class="leftButtonText2">DRAFTS</div>';
            html += '                </div>';

            html += '                <div class="buttonSpacer" style="width: 100%; float:left; height:3px; background-color:white; "></div>';
            html += '                <div allow="clipboard-read;clipboard-write;" id="divInnerLeftMenuButton_Junk" class="leftButton ' + workflowAppTheme + '" weightedheightvalue="20" style="display:none;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'loadAndRenderEmails_Junk\');">';
            html += '                    <div class="leftButtonText2">JUNK</div>';
            html += '                </div>';

            html += '                <div class="buttonSpacer" style="width: 100%; float:left; height:10px; background-color:white; "></div>';
            html += '                <div allow="clipboard-read;clipboard-write;" id="divInnerLeftMenuButton_Archived" class="leftButton ' + workflowAppTheme + '" weightedheightvalue="30" style="display:none;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'loadAndRenderEmails_Archived\');">';
            html += '                    <div class="leftButtonText2">ARCHIVED</div>';
            html += '                </div>';

            html += '                <div class="buttonSpacer" style="width: 100%; float:left; height:3px; background-color:white; "></div>';
            html += '                <div allow="clipboard-read;clipboard-write;" id="divInnerLeftMenuButton_TrashBin" class="leftButton ' + workflowAppTheme + '" weightedheightvalue="30" style="display:none;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'loadAndRenderEmails_TrashBin\');">';
            html += '                    <div class="leftButtonText2"><span><span class="bwEmailClient_Haraka_LeftMenuButton_UnicodeImage"><img src="/images/trashbin.png" style="height:40px;"></span></span></div>';
            html += '                </div>';
            ...
            if (developerModeEnabled == true) {
                ...
                html += '                    <div class="leftButtonText2"><span><span class="bwEmailClient_Haraka_LeftMenuButton_UnicodeImage">☎</span>&nbsp;Text Message INBOX</span></div>';
                html += '                </div>';

                html += '                <div class="buttonSpacer" style="width: 100%; float:left; height:3px; background-color:white; "></div>';
                html += '                <div class="leftButton ' + workflowAppTheme + '" weightedheightvalue="40" style="display:none;" onclick="$(\'.bwActiveMenu\').bwActiveMenu(\'RenderContentForInnerLeftMenuButtons\', this, \'WORKFLOW_AND_EMAIL\');">';
                html += '                    <div class="leftButtonText2"><span><span class="bwEmailClient_Haraka_LeftMenuButton_UnicodeImage">☎</span>&nbsp;SENT Text Message(s)</span></div>';
                html += '                </div>';



                html += '                <div class="buttonSpacer" style="width: 100%; float:left; height:10px; background-color:white; "></div>';
                html += '                <div class="leftButton ' + workflowAppTheme + '" weightedheightvalue="125" style="display:none;height:125px;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'displayAIConversation\');">';
                html += '                    <div class="leftButtonText2"><span><span class="bwEmailClient_Haraka_LeftMenuButton_UnicodeImage">🔊</span>&nbsp;AI Conversation</span><br><span style="font-size:10pt;font-style:italic;color:gray;">The system engages you in a <br>conversation about the <br>requests that you are <br>involved with.</span></div>';
                html += '                </div>';
            ...
            var developerModeEnabled = $('.bwAuthentication').bwAuthentication('option', 'developerModeEnabled');
            if (developerModeEnabled == true) {
                html += '                               <span class="spanButton" title="Click to send this email now!" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'sendPendingEmailNow\');">';
                html += '                                   ✉&nbsp;Send Now > xcx1';
                html += '                               </span>';
            }
            ...
            console.log('OPTIMIZING SPACE. // THIS MOVES THE WHOLE THING OVER AND UP. margin-left:-20px;margin-top:-15px; 8-6-2024. LOOK HERE FOR FINE TUNING.');
            html += '       <table xcx="xcx242366" style="width:100%;margin-left:-20px;margin-top:-15px;">'; // THIS MOVES THE WHOLE THING OVER AND UP. 8-6-2024.
            //html += '       <table xcx="xcx242366" style="width:100px;">'; // 8-6-2024.
            html += '           <colgroup>';
            html += '               <col style="WIDTH:5%;" />';
            ...
            //html += '                   <td xcx="xcx111">';
            ////html += 'xcx111';
            //html += '                       <span class="emailEditor_newMessageButton" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage\');">'; //
            //html += '                           &nbsp;✉&nbsp;New message&nbsp;';
            //html += '                       </span>';
            //html += '                   </td>';
            html += '                   <td xcx="xcx222-1">';
            //html += 'xcx222';
            ...
            html += '<div id="bwEmailClient_Haraka_EmailTopButtons"></div>'; // 6-27-2024.




            //html += '<span id="" style="float:right;white-space:nowrap;">   Search:    <span id="searchbox">       <input type="text" id="inputBwAuthentication_SearchBox" onkeydown="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'searchBox_OnKeyDown\', event);" style="WIDTH: 60%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 20pt;">       &nbsp;&nbsp;       <span class="emailEditor_newMessageButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'loadAndRenderEmails_Search\');">Search</span>   </span></span>';
            html += `<span id="" style="float:right;white-space:nowrap;">
                        Search:
                        <span id="searchbox">
                            <input type="text" xcx="xcx7737712" value="" id="inputBwAuthentication_SearchBox" onkeydown="$('.bwEmailClient_Haraka').bwEmailClient_Haraka('searchBox_OnKeyDown', event);" style="WIDTH: 60%;font-family: 'Segoe UI Light','Segoe UI','Segoe',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 20pt;">
                            &nbsp;&nbsp;<span class="emailEditor_newMessageButton" onclick="$('.bwEmailClient_Haraka').bwEmailClient_Haraka('loadAndRenderEmails_Search');">Search</span>
                        </span>
                    </span>`;
            ...
            html += '               <tr>';
            html += '                   <td xcx="xcx222-2" style="vertical-align:top;width:100px;">';

            // Middle column.
            html += '<table xcx="xcx7738495" >';
            html += '   <tr>';
            //html += '       <td style="width:350px;height:50px;text-align:left;background-color:white;margin:10px 20px 10px -3px;">';
            html += '       <td style="height:50px;text-align:left;background-color:white;margin:10px 20px 10px -3px;">'; // 8-6-2024.
            ...
            html += '                   <div id="divEmailPicker" xcx="xcx554324" style="height:600px;overflow-y:scroll;overscroll-behavior-y:contain;">'; // The width is set here for the email list... 2-9-2022 scroll can be change dto hidden.
            ...
            html += '                       <table id="tableEmailPicker" xcx="xcx111948475664-1" style=""></table>'; // width:460px;height:600px;overflow-y: scroll;overflow-x:hidden;
            ...
            html += '                   </td>';
            html += '                   <td id="tdBwEmailClient_Haraka_RightColumn" xcx="xcx333-2-2" style="vertical-align:middle;">';
            ...
            dropzone_inbox.addEventListener('dragenter', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_inbox.dragenter(). xcx3423234.');
                    //alert('In renderAndPopulateAttachmentsxx.dropzone_inbox.dragenter().');
                    e.preventDefault();
                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_inbox.dragenter(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_inbox.addEventListener('dragover', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_inbox.dragover().');
                    //alert('In renderAndPopulateAttachmentsxx.dropzone_inbox.dragover().');
                    e.preventDefault();
                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_inbox.drop(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_inbox.addEventListener('drop', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_inbox.drop().');
                    //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.dropzone_inbox.drop(). xcx23124.');
                    e.preventDefault();

                    var gotData;
                    if (e.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_inbox.drop(). Object is event.clipboardData.');
                        gotData = true;
                    } else if (e.dataTransfer) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_inbox.drop(). Object is event.dataTransfer. e: ' + JSON.stringify(e));
                        gotData = true;
                    } else if (window.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_inbox.drop(). Object is window.clipboardData.');
                        gotData = true;
                    } else {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwEmailClient_Haraka.js.dropzone_inbox.drop(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwEmailClient_Haraka.js.dropzone_inbox.drop(). Could not find a valid DataTransfer object.');
                    }
            ...
            dropzone_inbox.addEventListener('paste', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_inbox.paste().');
                    //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.dropzone_inbox.paste().');
                    e.preventDefault();

                    var gotData;
                    if (e.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_inbox.paste(). Object is event.clipboardData.');
                        gotData = true;
                    } else if (e.dataTransfer) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_inbox.paste(). Object is event.dataTransfer.');
                        gotData = true;
                    } else if (window.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_inbox.paste(). Object is window.clipboardData.');
                        gotData = true;
                    } else {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwEmailClient_Haraka.js.dropzone_inbox.paste(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwEmailClient_Haraka.js.dropzone_inbox.paste(). Could not find a valid DataTransfer object.');
                    }

                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_inbox.paste(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_junk.addEventListener('dragenter', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_junk.dragenter().');
                    //alert('In renderAndPopulateAttachmentsxx.dropzone_junk.dragenter().');
                    e.preventDefault();
                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_junk.dragenter(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_junk.addEventListener('dragover', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_junk.dragover().');
                    //alert('In renderAndPopulateAttachmentsxx.dropzone_junk.dragover().');
                    e.preventDefault();
                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_junk.drop(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_junk.addEventListener('drop', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_junk.drop().');
                    //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.dropzone_junk.drop(). xcx23124.');
                    e.preventDefault();

                    var gotData;
                    if (e.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_junk.drop(). Object is event.clipboardData.');
                        gotData = true;
                    } else if (e.dataTransfer) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_junk.drop(). Object is event.dataTransfer.');
                        gotData = true;
                    } else if (window.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_junk.drop(). Object is window.clipboardData.');
                        gotData = true;
                    } else {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwEmailClient_Haraka.js.dropzone_junk.drop(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwEmailClient_Haraka.js.dropzone_junk.drop(). Could not find a valid DataTransfer object.');
                    }
            ...
            dropzone_junk.addEventListener('paste', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_junk.paste().');
                    //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.dropzone_junk.paste().');
                    e.preventDefault();

                    var gotData;
                    if (e.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_junk.paste(). Object is event.clipboardData.');
                        gotData = true;
                    } else if (e.dataTransfer) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_junk.paste(). Object is event.dataTransfer.');
                        gotData = true;
                    } else if (window.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_junk.paste(). Object is window.clipboardData.');
                        gotData = true;
                    } else {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwEmailClient_Haraka.js.dropzone_junk.paste(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwEmailClient_Haraka.js.dropzone_junk.paste(). Could not find a valid DataTransfer object.');
                    }

                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_junk.paste(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_archived.addEventListener('dragenter', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_archived.dragenter().');
                    //alert('In renderAndPopulateAttachmentsxx.dropzone_archived.dragenter().');
                    e.preventDefault();
                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_archived.dragenter(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_archived.addEventListener('dragover', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_archived.dragover().');
                    //alert('In renderAndPopulateAttachmentsxx.dropzone_archived.dragover().');
                    e.preventDefault();
                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_archived.drop(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_archived.addEventListener('drop', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_archived.drop().');
                    //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.dropzone_archived.drop(). xcx23124.');
                    e.preventDefault();

                    var gotData;
                    if (e.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_archived.drop(). Object is event.clipboardData.');
                        gotData = true;
                    } else if (e.dataTransfer) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_archived.drop(). Object is event.dataTransfer.');
                        gotData = true;
                    } else if (window.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_archived.drop(). Object is window.clipboardData.');
                        gotData = true;
                    } else {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwEmailClient_Haraka.js.dropzone_archived.drop(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwEmailClient_Haraka.js.dropzone_archived.drop(). Could not find a valid DataTransfer object.');
                    }
            ...
            dropzone_archived.addEventListener('paste', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_archived.paste().');
                    //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.dropzone_archived.paste().');
                    e.preventDefault();

                    var gotData;
                    if (e.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_archived.paste(). Object is event.clipboardData.');
                        gotData = true;
                    } else if (e.dataTransfer) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_archived.paste(). Object is event.dataTransfer.');
                        gotData = true;
                    } else if (window.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_archived.paste(). Object is window.clipboardData.');
                        gotData = true;
                    } else {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwEmailClient_Haraka.js.dropzone_archived.paste(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwEmailClient_Haraka.js.dropzone_archived.paste(). Could not find a valid DataTransfer object.');
                    }

                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_archived.paste(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_trashbin.addEventListener('dragenter', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.dragenter().');
                    //alert('In renderAndPopulateAttachmentsxx.dropzone_trashbin.dragenter().');
                    e.preventDefault();
                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_trashbin.dragenter(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_trashbin.addEventListener('dragover', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.dragover().');
                    //alert('In renderAndPopulateAttachmentsxx.dropzone_trashbin.dragover().');
                    e.preventDefault();
                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_trashbin.drop(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            dropzone_trashbin.addEventListener('drop', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.drop().');
                    //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.dropzone_trashbin.drop(). xcx23124.');
                    e.preventDefault();

                    var gotData;
                    if (e.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.drop(). Object is event.clipboardData.');
                        gotData = true;
                    } else if (e.dataTransfer) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.drop(). Object is event.dataTransfer.');
                        gotData = true;
                    } else if (window.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.drop(). Object is window.clipboardData.');
                        gotData = true;
                    } else {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwEmailClient_Haraka.js.dropzone_trashbin.drop(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwEmailClient_Haraka.js.dropzone_trashbin.drop(). Could not find a valid DataTransfer object.');
                    }
            ...
            dropzone_trashbin.addEventListener('paste', function (e) {
                try {
                    console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.paste().');
                    //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.dropzone_trashbin.paste().');
                    e.preventDefault();

                    var gotData;
                    if (e.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.paste(). Object is event.clipboardData.');
                        gotData = true;
                    } else if (e.dataTransfer) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.paste(). Object is event.dataTransfer.');
                        gotData = true;
                    } else if (window.clipboardData) {
                        console.log('In bwEmailClient_Haraka.js.dropzone_trashbin.paste(). Object is window.clipboardData.');
                        gotData = true;
                    } else {
                        ...
                        if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                            ...
                            alert('Error in bwEmailClient_Haraka.js.dropzone_trashbin.paste(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                        }
                    ...
                    if (gotData == true) {
                        ...
                        alert('Error in bwEmailClient_Haraka.js.dropzone_trashbin.paste(). Could not find a valid DataTransfer object.');
                    }

                } catch (e) {
                    var msg = 'Exception in bwEmailClient_Haraka.js.dropzone_trashbin.paste(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    alert(msg);
                }
            });
            ...
            console.log('In bwEmailClient_Haraka.js._create(). The widget has been initialized.');

        } catch (e) {
            var html = '';
            html += '<span style="font-size:24pt;color:red;">bwEmailClient_Haraka: CANNOT INITIALIZE THE WIDGET</span>';
            html += '<br />';
            html += '<span style="">Exception in bwEmailClient_Haraka.Create(): ' + e.message + ', ' + e.stack + '</span>';
            thiz.element.html(html);

            var msg = 'Exception in bwEmailClient_Haraka.js._create(): ' + e.message + ', ' + e.stack;
    ...
    _destroy: function () {
        this.element
            .removeClass("bwEmailClient_Haraka")
            .text("");
    },
    ...
    loadAndRenderEmails_Inbox: function (bwWorkflowAppId) {
        try {
            console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Inbox(). bwWorkflowAppId: ' + bwWorkflowAppId);
            //alert('In bwEmailClient_Haraka.js.loadAndRenderEmails_Inbox(). bwWorkflowAppId: ' + bwWorkflowAppId);
            var thiz = this;

            $(thiz.element).find('#tableEmailPicker tr').remove(); // Remove all the rows in the emails table/list.

            // Hide the red dot.
            console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Inbox(). Hide the red dot. Presumably, when the user looks at an email, it is time to hide the dot. We will try it out and see... 5-5-2024.');
            ...
            $('.bwEmailClient_Haraka:first').find('.' + workflowAppTheme_SelectedButton).each(function (index, value) {
            ...
            $(thiz.element).find('#divEmailClient_CompositionWindow')[0].innerHTML = '<div xcx="xcx213123-2" style="font-size:25pt;color:lightgray;">SELECT AN EMAIL THAT YOU WISH TO VIEW.</div>';
            var x = document.getElementById('tdBwEmailClient_Haraka_RightColumn');
            x.style.verticalAlign = 'middle';
            // end: An email won't be selected until the user selects one.

            $('#bwEmailClient_Haraka_EmailTopButtons').html('');  // These are the top buttons when an email is displayed. Get rid of any lingering ones...

            $('#divPageContent2_Title').html('✉&nbsp;INBOX<span style="display:none;" xcx="xcx880-1" />');

            // Display the radio button and the title.
            html = '';
            //html += '<input type="checkbox" style="transform:scale(2);" id="checkboxToggleSentEmailCheckboxes" onchange="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'toggleSentEmailCheckboxes\', this);" />&nbsp;&nbsp;';
            html += '✉ Inbox Items';
            ...
            var html = '';
            //html += '                           <span xcx="xcx231232-2" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
            //html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
            //html += '                           </span>';
            //html += '&nbsp;&nbsp;';
            html += '                           <span xcx="xcx231232-2" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
            ...
            console.log('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Inbox(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Inbox(): ' + e.message + ', ' + e.stack);
        }
    },
    getMoreRecords_Inbox: function () {
        console.log('In bwEmailClient_Haraka.js.getMoreRecords_Inbox().');
        //alert('In bwEmailClient_Haraka.js.getMoreRecords_Inbox().');
        var thiz = this;
                                                ...
                                                .then(function (results) {
                                                    ...
                                                    for (var i = startIndex; i < emailItems.length; i++) { // Add these event listeners to all of the new ones.
                                                        ...
                                                        emailItems[i].addEventListener('dragstart', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Inbox.dragstart().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Inbox.dragstart(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
                                                        ...
                                                        emailItems[i].addEventListener('dragend', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Inbox.dragend().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Inbox.dragend(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
    ...
    getAndRenderPagedEmails_Inbox: function (offset, limit) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Inbox().');
                //alert('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Inbox().');
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Inbox():2: ' + e.message + ', ' + e.stack;
                            console.log(msg);
                    ...
                    error: function (data, errorCode, errorMessage) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Inbox():1: ' + errorCode + ', ' + errorMessage;
                        console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Inbox(): ' + e.message + ', ' + e.stack;
                console.log(msg);
    ...
    viewIndividualEmail_Inbox: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, _id) {
        try {
            console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //alert('In bwEmailClient_Haraka.js.viewIndividualEmail_Inbox().');
            var thiz = this;

            console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(). Hide the red dot. Presumably, when the user looks at an email, it is time to hide the dot. We will try it out and see... 5-5-2024.');
            document.getElementById('imgMessagingNotificationRedDot').style.display = 'none'; // Hide the red dot. Presumably, when the user looks at an email, it is time to hide the dot. We will try it out and see... 5-5-2024.
            $('.bwNotificationSound').bwNotificationSound('renderFavicon', false); // Turn off the red dot on the favicon.


            // imgMessagingNotificationRedDot
            ...
            this.displayExistingMessageHtml().then(function (results) {
                try {
                    if (results.status != 'SUCCESS') {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(): ' + results.message;
                        console.log(msg);
                        displayAlertDialog(msg);

                    } else {

                        console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(). Successfully returned from displayExistingMessageHtml().');
                        ...
                        thiz.loadIndividualEmail_Inbox(_id).then(function () {
                            try {
                                ...
                                html += '<button class="BwButton200" xcx="xcx2134264-1" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Reply&nbsp;</button>'; // emailEditor_newMessageButton
                                html += '&nbsp;&nbsp;&nbsp;';
                                html += '<button class="BwButton200" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Reply All&nbsp;</button>';
                                html += '&nbsp;&nbsp;&nbsp;';
                                html += '<button class="BwButton200" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Forward&nbsp;</button>';
                                $('#bwEmailClient_Haraka_EmailTopButtons').html(html);
                                ...
                                thiz.renderIndividualEmail_ReadOnly(_id, 'Inbox').then(function (results) { // strMailbox: ['Inbox', 'Sent', etc.]
                                    try {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (results) {
                                                        try {
                                                            ...
                                                            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox():8: ' + e.message + ', ' + e.stack;
                                                            console.log(msg);
                                                            displayAlertDialog(msg);
                                                        }
                                                    },
                                                    error: function (data, errorCode, errorMessage) {
                                                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(): ' + errorCode + ', ' + errorMessage;
                                                        console.log(msg);
                                                        displayAlertDialog(msg);
                                                    }
                                                });
                                        ...
                                        var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox():7: ' + e.message + ', ' + e.stack;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    }

                                }).catch(function (e) {
                                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox():6: ' + JSON.stringify(e);
                                    console.log(msg);
                                    displayAlertDialog(msg);
                                });

                            } catch (e) {
                                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox():5: ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                displayAlertDialog(msg);
                            }

                        }).catch(function (e) {
                            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox():4: ' + JSON.stringify(e);
                            console.log(msg);
                            displayAlertDialog(msg);
                        });
                    ...
                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox():3: ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    displayAlertDialog(msg);
                }

            }).catch(function (e) {
                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox():2: ' + JSON.stringify(e);
                console.log(msg);
                displayAlertDialog(msg);
            });

        } catch (e) {
            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    loadIndividualEmail_Inbox: function (_id) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.loadIndividualEmail_Inbox(). _id: ' + _id);
                //alert('In bwEmailClient_Haraka.js.loadIndividualEmail_Inbox(). _id: ' + _id);
                ...
                if (hasBeenLoaded == true) {
                    ...
                    if (!(workflowAppId && participantId && _id)) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Inbox(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id;
                        console.log(msg);
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.loadAndRenderEmails():xcx542: results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        ...
                                        if (!results.doc) {
                                            ...
                                            if (!foundIt) {
                                                ...
                                                var msg = 'Error in bwEmailClient_Haraka.js.loadAndRenderEmails():xcx231312-1: Could not find the email with _id: ' + _id;
                                                console.log(msg);
                                    ...
                                    var msg = 'Exception in bwEmailClient_Haraka.js.loadAndRenderEmails():2: ' + e.message + ', ' + e.stack;
                                    console.log(msg);
                            ...
                            error: function (data, errorCode, errorMessage) {
                                ...
                                var msg = 'Error in bwEmailClient_Haraka.js.loadAndRenderEmails():' + errorCode + ', ' + errorMessage;
                                console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Inbox():xcx453: ' + e.message + ', ' + e.stack;
    ...
    loadAndRenderEmails_Sent: function (bwWorkflowAppId) {
        try {
            console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Sent(). bwWorkflowAppId: ' + bwWorkflowAppId);
            //alert('In bwEmailClient_Haraka.js.loadAndRenderEmails_Sent(). bwWorkflowAppId: ' + bwWorkflowAppId);
            var thiz = this;
            ...
            console.log('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Sent(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Sent(): ' + e.message + ', ' + e.stack);
        }
    },
    getMoreRecords_Sent: function () {
        console.log('In bwEmailClient_Haraka.js.getMoreRecords_Sent().');
        //alert('In bwEmailClient_Haraka.js.getMoreRecords_Sent().');
        var thiz = this;
                                            ...
                                            thiz.getAndRenderPagedEmails_Sent(startIndex, 5)
                                                .then(function (results) {
                                                    ...
                                                    for (var i = startIndex; i < emailItems.length; i++) { // Add these event listeners to all of the new ones.
                                                        ...
                                                        emailItems[i].addEventListener('dragstart', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Sent.dragstart().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Sent.dragstart(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
                                                        ...
                                                        emailItems[i].addEventListener('dragend', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Sent.dragend().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Sent.dragend(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
    ...
    getAndRenderPagedEmails_Sent: function (offset, limit) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Sent().');
                //alert('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Sent().');
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Sent():2: ' + e.message + ', ' + e.stack;
                            console.log(msg);
                    ...
                    error: function (data, errorCode, errorMessage) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Sent():1: ' + errorCode + ', ' + errorMessage;
                        console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Sent(): ' + e.message + ', ' + e.stack;
                console.log(msg);
    ...
    viewIndividualEmail_Sent: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, _id) {
        try {
            console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Sent(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.viewIndividualEmail_Sent(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //alert('In bwEmailClient_Haraka.js.viewIndividualEmail_Sent().');
            var thiz = this;
            ...
            this.displayExistingMessageHtml().then(function (results) {
                try {
                    if (results.status != 'SUCCESS') {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_Sent(): ' + results.message;
                        console.log(msg);
                        displayAlertDialog(msg);

                    } else {

                        console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Sent(). Successfully returned from displayExistingMessageHtml().');
                        ...
                        thiz.loadIndividualEmail_Sent(_id).then(function () {
                            try {
                                ...
                                var html = '';
                                //html += 'From: <span class="EmailAddress_From">' + emailAddress + '</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; // + '[Reply]  [Reply All]  [Forward]';
                                html += '<span class="emailEditor_newMessageButton" xcx="xcx2134264-2" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Reply&nbsp;</span>';
                                html += '&nbsp;&nbsp;&nbsp;';
                                html += '<span class="emailEditor_newMessageButton" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Reply All&nbsp;</span>';
                                html += '&nbsp;&nbsp;&nbsp;';
                                html += '<span class="emailEditor_newMessageButton" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Forward&nbsp;</span>';
                                $('#bwEmailClient_Haraka_EmailTopButtons').html(html);
                                ...
                                thiz.renderIndividualEmail_ReadOnly(_id, 'Sent').then(function (results) { // strMailbox: ['Inbox', 'Sent', etc.]
                                    try {
                                        ...
                                        var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Sent():7: ' + e.message + ', ' + e.stack;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    }

                                }).catch(function (e) {
                                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Sent():6: ' + JSON.stringify(e);
                                    console.log(msg);
                                    displayAlertDialog(msg);
                                });

                            } catch (e) {
                                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Sent():5: ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                displayAlertDialog(msg);
                            }

                        }).catch(function (e) {
                            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Sent():4: ' + JSON.stringify(e);
                            console.log(msg);
                            displayAlertDialog(msg);
                        });
                    ...
                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Sent():3: ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    displayAlertDialog(msg);
                }

            }).catch(function (e) {
                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Sent():2: ' + JSON.stringify(e);
                console.log(msg);
                displayAlertDialog(msg);
            });

        } catch (e) {
            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Sent(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    ...
    loadIndividualEmail_Sent: function (_id) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.loadIndividualEmail_Sent(). _id: ' + _id);
                //alert('In bwEmailClient_Haraka.js.loadIndividualEmail_Sent(). _id: ' + _id);
                ...
                if (hasBeenLoaded == true) {
                    ...
                    if (!(workflowAppId && participantId && _id)) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Sent(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id;
                        console.log(msg);
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Sent():xcx542: results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        ...
                                        if (!results.doc) {
                                            ...
                                            if (!foundIt) {
                                                ...
                                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Sent():xcx231312: Could not find the email with _id: ' + _id;
                                                console.log(msg);
                                    ...
                                    var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Sent():2: ' + e.message + ', ' + e.stack;
                                    console.log(msg);
                            ...
                            error: function (data, errorCode, errorMessage) {
                                ...
                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Sent():' + errorCode + ', ' + errorMessage;
                                console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Sent():xcx453: ' + e.message + ', ' + e.stack;
    ...
    loadAndRenderEmails_Drafts: function (bwWorkflowAppId) {
        try {
            console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts(). bwWorkflowAppId: ' + bwWorkflowAppId);
            //alert('In bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts(). bwWorkflowAppId: ' + bwWorkflowAppId);
            var thiz = this;
            ...
            console.log('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts(): ' + e.message + ', ' + e.stack);
        }
    },
    getMoreRecords_Drafts: function () {
        console.log('In bwEmailClient_Haraka.js.getMoreRecords_Drafts().');
        //alert('In bwEmailClient_Haraka.js.getMoreRecords_Drafts().');
        var thiz = this;
                                            ...
                                            thiz.getAndRenderPagedEmails_Drafts(startIndex, 5)
                                                .then(function (results) {
                                                    ...
                                                    for (var i = startIndex; i < emailItems.length; i++) { // Add these event listeners to all of the new ones.
                                                        ...
                                                        emailItems[i].addEventListener('dragstart', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts.dragstart().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts.dragstart(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
                                                        ...
                                                        emailItems[i].addEventListener('dragend', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts.dragend().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts.dragend(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
    ...
    getAndRenderPagedEmails_Drafts: function (offset, limit) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Drafts().');
                //alert('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Drafts().');
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Drafts():2: ' + e.message + ', ' + e.stack;
                            console.log(msg);
                    ...
                    error: function (data, errorCode, errorMessage) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Drafts():1: ' + errorCode + ', ' + errorMessage;
                        console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Drafts(): ' + e.message + ', ' + e.stack;
                console.log(msg);
    ...
    viewIndividualEmail_Drafts: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, _id) {
        try {
            console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Drafts(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.viewIndividualEmail_Drafts(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //alert('In bwEmailClient_Haraka.js.viewIndividualEmail_Drafts(). _id: ' + _id);
            var thiz = this;
            ...
            this.displayNewMessageEditorHtml().then(function (results) {
                try {
                    if (results.status != 'SUCCESS') {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts(): ' + results.message;
                        console.log(msg);
                        displayAlertDialog(msg);

                    } else {

                        console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Drafts(). Successfully returned from displayNewMessageEditorHtml().');
                        ...
                        thiz.loadIndividualEmail_Drafts(_id).then(function () {
                            try {
                                ...
                                // Display the top buttons.
                                html = '';
                                html += '<button xcx="xcx324234667" class="BwButton200" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'SendSingleEmailNow\');">SEND NOW</button>'; // BwButton200ForRequestForm
                                html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                                html += '<button xcx="xcx213124-1" class="BwButton200" style="color:red;font-weight:bold;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'saveDraft\');">SAVE DRAFT</button>'; // BwSmallButton
                                $('#bwEmailClient_Haraka_EmailTopButtons').html(html);
                                // end: Display the top buttons.
                                ...
                                thiz.renderIndividualEmail_Editable(_id, 'Drafts').then(function (results) { // strMailbox: ['Inbox', 'Sent', etc.]
                                    try {
                                        ...
                                        var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts():7: ' + e.message + ', ' + e.stack;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    }

                                }).catch(function (e) {
                                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts():6: ' + JSON.stringify(e);
                                    console.log(msg);
                                    displayAlertDialog(msg);
                                });

                            } catch (e) {
                                console.log('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts():4: ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts():4: ' + e.message + ', ' + e.stack);
                            }

                        }).catch(function (e) {

                            console.log('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts():3: ' + JSON.stringify(e));
                            displayAlertDialog('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts():3: ' + JSON.stringify(e));
                    ...
                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts.displayNewMessageEditorHtml():2: ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    displayAlertDialog(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts.displayNewMessageEditorHtml(): ' + JSON.stringify(e);
                console.log(msg);
                displayAlertDialog(msg);
            ...
            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Drafts(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    ...
    loadIndividualEmail_Drafts: function (_id) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.loadIndividualEmail_Drafts(). _id: ' + _id);
                //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.loadIndividualEmail_Drafts(). _id: ' + _id);
                ...
                if (hasBeenLoaded == true) {
                    ...
                    if (!(workflowAppId && participantId && _id)) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Drafts(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id;
                        console.log(msg);
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Drafts():xcx542: results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        ...
                                        if (!results.doc) {
                                            ...
                                            if (!foundIt) {
                                                ...
                                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Drafts():xcx231312: Could not find the email.';
                                                console.log(msg);
                                    ...
                                    var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Drafts():2: ' + e.message + ', ' + e.stack;
                                    console.log(msg);
                            ...
                            error: function (data, errorCode, errorMessage) {
                                ...
                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Drafts():' + errorCode + ', ' + errorMessage;
                                console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Drafts():xcx453: ' + e.message + ', ' + e.stack;
    ...
    loadAndRenderEmails_Junk: function (bwWorkflowAppId) {
        try {
            console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Junk().');
            //alert('In bwEmailClient_Haraka.js.loadAndRenderEmails_Junk().');
            var thiz = this;
            ...
            console.log('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Junk(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Junk(): ' + e.message + ', ' + e.stack);
        }
    },
    getMoreRecords_Junk: function () {
        console.log('In bwEMailClient_Haraka.js.getMoreRecords_Junk().');
        //alert('In bwEMailClient_Haraka.js.getMoreRecords_Junk().');
        var thiz = this;
                                            ...
                                            thiz.getAndRenderPagedEmails_Junk(startIndex, 5)
                                                .then(function (results) {
                                                    ...
                                                    for (var i = startIndex; i < emailItems.length; i++) { // Add these event listeners to all of the new ones.
                                                        ...
                                                        emailItems[i].addEventListener('dragstart', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Junk.dragstart().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Junk.dragstart(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
                                                        ...
                                                        emailItems[i].addEventListener('dragend', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Junk.dragend().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Junk.dragend(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
    ...
    getAndRenderPagedEmails_Junk: function (offset, limit) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Junk().');
                //alert('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Junk().');
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Junk():2: ' + e.message + ', ' + e.stack;
                            console.log(msg);
                    ...
                    error: function (data, errorCode, errorMessage) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Junk():1: ' + errorCode + ', ' + errorMessage;
                        console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Junk(): ' + e.message + ', ' + e.stack;
                console.log(msg);
    ...
    viewIndividualEmail_Junk: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, _id) {
        try {
            console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Junk(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.viewIndividualEmail_Junk(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //alert('In bwEmailClient_Haraka.js.viewIndividualEmail_Junk(). _id: ' + _id);
            var thiz = this;
            ...
            this.displayNewMessageEditorHtml().then(function (results) {
                try {
                    if (results.status != 'SUCCESS') {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_Junk(): ' + results.message;
                        console.log(msg);
                        displayAlertDialog(msg);

                    } else {

                        console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Junk(). Successfully returned from displayNewMessageEditorHtml().');
                            ...
                            try {
                                ...
                                thiz.renderIndividualEmail_Editable(_id, 'Junk').then(function (results) { // strMailbox: ['Inbox', 'Sent', etc.]
                                    try {
                                        ...
                                        var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Junk():7: ' + e.message + ', ' + e.stack;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    }

                                }).catch(function (e) {
                                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Junk():6: ' + JSON.stringify(e);
                                    console.log(msg);
                                    displayAlertDialog(msg);
                                });

                            } catch (e) {
                                console.log('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Junk():4: ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Junk():4: ' + e.message + ', ' + e.stack);
                            }

                        }).catch(function (e) {

                            console.log('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Junk():3: ' + JSON.stringify(e));
                            displayAlertDialog('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Junk():3: ' + JSON.stringify(e));
                    ...
                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Junk.displayNewMessageEditorHtml():2: ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    displayAlertDialog(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Junk.displayNewMessageEditorHtml(): ' + JSON.stringify(e);
                console.log(msg);
                displayAlertDialog(msg);
            ...
            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Junk(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    loadIndividualEmail_Junk: function (_id) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.loadIndividualEmail_Junk(). _id: ' + _id);
                //alert('In bwEmailClient_Haraka.js.loadIndividualEmail_Junk(). _id: ' + _id);
                ...
                if (hasBeenLoaded == true) {
                    ...
                    if (!(workflowAppId && participantId && _id)) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Junk(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id;
                        console.log(msg);
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Junk():xcx542: results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        ...
                                        if (!results.doc) {
                                            ...
                                            if (!foundIt) {
                                                ...
                                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Junk():xcx231312-1: Could not find the email with _id: ' + _id;
                                                console.log(msg);
                                    ...
                                    var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Junk():2: ' + e.message + ', ' + e.stack;
                                    console.log(msg);
                            ...
                            error: function (data, errorCode, errorMessage) {
                                ...
                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Junk():' + errorCode + ', ' + errorMessage;
                                console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Junk():xcx453: ' + e.message + ', ' + e.stack;
    ...
    loadAndRenderEmails_Archived: function (bwWorkflowAppId) {
        try {
            console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Archived().');
            //alert('In bwEmailClient_Haraka.js.loadAndRenderEmails_Archived().');
            var thiz = this;
            ...
            console.log('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Archived(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Archived(): ' + e.message + ', ' + e.stack);
        }
    },
    getMoreRecords_Archived: function () {
        console.log('In bwEMailClient_Haraka.js.getMoreRecords_Archived().');
        //alert('In bwEMailClient_Haraka.js.getMoreRecords_Archived().');
        var thiz = this;
                                            ...
                                            thiz.getAndRenderPagedEmails_Archived(startIndex, 5)
                                                .then(function (results) {
                                                    ...
                                                    for (var i = startIndex; i < emailItems.length; i++) { // Add these event listeners to all of the new ones.
                                                        ...
                                                        emailItems[i].addEventListener('dragstart', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Archived.dragstart().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Archived.dragstart(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
                                                        ...
                                                        emailItems[i].addEventListener('dragend', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Archived.dragend().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Archived.dragend(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
    ...
    getAndRenderPagedEmails_Archived: function (offset, limit) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Archived().');
                //alert('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Archived().');
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Archived():2: ' + e.message + ', ' + e.stack;
                            console.log(msg);
                    ...
                    error: function (data, errorCode, errorMessage) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Archived():1: ' + errorCode + ', ' + errorMessage;
                        console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Archived(): ' + e.message + ', ' + e.stack;
                console.log(msg);
    ...
    viewIndividualEmail_Archived: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, _id) {
        try {
            console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Archived(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.viewIndividualEmail_Archived(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //alert('In bwEmailClient_Haraka.js.viewIndividualEmail_Archived(). _id: ' + _id);
            var thiz = this;
            ...
            this.displayNewMessageEditorHtml().then(function (results) {
                try {
                    if (results.status != 'SUCCESS') {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_Archived(): ' + results.message;
                        console.log(msg);
                        displayAlertDialog(msg);

                    } else {

                        console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Archived(). Successfully returned from displayNewMessageEditorHtml().');
                            ...
                            try {
                                ...
                                thiz.renderIndividualEmail_Editable(_id, 'Archived').then(function (results) { // strMailbox: ['Inbox', 'Sent', etc.]
                                    try {
                                        ...
                                        var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Archived():7: ' + e.message + ', ' + e.stack;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    }

                                }).catch(function (e) {
                                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Archived():6: ' + JSON.stringify(e);
                                    console.log(msg);
                                    displayAlertDialog(msg);
                                });

                            } catch (e) {
                                console.log('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Archived():4: ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Archived():4: ' + e.message + ', ' + e.stack);
                            }

                        }).catch(function (e) {

                            console.log('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Archived():3: ' + JSON.stringify(e));
                            displayAlertDialog('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Archived():3: ' + JSON.stringify(e));
                    ...
                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Archived.displayNewMessageEditorHtml():2: ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    displayAlertDialog(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Archived.displayNewMessageEditorHtml(): ' + JSON.stringify(e);
                console.log(msg);
                displayAlertDialog(msg);
            ...
            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Archived(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    ...
    loadIndividualEmail_Archived: function (_id) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.loadIndividualEmail_Archived(). _id: ' + _id);
                //alert('In bwEmailClient_Haraka.js.loadIndividualEmail_Archived(). _id: ' + _id);
                ...
                if (hasBeenLoaded == true) {
                    ...
                    if (!(workflowAppId && participantId && _id)) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Archived(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id;
                        console.log(msg);
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Archived():xcx542: results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        ...
                                        if (!results.results) {
                                            ...
                                            if (!foundIt) {
                                                ...
                                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Archived():xcx231312-1: Could not find the email with _id: ' + _id;
                                                console.log(msg);
                                    ...
                                    var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Archived():2: ' + e.message + ', ' + e.stack;
                                    console.log(msg);
                            ...
                            error: function (data, errorCode, errorMessage) {
                                ...
                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Archived():' + errorCode + ', ' + errorMessage;
                                console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Archived():xcx453: ' + e.message + ', ' + e.stack;
    ...
    loadAndRenderEmails_TrashBin: function (bwWorkflowAppId) {
        try {
            console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_TrashBin(). bwWorkflowAppId: ' + bwWorkflowAppId);
            //alert('In bwEmailClient_Haraka.js.loadAndRenderEmails_TrashBin(). bwWorkflowAppId: ' + bwWorkflowAppId);
            var thiz = this;
            ...
            console.log('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_TrashBin(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_TrashBin(): ' + e.message + ', ' + e.stack);
        }
    },
    getMoreRecords_TrashBin: function () {
        console.log('In bwEmailClient_Haraka.js.getMoreRecords_TrashBin().');
        //alert('In bwEmailClient_Haraka.js.getMoreRecords_TrashBin().');
        var thiz = this;
                                            ...
                                            thiz.getAndRenderPagedEmails_TrashBin(startIndex, 5)
                                                .then(function (results) {
                                                    ...
                                                    for (var i = startIndex; i < emailItems.length; i++) { // Add these event listeners to all of the new ones.
                                                        ...
                                                        emailItems[i].addEventListener('dragstart', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_TrashBin.dragstart().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_TrashBin.dragstart(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
                                                        ...
                                                        emailItems[i].addEventListener('dragend', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_TrashBin.dragend().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_TrashBin.dragend(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
    ...
    getAndRenderPagedEmails_TrashBin: function (offset, limit) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_TrashBin().');
                //alert('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_TrashBin().');
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_TrashBin():2: ' + e.message + ', ' + e.stack;
                            console.log(msg);
                    ...
                    error: function (data, errorCode, errorMessage) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.getAndRenderPagedEmails_TrashBin():1: ' + errorCode + ', ' + errorMessage;
                        console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_TrashBin(): ' + e.message + ', ' + e.stack;
                console.log(msg);
    ...
    viewIndividualEmail_TrashBin: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, _id) {
        try {
            console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //alert('In bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin().');
            var thiz = this;
            ...
            this.displayExistingMessageHtml().then(function (results) {
                try {
                    if (results.status != 'SUCCESS') {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin(): ' + results.message;
                        console.log(msg);
                        displayAlertDialog(msg);

                    } else {

                        console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin(). Successfully returned from displayExistingMessageHtml().');
                        ...
                        thiz.loadIndividualEmail_TrashBin(_id).then(function () {
                            try {
                                ...
                                var html = '';
                                //html += 'From: <span class="EmailAddress_From">' + emailAddress + '</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; // + '[Reply]  [Reply All]  [Forward]';
                                html += '<span class="emailEditor_newMessageButton" xcx="xcx2134264-3" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Reply&nbsp;</span>';
                                html += '&nbsp;&nbsp;&nbsp;';
                                html += '<span class="emailEditor_newMessageButton" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Reply All&nbsp;</span>';
                                html += '&nbsp;&nbsp;&nbsp;';
                                html += '<span class="emailEditor_newMessageButton" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'composeANewEmailMessage_Reply\');">&nbsp;✉&nbsp;Forward&nbsp;</span>';
                                ...
                                thiz.renderIndividualEmail_ReadOnly(_id, 'TrashBin').then(function (results) { // strMailbox: ['Inbox', 'Sent', etc.]
                                    try {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (results) {
                                                        try {
                                                            ...
                                                            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin():8: ' + e.message + ', ' + e.stack;
                                                            console.log(msg);
                                                            displayAlertDialog(msg);
                                                        }
                                                    },
                                                    error: function (data, errorCode, errorMessage) {
                                                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin(): ' + errorCode + ', ' + errorMessage;
                                                        console.log(msg);
                                                        displayAlertDialog(msg);
                                                    }
                                                });
                                        ...
                                        var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin():7: ' + e.message + ', ' + e.stack;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    }

                                }).catch(function (e) {
                                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin():6: ' + JSON.stringify(e);
                                    console.log(msg);
                                    displayAlertDialog(msg);
                                });

                            } catch (e) {
                                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin():5: ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                displayAlertDialog(msg);
                            }

                        }).catch(function (e) {
                            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin():4: ' + JSON.stringify(e);
                            console.log(msg);
                            displayAlertDialog(msg);
                        });
                    ...
                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin():3: ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    displayAlertDialog(msg);
                }

            }).catch(function (e) {
                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin():2: ' + JSON.stringify(e);
                console.log(msg);
                displayAlertDialog(msg);
            });

        } catch (e) {
            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_TrashBin(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    ...
    loadIndividualEmail_TrashBin: function (_id) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.loadIndividualEmail_TrashBin(). _id: ' + _id);
                //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.loadIndividualEmail_TrashBin(). _id: ' + _id);
                ...
                if (hasBeenLoaded == true) {
                    ...
                    if (!(workflowAppId && participantId && _id)) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_TrashBin(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id;
                        console.log(msg);
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_TrashBin():xcx542: results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        ...
                                        if (!results.results) {
                                            ...
                                            if (!foundIt) {
                                                ...
                                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_TrashBin():xcx231312: Could not find the email.';
                                                console.log(msg);
                                    ...
                                    var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_TrashBin():2: ' + e.message + ', ' + e.stack;
                                    console.log(msg);
                            ...
                            error: function (data, errorCode, errorMessage) {
                                ...
                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_TrashBin():' + errorCode + ', ' + errorMessage;
                                console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_TrashBin():xcx453: ' + e.message + ', ' + e.stack;
    ...
    searchBox_OnKeyDown: function (event) {
        try {
            console.log('In bwEmailClient_Haraka.js.searchBox_OnKeyDown().');
            ...
            console.log('Exception in bwEmailClient_Haraka.js.searchBox_OnKeyDown(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.searchBox_OnKeyDown(): ' + e.message + ', ' + e.stack);
        }
    },
    loadAndRenderEmails_Search: function (bwWorkflowAppId) {
        try {
            console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Search().');
            //alert('In bwEmailClient_Haraka.js.loadAndRenderEmails_Search(). PREVIOUSLY KNOWN AS thiz.renderEmails_search(); DO WE GET HERE? divEmailPicker is recreated below, this needs to be fixed as it only gets created once in _create().');
            var thiz = this;
            ...
            console.log('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Search(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Search(): ' + e.message + ', ' + e.stack);
        }
    },
    getMoreRecords_Search: function () {
        console.log('In bwEmailClient_Haraka.js.getMoreRecords_Search().');
        //alert('In bwEmailClient_Haraka.js.getMoreRecords_Search().');
        var thiz = this;
                                            ...
                                            thiz.getAndRenderPagedEmails_Search(startIndex, 5)
                                                .then(function (results) {
                                                    ...
                                                    for (var i = startIndex; i < emailItems.length; i++) { // Add these event listeners to all of the new ones.
                                                        ...
                                                        emailItems[i].addEventListener('dragstart', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Search.dragstart().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Search.dragstart(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
                                                        ...
                                                        emailItems[i].addEventListener('dragend', function (e) {
                                                            try {
                                                                console.log('In bwEmailClient_Haraka.js.loadAndRenderEmails_Search.dragend().');
                                                                ...
                                                                var msg = 'Exception in In bwEmailClient_Haraka.js.loadAndRenderEmails_Search.dragend(): ' + e.message + ', ' + e.stack;
                                                                console.log(msg);
                                                                alert(msg);
                                                            }
                                                        });
    ...
    getAndRenderPagedEmails_Search: function (offset, limit) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Search().');
                //alert('In bwEmailClient_Haraka.js.getAndRenderPagedEmails_Search().');
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Search():2: ' + e.message + ', ' + e.stack;
                            console.log(msg);
                    ...
                    error: function (data, errorCode, errorMessage) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Search():1: ' + errorCode + ', ' + errorMessage;
                        console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.getAndRenderPagedEmails_Search(): ' + e.message + ', ' + e.stack;
                console.log(msg);
    ...
    viewIndividualEmail_Search: function (originElementId, bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, _id) {
        try {
            console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Search(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.viewIndividualEmail_Search(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ', _id: ' + _id);
            var thiz = this;
            ...
            this.displayExistingMessageHtml().then(function (results) {
                try {
                    if (results.status != 'SUCCESS') {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_Search(): ' + results.message;
                        console.log(msg);
                        displayAlertDialog(msg);

                    } else {

                        console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Search(). Successfully returned from displayExistingMessageHtml().');
                            ...
                            try {
                                ...
                                thiz.renderIndividualEmail_ReadOnly(_id, 'Search').then(function (results) { // strMailbox: ['Inbox', 'Sent', etc.]
                                    try {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (results) {
                                                        try {
                                                            ...
                                                            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Search():8: ' + e.message + ', ' + e.stack;
                                                            console.log(msg);
                                                            displayAlertDialog(msg);
                                                        }
                                                    },
                                                    error: function (data, errorCode, errorMessage) {
                                                        var msg = 'Error in bwEmailClient_Haraka.js.viewIndividualEmail_Search(): ' + errorCode + ', ' + errorMessage;
                                                        console.log(msg);
                                                        displayAlertDialog(msg);
                                                    }
                                                });
                                        ...
                                        var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Search():7: ' + e.message + ', ' + e.stack;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    }

                                }).catch(function (e) {
                                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Search():6: ' + JSON.stringify(e);
                                    console.log(msg);
                                    displayAlertDialog(msg);
                                });

                            } catch (e) {
                                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Search():5: ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                displayAlertDialog(msg);
                            }

                        }).catch(function (e) {
                            var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Search():4: ' + JSON.stringify(e);
                            console.log(msg);
                            displayAlertDialog(msg);
                        });
                    ...
                    var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Search():3: ' + e.message + ', ' + e.stack;
                    console.log(msg);
                    displayAlertDialog(msg);
                }

            }).catch(function (e) {
                var msg = 'Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Search():2: ' + JSON.stringify(e);
                console.log(msg);
                displayAlertDialog(msg);
            });
            ...
            console.log('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Search(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.viewIndividualEmail_Search(). originElementId: ' + originElementId + ', bwParticipantId: ' + bwParticipantId + ', bwParticipantFriendlyName: ' + bwParticipantFriendlyName + ', bwParticipantEmail: ' + bwParticipantEmail + ': ' + e.message + ', ' + e.stack);
        }
    },
    loadIndividualEmail_Search: function (_id) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.loadIndividualEmail_Search(). _id: ' + _id);
                //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.loadIndividualEmail_Search(). _id: ' + _id);
                ...
                if (hasBeenLoaded == true) {
                    ...
                    if (!(workflowAppId && participantId && _id)) {
                        ...
                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Search(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id;
                        console.log(msg);
                        ...
                        $.ajax({
                            ...
                            success: function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Search():xcx542: results: ' + JSON.stringify(results);
                                        console.log(msg);
                                        ...
                                        if (!results.doc) {
                                            ...
                                            if (!foundIt) {
                                                ...
                                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Search():xcx231312-2: Could not find the email with _id: ' + _id;
                                                console.log(msg);
                                    ...
                                    var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Search():2: ' + e.message + ', ' + e.stack;
                                    console.log(msg);
                            ...
                            error: function (data, errorCode, errorMessage) {
                                ...
                                var msg = 'Error in bwEmailClient_Haraka.js.loadIndividualEmail_Search():' + errorCode + ', ' + errorMessage;
                                console.log(msg);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.loadIndividualEmail_Search():xcx453: ' + e.message + ', ' + e.stack;
    ...
    displayNewMessageEditorHtml: function (email) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.displayNewMessageEditorHtml().');
                //alert('In bwEmailClient_Haraka.js.displayNewMessageEditorHtml().');
                ...
                //// Display the top buttons.
                //html = '';
                //html += '<button xcx="xcx213124-1-2" class="BwSmallButton" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'SendSingleEmailNow\');">SEND NOW >></button>';
                //html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                //html += '<button xcx="xcx213124-1" class="BwSmallButton" style="color:red;font-weight:bold;" onclick="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'saveDraft\');">SAVE DRAFT</button>';
                //$('#bwEmailClient_Haraka_EmailTopButtons').html(html);
                //// end: Display the top buttons.
                ...
                html += '<input xcx="xcx2131123-2" type="text" id="bwEmailClient_Haraka_RecipientsList" style="WIDTH: 85%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
                html += '<div id="bwEmailClient_Haraka_RecipientsList_PeoplePicker" style="display:none;"></div>';
                html += '</div>';

                html += '<div style="margin-bottom:10px;"><div style="width:80px;display:inline-block;">From:</div>';
                html += '<input type="text" value="' + participantEmail + '" id="bwEmailClient_Haraka_From" xcx="xcx2314" readonly="true" style="WIDTH: 85%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
                html += '</div>';

                html += '<div style="margin-bottom:10px;"><div style="width:80px;display:inline-block;">Subject:</div>';
                html += '<input type="text" id="bwEmailClient_Haraka_EmailSubject" style="WIDTH: 85%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
                html += '</div>';
                ...
                html += '       <div id="divBbwEmailClient_Haraka_BwAttachments"></div>';
                html += '   </td>';
                ...
                html += '       <div id="divBbwEmailClient_Haraka_BwAttachments_Inline"></div>';
                html += '   </td>';
                html += '</tr>';
                html += '</table>';

                html += '<div xcx="xcx342352153145" id="bwEmailClient_Haraka_EmailBody" class="xdTextBoxRequired bwRequestJson" contenteditable="true" bwdatarequired="true" title="" style="height:500px; min-height: 100% !important;WORD-WRAP: break-word; WHITE-SPACE: normal; OVERFLOW-X: auto; OVERFLOW-Y: auto; WIDTH: 100%;BACKGROUND-COLOR: white;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
                html += '</div>';

                //$('#spanSelectedEmail').html(html); // divEmailClient_CompositionWindow
                $('#divEmailClient_CompositionWindow').html(html);

                var bodyElement = $(thiz.element).find('#bwEmailClient_Haraka_EmailBody')[0];

                //
                // We have to do this to make the [enter] key work as expected, without inserting p/paragraph elemenets.
                //

                console.log('In bwEmailClient_Haraka.js.displayNewMessageEditorHtml(). THIS IS THE ONLY PLACE WHERE THE SUMMERNOTE OBJECT SHOULD BE INSTANTIATED.');
                ...
                //if (email) {
                //    alert('In bwEmailClient_Haraka.js.displayNewMessageEditorHtml(). Instantiating bwAttachments_ForEmail_ATTACHMENTS.js. email._id: ' + email._id);
                //} else {
                //    alert('In bwEmailClient_Haraka.js.displayNewMessageEditorHtml(). Instantiating bwAttachments_ForEmail_ATTACHMENTS.js.');
                //}

                $('#divBbwEmailClient_Haraka_BwAttachments').bwAttachments_ForEmail_ATTACHMENTS({ ATTACHMENTS: true });

                $('#divBbwEmailClient_Haraka_BwAttachments_Inline').bwAttachments_ForEmail_INLINE({ INLINE: true });

                //
                // Recipients list autocomplete for element [bwEmailClient_Haraka_RecipientsList].
                //

                $('#bwEmailClient_Haraka_RecipientsList_PeoplePicker').empty(); // Clear the search text box.

                // Now we can hook up the Participant text box for autocomplete.
                $("#bwEmailClient_Haraka_RecipientsList").autocomplete({
                        ...
                        try {
                            ...
                            if (searchTerm == '') {
                                ...
                                $.ajax({
                                    ...
                                    success: function (results) {
                                        try {
                                            $('#bwEmailClient_Haraka_RecipientsList_PeoplePicker').html(''); // bwEmailClient_Haraka_RecipientsList_PeoplePicker
                                                ...
                                                for (var i = 0; i < results.data.length; i++) {
                                                    ...
                                                    if (emails.split(';').length == 1) {
                                                        ...
                                                        if (alreadyDisplayedEmailsArray.indexOf(email) > -1) {
                                                            ...
                                                            html += '<a style="cursor:pointer !important;text-decoration:underline;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdReturnEmailToToField\', \'' + email + '\');">' + email + '</a>'; // cmdReturnParticipantIdToFieldForJson
                                            ...
                                            $('#bwEmailClient_Haraka_RecipientsList_PeoplePicker').append(html);

                                            document.getElementById('bwEmailClient_Haraka_RecipientsList_PeoplePicker').style.display = 'inline';

                                        } catch (e) {
                                            var msg = 'Exception in bwEmailClient_Haraka.js.displayNewMessageEditorHtml.bwEmailClient_Haraka_RecipientsList.autocomplete.ajax(): ' + e.message + ', ' + e.stack;
                                            console.log(msg);
                                            alert(msg);
                                        }
                                    },
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.displayNewMessageEditorHtml.bwEmailClient_Haraka_RecipientsList.autocomplete(): ' + e.message + ', ' + e.stack;
                            console.log(msg);
                            alert(msg);
                        }
                    },
                ...
                //
                // end: Recipients list autocomplete for element [bwEmailClient_Haraka_RecipientsList].
                //
                ...
                //    try {
                //        console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.drop().');
                //        e.preventDefault();

                //        var gotData;
                //        if (e.clipboardData) {
                //            console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.drop(). Object is event.clipboardData.');
                //            gotData = true;
                //        } else if (e.dataTransfer) {
                //            console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.drop(). Object is event.dataTransfer.');
                //            gotData = true;
                //        } else if (window.clipboardData) {
                //            console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.drop(). Object is window.clipboardData.');
                //            gotData = true;
                //        } else {
                ...
                //                alert('FIREFOX BROWSER CANNOT DRAG-AND-DROP EXTERNAL FILES. THERE IS A WORK-AROUND: Please right click on your source file, and choose "COPY". Subsequently, right click here and choose "PASTE".');
                //            } else {
                //                alert('Error in bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.drop(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                //            }
                ...
                //        } else {
                //            alert('Error in bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.drop(). Could not find a valid DataTransfer object.');
                //        }

                //    } catch (e) {
                //        var msg = 'Exception in bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.drop(): ' + e.message + ', ' + e.stack;
                //        console.log(msg);
                //        alert(msg);
                //    }
                //});
                ...
                //    try {
                //        console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.paste().');
                //        e.preventDefault();

                //        var gotData;
                //        if (e.clipboardData) {
                //            console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.paste(). Object is event.clipboardData.');
                //            gotData = true;
                //        } else if (e.dataTransfer) {
                //            console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.paste(). Object is event.dataTransfer.');
                //            gotData = true;
                //        } else if (window.clipboardData) {
                //            console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.paste(). Object is window.clipboardData.');
                //            gotData = true;
                //        } else {
                ...
                //                alert('FIREFOX BROWSER CANNOT DRAG-AND-DROP EXTERNAL FILES. THERE IS A WORK-AROUND: Please right click on your source file, and choose "COPY". Subsequently, right click here and choose "PASTE".');
                //            } else {
                //                alert('Error in bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.paste(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                //            }
                ...
                //            thiz.dodrop(e, bwBudgetRequestId);
                //        } else {
                //            alert('Error in bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.paste(). Could not find a valid DataTransfer object.');
                //        }

                //    } catch (e) {
                //        var msg = 'Exception in bwEmailClient_Haraka.js.composeANewEmailMessage.dropzone.paste(): ' + e.message + ', ' + e.stack;
                //        console.log(msg);
                //        alert(msg);
                //    }
                //});
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.displayNewMessageEditorHtml(): ' + e.message + ', ' + e.stack;
    ...
    displayExistingMessageHtml: function () {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.displayExistingMessageHtml().');
                //alert('In bwEmailClient_Haraka.js.displayExistingMessageHtml().');
                ...
                // WAS: bwEmailView_To, bwEmailView_From, spanSelectedEmailSubject. NOW: bwEmailClient_Haraka_RecipientsList, bwEmailClient_Haraka_From, bwEmailClient_Haraka_EmailSubject.

                html += '<div style="margin-bottom:10px;"><div style="width:80px;display:inline-block;">From:</div>';
                html += '<input type="text" value="' + participantEmail + '" id="bwEmailClient_Haraka_From" xcx="xcx2314" readonly="true" style="WIDTH: 75%;font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif;color: #262626;font-size: 15pt;">';
                html += '&nbsp;&nbsp;&nbsp;&nbsp;<span id="bwEmailClient_Haraka_InternalExternalStatus" style="color:tomato;font-weight:bold;">[bwEmailClient_Haraka_InternalExternalStatus]</span>';
                html += '</div>';
                ...
                html += '   <div id="bwEmailClient_Haraka_EmailAttachments"></div>';
                ...
                //html += '   </div>';
                html += '   <div id="bwEmailClient_Haraka_EmailBody" xcx="xcx132166-6" style="padding:15px 20px 10px 15px;border:2px solid lightgray;background-color:white;min-height:500px;"></div>'; // This style is pretty good. I like the white background and padding. 7-8-2024.
                ...
                //    // Display the top buttons.
                //    html += '                           <span xcx="xcx231232-2" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + workflowAppId + '\');">';
                //    html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
                //    html += '                           </span>';
                //    html += '&nbsp;&nbsp;';
                //    html += '                           <span xcx="xcx231232-2" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + workflowAppId + '\', \'emptyfolder\');">';
                //    html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
                //    html += '                           </span>';
                ...
                //    // Display the radio button and the title.
                //    html = '';
                //    html += '<input type="checkbox" id="checkboxToggleSentEmailCheckboxes" onchange="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'toggleSentEmailCheckboxes\', this);" />&nbsp;&nbsp;';
                //    html += '✉ Sent Items';

                //    $(thiz.element).find('#spanSelectedEmailType_Title')[0].innerHTML = html; //'Sent Email';

                //    // Make this button appear selected.
                //    $(thiz.element).find('#spanDisplaySentEmailButton').removeClass('bwEmailClient_Haraka_LeftMenuButton').addClass('bwEmailClient_Haraka_LeftMenuButton_Selected');
                //    $(thiz.element).find('#spanDisplayPendingEmailButton').removeClass('bwEmailClient_Haraka_LeftMenuButton_Selected').addClass('bwEmailClient_Haraka_LeftMenuButton');
                ...
                ////html += '                           <span xcx="xcx231232-1" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteInboxEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
                ////html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
                ////html += '                           </span>';
                ////html += '&nbsp;&nbsp;';
                ////html += '                           <span xcx="xcx231232-1" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteInboxEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
                ////html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
                ////html += '                           </span>';
                ////$(thiz.element).find('#spanSelectedEmailType_TopButtons')[0].innerHTML = html; //'Pending Email';
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.displayExistingMessageHtml(): ' + e.message + ', ' + e.stack;
    ...
    renderIndividualEmail_Editable: function (_id, strMailbox) { // strMailbox: ['Inbox', 'Sent', etc.]
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.renderIndividualEmail_Editable().');
                displayAlertDialog('In bwEmailClient_Haraka.js.renderIndividualEmail_Editable().');

                //alert('Setting dom element _id to: ' + _id);
                $(thiz.element).find('#divEmailClient_CompositionWindow')[0].setAttribute('_id', _id);

                $(thiz.element).find('.bwEmailClient_Haraka_InnerLeftMenuButton_Selected').removeClass('bwEmailClient_Haraka_InnerLeftMenuButton_Selected'); // Reset them all, only 1 can be selected at a time.
                $('#bwEmailClient_Haraka_InnerLeftMenuButton_' + _id).removeClass('bwEmailClient_Haraka_InnerLeftMenuButton').addClass('bwEmailClient_Haraka_InnerLeftMenuButton_Selected'); // Indicate this one as selected.
                ...
                if (!email) {
                    ...
                    var msg = 'Error in bwEmailClient_Haraka.js.renderIndividualEmail_Editable(). COULD NOT LOCATE EMAIL. _id: ' + _id + ', strMailbox: ' + strMailbox;
                    console.log(msg);
                    alert(msg);
                    ...
                    $('#bwEmailClient_Haraka_From').val(emailAddress);
                    ...
                    $('#bwEmailClient_Haraka_InternalExternalStatus').html(internalExternalStatus);
                    ...
                    $('#bwEmailClient_Haraka_RecipientsList').val(emailToHtml);
                    ...
                    thiz.cleanEmailBodyHtmlForDisplay(email.html).then(function (results) {
                        try {
                            ...
                            if (results.status != 'SUCCESS') {
                                ...
                                $('#bwEmailClient_Haraka_EmailBody').summernote('code', results.html);

                                console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(). >>>>>>>>>> Here is a good opportunity to vertically stretch the .note-editor. xcx99385667.');
                                //alert('In bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(). >>>>>>>>>> Here is a good opportunity to vertically stretch the .note-editor. xcx99385667.');
                                ...
                                if (emailTemplateForSubject && emailTemplateForSubject != '') {
                                    $(thiz.element).find('#bwEmailClient_Haraka_EmailSubject')[0].value = emailTemplateForSubject;
                                } else {
                                    $(thiz.element).find('#bwEmailClient_Haraka_EmailSubject')[0].value = '';
                                }

                                //console.log('In bwEmailClient_Haraka.js.viewIndividualEmail_Inbox(). Turned off this call to bwActiveMenu.js.adjustLeftSideMenu(). DO WE NEED IT BACK????????? 12-24-2022');
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.renderIndividualEmail_Editable():3: ' + e.message + ', ' + e.stack;
                        ...
                        var msg = 'Exception in bwEmailClient_Haraka.js.renderIndividualEmail_Editable():2: ' + JSON.stringify(e);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.renderIndividualEmail_Editable(): ' + e.message + ', ' + e.stack;
    ...
    renderIndividualEmail_ReadOnly: function (_id, strMailbox) { // strMailbox: ['Inbox', 'Sent', 'Drafts', 'Junk', 'Archived', 'TrashBin']
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.renderIndividualEmail_ReadOnly().');
                //alert('In bwEmailClient_Haraka.js.renderIndividualEmail_ReadOnly().');
                ...
                if (!email) {
                    ...
                    var msg = 'Error in bwEmailClient_Haraka.js.renderIndividualEmail_ReadOnly(). COULD NOT LOCATE EMAIL. _id: ' + _id + ', strMailbox: ' + strMailbox;
                    ...
                    thiz.cleanEmailBodyHtmlForDisplay(email.html).then(function (results) {
                        try {
                            ...
                            if (results.status != 'SUCCESS') {
                                ...
                                // Display the email. If there are attachments, we come behind and backfill them. This makes it easier so we can use the DOM to do this.
                                console.log('Displaying the email. xcx23123435.');
                                $('#bwEmailClient_Haraka_EmailBody').html(results.html);
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.renderIndividualEmail_ReadOnly():3: ' + e.message + ', ' + e.stack;
                        ...
                        var msg = 'Exception in bwEmailClient_Haraka.js.renderIndividualEmail_ReadOnly():2: ' + JSON.stringify(e);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.renderIndividualEmail_ReadOnly(): ' + e.message + ', ' + e.stack;
    ...
    renderAttachments: function (_id, attachments) { // attachments is the array named attachments, from the email object/json.
        try {
            console.log('In bwEmailClient_Haraka.js.renderAttachments().');
            //alert('In bwEmailClient_Haraka.js.renderAttachments().');
            var thiz = this;
                    ...
                    if (attachments[j].contentDisposition == 'attachment') {
                        ...
                        switch (attachments[j].contentType) {
                            ...
                            case 'application/vnd.openxmlformats-officedocument.wordprocessingml.document':
                                ...
                                $('#bwEmailClient_Haraka_EmailAttachments').append(html);
                            ...
                            case 'application/pdf':
                                ...
                                if (!attachments[j].fileName) {
                                    ...
                                    if (!attachments[j].filename) {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.renderAttachments(): No valid value for filename or fileName was found for an email attachment. xcx213123123-2.';
                                        console.log(msg);
                                        displayAlertDialog_Persistent(msg);

                                    } else {

                                        var msg = 'Error in bwEmailClient_Haraka.js.renderAttachments(): No valid value for fileName was found for an email attachment, but did find a value for filename. xcx213123123-2.';
                                        console.log(msg);
                                        displayAlertDialog_Persistent(msg);
                                ...
                                var thumbnailFilename = attachments[j].fileName + '_60px_.png'; // 8-4-2024.
                            ...
                            case 'image/png': case 'image/jpeg': case 'image/pipeg':
                                ...
                                html += '<div class="bwEmailAttachment" xcx="xcx2131255-3-2" onclick="$(\'.bwAttachmentDialog\').bwAttachmentDialog(\'displayAttachmentInDialog\', \'' + fileUrl + '\', \'' + '[no filename]' + '\', \'[no description]\', \'x0d3d3e8c-1026-4518-9744-cb313c66a153x\');" ><img src="' + fileUrl_thumbnail + '" style="height:60px;" onmouseenter="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'showRowHoverDetails\', \'' + fileUrl + '\', this);this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseleave="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'hideRowHoverDetails\');this.style.backgroundColor=\'white\';" />&nbsp;&nbsp;' + attachments[j].fileName + '</div>';
                                $('#bwEmailClient_Haraka_EmailAttachments').append(html);
                        ...
                        //   - We need to find the <img element with the matching CID, then substitute this URL, so that it displays in the bwEmailClient_Haraka.js editor Ok.
                        //

                        var imgElements = $('#bwEmailClient_Haraka_EmailBody:first').find('img');
            ...
            var msg = 'Exception in bwEmailClient_Haraka.js.renderAttachments(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    cleanEmailBodyHtmlForDisplay: function (emailHtml) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwEmailClient_Haraka.js.cleanEmailBodyHtmlForDisplay().');
                //alert('In bwEmailClient_Haraka.js.cleanEmailBodyHtmlForDisplay().');
                ...
                if (!emailHtml) {
                    ...
                    var elements = divElement.getElementsByTagName('*');
                    for (var i = 0; i < elements.length; i++) {
                        if (elements[i] && elements[i].className && elements[i].className.split) {
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.cleanEmailBodyHtmlForDisplay(): ' + e.message + ', ' + e.stack;
                console.log(msg);
                displayAlertDialog(msg);
    ...
    renderMailboxItemInList: function (doc, element, mailboxName, prepend) { // mailboxName: ['Inbox', 'Sent', etc.] // prepend: [true, false] optional
        try {
            console.log('In bwEmailClient_Haraka.js.renderMailboxItemInList().');
            var thiz = this;
            ...
            html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" _id="' + doc._id + '" class="bwEmailMailboxRow" bwdevnote="The selected email background color is set at [xcx213235991]." xcx="xcx2224555-3" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_' + mailboxName + '\', \'' + 'btnEditRaciRoles_' + doc.bwParticipantId + '\', \'' + doc.bwParticipantId + '\', \'' + doc.bwParticipantFriendlyName + '\', \'' + doc.bwParticipantEmail + '\', \'' + doc._id + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + doc.bwParticipantId + '\', \'' + doc.bwParticipantId + '\');">';
            //html += '    <td style="vertical-align:top;max-width:20px;">';
            //html += '       <input type="checkbox" style="transform:scale(2);" class="inboxEmailCheckbox" bwinboxemailid="' + doc._id + '" />';
            //html += '   </td>';


            //html += '    <td class="bwemailitems" _id="' + doc._id + '" draggable="true" id="bwEmailClient_Haraka_InnerLeftMenuButton_' + doc._id + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;max-width:350px;">';
            html += '    <td class="bwemailitems" _id="' + doc._id + '" draggable="true" id="bwEmailClient_Haraka_InnerLeftMenuButton_' + doc._id + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
                    ...
                    if (doc.attachments[j].contentDisposition == 'inline') { // contentDisposition: [inline, attachment]
                        ...
                        switch (doc.attachments[j].contentType) {
                            ...
                            case 'image/png': case 'image/jpeg':
                                ...
                                var thumbnailFilename = doc.attachments[j].fileName + '_60px_.png'; // 8-4-2024.
                                ...
                                iconHtml += '<img src="' + fileUrl_thumbnail + '" style="width:40px;float:right;" id="tempElementId1" xcx="xcx12312342-1-1" onmouseenter="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'showRowHoverDetails\', \'' + fileUrl + '\', this);this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseleave="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'hideRowHoverDetails\');this.style.backgroundColor=\'white\';" />';
                            ...
                            case 'image/png': case 'image/jpeg': case 'image/pipeg':
                                ...
                                if (!doc.attachments[j].fileName) {
                                    ...
                                    if (!doc.attachments[j].filename) {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.xx(): No valid value for filename or fileName was found for an email attachment. xcx213123123-1.';
                                        console.log(msg);
                                        displayAlertDialog_Persistent(msg);

                                    } else {

                                        var msg = 'Error in bwEmailClient_Haraka.js.xx(): No valid value for fileName was found for an email attachment, but did find a value for filename. xcx213123123-1.';
                                        console.log(msg);
                                        displayAlertDialog_Persistent(msg);
                                ...
                                var participantId = $('.bwAuthentication').bwAuthentication('option', 'participantId');
                                debugger; // 8-13-2024. bad ASI
                                console.log('IS THS THE WRONG JSON.parse(activeStateIdentifier).ActiveStateIdentifier: ' + JSON.parse(activeStateIdentifier).ActiveStateIdentifier);
                                fileUrl_thumbnail = thiz.options.operationUriPrefix + '_files/_emailAttachments/' + participantId + '/' + doc._id + '/ATTACHMENTS/' + encodeURIComponent(thumbnailFilename) + '?v=' + preventCachingGuid + '&ActiveStateIdentifier=' + JSON.parse(activeStateIdentifier).ActiveStateIdentifier; 
                                fileUrl = thiz.options.operationUriPrefix + '_files/_emailAttachments/' + participantId + '/' + doc._id + '/ATTACHMENTS/' + encodeURIComponent(doc.attachments[j].fileName) + '?v=' + preventCachingGuid + '&ActiveStateIdentifier=' + JSON.parse(activeStateIdentifier).ActiveStateIdentifier;  


                                //}

                                iconHtml += '<img src="' + fileUrl_thumbnail + '" style="width:40px;float:right;" id="tempElementId1" xcx="xcx12312342-1-2-xcx2" onmouseenter="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'showRowHoverDetails\', \'' + fileUrl + '\', this);this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseleave="$(\'.bwEmailClient_Haraka:first\').bwEmailClient_Haraka(\'hideRowHoverDetails\');this.style.backgroundColor=\'white\';" />';
            ...
            html += '<td class="bwEmailClient_Haraka_Trashbin" style="max-width:40px;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteIndividualEmail\', \'' + doc._id + '\', \'' + mailboxName + '\');event.stopPropagation();">';
            ...
            console.log('Exception in bwEmailClient_Haraka.js.renderMailboxItemInList(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.renderMailboxItemInList(): ' + e.message + ', ' + e.stack);
        }
    },

    loadNewEmail_bwNotificationSound_Notification: function (results) { // The results come in as a string, the  results from _bw/doweneedtomakeanotificationsound.
        var thiz = this;
        return new Promise(function (resolve, reject) {
            try {
                ...
                //
                //   IT IS IMPORTANT that it checks to see if it is displayed already. Also, it needs to check if it has been put in the TrashBin/Archive already. 8-9-2024.
                //

                if (!(results && results.bwNotificationDetailsJson && results.bwNotificationDetailsJson.length)) {

                    var msg = 'In bwEmailClient_Haraka.js.loadNewEmail_bwNotificationSound_Notification(). Invalid value for bwNotificationDetailsJson. results: ' + JSON.stringify(results);
                    console.log(msg);
                    displayAlertDialog(msg);
                    ...
                    if (!(displayedInboxRows && displayedInboxRows.length && (displayedInboxRows.length > 0))) {
                        ...
                        var msg = 'In bwEmailClient_Haraka.js.loadNewEmail_bwNotificationSound_Notification(). No email is being displayed. Could not find element [.bwEmailMailboxRow].';

                        var result = {
                            status: 'SUCCESS',
                            message: msg,
                            playTheSound: playTheSound
                        }
                        ...
                        //
                        // The user is viewing their Inbox. We need to add the new email to their list. This makes for a pleasant user experience. 6-18-2024. NOTE IF THERE ARE NO ROWS, WE NEED TO FIX THAT!!!!!!!!!!!!!!!! <<<<<<<<<<<<<<<<<<<<<<<
                        //
                        ...
                        for (var i = 0; i < bwNotificationDetailsJson.length; i++) {
                            ...
                            var addTheEmailToTheInbox = true;
                            if (!(thiz.options.Inbox && thiz.options.Inbox.docs && thiz.options.Inbox.docs.length)) {

                                var msg = 'Error in bwEmailClient_Haraka.js.loadNewEmail_bwNotificationSound_Notification(). No docs in the Inbox, and the Inbox has not been initialized.';
                                console.log(msg);
                                displayAlertDialog(msg);
                                ...
                                if (thiz.options.TrashBin && thiz.options.TrashBin.docs) {
                                    for (var j = 0; j < thiz.options.TrashBin.docs.length; j++) {
                                        if (thiz.options.TrashBin.docs[j]._id == bwNotificationDetailsJson[i]._id) {
                                            addTheEmailToTheInbox = false; // It is already in the TrashBin.
                                            playTheSound = false;
                                            break;
                                        }
                                    }
                                ...
                                if (thiz.options.Archived && thiz.options.Archived.docs) {
                                    for (var j = 0; j < thiz.options.Archived.docs.length; j++) {
                                        if (thiz.options.Archived.docs[j]._id == bwNotificationDetailsJson[i]._id) {
                                            addTheEmailToTheInbox = false; // It is already in the Archived folder.
                                            playTheSound = false;
                                            break;
                                        }
                                    }
                                ...
                                if (addTheEmailToTheInbox) {
                                    for (var j = 0; j < thiz.options.Inbox.docs.length; j++) {
                                        if (thiz.options.Inbox.docs[j]._id == bwNotificationDetailsJson[i]._id) {
                                            addTheEmailToTheInbox = false; // It's already in the Inbox.
                                            playTheSound = false;
                                            break;
                                        }
                                    }
                                ...
                                if (addTheEmailToTheInbox == true) { // It's not already in the Inbox, so we should add it, and display it at the top of the list.

                                    //
                                    // Trying to figure out the orphaned or something email which I delete but then comes back at weird times lol. 1-2-2025.
                                    //
                                    var msg = 'Its not already in the Inbox, so we should add it, and display it at the top of the list.';
                                    console.log(msg);
                                    //displayAlertDialog(msg);

                                    thiz.options.Inbox.docs.push(bwNotificationDetailsJson[i]);

                                    var element = $(thiz.element).find('#tableEmailPicker')[0];
                                    console.log('xcx231223 calling renderMailboxItemInList().');
                                    thiz.renderMailboxItemInList(bwNotificationDetailsJson[i], element, 'Inbox', true);
                ...
                var msg = 'Exception in bwEmailClient_Haraka.js.loadNewEmail_bwNotificationSound_Notification(): ' + e.message + ', ' + e.stack;
                console.log(msg);
                displayAlertDialog(msg);
            ...
            //try {
            //    console.log('In bwEmailClient_Haraka.js.loadNewEmail_bwNotificationSound_Notification().');
            //    //displayAlertDialog_Persistent('In bwEmailClient_Haraka.js.loadNewEmail_bwNotificationSound_Notification(). results: ' + JSON.stringify(results));
            ...
            //    var msg = 'Error in bwEmailClient_Haraka.js.loadNewEmail_bwNotificationSound_Notification(). Invalid value for bwNotificationDetailsJson.';
            ...
            //    var msg = 'In bwEmailClient_Haraka.js.loadNewEmail_bwNotificationSound_Notification(). Play the sound.';
    ...
    dodrop: function (event, mailbox) { // mailbox: ['INBOX', ...] 
        try {
            console.log('In bwEmailClient_Haraka.js.dodrop(). mailbox: ' + mailbox);
            //alert('In bwEmailClient_Haraka.js.dodrop(). mailbox: ' + mailbox);
            var thiz = this;

            if (event.dataTransfer.items.length == 0) {

                alert('In bwEMailClient_Haraka.js.dodrop(). NO event.dataTransfer ITEMS xcx23123123. event: ' + JSON.stringify(event));
                ...
                console.log('In bwEmailClient_Haraka.js.dodrop(). Moving email [' + data._id + '] from ' + fromMailbox + ' to ' + toMailbox + '.');
                //alert('In bwEmailClient_Haraka.js.dodrop(). Moving email [' + data._id + '] from ' + fromMailbox + ' to ' + toMailbox + '.');
                ...
                if (fromMailbox == 'INBOX') {
                    ...
                    var msg = 'In bwEmailClient_Haraka.js.dodrop(). Currently only moving items from the INBOX is supported. This action cannot be completed.';
                    console.log(msg);
                    displayAlertDialog(msg);
            ...
            var msg = '';
            if (data1) {
                msg = 'Exception in bwEmailClient_Haraka.js.dodrop(). data1: ' + data1 + ' :: ' + e.message + ', ' + e.stack;
            } else {
                msg = 'Exception in bwEmailClient_Haraka.js.dodrop(): ' + e.message + ', ' + e.stack;
            }
            console.log(msg);
            displayAlertDialog_Persistent(msg);
    ...
    showRowHoverDetails: function (fileUrl, imgElement) {
        try {
            console.log('In bwEmailClient_Haraka.js.showRowHoverDetails().');
            //alert('In bwEmailClient_Haraka.js.showRowHoverDetails().'); // id: ' + $(imgElement).attr('id'));
            var thiz = this;
            ...
            var div = document.getElementById('bwEmailClient_Haraka_ImageHoverOverDialog');
            if (!div) { // for some reason this gets added twice to the DOM. Figure this out someday, but for now this seems to fix it and is a good safety I suppose.
                div = document.createElement('div');
                div.id = 'bwEmailClient_Haraka_ImageHoverOverDialog';
            ...
            $('#bwEmailClient_Haraka_ImageHoverOverDialog').dialog({
                resizable: false,
                draggable: false,
                width: "760",
                position: position,
                open: function (event, ui) {
                    try {
                        ...
                        console.log('Exception in bwEmailClient_Haraka.js.showRowHoverDetails.dialog.open(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwEmailClient_Haraka.js.showRowHoverDetails.dialog.open(): ' + e.message + ', ' + e.stack);
                    }
                },
                close: function () {
                    $('#bwEmailClient_Haraka_ImageHoverOverDialog').dialog('destroy');
                }
            });
            $('#bwEmailClient_Haraka_ImageHoverOverDialog').dialog().parents('.ui-dialog').find('.ui-dialog-titlebar').remove();

        } catch (e) {
            console.log('Exception in bwEmailClient_Haraka.js.showRowHoverDetails(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.showRowHoverDetails(): ' + e.message + ', ' + e.stack);
        }
    },

    hideRowHoverDetails: function (e) {
        try {
            console.log('In bwEmailClient_Haraka.js.hideRowHoverDetails().');
            //alert('In bwEmailClient_Haraka.js.hideRowHoverDetails().');

            $('#bwEmailClient_Haraka_ImageHoverOverDialog').dialog('close');

        } catch (e) {
            console.log('Exception in bwEmailClient_Haraka.js.hideRowHoverDetails(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.hideRowHoverDetails(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    displayEmailInDialog: function (TrashBin, budgetRequestId, arNamexx, brTitle, title, bwAssignedToRaciRoleAbbreviation, bwWorkflowTaskItemId, bwRequestJson) { // If invoked from a task link, make sure bwWorkflowTaskItemId is populated!!!! 12-23-2021
        try {
            ...
            //
            console.log('In bwEmailClient_Haraka.js.displayEmailInDialog(). budgetRequestId: ' + budgetRequestId + ', bwWorkflowTaskItemId: ' + bwWorkflowTaskItemId + ', TrashBin: ' + TrashBin);
            //alert('In bwEmailClient_Haraka.js.displayEmailInDialog(). budgetRequestId: ' + budgetRequestId + ', bwWorkflowTaskItemId: ' + bwWorkflowTaskItemId + ', TrashBin: ' + TrashBin);
            var thiz = this;
                ...
                for (var i = 0; i < poppedOutRequestWindows.length; i++) {
                    if (poppedOutRequestWindows[i].bwBudgetRequestId == budgetRequestId) {
                        ...
                        if (poppedOutRequestWindows[i].windowObjectReference.closed) {
                            console.log('Error? in bwEmailClient_Haraka.js.displayEmailInDialog(). The popped-out window was in the list, but does not actually exist.');
            ...
            console.log('In bwEmailClient_Haraka.js.displayEmailInDialog(). There are ' + windowCount + ' popped-out windows for us to check to make sure we don\'t display a request more than once.');
            ...
            if (alreadyDisplayingTheRequest == true) {
                ...
                if (budgetrequestform) {
                    ...
                    console.log('');
                    console.log('==========================================');
                    console.log('In bwEmailClient_Haraka.js.displayEmailInDialog(). This request is already being displayed, so bringing it to the top. budgetRequestId: ' + budgetRequestId);
                    console.log('==========================================');
                    console.log('');
                    ...
                    if (bwRequestJson) {
                        console.log('In bwEmailClient_Haraka.js.displayEmailInDialog(). bwRequestJson has been passed.');
                    }
                    ...
                    if (displayTaskDetailsBeforeRequests != true) {
                        ...
                        console.log('In bwEmailClient_Haraka.js.displayEmailInDialog(). IS THIS THE ONLY PLACE THIS SHOULD BE HAPPENING? 3-16-2022 xcx3243465');
                        ...
                        if (!budgetRequestId && !brTitle) {
                            ...
                            alert('In bwEmailClient_Haraka.js.displayEmailInDialog(). This means we are coming from a .xsl, so we have to find the values.');
                            ...
                            alert('In bwEmailClient_Haraka.js.displayEmailInDialog(). !appWebUrl && !budgetRequestId && !title.');
                            ...
                            alert('In bwEmailClient_Haraka.js.displayEmailInDialog(). This shows the AR in the dialog.');
                            ...
                            try {
                                ...
                                $.ajax({
                                    ...
                                    success: function (wtItems) {
                                        try {
                                            ...
                                            console.log('Exception in bwEmailClient_Haraka.js.displayEmailInDialog():xcx335-6: ' + e.message + ', ' + e.stack);
                                            displayAlertDialog('Exception in bwEmailClient_Haraka.js.displayEmailInDialog():xcx335-6: ' + e.message + ', ' + e.stack);
                                        }
                                    },
                                    error: function (error) {
                                        var msg = 'Error in bwEmailClient_Haraka.js.displayEmailInDialog(). error: ' + error;
                                        console.log(msg);
                                        alert(msg);
                                    }
                                ...
                                var msg = 'Exception in bwEmailClient_Haraka.js.displayEmailInDialog():2: ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                alert(msg);
                            }
            ...
            var msg = 'Exception in bwEmailClient_Haraka.js.displayEmailInDialog():1: ' + e.message + ', ' + e.stack;
            console.log(msg);
            alert(msg);
        }
    },
    ...
    LaunchIntoDialog: function (requestDialogId, bwBudgetRequestId, bwWorkflowTaskItemId) { // See also method displayRequestFormInNewBrowserWindow().
        try {
            console.log('In bwEmailClient_Haraka.js.LaunchIntoDialog().');
            alert('In bwEmailClient_Haraka.js.LaunchIntoDialog().');
            ...
            //// When the window.open is called, bwAuthentication.js.checkIfAuthenticatedAndProcessQuerystringParameters() handles the loading of the request form... by calling bwEmailClient_Haraka.js.displayRequestFormInNewBrowserWindow().
            ...
            console.log('Exception in bwEmailClient_Haraka.js.LaunchIntoDialog(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.LaunchIntoDialog(): ' + e.message + ', ' + e.stack);
        }
    },

    saveDraft: function () {
        try {
            console.log('In bwEmailClient_Haraka.js.saveDraft().');
            //alert('In bwEmailClient_Haraka.js.saveDraft(). This functionality is incomplete. Coming soon!');
            var thiz = this;
            ...
            var recipients; // = [];
            var singleRecipient = $('#bwEmailClient_Haraka_RecipientsList').val(); // 'fred@budgetworkflow.com;betty@budgetworkflow.com;dino@budgetworkflow.com'
            recipients = singleRecipient;

            var fromEmailAddress = participantEmail;
            var subject = $('#bwEmailClient_Haraka_EmailSubject').val();
            var body = $('#bwEmailClient_Haraka_EmailBody').summernote('code');
            var _id = $('#divEmailClient_CompositionWindow')[0].getAttribute('_id');

            if (!_id) {

                var msg = 'Error in bwEmailClient_Haraka.js.saveDraft(). INVALID VALUE FOR _id: ' + _id;
                console.log(msg);
                displayAlertDialog(msg);
                    ...
                    success: function (results) {
                        try {
                            ...
                            if (results.status != 'SUCCESS') {
                                ...
                                //alert('>>> In bwEmailClient_Haraka.js.saveDraft(). Saved DRAFT EMAIL, RETURNED VALUE FOR _id: ' + _id);
                                ...
                                if (thiz.options.Drafts && thiz.options.Drafts.docs && thiz.options.Drafts.docs.length) {
                                    ...
                                    //        } catch (e) {
                                    //            console.log('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts():2: ' + e.message + ', ' + e.stack);
                                    //            displayAlertDialog('Exception in bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts():2: ' + e.message + ', ' + e.stack);
                                    //        }
                                    //    },
                                    //    error: function (data, errorCode, errorMessage) {
                                    //        console.log('Error in bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts():' + errorCode + ', ' + errorMessage);
                                    //        displayAlertDialog('Error in bwEmailClient_Haraka.js.loadAndRenderEmails_Drafts():' + errorCode + ', ' + errorMessage);
                                    //    }
                                    //});
                            ...
                            console.log('Exception in bwEmailClient_Haraka.js.saveDraft():2: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwEmailClient_Haraka.js.saveDraft():2: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (data, errorCode, errorMessage) {
                        console.log('Error in bwEmailClient_Haraka.js.saveDraft():' + errorCode + ', ' + errorMessage);
                        displayAlertDialog('Error in bwEmailClient_Haraka.js.saveDraft():' + errorCode + ', ' + errorMessage);
                    }
                });
            ...
            console.log('Exception in bwEmailClient_Haraka.js.saveDraft(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.saveDraft(): ' + e.message + ', ' + e.stack);
        }
    },
    addAttachment: function () {
        try {
            console.log('In bwEmailClient_Haraka.js.addAttachment().');

            alert('This functionality is incomplete. Coming soon!');

        } catch (e) {
            console.log('Exception in bwEmailClient_Haraka.js.addAttachment(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.addAttachment(): ' + e.message + ', ' + e.stack);
        }
    },
    addInlineImage: function () {
        try {
            console.log('In bwEmailClient_Haraka.js.addInlineImage().');

            alert('This functionality is incomplete. Coming soon!');

        } catch (e) {
            console.log('Exception in bwEmailClient_Haraka.js.addInlineImage(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.addInlineImage(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    deleteIndividualEmail: function (_id, mailboxName) { // mailboxName: ['Inbox', 'Sent', 'Drafts', 'Junk', 'Archived', 'TrashBin']
        try {
            console.log('In bwEmailClient_Haraka.js.deleteIndividualEmail(). _id: ' + _id + ', mailboxName: ' + mailboxName);
            //alert('In bwEmailClient_Haraka.js.deleteIndividualEmail(). _id: ' + _id + ', mailboxName: ' + mailboxName);
            var thiz = this;
            ...
            if (!(workflowAppId && participantId && _id && mailboxName)) {
                ...
                console.log('Error in bwEmailClient_Haraka.js.deleteIndividualEmail(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id + ', mailboxName: ' + mailboxName);
                displayAlertDialog('Error in bwEmailClient_Haraka.js.deleteIndividualEmail(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id + ', mailboxName: ' + mailboxName);

            } else {

                console.log('In bwEmailClient_Haraka.js.deleteIndividualEmail(). Hide the red dot. Presumably, when the user looks at an email, it is time to hide the dot. We will try it out and see... 8-31-2024.');
                document.getElementById('imgMessagingNotificationRedDot').style.display = 'none'; // Hide the red dot. Presumably, when the user looks at an email, it is time to hide the dot. We will try it out and see... 8-31-2024.
                $('.bwNotificationSound').bwNotificationSound('renderFavicon', false); // Turn off the red dot on the favicon.
                ...
                if (mailboxName == 'Inbox') {
                    ...
                    ShowActivitySpinner_Promise('Moving to the TrashBin...')
                        .then(function (results) {
                            try {
                                ...
                                $.ajax({
                                    ...
                                    success: function (results) {
                                        try {
                                            ...
                                            if (results.status != 'SUCCESS') {
                                                ...
                                                for (var i = 0; i < thiz.options.Inbox.docs.length; i++) {
                                                    if (thiz.options.Inbox.docs[i]._id == _id) {
                                                        ...
                                                        // First, put it in the local options.TrashBin, so that the notification sound will know if we deleted it or not.
                                                        if (!thiz.options.TrashBin) {
                                                            thiz.options.TrashBin = {
                                                                docs: []
                                                            }
                                                        } 
                                                        thiz.options.TrashBin.docs.push(thiz.options.Inbox.docs[i])
                                                ...
                                                if (!foundIt) {
                                                    ...
                                                    var elementName = 'bwEmailClient_Haraka_InnerLeftMenuButton_' + _id;
                                                    ...
                                                    if (currentlyDisplayedEmail_id == _id) {
                                                        ...
                                                        $('#bwEmailClient_Haraka_EmailTopButtons').html('');
                                            ...
                                            console.log('Exception in bwEmailClient_Haraka.js.deleteIndividualEmail():4: ' + e.message + ', ' + e.stack);
                                            displayAlertDialog('Exception in bwEmailClient_Haraka.js.deleteIndividualEmail(): 4:' + e.message + ', ' + e.stack);
                                        }
                                    },
                                    error: function (data, errorCode, errorMessage) {
                                        ...
                                        var msg = 'Fail in bwEmailClient_Haraka.js.deleteIndividualEmail(): ' + JSON.stringify(data) + ', ' + errorCode + ', ' + errorMessage;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                ...
                                var msg = 'Exception in bwEmailClient_Haraka.js.deleteIndividualEmail():3: ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                displayAlertDialog(msg);
                        ...
                        .catch(function (e) {
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.deleteIndividualEmail():2: ' + JSON.stringify(e);
                            console.log(msg);
                            displayAlertDialog(msg);
                    ...
                    var msg = 'Error in bwEmailClient_Haraka.js.deleteIndividualEmail(). Invalid value for mailboxName: ' + mailboxName;
                    console.log(msg);
                    displayAlertDialog(msg);
            ...
            var msg = 'Exception in bwEmailClient_Haraka.js.deleteIndividualEmail(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    undeleteIndividualEmail: function (_id) {
        try {
            console.log('In bwEmailClient_Haraka.js.undeleteIndividualEmail(). _id: ' + _id);
            var thiz = this;
            ...
            if (!(workflowAppId && participantId && _id)) {
                ...
                console.log('Error in bwEmailClient_Haraka.js.undeleteIndividualEmail(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id);
                displayAlertDialog('Error in bwEmailClient_Haraka.js.undeleteIndividualEmail(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id);
                ...
                ShowActivitySpinner_Promise('Moving to the TrashBin...')
                    .then(function (results) {
                        try {
                            ...
                            $.ajax({
                                ...
                                success: function (results) {
                                    try {
                                        ...
                                        console.log('Exception in bwEmailClient_Haraka.js.undeleteIndividualEmail():4: ' + e.message + ', ' + e.stack);
                                        displayAlertDialog('Exception in bwEmailClient_Haraka.js.undeleteIndividualEmail(): 4:' + e.message + ', ' + e.stack);
                                    }
                                ...
                                error: function (data, errorCode, errorMessage) {
                                    ...
                                    var msg = 'Fail in bwEmailClient_Haraka.js.undeleteIndividualEmail(): ' + JSON.stringify(data) + ', ' + errorCode + ', ' + errorMessage;
                                    console.log(msg);
                                    displayAlertDialog(msg);
                            ...
                            var msg = 'Exception in bwEmailClient_Haraka.js.undeleteIndividualEmail():3: ' + e.message + ', ' + e.stack;
                            console.log(msg);
                            displayAlertDialog(msg);
                    ...
                    .catch(function (e) {
                        ...
                        var msg = 'Exception in bwEmailClient_Haraka.js.undeleteIndividualEmail():2: ' + JSON.stringify(e);
                        console.log(msg);
                        displayAlertDialog(msg);
            ...
            var msg = 'Exception in bwEmailClient_Haraka.js.undeleteIndividualEmail(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    search: function (mailbox) { // mailbox: ['INBOX', 'SENT', ...]
        try {
            console.log('In bwEmailClient_Haraka.js.search(). mailbox: ' + mailbox);
            alert('In bwEmailClient_Haraka.js.search(). mailbox: ' + mailbox);
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        HideActivitySpinner();
                        console.log('Exception in bwEmailClient_Haraka.js.search.getsearchresults.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwEmailClient_Haraka.js.search.getsearchresults.success(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    HideActivitySpinner();
                    console.log('Error in bwEmailClient_Haraka.js.search.getsearchresults.error(): ' + errorCode + ', ' + errorMessage + JSON.stringify(data));
                    displayAlertDialog('Error in bwEmailClient_Haraka.js.search.getsearchresults.error(): ' + errorCode + ', ' + errorMessage + JSON.stringify(data));
                }
            });

        } catch (e) {
            HideActivitySpinner();
            console.log('Exception in bwEmailClient_Haraka.js.search(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.search(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    cmdReturnEmailToToField: function (email) {
        try {
            console.log('In bwEmailClient_Haraka.js.cmdReturnEmailToToField().');

            var emails = $('#bwEmailClient_Haraka_RecipientsList').val();
            ...
            $('#bwEmailClient_Haraka_RecipientsList').val(newEmailsString);

            $('#bwEmailClient_Haraka_RecipientsList_PeoplePicker').html('');

        } catch (e) {
            var msg = 'Exception in bwEmailClient_Haraka.js.cmdReturnEmailToToField(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    composeANewEmailMessage: function () {
        try {
            console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage().');
            //alert('In bwEmailClient_Haraka.js.composeANewEmailMessage().');
            var thiz = this;
            ...
            this.displayNewMessageEditorHtml().then(function (results) {
                ...
                if (results.status != 'SUCCESS') {
                    ...
                    var msg = 'Error in bwEmailClient_Haraka.js.composeANewEmailMessage(): ' + results.message;
                    console.log(msg);
                    displayAlertDialog(msg);

                } else {

                    console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage(). Successfully returned from displayNewMessageEditorHtml().');

                }

            }).catch(function (e) {

                var msg = 'Exception in bwEmailClient_Haraka.js.composeANewEmailMessage(): ' + JSON.stringify(e);
                console.log(msg);
                displayAlertDialog(msg);
            ...
            console.log('Exception in bwEmailClient_Haraka.js.composeANewEmailMessage(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.composeANewEmailMessage(): ' + e.message + ', ' + e.stack);
        }
    },
    composeANewEmailMessage_Reply: function () {
        try {
            console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage_Reply().');
            //alert('In bwEmailClient_Haraka.js.composeANewEmailMessage_Reply().');
            var thiz = this;
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            console.log('In composeANewEmailMessage_Reply(). Just returned from _files/createdraftemailreply().');
                            ...
                            thiz.displayNewMessageEditorHtml(results.bwDraftEmail).then(function (results) {
                                try {
                                    ...
                                    if (results.status != 'SUCCESS') {
                                        ...
                                        var msg = 'Error in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply(): ' + results.message;
                                        console.log(msg);
                                        displayAlertDialog(msg);

                                    } else {

                                        console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage_Reply(). Successfully returned from displayNewMessageEditorHtml().');

                                        var email = results.email;

                                        if (!email) {

                                            var msg = 'Error in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply(). Could not locate the email in the bwDraftEmail table.';
                                            console.log(msg);
                                            displayAlertDialog(msg);
                                            ...
                                            thiz.cleanEmailBodyHtmlForDisplay(newBody).then(function (results) {
                                                try {
                                                    ...
                                                    if (results.status != 'SUCCESS') {
                                                        ...
                                                        var msg = 'Error in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply.cleanEmailBodyHtmlForDisplay(). ' + results.status + ', ' + results.message;
                                                        console.log(msg);
                                                        displayAlertDialog(msg);
                                                        ...
                                                        console.log('In bwEmailClient_Haraka.js.composeANewEmailMessage_Reply(). >>>>>>>>>> Here is a good opportunity to vertically stretch the .note-editor. xcx99385667.');
                                                        ...
                                                        $('#bwEmailClient_Haraka_RecipientsList').val(email.to);

                                                        //var newSubject = 'Fwd: ' + email.subject;
                                                        //$('#bwEmailClient_Haraka_EmailSubject').val(newSubject);
                                                    ...
                                                    var msg = 'Exception in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply():3: ' + e.message + ', ' + e.stack;
                                                ...
                                                var msg = 'Exception in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply():2: ' + JSON.stringify(e);
                                    ...
                                    console.log('Exception in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply():3: ' + e.message + ', ' + e.stack);
                                    displayAlertDialog('Exception in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply():3: ' + e.message + ', ' + e.stack);
                                }
                        ...
                        console.log('Exception in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply():2: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply():2: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply():' + errorCode + ', ' + errorMessage);
                    displayAlertDialog('Error in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply():' + errorCode + ', ' + errorMessage);
                }
            });

        } catch (e) {
            console.log('Exception in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.composeANewEmailMessage_Reply(): ' + e.message + ', ' + e.stack);
        }
    },

    SendSingleEmailNow: function () {
        try {
            console.log('In bwEmailClient_Haraka.js.SendSingleEmailNow().');
            //alert('In bwEmailClient_Haraka.js.SendSingleEmailNow().');
            ...
            if (!_id) {
                ...
                var msg = 'Error in bwEmailClient_Haraka.js.SendSingleEmailNow(). INVALID VALUE FOR _id: ' + _id;
                console.log(msg);
                displayAlertDialog(msg);

            } else {

                console.log('In bwEmailClient_Haraka.js.SendSingleEmailNow(). xcx2312312 bwdraftemailid/_id: ' + _id);
                //alert('In bwEmailClient_Haraka.js.SendSingleEmailNow(). xcx2312312 bwdraftemailid/_id: ' + _id);
                    ...
                    $.ajax({
                        ...
                        success: function (results) {
                            try {
                                ...
                                console.log('Exception in bwEmailClient_Haraka.js.SendSingleEmailNow():2: ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwEmailClient_Haraka.js.SendSingleEmailNow():2: ' + e.message + ', ' + e.stack);
                            }
                        },
                        error: function (data, errorCode, errorMessage) {
                            console.log('Error in bwEmailClient_Haraka.js.SendSingleEmailNow():' + errorCode + ', ' + errorMessage);
                            displayAlertDialog('Error in bwEmailClient_Haraka.js.SendSingleEmailNow():' + errorCode + ', ' + errorMessage);
                        }
            ...
            console.log('Exception in bwEmailClient_Haraka.js.SendSingleEmailNow(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.SendSingleEmailNow(): ' + e.message + ', ' + e.stack);
        }
    },
    SendSingleEmailScheduled: function () {
        try {
            console.log('In bwEmailClient_Haraka.js.SendSingleEmailScheduled().');

            alert('In bwEmailClient_Haraka.js.SendSingleEmailScheduled(). This functionality is incomplete. Coming soon!');
            ...
            //var subject = $('#bwEmailClient_Haraka_EmailSubject').val(); //'test subject xcx2131234234';

            //var body = $('#bwEmailClient_Haraka_EmailBody').html(); //'test body xcx12346u';
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'displayForestPendingEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'displayForestPendingEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'displayPendingEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'displayPendingEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        try {
                            ...
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'displaySentEmails\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'displaySentEmails\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
                            ...
                            console.log('Exception in bwEmailClient_Haraka.js.expandOrCollapseSentEmails():1: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwEmailClient_Haraka.js.expandOrCollapseSentEmails():1: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (data, errorCode, errorMessage) {
                        console.log('Error in bwEmailClient_Haraka.js.expandOrCollapseSentEmails():' + errorCode + ', ' + errorMessage);
                        displayAlertDialog('Error in bwEmailClient_Haraka.js.expandOrCollapseSentEmails():' + errorCode + ', ' + errorMessage);
                    }
                });
            }
        } catch (e) {
            console.log('Exception in bwEmailClient_Haraka.js.expandOrCollapseSentEmails(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwEmailClient_Haraka.js.expandOrCollapseSentEmails(): ' + e.message + ', ' + e.stack);
        }
    },
            ...
            if (img.src.indexOf(urlClose) > -1) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            var html = '';
                            html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'displayErrorsAndSuggestions\', \'' + 'all' + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="">';
                            html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + 'ADMIN/ALL';
                            html += '                   </div>';
                            if (!data.length || data.length == 0) {
                                html += '<span style="font-size:10pt;font-weight:normal;color:black;">';
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    html += '                   <div class="spanButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'displayErrorsAndSuggestions\', \'' + data[i].bwWorkflowAppId + '\');" style="text-align:left;font-size:14px;white-space:nowrap;cursor:pointer;padding:20px 20px 20px 20px;" title="' + 'Owner: ' + data[i].bwTenantOwnerFriendlyName + ' (' + data[i].bwTenantOwnerEmail + ')' + '">';
                                    html += '                       &nbsp;&nbsp;&nbsp;&nbsp;' + data[i].bwWorkflowAppTitle;
                                    html += '                   </div>';
                                }
                            }
                    ...
                    success: function (data) {
                        try {
                            if (!data.length || data.length == 0) {
                                ...
                                var html = '';
                                for (var i = 0; i < data.length; i++) {
                                    html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-1" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
    ...
    displayForestPendingEmails: function (bwWorkflowAppId) {
        try {
            ...
            try {
                var html = '';
                html += '<input type="checkbox" id="checkboxToggleForestPendingEmailCheckboxes" onchange="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'toggleForestPendingEmailCheckboxes\', this);" />';
                html += '                           <span style="padding: 4px 4px 4px 4px;border:1px solid lightblue;cursor:pointer;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteForestPendingEmailsDialog\');">';
                ...
                success: function (data) {
                    try {
                        ...
                        if (!data.length || data.length == 0) {
                            ...
                            html = '<table>';
                            for (var i = 0; i < data.length; i++) {
                                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewForestPendingEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwPendingEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                            ...
                            html = '';
                            html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'sendForestPendingEmailNow\');">';
    ...
    displayAIConversation: function () {
        try {
            console.log('In bwEmailClient_Haraka.js.displayAIConversation().');
            //alert('In bwEmailClient_Haraka.js.displayAIConversation().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwEmailClient_Haraka.js.displayAIConversation(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwEmailClient_Haraka.js.displayAIConversation(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    displayAlertDialog('Error in bwEmailClient_Haraka.js.displayAIConversation():' + errorCode + ', ' + errorMessage);
                }
            });
    ...
    displayPendingEmails: function () { // Accepts "all" as a value for bwWorkflowAppId. This is for the forest administrator.
        try {
            ...
            //if (!bwWorkflowAppId) {
            //    alert('Error in bwEmailClient_Haraka.js.displayPendingEmails(). Invalid value for bwWorkflowAppId: ' + bwWorkflowAppId);
            //} else {
            var participantId = $('.bwAuthentication').bwAuthentication('option', 'participantId');
            //var participantEmail = $('.bwAuthentication').bwAuthentication('option', 'participantEmail');
            //var participantFriendlyName = $('.bwAuthentication').bwAuthentication('option', 'participantFriendlyName');
            ...
            try {
                ...
                // Display the top buttons.
                html += '                           <span xcx="xcx231232-14" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeletePendingEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
                html += '                               <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" xcx="664993" >&nbsp;Delete';
                html += '                           </span>';
                html += '&nbsp;&nbsp;';
                html += '                           <span xcx="xcx231232-14" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeletePendingEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
                ...
                // Display the radio button and the title.
                html = '';
                //html += '<input type="checkbox" id="checkboxTogglePendingEmailCheckboxes" onchange="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'togglePendingEmailCheckboxes\', this);" />&nbsp;&nbsp;';
                html += '✉ Pending Inbox Items';
                $(thiz.element).find('#spanSelectedEmailType_Title')[0].innerHTML = html; //'Pending Email';

                // Make this button appear selected.
                $(thiz.element).find('#spanDisplaySentEmailButton').removeClass('bwEmailClient_Haraka_LeftMenuButton_Selected').addClass('bwEmailClient_Haraka_LeftMenuButton');
                $(thiz.element).find('#spanDisplayPendingEmailButton').removeClass('bwEmailClient_Haraka_LeftMenuButton').addClass('bwEmailClient_Haraka_LeftMenuButton_Selected');
                    ...
                    success: function (data) {
                        try {
                            ...
                            if (!data.length || data.length == 0) {
                                ...
                                html = '<table>';
                                for (var i = 0; i < data.length; i++) {
                                    html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewPendingEmail\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwPendingEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                                    html += '    <td style="vertical-align:top;"><input type="checkbox" class="pendingEmailCheckbox" bwpendingemailid="' + data[i].bwPendingEmailId + '" /></td>';
                                    //var timestamp = getFriendlyDateAndTime(data[i].Timestamp);
                                    html += '    <td colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
                                    html += '<span style="font-weight:bold;color:black;">' + data[i].ToParticipantFriendlyName + '<br />';
                                ...
                                html = '';
                                html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'sendPendingEmailNow\');">';
    ...
    resize: function () {
        try {
            console.log('In bwEmailClient_Haraka.js.resize().');
            //alert('In bwEmailClient_Haraka.js.resize().');
            ...
            var msg = 'Exception in bwEmailClient_Haraka.js.resize(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    displayIncomingEmails: function (bwWorkflowAppId) {
        try {
            ...
            try {
                ...
                // Display the top buttons.
                html += '                           <span xcx="xcx231232-15" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
                html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
                html += '                           </span>';
                html += '&nbsp;&nbsp;';
                html += '                           <span xcx="xcx231232-15" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
                html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
                html += '                           </span>';
                $(thiz.element).find('#spanSelectedEmailType_TopButtons')[0].innerHTML = html; //'Pending Email';
                    ...
                    try {
                        ...
                        if (!data.length || data.length == 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-2" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
                            ...
                            //html += '                       <div class="spanButton" style="width:100px;text-align:right;" title="Click to send this email now!" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'sendEmailNow\');">';
                            //html += '                           ✉&nbsp;Send Now > xcx4';
                            //html += '                       </div>';
                            html += '<span id="spanSelectedEmailSubject" style="font-size:13pt;font-weight:bold;color:#95b1d3;"></span>';
                            html += '<br /><br />';
            ...
            //                            html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-3" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
            //                            //debugger; // xcx999999
            //                            html += '    <td style="vertical-align:top;"><input type="checkbox" class="sentEmailCheckbox" bwsentemailid="' + data[i].bwSentEmailId + '" /></td>';
            //                            //debugger;
            //                            //var timestamp = getFriendlyDateAndTime(data[i].Timestamp);
            ...
            //                            html += '    <td id="bwEmailClient_Haraka_InnerLeftMenuButton_' + data[i].bwSentEmailId + '" colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
            ...
            //            },
            //            error: function (data, errorCode, errorMessage) {
            //                console.log('Error in bwEmailClient_Haraka.js.displayIncomingEmails():xcx1: ' + errorCode + ', ' + errorMessage);
            //                //displayAlertDialog('Error in bwEmailClient_Haraka.js.displayIncomingEmails():xcx1: ' + errorCode + ', ' + errorMessage); // PUT THIS BACK SOMETIME 5-5-2022
            //            }
            //        });
            ...
            //                        html += '<table>';
            //                        for (var i = 0; i < data.length; i++) {
            //                            html += '<tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" xcx="xcx2224555-4" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantFriendlyName + '\', \'' + data[i].bwParticipantEmail + '\', \'' + data[i].bwSentEmailId + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
            //                            html += '   <td style="vertical-align:top;"><input type="checkbox" class="sentEmailCheckbox" bwsentemailid="' + data[i].bwSentEmailId + '" /></td>';
            //                            html += '   <td colspan="4" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;">';
            ...
            //            },
            //            error: function (data, errorCode, errorMessage) {
            //                displayAlertDialog('Error in bwEmailClient_Haraka.js.displayIncomingEmails():xcx2: ' + errorCode + ', ' + errorMessage);
            //            }
            //        });
            //    }
    ...
    cmdDisplayDeleteInboxEmailsDialog: function (bwWorkflowAppId, instruction) { // 6-24-2024.
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                html += '   </span>';
                html += '   <br /><br /><br />';
                //html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteSelectedSentEmails\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    html = '';
                    html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'putInboxFolderIntoTheTrashBin\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                    html += '       Delete the Inbox Emails';
                    html += '   </div>';
                    ...
                    if (selectedEmails.length == 0) {
                        ...
                        html = '';
                        html += '   <div id="divBwEmailMonitor_DeleteTheInboxEmails" class="divSignInButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteSelectedInboxEmails\', \'' + bwWorkflowAppId + '\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                        html += '       Delete the Inbox Emails';
                        html += '   </div>';
        ...
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    html = '';
                    html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteSelectedPendingEmails\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                    html += '       Delete the Pending Emails';
                    html += '   </div>';
                    ...
                    if (selectedEmails.length == 0) {
                        ...
                        html = '';
                        html += '   <div id="divBwEmailMonitor_DeleteThePendingEmails" class="divSignInButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteSelectedPendingEmails\', \'' + bwWorkflowAppId + '\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                        html += '       Delete the Pending Emails';
                        html += '   </div>';
                        document.getElementById('divBwEmailMonitor_DeleteThePendingEmails').outerHTML = html;
        ...
        try {
            ...
            if (!bwWorkflowAppId || (bwWorkflowAppId == 'undefined')) {
                ...
                if (instruction && instruction == 'emptyfolder') {
                    ...
                    html = '';
                    html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'putSentFolderIntoTheTrashBin\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                    html += '       Delete the Sent Emails';
                    html += '   </div>';
                    document.getElementById('divBwEmailMonitor_DeleteTheSentEmails').outerHTML = html;
                    ...
                    if (selectedEmails.length == 0) {
                        ...
                        html = '';
                        html += '   <div id="divBwEmailMonitor_DeleteTheSentEmails" class="divSignInButton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteSelectedSentEmails\', \'' + bwWorkflowAppId + '\');" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" >';
                        html += '       Delete the Sent Emails';
                        html += '   </div>';
                        document.getElementById('divBwEmailMonitor_DeleteTheSentEmails').outerHTML = html;
    ...
    //                        for (var j = 0; j < this.options.TrashBin.docs.length; j++) {
    //                            if (this.options.TrashBin.docs[j]._id == bwNotificationDetailsJson[i]._id) {
    //                                addTheEmailToTheInbox = false; // It is already in the TrashBin.
    //                                break;
    //                            }
    //                        }

    //                        for (var j = 0; j < this.options.Archived.docs.length; j++) {
    //                            if (this.options.Archived.docs[j]._id == bwNotificationDetailsJson[i]._id) {
    //                                addTheEmailToTheInbox = false; // It is already in the Archived folder.
    //                                break;
    //                            }
    //                        }
    ...
    //                                    addTheEmailToTheInbox = false; // It's not in the Inbox.
    //                                    break;
    //                                }
    //                            }
    //                        }

    //                        if (addTheEmailToTheInbox) { // It's not already in the Inbox, so we should add it, and display it at the top of the list.
    ...
    //        console.log('In bwEmailClient_Haraka.js.renderEmails_Inbox(). bwWorkflowAppId: ' + bwWorkflowAppId);
    //        alert('In bwEmailClient_Haraka.js.renderEmails_Inbox(). bwWorkflowAppId: ' + bwWorkflowAppId);
    //        var thiz = this;
    ...
    //        //// Display the top buttons.
    //        //html += '                           <span xcx="xcx231232-7" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteInboxEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
    //        //html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
    //        //html += '                           </span>';
    //        //html += '&nbsp;&nbsp;';
    //        //html += '                           <span xcx="xcx231232-7" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteInboxEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
    //        //html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
    //        //html += '                           </span>';
    //        //$(thiz.element).find('#spanSelectedEmailType_TopButtons')[0].innerHTML = html; //'Pending Email';
    ...
    //        //console.log('xcx2313555. In bwEmailClient_Haraka.js.renderEmails_Inbox(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    //                    $(thiz.element).find('#divEmailClient_CompositionWindow')[0].innerHTML = '<div xcx="xcx213123-1" style="font-size:25pt;color:lightgray;">SELECT AN EMAIL THAT YOU WISH TO VIEW.</div>';
    ...
    //                    emailItems[i].addEventListener('dragstart', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Inbox.dragstart().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_Inbox.dragstart(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //                    emailItems[i].addEventListener('dragend', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Inbox.dragend().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_Inbox.dragend(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //    } catch (e) {
    //        console.log('Exception in bwEmailClient_Haraka.js.renderEmails_Inbox(): ' + e.message + ', ' + e.stack);
    //        alert('Exception in bwEmailClient_Haraka.js.renderEmails_Inbox(): ' + e.message + ', ' + e.stack);
    //    }
    //},
    ...
    //        // Display the top buttons.
    //        html += '                           <span xcx="xcx231232-8" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
    //        html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
    //        html += '                           </span>';
    //        html += '&nbsp;&nbsp;';
    //        html += '                           <span xcx="xcx231232-8" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
    //        html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
    //        html += '                           </span>';
    //        $(thiz.element).find('#spanSelectedEmailType_TopButtons')[0].innerHTML = html; //'Pending Email';
    ...
    //        console.log('xcx2313555. In bwEmailClient_Haraka.js.renderEmails_Sent(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    //                //html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'#d8d8d8\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
    //                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" _id="' + thiz.options.Sent[i]._id + '" class="bwEmailSentItemsRow" xcx="xcx2224555-3" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_Sent\', \'' + 'btnEditRaciRoles_' + thiz.options.Sent[i].bwParticipantId + '\', \'' + thiz.options.Sent[i].bwParticipantId + '\', \'' + thiz.options.Sent[i].bwParticipantFriendlyName + '\', \'' + thiz.options.Sent[i].bwParticipantEmail + '\', \'' + thiz.options.Sent[i]._id + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + thiz.options.Sent[i].bwParticipantId + '\', \'' + thiz.options.Sent[i].bwParticipantId + '\');">';
    //                //debugger; // xcx999999
    ...
    //                html += '    <td class="bwemailitems" _id="' + thiz.options.Sent[i]._id + '" draggable="true" id="bwEmailClient_Haraka_InnerLeftMenuButton_' + thiz.options.Sent[i]._id + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;max-width:350px;">';
    //                //debugger; // RelatedRequestId	ad19f2b8-707f-40ad-8228-a07d55a1ddac
    ...
    //                html += '<td class="bwEmailClient_Haraka_Trashbin" style="max-width:40px;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteIndividualEmail\', \'' + thiz.options.Sent[i]._id + '\');event.stopPropagation();">';
    //                html += '<img src="/images/trashbin.png" />';
    //                html += '</td>';
    ...
    //                    emailItems[i].addEventListener('dragstart', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Sent.dragstart().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in bwEmailClient_Haraka.js.renderEmails_Sent.dragstart(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //                    emailItems[i].addEventListener('dragend', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Sent.dragend().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_Sent.dragend(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //    } catch (e) {
    //        console.log('Exception in bwEmailClient_Haraka.js.renderEmails_Sent(): ' + e.message + ', ' + e.stack);
    //        alert('Exception in bwEmailClient_Haraka.js.renderEmails_Sent(): ' + e.message + ', ' + e.stack);
    //    }
    //},
    ...
    //        // Display the top buttons.
    //        html += '                           <span xcx="xcx231232-9" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteDraftEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
    //        html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
    //        html += '                           </span>';
    //        html += '&nbsp;&nbsp;';
    //        html += '                           <span xcx="xcx231232-9" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteDraftEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
    //        html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
    //        html += '                           </span>';
    //        $(thiz.element).find('#spanSelectedEmailType_TopButtons')[0].innerHTML = html; //'Pending Email';
    ...
    //        // Display the radio button and the title.
    //        html = '';
    //        html += '<input type="checkbox" id="checkboxToggleDraftEmailCheckboxes" onchange="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'toggleDraftEmailCheckboxes\', this);" />&nbsp;&nbsp;';
    //        html += '✉ Draft Items';

    //        $(thiz.element).find('#spanSelectedEmailType_Title')[0].innerHTML = html; //'Draft Email';

    //        // Make this button appear selected.
    //        $(thiz.element).find('#spanDisplayDraftEmailButton').removeClass('bwEmailClient_Haraka_LeftMenuButton').addClass('bwEmailClient_Haraka_LeftMenuButton_Selected');
    //        $(thiz.element).find('#spanDisplayPendingEmailButton').removeClass('bwEmailClient_Haraka_LeftMenuButton_Selected').addClass('bwEmailClient_Haraka_LeftMenuButton');
    ...
    //        console.log('xcx2313555. In bwEmailClient_Haraka.js.renderEmails_Drafts(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    //            for (var i = 0; i < thiz.options.Drafts.length; i++) {
    //                //html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'#d8d8d8\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
    //                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" _id="' + thiz.options.Drafts[i]._id + '" class="bwEmailDraftItemsRow" xcx="xcx2224555-3" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_Drafts\', \'' + 'btnEditRaciRoles_' + thiz.options.Drafts[i].bwParticipantId + '\', \'' + thiz.options.Drafts[i].bwParticipantId + '\', \'' + thiz.options.Drafts[i].bwParticipantFriendlyName + '\', \'' + thiz.options.Drafts[i].bwParticipantEmail + '\', \'' + thiz.options.Drafts[i]._id + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + thiz.options.Drafts[i].bwParticipantId + '\', \'' + thiz.options.Drafts[i].bwParticipantId + '\');">';
    //                //debugger; // xcx999999
    ...
    //                html += '    <td class="bwemailitems" _id="' + thiz.options.Drafts[i]._id + '" draggable="true" id="bwEmailClient_Haraka_InnerLeftMenuButton_' + thiz.options.Drafts[i]._id + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;max-width:350px;">';
    //                //debugger; // RelatedRequestId	ad19f2b8-707f-40ad-8228-a07d55a1ddac
    ...
    //                html += '<td class="bwEmailClient_Haraka_Trashbin" style="max-width:40px;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteIndividualEmail_Drafts\', \'' + thiz.options.Drafts[i]._id + '\');event.stopPropagation();">';
    //                html += '<img src="/images/trashbin.png" />';
    //                html += '</td>';
    ...
    //                    $(thiz.element).find('#divEmailClient_CompositionWindow')[0].innerHTML = '<div xcx="xcx213123-3" style="font-size:25pt;color:lightgray;">SELECT AN EMAIL THAT YOU WISH TO VIEW.</div>';
    ...
    //                    emailItems[i].addEventListener('dragstart', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Drafts.dragstart().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_Drafts.dragstart(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //                    emailItems[i].addEventListener('dragend', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Drafts.dragend().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_Drafts.dragend(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //    } catch (e) {
    //        console.log('Exception in bwEmailClient_Haraka.js.renderEmails_Drafts(): ' + e.message + ', ' + e.stack);
    //        displayAlertDialog('Exception in bwEmailClient_Haraka.js.renderEmails_Drafts(): ' + e.message + ', ' + e.stack);
    //    }
    //},
    ...
    //        // Display the top buttons.
    //        html += '                           <span xcx="xcx231232-10" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
    //        html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
    //        html += '                           </span>';
    //        html += '&nbsp;&nbsp;';
    //        html += '                           <span xcx="xcx231232-10" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
    //        html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
    //        html += '                           </span>';
    //        $(thiz.element).find('#spanSelectedEmailType_TopButtons')[0].innerHTML = html; //'Pending Email';
    ...
    //        console.log('xcx2313555. In bwEmailClient_Haraka.js.renderEmails_Junk(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    //                //html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'#d8d8d8\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
    //                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" _id="' + thiz.options.Junk[i]._id + '" class="bwEmailJunkItemsRow" xcx="xcx2224555-3" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + thiz.options.Junk[i].bwParticipantId + '\', \'' + thiz.options.Junk[i].bwParticipantId + '\', \'' + thiz.options.Junk[i].bwParticipantFriendlyName + '\', \'' + thiz.options.Junk[i].bwParticipantEmail + '\', \'' + thiz.options.Junk[i]._id + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + thiz.options.Junk[i].bwParticipantId + '\', \'' + thiz.options.Junk[i].bwParticipantId + '\');">';
    //                //debugger; // xcx999999
    ...
    //                html += '    <td class="bwemailitems" _id="' + thiz.options.Junk[i]._id + '" draggable="true" id="bwEmailClient_Haraka_InnerLeftMenuButton_' + thiz.options.Junk[i]._id + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;max-width:350px;">';
    //                //debugger; // RelatedRequestId	ad19f2b8-707f-40ad-8228-a07d55a1ddac
    ...
    //                html += '<td class="bwEmailClient_Haraka_Trashbin" style="max-width:40px;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteIndividualEmail\', \'' + thiz.options.Junk[i]._id + '\');event.stopPropagation();">';
    //                html += '<img src="/images/trashbin.png" />';
    //                html += '</td>';
    ...
    //                    emailItems[i].addEventListener('dragstart', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Junk.dragstart().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in bwEmailClient_Haraka.js.renderEmails_Junk.dragstart(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //                    emailItems[i].addEventListener('dragend', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Junk.dragend().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_Junk.dragend(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //    } catch (e) {
    //        console.log('Exception in bwEmailClient_Haraka.js.renderEmails_Junk(): ' + e.message + ', ' + e.stack);
    //        alert('Exception in bwEmailClient_Haraka.js.renderEmails_Junk(): ' + e.message + ', ' + e.stack);
    //    }
    //},
    ...
    //        // Display the top buttons.
    //        html += '                           <span xcx="xcx231232-11" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
    //        html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
    //        html += '                           </span>';
    //        html += '&nbsp;&nbsp;';
    //        html += '                           <span xcx="xcx231232-11" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
    //        html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
    //        html += '                           </span>';
    //        $(thiz.element).find('#spanSelectedEmailType_TopButtons')[0].innerHTML = html; //'Pending Email';
    ...
    //        console.log('xcx2313555. In bwEmailClient_Haraka.js.renderEmails_Archived(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    //            for (var i = 0; i < thiz.options.Sent.length; i++) {
    //                //html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'#d8d8d8\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
    //                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" _id="' + thiz.options.Sent[i]._id + '" class="bwEmailArchivedItemsRow" xcx="xcx2224555-3" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_Inbox\', \'' + 'btnEditRaciRoles_' + thiz.options.Sent[i].bwParticipantId + '\', \'' + thiz.options.Sent[i].bwParticipantId + '\', \'' + thiz.options.Sent[i].bwParticipantFriendlyName + '\', \'' + thiz.options.Sent[i].bwParticipantEmail + '\', \'' + thiz.options.Sent[i]._id + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + thiz.options.Sent[i].bwParticipantId + '\', \'' + thiz.options.Sent[i].bwParticipantId + '\');">';
    //                //debugger; // xcx999999
    //                html += '    <td style="vertical-align:top;max-width:20px;"><input type="checkbox" class="sentEmailCheckbox" bwsentemailid="' + thiz.options.Sent[i].bwSentEmailId + '" /></td>';
    //                //debugger;
    //                //var timestamp = getFriendlyDateAndTime(data[i].Timestamp);
    ...
    //                    emailItems[i].addEventListener('dragstart', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Archived.dragstart().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in bwEmailClient_Haraka.js.renderEmails_Archived.dragstart(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //                    emailItems[i].addEventListener('dragend', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_Archived.dragend().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_Archived.dragend(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //    } catch (e) {
    //        console.log('Exception in bwEmailClient_Haraka.js.renderEmails_Archived(): ' + e.message + ', ' + e.stack);
    //        alert('Exception in bwEmailClient_Haraka.js.renderEmails_Archived(): ' + e.message + ', ' + e.stack);
    //    }
    //},
    ...
    //        // Display the top buttons.
    //        html += '                           <span xcx="xcx231232-12" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
    //        html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
    //        html += '                           </span>';
    //        html += '&nbsp;&nbsp;';
    //        html += '                           <span xcx="xcx231232-12" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
    //        html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
    //        html += '                           </span>';
    //        $(thiz.element).find('#spanSelectedEmailType_TopButtons')[0].innerHTML = html; //'Pending Email';
    ...
    //        console.log('xcx2313555. In bwEmailClient_Haraka.js.renderEmails_TrashBin(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    //            for (var i = 0; i < thiz.options.TrashBin.length; i++) {
    //                //html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'#d8d8d8\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
    //                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" _id="' + thiz.options.TrashBin[i]._id + '" class="bwEmailTrashBinItemsRow" xcx="xcx2224555-3" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_TrashBin\', \'' + 'btnEditRaciRoles_' + thiz.options.TrashBin[i].bwParticipantId + '\', \'' + thiz.options.TrashBin[i].bwParticipantId + '\', \'' + thiz.options.TrashBin[i].bwParticipantFriendlyName + '\', \'' + thiz.options.TrashBin[i].bwParticipantEmail + '\', \'' + thiz.options.TrashBin[i]._id + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + thiz.options.TrashBin[i].bwParticipantId + '\', \'' + thiz.options.TrashBin[i].bwParticipantId + '\');">';
    //                //debugger; // xcx999999
    ...
    //                html += '    <td class="bwemailitems" _id="' + thiz.options.TrashBin[i]._id + '" draggable="true" id="bwEmailClient_Haraka_InnerLeftMenuButton_' + thiz.options.TrashBin[i]._id + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;max-width:350px;">';
    //                //debugger; // RelatedRequestId	ad19f2b8-707f-40ad-8228-a07d55a1ddac
    ...
    //                html += '<td class="bwEmailClient_Haraka_Trashbin" style="max-width:40px;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteIndividualEmail\', \'' + thiz.options.TrashBin[i]._id + '\');event.stopPropagation();">';
    //                html += '<img src="/images/trashbin.png" />';
    //                html += '</td>';
    ...
    //                    $(thiz.element).find('#divEmailClient_CompositionWindow')[0].innerHTML = '<div xcx="xcx213123-4" style="font-size:25pt;color:lightgray;">SELECT AN EMAIL THAT YOU WISH TO VIEW.</div>';
    ...
    //                    emailItems[i].addEventListener('dragstart', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_TrashBin.dragstart().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in bwEmailClient_Haraka.js.renderEmails_TrashBin.dragstart(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //                    emailItems[i].addEventListener('dragend', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_TrashBin.dragend().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_TrashBin.dragend(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //    } catch (e) {
    //        console.log('Exception in bwEmailClient_Haraka.js.renderEmails_TrashBin(): ' + e.message + ', ' + e.stack);
    //        alert('Exception in bwEmailClient_Haraka.js.renderEmails_TrashBin(): ' + e.message + ', ' + e.stack);
    //    }
    //},
    //renderEmails_search: function (bwWorkflowAppId) {
    //    try {
    //        alert('xcx23123 DO WE STILL USE THIS????');
    //        console.log('In bwEmailClient_Haraka.js.renderEmails_search(). bwWorkflowAppId: ' + bwWorkflowAppId);
    //        //alert('In bwEmailClient_Haraka.js.renderEmails_search(). bwWorkflowAppId: ' + bwWorkflowAppId);
    //        var thiz = this;
    //        debugger;
    //        var participantId = $('.bwAuthentication').bwAuthentication('option', 'participantId');
    ...
    //        // Display the top buttons.
    //        html += '                           <span xcx="xcx231232-13" class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\');">';
    //        html += '                               <img title="Delete..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx123468" />&nbsp;Delete';
    //        html += '                           </span>';
    //        html += '&nbsp;&nbsp;';
    //        //html += '                           <span class="emailEditor_topbarbutton" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'cmdDisplayDeleteSentEmailsDialog\', \'' + bwWorkflowAppId + '\', \'emptyfolder\');">';
    //        //html += '                               <img title="Empty folder..." style="cursor:pointer;" src="images/trash-can.png" xcx="xcx23423467898">&nbsp;Empty folder';
    //        //html += '                           </span>';
    //        $(thiz.element).find('#spanSelectedEmailType_TopButtons')[0].innerHTML = html; //'Pending Email';
    ...
    //        console.log('xcx2313555. In bwEmailClient_Haraka.js.renderEmails_search(). Calling GET ' + webserviceurl + '/participantemail_inbox/ this.options.OnlyDisplayEmailsForCurrentParticipant: ' + this.options.OnlyDisplayEmailsForCurrentParticipant);
    ...
    //                //html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'#d8d8d8\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + data[i].bwParticipantId + '\', \'' + data[i].bwParticipantId + '\');">';
    //                html += '  <tr style="cursor:pointer;font-size:6pt;font-weight:normal;color:black;" _id="' + thiz.options.SearchResults[i]._id + '" class="bwEmailSearchItemsRow" xcx="xcx2224555-3" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'viewIndividualEmail_SearchResults\', \'' + 'btnEditRaciRoles_' + thiz.options.SearchResults[i].bwParticipantId + '\', \'' + thiz.options.SearchResults[i].bwParticipantId + '\', \'' + thiz.options.SearchResults[i].bwParticipantFriendlyName + '\', \'' + thiz.options.SearchResults[i].bwParticipantEmail + '\', \'' + thiz.options.SearchResults[i]._id + '\');" onmouseover="this.style.backgroundColor=\'lightgoldenrodyellow\';" onmouseout="this.style.backgroundColor=\'transparent\';" onclick="$(\'.bwParticipantsEditor\').bwParticipantsEditor(\'renderParticipantRoleMultiPickerInACircle\', \'' + 'btnEditRaciRoles_' + thiz.options.SearchResults[i].bwParticipantId + '\', \'' + thiz.options.SearchResults[i].bwParticipantId + '\');">';
    //                //debugger; // xcx999999
    ...
    //                html += '    <td class="bwemailitems" _id="' + thiz.options.SearchResults[i]._id + '" draggable="true" id="bwEmailClient_Haraka_InnerLeftMenuButton_' + thiz.options.SearchResults[i]._id + '" style="border:1px solid gainsboro;font-size:10pt;padding:10px 10px 10px 10px;max-width:350px;">';
    //                //debugger; // RelatedRequestId	ad19f2b8-707f-40ad-8228-a07d55a1ddac
    ...
    //                html += '<td class="bwEmailClient_Haraka_Trashbin" style="max-width:40px;" onclick="$(\'.bwEmailClient_Haraka\').bwEmailClient_Haraka(\'deleteIndividualEmail\', \'' + thiz.options.SearchResults[i]._id + '\');event.stopPropagation();">';
    //                html += '<img src="/images/trashbin.png" />';
    //                html += '</td>';
    ...
    //                    emailItems[i].addEventListener('dragstart', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_search.dragstart().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_search.dragstart(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //                    emailItems[i].addEventListener('dragend', function (e) {
    //                        try {
    //                            console.log('In bwEmailClient_Haraka.js.renderEmails_search.dragend().');
    ...
    //                        } catch (e) {
    //                            var msg = 'Exception in In bwEmailClient_Haraka.js.renderEmails_search.dragend(): ' + e.message + ', ' + e.stack;
    //                            console.log(msg);
    //                            alert(msg);
    //                        }
    //                    });
    ...
    //    } catch (e) {
    //        console.log('Exception in bwEmailClient_Haraka.js.renderEmails_search(): ' + e.message + ', ' + e.stack);
    //        alert('Exception in bwEmailClient_Haraka.js.renderEmails_search(): ' + e.message + ', ' + e.stack);
    //    }
    //},
    ...
    //    try {
    //        console.log('In bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts(). _id: ' + _id);
    //        //alert('In bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts(). _id: ' + _id);
    //        var thiz = this;
    ...
    //            console.log('Error in bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id);
    //            displayAlertDialog('Error in bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts(): Invalid value. Expected values for workflowAppId: ' + workflowAppId + ', participantId: ' + participantId + ', _id: ' + _id);
    ...
    //                                console.log('Exception in bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts():4: ' + e.message + ', ' + e.stack);
    //                                displayAlertDialog('Exception in bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts(): 4:' + e.message + ', ' + e.stack);
    //                            }
    ...
    //                            var msg = 'Fail in bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts(): ' + JSON.stringify(data) + ', ' + errorCode + ', ' + errorMessage;
    //                            console.log(msg);
    //                            displayAlertDialog(msg);
    ...
    //                        var msg = 'Exception in bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts():3: ' + e.message + ', ' + e.stack;
    //                        console.log(msg);
    //                        displayAlertDialog(msg);
    ...
    //                    var msg = 'Exception in bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts():2: ' + JSON.stringify(e);
    //                    console.log(msg);
    //                    displayAlertDialog(msg);
    ...
    //    } catch (e) {
    //        var msg = 'Exception in bwEmailClient_Haraka.js.deleteIndividualEmail_Drafts(): ' + e.message + ', ' + e.stack;
    //        console.log(msg);
    //        displayAlertDialog(msg);
    //    }
    //},
