$.widget("bw.bwAttachments", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwAttachments.js jQuery Widget. 
        ===========================================================
    ...
    _create: function () {
        console.log('In bwAttachments.js._create().');
        //alert('In bwAttachments.js._create().');
        this.element.addClass("bwAttachments");
        ...
        try {
            ...
            if (this.options.inFormsEditor == true) {
                ...
                console.log('In bwAttachments.js._create().option.inFormsEditor == true.');
                ...
                console.log('In bwAttachments.js._create().option.STAND_ALONE == true.');
                ...
                console.log('In bwAttachments.js._create().option.allowRequestModifications == false.');
                this.renderAndPopulateAttachments_ReadOnly(); // Need to render, not allowing the user to make modifications.

            } else if (this.options.allowRequestModifications == true) {

                console.log('In bwAttachments.js._create().option.allowRequestModifications == true.');
                this.renderAndPopulateAttachments();

            } else {
                var html = '';
                html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments</span>';
                html += '<br />';
            ...
            html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments</span>';
            html += '<br />';
            html += '<span style="">Exception in bwAttachments.Create(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    _destroy: function () {
        this.element
            .removeClass("bwAttachments")
            .text("");
    },
    getDataType: function () {
        try {
            console.log('In bwAttachments.js.getDataType().');

            return 'attachments';
        } catch (e) {
            console.log('Exception in bwAttachments.js.getDataType(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.js.getDataType(): ' + e.message + ', ' + e.stack);
        }
    },
    getData: function () {
        try {
            console.log('In bwAttachments.getData().');
            ...
            console.log('Exception in bwAttachments.getData(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.getData(): ' + e.message + ', ' + e.stack);
        }
    },
    isARequiredField: function () {
        try {
            console.log('In bwAttachments.isARequiredField().');
            return this.options.renderAsARequiredField;
        } catch (e) {
            console.log('Exception in bwAttachments.isARequiredField(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.isARequiredField(): ' + e.message + ', ' + e.stack);
        }
    },
    getfieldTitle: function () {
        try {
            console.log('In bwAttachments.getfieldTitle().');
            return this.options.fieldTitle;
        } catch (e) {
            console.log('Exception in bwAttachments.getfieldTitle(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.getfieldTitle(): ' + e.message + ', ' + e.stack);
        }
    },
    downloadZippedFiles: function (bwBudgetRequestId, bwRequestTitle) {
        try {
            console.log('In bwAttachments.js.downloadZippedFiles().');
            //alert('In bwAttachments.js.downloadZippedFiles().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            var msg = 'Error in bwAttachments.js.downloadZippedFiles(). ' + results.status + ': ' + results.message;
                            console.log(msg);
                        ...
                        var msg = 'Exception in bwAttachments.js.downloadZippedFiles.DownloadAllFilesZippedForBudgetRequest(): ' + e.message + ', ' + e.stack;
                        console.log(msg);
                        displayAlertDialog(msg);
                ...
                error: function (data, errorCode, errorMessage) {
                    ...
                    var msg = 'Error in bwAttachments.js.downloadZippedFiles.DownloadAllFilesZippedForBudgetRequest(): ' + errorMessage;
                    console.log(msg);
                    displayAlertDialog(msg);
            ...
            var msg = 'Exception in bwAttachments.js.downloadZippedFiles(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            alert(msg);
    ...
    renderAndPopulateAttachments: function () {
        try {
            var thiz = this;
            console.log('In bwAttachments.js.renderAndPopulateAttachments().');
            //alert('In bwAttachments.js.renderAndPopulateAttachments().');
            ...
            if (!bwBudgetRequestId) {
                ...
                alert('Error in bwAttachments.js.xx(). Unexpected value for bwBudgetRequestId: ' + bwBudgetRequestId);
                displayAlertDialog('Error in bwAttachments.js.xx(). Unexpected value for bwBudgetRequestId: ' + bwBudgetRequestId);
                ...
                html += '   <tbody>';
                html += '       <tr xcx="xcx21342526-1" id="xcx21342526-1" class="xdTableOffsetRow xdTableOffsetRow-editor" id="toolboxdraggablerow_2" draggable="true" bwwidgetname="bwAttachments">';
                ...
                if (/(iPad|iPhone|iPod)/g.test(navigator.userAgent)) {
                    ...
                    //html += '                           </table>';
                    //html += '                           <br /><br />';
                    //html += '                           <table id="dropzone1xx" onclick="$(\'.bwAttachments\').bwAttachments(\'downloadZippedFiles\', \'' + bwBudgetRequestId + '\', \'' + bwRequestTitle + '\');" contenteditable="true" style="height:100%;border:1px solid goldenrod;background-color:#f6f6f6;color:gray;font-size:10pt;cursor:pointer;">';
                    //html += '                               <tr>';
                    //html += '                                   <td style="vertical-align:middle;">';
                ...
                html += '<input type="file" multiple name="multerFileUploadIdentifier_original" id="inputFile_' + bwBudgetRequestId + '" class="upload" style="visibility:hidden;" onchange="$(\'.bwAttachments:first\').bwAttachments(\'uploadAttachment\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\');" />';
                //html += '<input type="file" name="multerFileUploadIdentifier_original" id="inputFile_' + bwBudgetRequestId + '" class="upload" style="visibility:hidden;" onchange="$(\'.bwAttachments:first\').bwAttachments(\'uploadAttachment\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\');" />';





                //alert('Rendering onchange .bwAttachments:closest uploadAttachment().')
                ...
                html += '           <p id="newrequestattachments" xcx="xcx448-1-1-1" style="word-break:break-all;white-space:normal;"></p>';
                ...
                html += '               onclick="$(\'.bwAttachments:first\').bwAttachments(\'copyAttachments\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\', \'' + bwRequestTitle + '\', \'' + bwRequestTypeId + '\');" />';
                ...
                html += '               onclick="$(\'.bwAttachments:first\').bwAttachments(\'performOCR_MultipleImages\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\', \'' + bwRequestTitle + '\', \'' + bwRequestTypeId + '\');" />';
                ...
                html += '               onclick="$(\'.bwAttachments:first\').bwAttachments(\'performCHATGPT_MultipleImages\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\', \'' + bwRequestTitle + '\', \'' + bwRequestTypeId + '\');" />';
                ...
                if (this.options.inFormsEditor != true) {
                    ...
                    //debugger;
                    //var element = $('.bwAttachments:first').find('.xdTableOffsetRow');

                    $('.bwAttachments:first').find('.xdTableOffsetRow').removeAttr('draggable'); // 4-19-2024. 
                    $('.bwAttachments:first').find('.xdTableOffsetRow').removeClass('xdTableOffsetRow-editor');
                ...
                var dropzone = document.getElementById('bwAttachments_dropzone_' + bwBudgetRequestId);
                    ...
                    try {
                        ...
                        if (e.clipboardData) {
                            ...
                            if (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) {
                                ...
                                alert('Error in bwAttachments.js.dropzone.drop(). Could not find a valid DataTransfer object. e: ' + JSON.stringify(e) + ', navigator.userAgent: ' + navigator.userAgent);
                            }
                        ...
                        if (gotData == true) {
                            ...
                            alert('Error in bwAttachments.js.dropzone.drop(). Could not find a valid DataTransfer object.');
                        }

                    } catch (e) {
                        var msg = 'Exception in bwAttachments.js.dropzone.drop(): ' + e.message + ', ' + e.stack;
                        console.log(msg);
                        alert(msg);
                    }
                });
                ...
                //                    console.log('In bwAttachments.js.renderAndPopulateAttachments.dropzone.paste(). No base64 in the img src or this element. It must be a http reference... imgSrc: ' + imgSrc);
                ...
                //                        alert('In bwAttachments.js.renderAndPopulateAttachments.dropzone.drop(). xcx12132123-2. tmp1: ' + tmp1 + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', fileNameToCutAndPaste: ' + fileNameToCutAndPaste);
                ...
                //                                alert('Exception in bwAttachments.js.renderAndPopulateAttachments.dropzone.drop(). from psomise xcx87987 ' + e + ', Exception when fetching "' + imgSrc + '".');
                //                                imgElement.remove(); // Remove the img element which is displaying the pasted image.
                ...
                //                    //
                //                    // When we get here, we may have a drag-and-dropped file which was dropped on the bwAttachments form widget... we need to get it by Blob "CreateUrl()" maybe....????
                //                    //

                //                    var msg = 'When we get here, we may have a drag-and-dropped file which was dropped on the bwAttachments form widget... we need to get it by Blob "CreateUrl()" maybe....????';
                //                    displayAlertDialog_Persistent(msg);
                ...
                //    try {
                //        console.log('In bwAttachments.js.renderAndPopulateAttachments.dropzone.drop().');
                ...
                if (this.options.jsonData) {
                    ...
                    ////alert('In bwAttachments.js.renderAndPopulateAttachments(). this.options.jsonData.bwBudgetRequestId: ' + this.options.jsonData.bwBudgetRequestId + ', this.options.jsonData: ' + JSON.stringify(this.options.jsonData));
                    console.log('Calling bwAttachments.js.populateAttachments(). xcx13124-1');
            ...
            html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments</span>';
            html += '<br />';
            html += '<span style="">Exception in bwAttachments.renderAndPopulateAttachments(): ' + e.message + ', ' + e.stack + '</span>';
            this.element.html(html);
        }
    },
    renderAndPopulateAttachments_STANDALONE: function () {
        try {
            console.log('');
            console.log('##################################');
            console.log('In bwAttachments.js.renderAndPopulateAttachments_STANDALONE().');
            console.log('##################################');
            console.log('');
            var thiz = this;
            ...
            if (!bwBudgetRequestId) {
                ...
                if (/(iPad|iPhone|iPod)/g.test(navigator.userAgent)) {
                    ...
                    //    html += '                           <div id="dropzone1xx" onclick="$(\'.bwAttachments\').bwAttachments(\'downloadZippedFiles\', \'' + bwBudgetRequestId + '\', \'' + bwRequestTitle + '\');" contenteditable="false" style="height:180px;border:1px solid goldenrod;background-color:#f6f6f6;color:gray;font-size:10pt;cursor:pointer;background-image:url(\'/images/download_arrow_icon.png\');background-repeat: no-repeat;background-size: 130px;text-align: center;padding: 5px; background-position: center bottom;" >';
                    //    html += '                               <div style="color:goldenrod;">Click to download these files as a zip archive.</div>';
                    //    html += '                           </div>';
                ...
                html += '           <p id="newrequestattachments" xcx="xcx448-1-1-2" style="word-break:break-all;white-space:normal;"></p>';
            ...
            html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments</span>';
            html += '<br />';
            html += '<span style="">Exception in bwAttachments.renderAndPopulateAttachments_STANDALONE(): ' + e.message + ', ' + e.stack + '</span>';
            this.element.html(html);
        }
    },
    ConvertMediaFileToBaselineShareable: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments.js.ConvertMediaFileToBaselineShareable().');
            var thiz = this;
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            displayAlertDialog('In bwAttachments.js.ConvertMediaFileToBaselineShareable.success(): ' + results.status + ', ' + results.message);
                        ...
                        console.log('Exception in bwAttachments.js.ConvertMediaFileToBaselineShareable.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments.js.ConvertMediaFileToBaselineShareable.success(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    ...
                    console.log('Error in bwAttachments.js.ConvertMediaFileToBaselineShareable.error(): ' + errorMessage);
                    displayAlertDialog('Error in bwAttachments.js.ConvertMediaFileToBaselineShareable.error(): ' + errorMessage);
                }
            });
            ...
            var msg = 'Exception in bwAttachments.js.ConvertMediaFileToBaselineShareable(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    launchFileConversion: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments.js.launchFileConversion().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (data) {
                    try {
                        ...
                        console.log('Exception in bwAttachments.js.launchFileConversion.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments.js.launchFileConversion.success(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwAttachments.js.launchFileConversion.error(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Error in bwAttachments.js.launchFileConversion.error(): bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename + ', errorMessage: ' + errorMessage);
                }
            });

        } catch (e) {
            console.log('Exception in bwAttachments.js.launchFileConversion(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.launchFileConversion(): ' + e.message + ', ' + e.stack);
        }
    },
    getExifData: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments.js.getExifData().');
            var thiz = this;
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        console.log('Exception in bwAttachments.js.getExifData.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments.js.getExifData.success(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwAttachments.js.getExifData.error(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Error in bwAttachments.js.getExifData.error(): bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename + ', errorMessage: ' + errorMessage);
                }
            });

        } catch (e) {
            console.log('Exception in bwAttachments.js.getExifData(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.getExifData(): ' + e.message + ', ' + e.stack);
        }
    },

    performOCR: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments.js.performOCR().');
            ...
            console.log('Exception in bwAttachments.js.performOCR(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.performOCR(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.js.performOCR(): ' + e.message + ', ' + e.stack);
        }
    },

    performOCR_MultipleImages: function (requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId) { // filename) {
        try {
            console.log('In bwAttachments.js.performOCR_MultipleImages().');
            var thiz = this;
            //alert('In bwAttachments.js.performOCR_MultipleImages(). bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename);
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            //                console.log('Exception in bwAttachments.js.copyAttachments.displayImageThumbnail(): ' + e.message + ', ' + e.stack);
                            //                displayAlertDialog('Exception in bwAttachments.js.copyAttachments.displayImageThumbnail(): ' + e.message + ', ' + e.stack);
                            ...
                            //        console.log('Fail in bwAttachments.js.copyAttachments.displayImageThumbnail(): ' + JSON.stringify(result));
                            //        displayAlertDialog('Fail in bwAttachments.js.copyAttachments.displayImageThumbnail(): ' + JSON.stringify(result));
                            //        document.getElementById(imgId).src = globalUrlPrefix + globalUrl + '/images/mp4.jfif'; // There is no thumbnail, so display the icon.
                            //    });
                            //}
                        ...
                        console.log('Exception in bwAttachments.js.copyAttachments.dialog.open.ajax.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments.js.copyAttachments.dialog.open.ajax.success(): ' + e.message + ', ' + e.stack);
                    }

                },
                error: function (data, errorCode, errorMessage) {
                    console.log('Error in bwAttachments.js.copyAttachments.dialog.open.ajax.error(): ' + errorMessage + ', workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', participantId: ' + participantId);
                    displayAlertDialog('Error in bwAttachments.js.copyAttachments.dialog.open.ajax.error(): ' + errorMessage + ', workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', participantId: ' + participantId);
                }
            });

        } catch (e) {
            console.log('Exception in bwAttachments.js.performOCR_MultipleImages(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.performOCR_MultipleImages(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.js.performOCR_MultipleImages(): ' + e.message + ', ' + e.stack);
        }
    },

    performCHATGPT_MultipleImages: function (requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId) { // filename) {
        try {
            console.log('In bwAttachments.js.performCHATGPT_MultipleImages().');
            var thiz = this;
            //alert('In bwAttachments.js.performCHATGPT_MultipleImages().'); // bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename);
            ...
            if (!div) {
                ...
                html += '  <br /><br />';
                html += '  <div id="btnRunDiagnostics" onclick="$(\'.bwAttachments:first\').bwAttachments(\'performCHATGPT_MultipleImages_Invoke\');" class="divDialogButton" title="Click here to run the large language model...">';
            ...
            HideActivitySpinner();
            console.log('Exception in bwAttachments.js.performCHATGPT_MultipleImages(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.performCHATGPT_MultipleImages(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.js.performCHATGPT_MultipleImages(): ' + e.message + ', ' + e.stack);
        }
    },
    performCHATGPT_MultipleImages_Invoke: function () {
        try {
            ...
            HideActivitySpinner();
            console.log('Exception in bwAttachments.js.performCHATGPT_MultipleImages_Invoke(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.performCHATGPT_MultipleImages_Invoke(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.js.performCHATGPT_MultipleImages_Invoke(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    repairFileType: function (bwBudgetRequestId, originalFilename) {
        try {
            console.log('In bwAttachments.js.repairFileType().');
            var thiz = this;
            ...
            if (!div) {
                ...
                console.log('In bwAttachments.js.repairFileType(). adding element to the dom: ' + 'divRepairFileTypeDialog');
                    ...
                    $.ajax({
                        ...
                        success: function (results) {
                            try {
                                ...
                                console.log('Exception in bwAttachments.js.repairFileType.post.removeattachment.success(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwAttachments.js.repairFileType.post.removeattachment.success(): ' + e.message + ', ' + e.stack);
                            }
                        },
                        error: function (data, errorCode, errorMessage) {
                            console.log('Error in bwAttachments.js.repairFileType.post.removeattachment.error(): ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Error in bwAttachments.js.repairFileType.post.removeattachment.error(): bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename + ', errorMessage: ' + errorMessage);
                        }
                    });
                } catch (e) {
                    console.log('Exception in bwAttachments.js.repairFileType.deletebutton.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments.js.repairFileType.deletebutton.click(): ' + e.message + ', ' + e.stack);
                }
            });


        } catch (e) {
            console.log('Exception in bwAttachments.js.repairFileType(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.repairFileType(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    copyAttachments: function (attachmentsElementId, requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId) { // bwrequesttitle, bwrequesttypeid
        try {
            console.log('In bwAttachments.js.copyAttachments().');
            //alert('In bwAttachments.js.copyAttachments().');
            var thiz = this;
            ...
            if (!externallyFacingUrlForAttachments) {
                ...
                if (!div) {
                    //alert('In bwAttachments.js.copyAttachments(). Adding ' + dialogId + ' to the DOM.');
                    div = document.createElement('div');
                    div.id = dialogId;
                    div.style.display = 'none';
                ...
                html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwAttachments\').bwAttachments(\'copyFiles\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\', \'' + bwRequestTitle + '\', \'' + bwRequestTypeId + '\');">';
                ...
                $('#' + dialogId).dialog({
                    ...
                    open: function () {
                        try {
                            ...
                            console.log('Exception in bwAttachments.js.copyAttachments.dialog.open(): ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwAttachments.js.copyAttachments.dialog.open(): ' + e.message + ', ' + e.stack);
                        }
                    }
                });
            ...
            console.log('Exception in bwAttachments.js.copyAttachments(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.copyAttachments(): ' + e.message + ', ' + e.stack);
        }
    },
    copyFiles: function (attachmentsElementId, requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId) {
        try {
            console.log('In bwAttachments.js.copyFiles().');
            var thiz = this;
            ...
            if (checkboxes && checkboxes.length) {
                for (var i = 0; i < checkboxes.length; i++) {
                    if (checkboxes[i].checked) {
                        ...
                        // img_bwAttachments_4143c511-8afa-4023-87fc-cac61c765957_8cad99af-1797-4d1b-9b9e-e98bb173b058_0
                        ...
                        if (!img) {
                            ...
                            //displayAlertDialog('Error in bwAttachments.js.copyFiles(). Could not locate the img element. Doing it anyway. xcx21345677-1');
                ...
                $.ajax({
                    ...
                    success: function (results) {
                        try {
                            ...
                            HideActivitySpinner();
                            console.log('Exception in bwAttachments.js.copyFiles():1: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwAttachments.js.copyFiles():1: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (data, errorCode, errorMessage) {
                        HideActivitySpinner();
                        console.log('Error in bwAttachments.js.copyFiles(): ' + errorCode + ' ' + errorMessage + ', data: ' + JSON.stringify(data));
                        displayAlertDialog('Error in bwAttachments.js.copyFiles(): ' + errorCode + ' ' + errorMessage + ', data: ' + JSON.stringify(data));
                    }
                });
            ...
            HideActivitySpinner();
            console.log('Exception in bwAttachments.js.copyFiles(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.copyFiles(): ' + e.message + ', ' + e.stack);
        }
    },
    emailAttachments: function (attachmentsElementId, requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId, attachments) { // bwrequesttitle, bwrequesttypeid
        try {
            console.log('In bwAttachments.js.emailAttachments().');
            //alert('In bwAttachments.js.emailAttachments().');
            var thiz = this;
            ...
            if (!externallyFacingUrlForAttachments) {
                ...
                html += '<div style="white-space:nowrap;">';
                //html += '<div class="divSignInButton" style="width:90%;text-align:center;line-height:1.1em;font-weight:bold;" onclick="$(\'.bwAttachments\').bwAttachments(\'sendEmail\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\');">';
                ...
                $('#' + dialogId).dialog({
                    ...
                    open: function () {
                        try {
                            ...
                            var divEmailRecipients = 'divEmailAttachmentsDialog_bwAttachments_bwPeoplePicker_EmailRecipients_' + thiz.options.elementIdSuffix;
                            ...
                            if (!bwBudgetRequestId) {
                                console.log('ERROR IN bwAttachments.js.emailAttachments(). Unexpected value for bwBudgetRequestId: ' + bwBudgetRequestId);
                                displayAlertDialog('ERROR IN bwAttachments.js.emailAttachments(). Unexpected value for bwBudgetRequestId: ' + bwBudgetRequestId);
                            } else {
                            ...
                            console.log('Exception in bwAttachments.js.emailAttachments():2: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwAttachments.js.emailAttachments():2: ' + e.message + ', ' + e.stack);
                        }
            ...
            console.log('Exception in bwAttachments.js.emailAttachments(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.emailAttachments(): ' + e.message + ', ' + e.stack);
        }
    },
    sendEmail: function (attachmentsElementId, requestDialogId, bwBudgetRequestId, bwRequestTitle, bwRequestTypeId) {
        try {
            ...
            var widgetId = 'divEmailAttachmentsDialog_bwAttachments_bwPeoplePicker_EmailRecipients_' + this.options.elementIdSuffix;
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        try {
                            ...
                            HideActivitySpinner();
                            console.log('Exception in bwAttachments.js.sendEmail():1: ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Exception in bwAttachments.js.sendEmail():1: ' + e.message + ', ' + e.stack);
                        }
                    },
                    error: function (data, errorCode, errorMessage) {
                        HideActivitySpinner();
                        console.log('Error in bwAttachments.js.sendEmail(): ' + errorCode + ' ' + errorMessage);
                        displayAlertDialog('Error in bwAttachments.js.sendEmail(): ' + errorCode + ' ' + errorMessage);
                    }
                });
            }
    ...
    renderAndPopulateAttachments_ReadOnly: function (requestDialogId) {
        try {
            console.log('In bwAttachments.js.renderAndPopulateAttachments_ReadOnly().');
            //alert('In bwAttachments.js.renderAndPopulateAttachments_ReadOnly(). This method may need some work.');
            var thiz = this;
            ...
            //html += '<input type="file" multiple name="multerFileUploadIdentifier" id="inputFile_' + bwBudgetRequestId + '" class="upload" style="visibility:hidden;" onchange="$(\'.bwAttachments:first\').bwAttachments(\'uploadAttachment\',\'newrequestattachments\', \'' + requestDialogId + '\', \'' + bwBudgetRequestId + '\');" />';
            ...
            if (this.options.jsonData) {
                ...
                console.log('Calling bwAttachments.js.populateAttachments(). xcx13124-2');
            ...
            html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments</span>';
            html += '<br />';
            html += '<span style="">Exception in bwAttachments.renderAndPopulateAttachments_ReadOnly(): ' + e.message + ', ' + e.stack + '</span>';
            this.element.html(html);
        }
        //try {
        //    console.log('In bwAttachments.js.renderAndPopulateAttachments_ReadOnly().');
        //    alert('In bwAttachments.js.renderAndPopulateAttachments_ReadOnly().');
        //    //var thiz = this;
        //    var html = '';

        //    html += '<table style="width:100%;">';
        //    html += '                        <tbody><tr  xcx="xcx21342526-2" id="xcx21342526-2" class="xdTableOffsetRow xdTableOffsetRow-editor" id="toolboxdraggablerow_2" draggable="true" bwwidgetname="bwAttachments">';
        ...
        //    //html += '               <input type="file" id="inputFile" class="upload" style="visibility:hidden;" onchange="$(\'.bwAttachments\').bwAttachments(\'uploadAttachment\',\'newrequestattachments\');" />';
        //    //html += '           </div>';
        //    //html += '           <!--<br />';
        ...
        //} catch (e) {
        //    console.log('Exception in bwAttachments.js.renderAndPopulateAttachments_ReadOnly: ' + e.message + ', ' + e.stack);

        //    //renderAndPopulateAttachments
        //    //$(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments.renderAndPopulateAttachments_ReadOnly: ' + e.message + ', ' + e.stack;
        //    var html = '';
        //    html += '<span style="font-size:24pt;color:red;">CANNOT RENDER bwAttachments</span>';
        //    html += '<br />';
        //    html += '<span style="">Exception in bwAttachments.js.renderAndPopulateAttachments_ReadOnly(): ' + e.message + ', ' + e.stack + '</span>';
        //    thiz.element.html(html);
        //}
    },
    ...
    uploadAttachment: function (displayAttachmentsTagName, requestDialogId, bwBudgetRequestId, objDataTransfer) {
        try {
            ...
            console.log('Error in bwAttachments.js.uploadAttachment(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Error in bwAttachments.js.uploadAttachment(): ' + e.message + ', ' + e.stack);
            $(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments.uploadAttachment(): ' + e.message + ', ' + e.stack;
        }
    ...
    uploadPastedAttachment: function (imgSrc) {
        try {
            //console.log('In bwAttachments.js.uploadPastedAttachment(). attachmentsAreStoredInIndexDb: ' + this.options.attachmentsAreStoredInIndexDb + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            //console.log('In uploadPastedAttachment().  Using .bwAttachments:closest.  bwBudgetRequestId: ' + bwBudgetRequestId + ', elementIdSuffix: ' + this.options.elementIdSuffix + ', displayAttachmentsTagName: ' + displayAttachmentsTagName + ', requestDialogId: ' + requestDialogId);
    ...
    cmdDisplayConfirmFileUploadDialog: function (displayAttachmentsTagName, bwBudgetRequestId, requestDialogId, element) { // element is >>> var x = $('#inputFile_' + bwBudgetRequestId)[0]; // $('#' + requestDialogId).find('#inputFile')[0];
        try {
            console.log('In bwAttachments.js.cmdDisplayConfirmFileUploadDialog(). bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            if (!(x && x.files && x.files.length && (x.files.length > 0))) {
                ...
                alert('xcx3124 Fatal error in bwAttachments.js.cmdDisplayConfirmFileUploadDialog(). NO FILES FOR ELEMENT [' + 'inputFile_' + bwBudgetRequestId + '].')
                ...
                if (!file) { // Don't like doing this but sometimes file is undefined... is this a race condition or a duplicate DOM element?? 6-23-2020
                    ...
                    if (file.size > 100000000) {
                        ...
                        console.log('>>>> In bwAttachments.js.uploadAttachment(). Calling .dialog(). bwBudgetRequestId: ' + bwBudgetRequestId + ', file.length: ' + file.length);
                                        ...
                                        $(this).ready(function () {
                                            ...
                                            $('#' + dialogId + '_btnUploadTheFileNow').off('click').click(function () { // divConfirmFileUploadDialog_ForAttachments_78ebbdca-32d7-4019-9c53-cdc55e11a775_btnUploadTheFileNow
                                                try {
                                                    ...
                                                    alert('THIS IS THE ONE... xcx11 In bwAttachments.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
                                                    ...
                                                    console.log('In bwAttachments.js.UploadButton_OnClick(). Getting ready to call processUpload(). filename: ' + filename + ', file.name: ' + file.name); //              displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
                                                    //alert('In bwAttachments.js.UploadButton_OnClick(). Getting ready to call processUpload(). filename: ' + filename + ', file.name: ' + file.name); //              displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            console.log('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm: async function (displayAttachmentsTagName, bwBudgetRequestId, requestDialogId, element, file) { // element is >>> var x = $('#inputFile_' + bwBudgetRequestId)[0]; // $('#' + requestDialogId).find('#inputFile')[0];
        try {
            ...
            console.log('In bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(). bwBudgetRequestId: ' + bwBudgetRequestId);
            //alert('###########In bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(). bwBudgetRequestId: ' + bwBudgetRequestId);
                    ...
                    try {
                        ...
                        if (!uploadButton) {
                            ...
                            $('#' + dialogId + '_btnUploadTheFileNow').off('click').click(function () { // divConfirmFileUploadDialog_ForAttachments_78ebbdca-32d7-4019-9c53-cdc55e11a775_btnUploadTheFileNow
                                ...
                                alert('#>>>>In bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.dialog.open(). xcx23123142. file.name: ' + file.name + '. Element id: ' + 'inputFile_' + bwBudgetRequestId);
                                ...
                                //alert('xcx21321312. In bwAttachments.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            $('#' + dialogId + '_btnInitializeFfmpegWasm').off('click').click(function (x) {
                try {
                    ...
                    alert('#>>>>In bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.xxxxxxxxxx(). x.length: ' + x2.length + '. Element id: ' + 'inputFile_' + bwBudgetRequestId);



                    //alert('#>>>>$$$$$$$$$$$In bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.dialog.open(). files.length: ' + files.length + '. Element id: ' + 'inputFile_' + bwBudgetRequestId);



                    //alert('###$$$$$$In bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm._btnInitializeFfmpegWasm.click(). files.length: ' + files.length + '. Element id: ' + 'inputFile_' + bwBudgetRequestId);
                    ...
                    if (!(x && x.files && x.files.length && (x.files.length > 0))) {
                        ...
                        alert('xcx3124 Fatal error in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(). NO FILES FOR ELEMENT xcx12345364 [' + 'inputFile_' + bwBudgetRequestId + '].')
                                                    ...
                                                    try {
                                                        ...
                                                        canvas.toBlob(async (blob) => {
                                                            try {
                                                                ...
                                                                console.log('In bwAttachments.js.UploadButton_OnClick(). xcx124677'); // displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
                    ...
                    alert('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.button.click(): ' + e.message + ', ' + e.stack);
                    console.log('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.button.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm.button.click(): ' + e.message + ', ' + e.stack);

                }
            });

        } catch (e) {
            console.log('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_ffmpeg_wasm(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    downloadLargeFile: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments.js.downloadLargeFile().');
            alert('In bwAttachments.js.downloadLargeFile().');
            ...
            $.ajax({
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            var msg = 'Error in bwAttachments.js.downloadLargeFile(). ' + results.status + ': ' + results.message;
                            console.log(msg);
                            displayAlertDialog(msg);
                        ...
                        var msg = 'Exception in bwAttachments.js.downloadLargeFile.download(): ' + e.message + ', ' + e.stack;
                        console.log(msg);
                        displayAlertDialog(msg);
                        //$(this.element).find('#newrequestattachments')[0].innerHTML = msg;
                    }
                ...
                error: function (data, errorCode, errorMessage) {
                    ...
                    var msg = 'Error in bwAttachments.js.downloadLargeFile.download(): errorMessage: ' + errorMessage + ', errorCode: ' + errorCode + ', data: ' + JSON.stringify(data) + ', operationUri: ' + operationUri;
                    console.log(msg);
                    displayAlertDialog(msg);
            ...
            var msg = 'Exception in bwAttachments.js.downloadLargeFile(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    cmdDisplayConfirmFileUploadDialog_zip_wasm: async function (displayAttachmentsTagName, bwBudgetRequestId, requestDialogId, element) { // element is >>> var x = $('#inputFile_' + bwBudgetRequestId)[0]; // $('#' + requestDialogId).find('#inputFile')[0];
        try {
            ...
            console.log('In bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(). bwBudgetRequestId: ' + bwBudgetRequestId);
            alert('In bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(). bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            //    } catch (e) {
            //        console.log('Exception in bwAttachments.js.uploadZipFile(): ' + e.message + ', ' + e.stack);
            //        alert('Exception in bwAttachments.js.uploadZipFile(): ' + e.message + ', ' + e.stack);
            //        displayAlertDialog('Exception in bwAttachments.js.uploadZipFile(): ' + e.message + ', ' + e.stack);
            //    }
            //}
            ...
            $('#' + dialogId + '_btnInitializeZipWasm').off('click').click(function (error) {
                try {
                    ...
                    console.log('In bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click(). PREPARING TO ZIP THESE FILES AND UPLOAD TO THE SERVER: ' + JSON.stringify(trackingArray));
                    ...
                    for (var i = 0; i < files.length; i++) {
                        ...
                        reader.onload = function (event) {
                            try {
                                ...
                                console.log('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click.reader.load(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click.reader.load(): ' + e.message + ', ' + e.stack);
                                alert('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click.reader.load(): ' + e.message + ', ' + e.stack);
                            }
                        };
                    ...
                    console.log('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click(): ' + e.message + ', ' + e.stack);
                    alert('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm.button.click(): ' + e.message + ', ' + e.stack);
                }
            });
                        ...
                        if (!uploadButton) {
                            ...
                            $(this).ready(function () {
                                ...
                                $('#' + dialogId + '_btnUploadTheFileNow').off('click').click(function () { // divConfirmFileUploadDialog_ForAttachments_78ebbdca-32d7-4019-9c53-cdc55e11a775_btnUploadTheFileNow
                                    ...
                                    alert('xcx999994-1. In bwAttachments.js.UploadButton_OnClick(). displayAttachmentsTagName: ' + displayAttachmentsTagName + ', bwBudgetRequestId: ' + bwBudgetRequestId);
            ...
            console.log('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.js.cmdDisplayConfirmFileUploadDialog_zip_wasm(): ' + e.message + ', ' + e.stack);
        }
    },

    ffmpegMultiFileMergeAndUpload: async function (bwBudgetRequestId, inputFileAttachmentsElement) {
        try {
            console.log('In bwAttachments.js.ffmpegMultiFileMergeAndUpload(). bwBudgetRequestId: ' + bwBudgetRequestId);
            alert('In bwAttachments.js.ffmpegMultiFileMergeAndUpload(). bwBudgetRequestId: ' + bwBudgetRequestId + ', files.length: ' + inputFileAttachmentsElement.files.length);
            ...
            console.log('Exception in bwAttachments.js.ffmpegMultiFileMergeAndUpload(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.ffmpegMultiFileMergeAndUpload(): ' + e.message + ', ' + e.stack);
            alert('Exception in bwAttachments.js.ffmpegMultiFileMergeAndUpload(): ' + e.message + ', ' + e.stack);
        }
    },
    ...
    FFMPEGConvertAndUploadMultipleVideoFiles_Batch: function (x, bwBudgetRequestId, dialogId) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwAttachments.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch().');
                ...
                for (var i = 0; i < thiz.options.smallFileBatchArray[x].length; i++) {
                    ...
                    var promise = thiz.FFMPEGConvertAndUploadVideoFile(thiz.options.smallFileBatchArray[x][i], bwBudgetRequestId, dialogId).then(function (results) {
                        ...
                        alert('Exception in bwAttachments.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch(). xcx4567. e.FailedFileName: ' + e.FailedFileName + ', JSON.stringify(e): ' + JSON.stringify(e));
                        var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch():3: e.FailedFileName: ' + e.FailedFileName + ', JSON.stringify(e): ' + JSON.stringify(e);
                ...
                Promise.all(promiseArray)
                    .then(function (results) {
                        ...
                        var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch():2: ' + JSON.stringify(e);
                        alert(msg);
                        var result = {
                            status: 'EXCEPTION',
                            message: msg
                ...
                var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadMultipleVideoFiles_Batch():1: ' + e.message + ', ' + e.stack;
    ...
    FFMPEGConvertAndUploadVideoFile: function (file, bwBudgetRequestId, dialogId) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                console.log('In bwAttachments.js.FFMPEGConvertAndUploadVideoFile().');
                //alert('In bwAttachments.js.FFMPEGConvertAndUploadVideoFile(). file.name: ' + file.name);
                    ...
                    try {
                        ...
                        function load_file(file) {
                            try {
                                ...
                                HideActivitySpinner();
                                var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.load_file(): ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                alert(msg);
                        ...
                        async function print_file(files) {
                            try {
                                ...
                                if (!result) {
                                    ...
                                    displayAlertDialog_Persistent('Error in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file(). files.currentTarget.result: ' + files.currentTarget.result + ', inputFilename: ' + inputFilename + ', bwBudgetRequestId: ' + bwBudgetRequestId);

                                    var msg = 'Error in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file(). FATAL ERROR! NO result in print_file(). result: ' + result;
                                    console.log(msg);
                                    alert(msg);
                                    ...
                                    ffmpeg.writeFile(inputFilename, uint8_view).then(function (data) {
                                        try {
                                            ...
                                            ffmpeg.exec(executionString).then(function (data) {
                                                try {
                                                    ...
                                                    ffmpeg.deleteFile(inputFilename).then(function (data) {
                                                        try {
                                                            ...
                                                            if (data != true) {
                                                                ...
                                                                ffmpeg.readFile(outputFilename).then(function (data) {
                                                                    try {
                                                                        ...
                                                                        thiz.performUpload3(outFile, outputFilename, bwBudgetRequestId, null, false).then(function (data) {
                                                                            ...
                                                                            ffmpeg.deleteFile(inputFilename).then(function (data) {
                                                                                    ...
                                                                                    if (data != true) {
                                                                                        ...
                                                                                        ffmpeg.deleteFile(outputFilename).then(function (data) {
                                                                                            try {
                                                                                                ...
                                                                                                var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile():2-xcx1: ' + e.message + ', ' + e.stack;
                                                                                                console.log(msg);
                                                                                                alert(msg);
                                                                                            }
                                                                                            ...
                                                                                            var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile.catch():1-2-1-xcx1: ' + JSON.stringify(e);
                                                                                            console.log(msg);
                                                                                            alert(msg);
                                                                                ...
                                                                                var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile.catch():1-2-2-xcx1: ' + JSON.stringify(e);
                                                                                console.log(msg);
                                                                                alert(msg);
                                                                        ...
                                                                        var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile():2: ' + e.message + ', ' + e.stack;
                                                                        console.log(msg);
                                                                        alert(msg);
                                                                    ...
                                                                    var msg = 'WILL THIS BUBBLE TO THE TOP1? Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile.catch():1: FATAL EXCEPTION. PUTTING THE FILE IN THE RETRY LIST1. JSON.stringify(e): ' + JSON.stringify(e);
                                                                    console.log(msg);
                                                                    alert(msg);
                                                                    displayAlertDialog_Persistent(msg);
                                                        ...
                                                        var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec.readFile.catch():1-2-2: ' + JSON.stringify(e);
                                                        console.log(msg);
                                                        alert(msg);
                                                    ...
                                                    var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.exec():2: ' + e.message + ', ' + e.stack;
                                                    console.log(msg);
                                                    alert(msg);
                                                ...
                                                try {
                                                    ...
                                                    var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile.catch(): ' + e.message + ', ' + e.stack;
                                                    console.log(msg);
                                                    alert(msg);
                                                    displayAlertDialog_Persistent(msg);
                                            ...
                                            var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile():2: ' + e.message + ', ' + e.stack;
                                            console.log(msg);
                                            alert(msg);
                                        ...
                                        var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file.ffmpeg.writeFile():1: ' + JSON.stringify(e);
                                        console.log(msg);
                                        alert(msg);
                                ...
                                var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode.print_file(): ' + e.message + ', ' + e.stack;
                                console.log(msg);
                                alert(msg);
                                displayAlertDialog(msg);
                        ...
                        var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile.transcode(): ' + e.message + ', ' + e.stack;
                        console.log(msg);
                        alert(msg);
                ...
                var msg = 'Exception in bwAttachments.js.FFMPEGConvertAndUploadVideoFile(): ' + e.message + ', ' + e.stack;
                console.log(msg);
    ...
    CloseDialog_btnCancelUploadTheFileNow: function (bwBudgetRequestId, dialogId) {
        try {
            console.log('In bwAttachments.js.CloseDialog_btnCancelUploadTheFileNow().');
            ...
            var msg = 'Exception in bwAttachments.js.CloseDialog_btnCancelUploadTheFileNow(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    processUpload: function (displayAttachmentsTagName, _budgetRequestId, file, filename, convertToAPdf) { // convertToAPdf means that we will attempt to put the attachment into a pdf and save it as a pdf file.
        try {
            console.log('In bwAttachments.js.processUpload().');
            //alert('In bwAttachments.js.processUpload(). filename: ' + filename);
            var thiz = this;
            ...
            if (!file || file.length == 0) {
                ...
                console.log('In bwAttachments.js.processUpload(). filename: ' + filename);
                //alert('In bwAttachments.js.processUpload(). filename: ' + filename);
                ...
                if (filename.indexOf('.xml') > 0) {
                    ...
                    console.log('In bwAttachments.js.processUpload(). Calling performUpload().');
    ...
    performUpload: function (outFile, filename, displayAttachmentsTagName, bwBudgetRequestId, convertToAPdf) { // convertToAPdf means that we will attempt to put the attachment into a pdf and save it as a pdf file.
        try {
            console.log('In bwAttachments.js.performUpload().');
            console.log('In bwAttachments.js.performUpload(). ARE WE STILL USING THIS METHOD? filename: ' + filename + ', outFile.name: ' + outFile.name);
            var thiz = this;
            ...
            // 2-4-2022
            console.log('In bwAttachments.js.performUpload(). workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId);
                                ...
                                try {
                                    ...
                                    if (data.status == 'SUCCESS') {
                                        ...
                                        if (!budgetrequestform) {
                                            ...
                                            displayAlertDialog('In bwAttachments.js.performUpload(). Could not find budgetrequestform with bwBudgetRequestId: ' + bwBudgetRequestId);
                                            ...
                                            $('.bwRequest').bwRequest('saveAndPublishTheRequest', 'divPageContent1', true, bwBudgetRequestId, bwRequestTypeId) // This saves and publishes the New Request for the first time. 9-8-2022
                                                .then(function (results) {
                                                    ...
                                                    if (results.status != 'SUCCESS') {
                                                        ...
                                                        var msg = 'Error in bwAttachments.js.performUpload(). xcx21345-1: ' + results.status + ', ' + results.message;
                                                        displayAlertDialog(msg);
                                                    ...
                                                    thiz.populateAttachments(workflowAppId, bwBudgetRequestId, displayAttachmentsTagName, true); // This lists the attachments in the <p> tag with id='attachments'.
                                                    console.log('Exception from Promise in bwAttachments.js.performUpload(). xcx21345-2: ' + JSON.stringify(e));
                                        ...
                                        if (data.message.indexOf('gmError: Error: Command failed: identify-im6.q16: no decode delegate for this image format `M4A') > -1) {
                                            ...
                                            var msg = data.status + ' in bwAttachments.js.performUpload() xcx02856-1: ' + data.message;
                                            console.log(msg);
                                            displayAlertDialog(msg);
                                        ...
                                        var msg = data.status + ' in bwAttachments.js.performUpload() xcx02856-2: ' + data.message;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    ...
                                    $(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments.performUpload():2: ' + e.message + ', ' + e.stack;
                                }
                            },
                            error: function (data, errorCode, errorMessage) {
                                $('#divWorkingOnItDialog').dialog('close'); // Close the "Working on it..." dialog.
                    ...
                    $.ajax({
                            ...
                            try {
                                ...
                                xhr.upload.addEventListener("error", function (evt) {
                                    try {
                                        ...
                                        var msg = 'Error in bwAttachments.js.performUpload.xhr.upload.error():xcx1-1: workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', evt: ' + JSON.stringify(evt);
                        ...
                        success: function (data) {
                            try {
                                ...
                                console.log('Exception in bwAttachments.js.performUpload():xcx33: ' + e.message + ', ' + e.stack);
                                alert('Exception in bwAttachments.js.performUpload():xcx33: ' + e.message + ', ' + e.stack);
                                //$(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments.performUpload():xcx33: ' + e.message + ', ' + e.stack;
                                //displayAlertDialog('Exception in bwAttachments.js.performUpload():xcx33: ' + e.message + ', ' + e.stack);
                            }
                        },
                        error: function (e) {
            ...
            console.log('Exception in bwAttachments.js.performUpload(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.performUpload(): ' + e.message + ', ' + e.stack);
            $(this.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments.performUpload(): ' + e.message + ', ' + e.stack;
        }
    },
    ...
    performUpload3: function (outFile, fileName, bwBudgetRequestId, displayAttachmentsTagName, convertToAPdf, forEmail) { // convertToAPdf means that we will attempt to put the attachment into a pdf and save it as a pdf file.
        ...
        return new Promise(function (resolve, reject) {
            ...
            //
            try {
                console.log('In bwAttachments.js.performUpload3(). fileName: ' + fileName);
                //alert('In bwAttachments.js.performUpload2(). fileName: ' + fileName);
                                ...
                                success: function (data) {
                                    try {
                                        ...
                                        if (data.status == 'SUCCESS') {
                                            ...
                                            var msg = data.status + ' in bwAttachments.js.performUpload2() xcx02856-2-3: ' + data.message;
                                            console.log(msg);
                                            displayAlertDialog(msg);
                                        ...
                                        console.log('Exception in performUpload2():2: ' + e.message + ', ' + e.stack);
                                        displayAlertDialog('Exception in performUpload2():2: ' + e.message + ', ' + e.stack);
                                        $(thiz.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments.performUpload2:2: ' + e.message + ', ' + e.stack;
                                    }
                                },
                                error: function (data, errorCode, errorMessage) {
                                ...
                                try {
                                    ...
                                    xhr.upload.addEventListener("error", function (evt) {
                                        try {
                                            ...
                                            var msg = 'Error in bwAttachments.js.performUpload.xhr.upload.error():xcx1-2-2: workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', evt: ' + JSON.stringify(evt) + ', evt.type: ' + evt.type + ', lengthComputable: ' + evt.lengthComputable + ', loaded: ' + evt.loaded + ', total: ' + evt.total;
                            ...
                            success: function (data) {
                                try {
                                    ...
                                    if (data.status == 'SUCCESS') {
                                        ...
                                        var msg = data.status + ' in bwAttachments.js.performUpload2() xcx02856-2-4: ' + data.message;
                                        console.log(msg);
                                        displayAlertDialog(msg);
                                    ...
                                    console.log('Exception in bwAttachments.js.performUpload2():xcx33: ' + e.message + ', ' + e.stack);
                                    alert('Exception in bwAttachments.js.performUpload2():xcx33: ' + e.message + ', ' + e.stack);
                                    //$(thiz.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments.performUpload2:xcx33: ' + e.message + ', ' + e.stack;
                                    //displayAlertDialog('Exception in bwAttachments.js.performUpload2():xcx33: ' + e.message + ', ' + e.stack);
                                }
                            },
                            error: function (e) {
                ...
                console.log('Exception in bwAttachments.js.performUpload2(): ' + e.message + ', ' + e.stack);
                displayAlertDialog('Exception in bwAttachments.js.performUpload2(): ' + e.message + ', ' + e.stack);
                $(thiz.element).find('#newrequestattachments')[0].innerHTML = 'Exception in bwAttachments.performUpload2: ' + e.message + ', ' + e.stack;
            }
        });
    },
    ...
    GetStatusUpdateForMediaFileConversion: function (json, bwWorkflowAppId, bwBudgetRequestId) {
        try {
            console.log('In bwAttachments.js.GetStatusUpdateForMediaFileConversion().');
            var thiz = this;
            var filename = JSON.parse(decodeURI(json)).Display_Filename;

            //alert('filename: ' + filename);
            //displayAlertDialog_Persistent('In bwAttachments.js.GetStatusUpdateForMediaFileConversion(). bwWorkflowAppId: ' + bwWorkflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', json: ' + decodeURI(json));
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            displayAlertDialog('Error in bwAttachments.js.GetStatusUpdateForMediaFileConversion.success(): ' + results.status + ', ' + results.message);
                        ...
                        console.log('Exception in bwAttachments.js.GetStatusUpdateForMediaFileConversion.success(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments.js.GetStatusUpdateForMediaFileConversion.success(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    ...
                    console.log('Error in bwAttachments.js.GetStatusUpdateForMediaFileConversion.error(): ' + errorMessage);
                    displayAlertDialog('Error in bwAttachments.js.GetStatusUpdateForMediaFileConversion.error(): ' + errorMessage);
                }
            });

        } catch (e) {
            var msg = 'Exception in bwAttachments.js.GetStatusUpdateForMediaFileConversion(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    },
    ...
    populateAttachments: function (bwWorkflowAppId, bwBudgetRequestId, attachmentsTagId, showRemoveAttachmentButton, requestDialogId) {
        try {
            console.log('In bwAttachments.js.populateAttachments(). bwBudgetRequestId: ' + bwBudgetRequestId);
            //alert('In bwAttachments.js.populateAttachments(). It would be nice to know where this was called from. bwBudgetRequestId: ' + bwBudgetRequestId);
            var thiz = this;

            if (!bwBudgetRequestId) {

                var msg = 'Error in bwAttachments.js.populateAttachments. Unexpected value for bwBudgetRequestId: ' + bwBudgetRequestId;
                console.log(msg);
                displayAlertDialog(msg);
                ...
                if (bwBudgetRequestId == 'standalone') {
                    ...
                    if (!inputFileAttachmentsElement) {
                        console.log('Error in bwAttachments.js.populateAttachments(). This error is most likely because this was rendered with renderAndPopulateAttachments_ReadOnly(). It is readonly. DEV: This needs some work. Proceed from here.')
                        //displayAlertDialog('Error in bwAttachments.js.populateAttachments(). This error is most likely because this was rendered with renderAndPopulateAttachments_ReadOnly(). It is readonly. DEV: This needs some work. Proceed from here.')
                    } else {
                        inputFileAttachmentsElement.value = '';
                    }
                    //
                    ...
                    for (var i = 0; i < forms.length; i++) {
                        if (forms[i].getAttribute('bwbudgetrequestid') == bwBudgetRequestId) {
                            console.log('In bwAttachments.js.populateAttachments(). FOUND THE FORM');
                            form = forms[i];
                        }
                    }
                    if (!form) {

                        console.log('Error in bwAttachments.js.populateAttachments(). NO FORM FOUND for bwBudgetRequestId: ' + bwBudgetRequestId);
                        displayAlertDialog('Error in bwAttachments.js.populateAttachments(). NO FORM FOUND for bwBudgetRequestId: ' + bwBudgetRequestId);

                    } else {

                        var attachmentWidget = $(form).find('.bwAttachments')[0];

                        if (!attachmentWidget) {

                            console.log('Error in bwAttachments.js.populateAttachments(). Could not locate the bwAttachment widget. xcx32425263. bwBudgetRequestId: ' + bwBudgetRequestId);
                            displayAlertDialog('Error in bwAttachments.js.populateAttachments(). Could not locate the bwAttachment widget. xcx32425263. bwBudgetRequestId: ' + bwBudgetRequestId);

                        } else {

                            console.log('In bwAttachments.js.populateAttachments(). workflowAppId: ' + workflowAppId + ', bwBudgetRequestId: ' + bwBudgetRequestId + ', attachmentsTagId: ' + attachmentsTagId + ', showRemoveAttachmentButton: ' + showRemoveAttachmentButton + ').');
                            ...
                            $.ajax({
                                ...
                                success: function (results) {
                                    try {
                                        ...
                                        $(attachmentWidget).find('#newrequestattachments')[0].innerHTML = '<span style="color:tomato;">Exception in bwAttachments.populateAttachments():1: ' + e.message + ', ' + e.stack + '</span>';
                                        if (e.number) {
                                            console.log('Exception in bwAttachments.js.populateAttachments():1: ' + e.message + ', ' + e.stack);
                                            displayAlertDialog('Exception in bwAttachments.js.populateAttachments():1: ' + e.message + ', ' + e.stack);
                                        } else {
            ...
            console.log('Exception in bwAttachments.js.populateAttachments(): ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.populateAttachments(): ' + e.message + ', ' + e.stack);

            //renderAndPopulateAttachments
            //$(thiz.element).find('#newrequestattachments')[0].innerHTML = '<span style="color:tomato;">Exception in bwAttachments.populateAttachments(): ' + e.message + ', ' + e.stack + '</span>';
            //$(attachmentWidget).find('#newrequestattachments')[0].innerHTML = '<span style="color:tomato;">Exception in bwAttachments.populateAttachments(): ' + e.message + ', ' + e.stack + '</span>';
    ...
    cmdSaveAttachmentMetadata: function (bwBudgetRequestId, originalFilename) {
        try {
            console.log('In bwAttachments.js.cmdSaveAttachmentMetadata().');
            var thiz = this;
                    ...
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            if (document.getElementById('attachmentsInXslForm')) {
                                ...
                                console.log('Calling bwAttachments.js.populateAttachments(). xcx13124-7');
                                ...
                                console.log('Calling bwAttachments.js.populateAttachments(). xcx13124-8');
                        ...
                        console.log('Exception in bwAttachments.js.cmdSaveAttachmentMetadata(): ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in bwAttachments.js.cmdSaveAttachmentMetadata(): ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    ...
                    displayAlertDialog('Error in bwAttachments.js.cmdSaveAttachmentMetadata().saveattachmentmetadata: ' + JSON.stringify(data) + ', ' + errorMessage);
                }
            });
        } catch (e) {
            console.log('Exception in bwAttachments.js.cmdSaveAttachmentMetadata():2: ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.cmdSaveAttachmentMetadata():2: ' + e.message + ', ' + e.stack);
        }
    },

    cmdDeleteAttachment: function (bwBudgetRequestId, filename) {
        try {
            console.log('In bwAttachments.js.cmdDeleteAttachment(' + bwBudgetRequestId + ', ' + filename + ').');
            //alert('In bwAttachments.js.cmdDeleteAttachment(' + bwBudgetRequestId + ', ' + filename + ').');
            var thiz = this;
            ...
            $('#divDeleteAnAttachmentOfflineDialogDeleteRequestButton').off('click').click(function (error) {
                try {
                    ...
                    console.log('In bwAttachments.js.cmdDeleteAttachment.divDeleteAnAttachmentOfflineDialogDeleteRequestButton.click(). bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename);
                        ...
                        success: function (data) {
                            try {
                                ...
                                if (JSON.stringify(data).toUpperCase().indexOf('THE FILE WAS DELETED') > -1) {
                                    ...
                                    console.log('Calling bwAttachments.js.populateAttachments(). xcx13124-9');
                                    ...
                                    console.log('Calling bwAttachments.js.populateAttachments(). xcx13124-10');
                                ...
                                debugger;
                                console.log('Exception in bwAttachments.js.cmdDeleteAttachment.post.removeattachment.success(): ' + e.message + ', ' + e.stack);
                                displayAlertDialog('Exception in bwAttachments.js.cmdDeleteAttachment.post.removeattachment.success(): ' + e.message + ', ' + e.stack);
                            }
                        },
                        error: function (data, errorCode, errorMessage) {
                            debugger;
                            console.log('Error in bwAttachments.js.cmdDeleteAttachment.post.removeattachment.error(): ' + e.message + ', ' + e.stack);
                            displayAlertDialog('Error in bwAttachments.js.cmdDeleteAttachment.post.removeattachment.error(): bwBudgetRequestId: ' + bwBudgetRequestId + ', filename: ' + filename + ', errorMessage: ' + errorMessage);
                        }
                    });
                } catch (e) {
                    debugger;
                    console.log('Exception in bwAttachments.js.cmdDeleteAttachment.deletebutton.click(): ' + e.message + ', ' + e.stack);
                    displayAlertDialog('Exception in bwAttachments.js.cmdDeleteAttachment.deletebutton.click(): ' + e.message + ', ' + e.stack);
                }
            });

        } catch (e) {
            debugger;
            console.log('Exception in bwAttachments.js.cmdDeleteAttachment():2: ' + e.message + ', ' + e.stack);
            displayAlertDialog('Exception in bwAttachments.js.cmdDeleteAttachment():2: ' + e.message + ', ' + e.stack);
        }
    }
    ...
    //    } catch (e) {
    //        console.log('Exception in bwAttachments.js.cmdDisplayMultiFileUploadDialog.button.click.onAllFilesLoaded(): ' + e.message + ', ' + e.stack);
    //        displayAlertDialog('Exception in bwAttachments.js.cmdDisplayMultiFileUploadDialog.button.click.onAllFilesLoaded(): ' + e.message + ', ' + e.stack);
    //        alert('Exception in bwAttachments.js.cmdDisplayMultiFileUploadDialog.button.click.onAllFilesLoaded(): ' + e.message + ', ' + e.stack);
    //    }
    //}
    ...
    //        } catch (e) {
    //            console.log('Exception in bwAttachments.js.cmdDisplayMultiFileUploadDialog.button.click.reader.load(): ' + e.message + ', ' + e.stack);
    //            displayAlertDialog('Exception in bwAttachments.js.cmdDisplayMultiFileUploadDialog.button.click.reader.load(): ' + e.message + ', ' + e.stack);
    //            alert('Exception in bwAttachments.js.cmdDisplayMultiFileUploadDialog.button.click.reader.load(): ' + e.message + ', ' + e.stack);
    //        }
    //    };
