...
function calendarJs(elementOrId, options, searchOptions) {
    ...
    function buildDisabledBackground() {
        // Todd disabled the modal behavior of the event dialog. 12-15-2024.
    ...
    function buildEventEditorEventTabContent() {
        console.log('In calendar.js.buildEventEditorEventTabContent().');
    ...
    function showEventEditingDialog(eventDetails, overrideTodayDate, overrideTimeValues, originDayDate) {
        console.log('calendar.js.showEventEditingDialog().');
    ...
    function eventDialogEvent_OK() {
        console.log('In calendar.js.eventDialogEvent_OK().');
                    ...
                    if (!ignoreFields) {
                        var isExistingEvent = isDefined(newId),
                            newEvent = {
                                ...
                                createdBy_ParticipantId: $('.bwAuthentication').bwAuthentication('option', 'participantId'),
                                createdBy_ParticipantEmail: $('.bwAuthentication').bwAuthentication('option', 'participantEmail'),
                                createdBy_ParticipantFriendlyName: $('.bwAuthentication').bwAuthentication('option', 'participantFriendlyName')
                            };
    ...
    function eventDialogEvent_Remove() {
        ...
        var onYesEvent = function () {
            ...
            if (isDefined(_element_Dialog_EventEditor_EventDetails.id)) {
                ...
                _that.removeEvent(_element_Dialog_EventEditor_EventDetails.id, true).then(function (results) {
                    debugger;
                    if (_options.isWidget) {
                        build(_calendar_CurrentDate);
                    } else {
                        ...
                        //if (updateEvents) {
                            //console.log('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-7. Commented this out for the time being!!!!<<<<<<<<<');
                            //storeEventsInLocalStorage(); // Commented this out for the time being!!!!<<<<<<<<<
                            updateSideMenu();
                            buildFullMonthViewDayEvents();
                            refreshOpenedViews();
                        //}
                    ...
                    var msg = 'Exception in calendar.js.eventDialogEvent_Remove(): ' + e.message + ', ' + e.stack;
                    console.log(msg);
    ...
    function onViewEventDropped(e, dateDropped, container) {
        ...
        if (_element_View_Event_Dragged === null) {
            ...
            alert('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-2.');
            storeEventsInLocalStorage();
    ...
    function onMouseUpResizeTracking(e) {
        ...
        if (_options.manualEditingEnabled) {
            ...
            if (container !== null && eventsLength > 0) {
                ...
                if (eventsResized) {
                    alert('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-3.');
                    storeEventsInLocalStorage();
                    refreshOpenedViews();
                }
            }
    ...
    function removeNonRepeatingEventsOnSpecificDate(date, compareFunc) {
        ...
        var onYesEvent = function () {
            ...
            alert('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-4.');
            storeEventsInLocalStorage();
    ...
    function saveNewEvent(newEvent) {
        try {
            console.log('In calendar.js.saveNewEvent().');

            // /_bw/saveorganizationcalendar
            ...
            var workflowAppId = $('.bwAuthentication:first').bwAuthentication('option', 'workflowAppId');
            var participantId = $('.bwAuthentication:first').bwAuthentication('option', 'participantId');
            var participantEmail = $('.bwAuthentication:first').bwAuthentication('option', 'participantEmail');
            var participantFriendlyName = $('.bwAuthentication:first').bwAuthentication('option', 'participantFriendlyName');

            var activeStateIdentifier = $('.bwAuthentication:first').bwAuthentication('getActiveStateIdentifier');

            newEvent["bwWorkflowAppId"] = workflowAppId;
            newEvent["OrganizationCalendarId"] = 1;
            ...
            var data = {
                ...
                organizationCalendarId: 1, // 1 is the main one.
                event: event
            };
            ...
            $.ajax({
                url: operationUriPrefix + "_bw/saveorganizationcalendarevent",
                type: 'POST',
                data: data,
                headers: {
                ...
                success: function (results) {
                    try {
                        if (results.status != 'SUCCESS') {
                            displayAlertDialog('Error in calendar.js.saveorganizationcalendar(). url: _bw/saveorganizationcalendarevent, results: ' + JSON.stringify(results));
                        } else {

                            console.log('SUCCESS RESULTS results: ' + JSON.stringify(results));
                            displayAlertDialog_QuickNotice('Saved!'); 

                        }
                    } catch (e) {
                        HideActivitySpinner();
                        console.log('Exception in saveorganizationcalendar: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in saveorganizationcalendar: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    var msg = 'Error in saveorganizationcalendar: ' + JSON.stringify(data) + ', ' + errorCode + ', ' + errorMessage;
                    console.log(msg);
                    displayAlertDialog(msg);
                }
            });
            ...
            var msg = 'Exception in calendar.js.saveNewEvent(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    }
    ...
    function updateEvent(event1) {
        try {
            console.log('In calendar.js.updateEvent().');
            ...
            event1["bwWorkflowAppId"] = workflowAppId;
            event1["OrganizationCalendarId"] = 1;

            var event = JSON.stringify(event1);
            ...
            $.ajax({
                url: operationUriPrefix + "_bw/updateorganizationcalendarevent",
                type: 'POST',
                data: data,
                headers: {
                    "Accept": "application/json; odata=verbose"
                ...
                success: function (results) {
                    try {
                        if (results.status != 'SUCCESS') {
                            ...
                            displayAlertDialog('Error in calendar.js.updateEvent(). url: _bw/updateorganizationcalendarevent, results: ' + JSON.stringify(results));

                        } else {

                            displayAlertDialog_QuickNotice('Updated!'); 

                        }
                    } catch (e) {
                        HideActivitySpinner();
                        console.log('Exception in updateEvent: ' + e.message + ', ' + e.stack);
                        alert('Exception in updateEvent: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    var msg = 'Error in updateEvent.updateorganizationcalendarevent(): ' + JSON.stringify(data) + ', ' + errorCode + ', ' + errorMessage;
                    console.log(msg);
                    displayAlertDialog(msg);
                }
            });
            ...
            var msg = 'Exception in calendar.js.updateEvent(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    }

    function deleteEvent(event1) {
        var thiz = this;
        return new Promise(function (resolve, reject) {
            try {
                console.log('In calendar.js.deleteEvent().');
                ...
                $.ajax({
                    url: operationUriPrefix + "_bw/deleteorganizationcalendarevent",
                    type: 'POST',
                    data: data,
                    headers: {
                        "Accept": "application/json; odata=verbose"
                    ...
                    success: function (results) {
                        try {
                            ...
                            if (results.status != 'SUCCESS') {
                                ...
                                var msg = 'Error in calendar.js.deleteEvent(). url: _bw/deleteorganizationcalendarevent, results: ' + JSON.stringify(results);
                                displayAlertDialog(msg);
                                ...
                                displayAlertDialog_QuickNotice('Deleted!');
                            ...
                            HideActivitySpinner();
                            console.log('Exception in deleteEvent: ' + e.message + ', ' + e.stack);
                            alert('Exception in deleteEvent: ' + e.message + ', ' + e.stack);
                    ...
                    error: function (data, errorCode, errorMessage) {
                        var msg = 'Error in deleteEvent.updateorganizationcalendarevent(): ' + JSON.stringify(data) + ', ' + errorCode + ', ' + errorMessage;
                        console.log(msg);
                        displayAlertDialog(msg);
                ...
                var msg = 'Exception in calendar.js.deleteEvent(): ' + e.message + ', ' + e.stack;
                console.log(msg);
                displayAlertDialog(msg);
    ...
    function loadEvents() {
        try {
            console.log('In calendar.js.loadEvents(). CALLING THE WEB SERVICE TO GET THE CALENDAR ITEMS!!!!');
            ...
            $.ajax({
                url: operationUriPrefix + "_bw/getorganizationcalendarevents",
                type: 'POST',
                data: data,
                headers: {
                    "Accept": "application/json; odata=verbose"
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            displayAlertDialog('Error in calendar.js.getorganizationcalendarevents(). url: /_bw/getorganizationcalendarevents/, results: ' + JSON.stringify(results));

                        } else {

                            console.log('SUCCESS RESULTS >>>>>>>>>results: ' + JSON.stringify(results));

                            var events = JSON.parse(results.data);
                            for (var i = 0; i < events.length; i++) {

                                event = getObjectFromString(JSON.stringify(events[i]));
                                if (isDefined(event)) {
                                    _that.addEvent(event, true, false, false);
                                }
                            }
                        ...
                        HideActivitySpinner();
                        console.log('Exception in getorganizationcalendarevents: ' + e.message + ', ' + e.stack);
                        displayAlertDialog('Exception in getorganizationcalendarevents: ' + e.message + ', ' + e.stack);
                    }
                },
                error: function (data, errorCode, errorMessage) {
                    var msg = 'Error in getorganizationcalendarevents: ' + JSON.stringify(data) + ', ' + errorCode + ', ' + errorMessage;
                    console.log(msg);
                    displayAlertDialog(msg); //+ error.message.value + ' ' + error.innererror.message);
                }
            });
        } catch (e) {
            var msg = 'Exception in calendar.js.loadEvents(): ' + e.message + ', ' + e.stack;
            console.log(msg);
            displayAlertDialog(msg);
        }
    }
    ...
    function importFromFilesCompleted(eventsAddedOrUpdated) {
        if (eventsAddedOrUpdated.length > 0) {
            alert('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-5.');
            storeEventsInLocalStorage();
            updateSideMenu();
            buildFullMonthViewDayEvents();
            refreshOpenedViews();
    ...
    _that.addEvents = function (events, updateEvents, triggerEvent) {
        if (!_element_Mode_DatePicker_Enabled) {
            ...
            alert('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-6.');
            storeEventsInLocalStorage();
    ...
    _that.updateEvents = function (events, updateEvents, triggerEvent) {
        if (!_element_Mode_DatePicker_Enabled) {
            ...
            if (updateEvents) {
                alert('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-8.');
                storeEventsInLocalStorage();
                updateSideMenu();
                buildFullMonthViewDayEvents();
                refreshOpenedViews();
    ...
    _that.updateEvent = function (id, event, updateEvents, triggerEvent) {
        ...
        debugger;
        if (!_element_Mode_DatePicker_Enabled) {
            //updated = _that.removeEvent(id, false, false); // We dont do it this way anymore. todd 12-14-2024.
        ...
        if (!_element_Mode_DatePicker_Enabled) {
            ...
            getAllEventsFunc(function (eventDetails) {
                if (eventDetails.id === id) {
                    ...
                    if (updateEvents) {
                        alert('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-10.');
                        storeEventsInLocalStorage();
                        updateSideMenu();
                        buildFullMonthViewDayEvents();
                        refreshOpenedViews();
                    ...
                    getAllEventsFunc(function (event, storageDate, storageGuid) {
                        try {
                            ...
                            if (storageGuid === id) {
                                ...
                                deleteEvent(event).then(function (results) {
                                    if (results.status != 'SUCCESS') {
                                        reject(results);
                                    } else {
                                        resolve(results);
    ...
    _that.clearEvents = function (updateEvents, triggerEvent) {
        if (!_element_Mode_DatePicker_Enabled) {
            ...
            if (updateEvents) {
                alert('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-12.');
                storeEventsInLocalStorage();
                updateSideMenu();
                buildFullMonthViewDayEvents();
                refreshOpenedViews();
    ...
    _that.removeExpiredEvents = function (updateEvents, triggerEvent) {
        if (!_element_Mode_DatePicker_Enabled) {
            ...
            if (updateEvents) {
                alert('Calling calendar.js.storeEventsInLocalStorage(). xcx23214-13.');
                storeEventsInLocalStorage();
                updateSideMenu();
                buildFullMonthViewDayEvents();
                refreshOpenedViews();
