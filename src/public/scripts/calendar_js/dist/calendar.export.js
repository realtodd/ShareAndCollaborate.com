...
export function calendarJs(elementOrId, options, searchOptions) {
        ...
        if (fromTime.length < 2) {
            ...
            if (toDate < fromDate) {
                ...
                var normalSave = function (newId, newFromDate, newToDate, newRepeatEndsDate, ignoreFields) {
                    ...
                    if (!ignoreFields) {
                        var isExistingEvent = isDefined(newId), newEvent = {
    ...
    function storeEventsInLocalStorage() {
        alert('In calendar.export.js.storeEventsInLocalStorage().');
        if (_options.useLocalStorageForEvents && _parameter_Window.localStorage) {
            ...
            for (var orderedEventIndex = 0; orderedEventIndex < orderedEventsLength; orderedEventIndex++) {
                ...
                alert('Saving item CJS_' + orderedEventIndex.toString());
            }
        }
    }
    function loadEventsFromLocalStorage() {
        if (_options.useLocalStorageForEvents && _parameter_Window.localStorage) {
            ...
            for (var keyIndex = 0; keyIndex < keysLength; keyIndex++) {
                ...
                alert('Loading item ' + _parameter_Window.localStorage.key(keyIndex));
                if (isDefined(event)) {
