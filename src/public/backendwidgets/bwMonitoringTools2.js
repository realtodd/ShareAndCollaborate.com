$.widget("bw.bwMonitoringTools2", {
    options: {
        ...
        */
        ...
        /*
        ===========================================================
        This is the bwMonitoringTools2.js jQuery Widget. 
        ===========================================================
    ...
    _create: function (assignmentRowChanged_ElementId) {
        this.element.addClass("bwMonitoringTools2");
    ...
    loadAndRenderMonitoringTools: function () {
        try {
            console.log('In bwMonitoringTools2.js.loadAndRenderMonitoringTools().');
            //alert('In loadAndRenderMonitoringTools().');
            var thiz = this;
            ...
            var clientException;
            var element = document.getElementById('bwMonitoringTools2_ClientOrServerMessageSelector');
            if (element) {
                clientException = element.checked;

                console.log('In bwMonitoringTools2.js.loadAndRenderMonitoringTools(). Calling websiteerrorthreatsummary(). clientException: ' + clientException);
                //alert('In bwMonitoringTools2.js.loadAndRenderMonitoringTools(). Calling websiteerrorthreatsummary(). clientException: ' + clientException);
            }
                ...
                success: function (data) {
                    try {
                        ...
                        if (!data.result) {
                            ...
                            html += '<br /><br />';
                            html += '<br /><br />';
                            html += '           <input type="checkbox" id="bwMonitoringTools2_ClientOrServerMessageSelector" onchange="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'selectOrganizationThreats_OnChange\', this);" style="transform:scale(3);" />&nbsp;&nbsp;Select to display client-side messages.';

                            html += '<br /><br />';
                            html += '           <input type="checkbox" id="bwMonitoringTools2_ClientOrServerMessageSelectorxx" onchange="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'selectOrganizationThreats_OnChangexx\', this);" style="transform:scale(3);" />&nbsp;&nbsp;Select to display web and file services messages.';

                            html += '<br /><br />';
                            html += '           <input type="checkbox" id="bwMonitoringTools2_ClientOrServerMessageSelectorxx" onchange="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'selectOrganizationThreats_OnChangexx\', this);" style="transform:scale(3);" />&nbsp;&nbsp;Select to display Timer Services messages.';

                            html += '<br /><br />';
                            html += '           <input type="checkbox" id="bwMonitoringTools2_ClientOrServerMessageSelectorxx" onchange="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'selectOrganizationThreats_OnChangexx\', this);" style="transform:scale(3);" />&nbsp;&nbsp;Select to display Haraka email service messages.';
                            ...
                            $.ajax({
                                ...
                                success: function (data2) {
                                    try {
                                        ...
                                        //html += '    <td>';
                                        //html += '      <span style="color:white;background-color:skyblue;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdRefreshWebsiteErrorThreatDetails\');" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails">Refresh';
                                        //html += '      </span>';
                                        //html += '    </td>';

                                        //html += '    <td>';
                                        //html += '      <span style="color:white;background-color:#009933;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'verbose\', \'' + bwWorkflowAppId + '\');" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails">Verbose: <span>#</span>';
                                        //html += '      </span>';
                                        //html += '    </td>';
                                        ...
                                        //html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'severe\', \'' + bwWorkflowAppId + '\');">Severe: ' + severeErrorThreats.length + '</span>';
                                        //if (severeErrorThreats.length > 0) {
                                        //    html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'severe\', \'ALL\');">';
                                        //}
                                        //html += '      </span>';
                                        //html += '    </td>';
                                        ...
                                        //html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'high\', \'' + bwWorkflowAppId + '\');">High: ' + highLevelErrorThreats.length + '</span>';
                                        //if (highLevelErrorThreats.length > 0) {
                                        //    html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'high\', \'ALL\');">';
                                        //}
                                        //html += '      </span>';
                                        //html += '    </td>';
                                        ...
                                        //html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'elevated\', \'' + bwWorkflowAppId + '\');">Elevated (client display): ' + elevatedErrorThreats.length + '</span>';
                                        //if (elevatedErrorThreats.length > 0) {
                                        //    html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'elevated\', \'ALL\');">';
                                        //}
                                        //html += '      </span>';
                                        //html += '    </td>';
                                        ...
                                        //html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'guarded\', \'' + bwWorkflowAppId + '\');">Guarded: ' + guardedErrorThreats.length + '</span>';
                                        //if (guardedErrorThreats.length) {
                                        //    html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'guarded\', \'ALL\');">';
                                        //}
                                        //html += '      </span>';
                                        //html += '    </td>';
                                        ...
                                        //html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'low\', \'' + bwWorkflowAppId + '\');">Low: ' + lowErrorThreats.length + '</span>';
                                        //if (lowErrorThreats.length) {
                                        //    html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'low\', \'ALL\');">';
                                        //}
                                        //html += '      </span>';
                                        //html += '    </td>';
                                        ...
                                        //html += '    <td>';
                                        //html += '      <span style="color:white;background-color:#009933;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails">';
                                        //html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'email\', \'' + bwWorkflowAppId + '\');">Email: ' + emailErrorThreats.length + '</span>';
                                        //if (emailErrorThreats.length) {
                                        //    html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'email\', \'ALL\');">';
                                        //}
                                        //html += '      </span>';
                                        //html += '    </td>';
    ...
    selectOrganizationThreats_OnChange: function (element) {
        try {
            console.log('In bwMonitoringTools2.js.selectOrganizationThreats_OnChange().');
            //alert('In bwMonitoringTools2.js.selectOrganizationThreats_OnChange().');
            ...
            console.log('In bwMonitoringTools2.js.selectOrganizationThreats_OnChange(). Calling cmdDisplayWebsiteErrorThreats(). xcx2134253.');
            //alert('In bwMonitoringTools2.js.selectOrganizationThreats_OnChange(). Calling cmdDisplayWebsiteErrorThreats(). xcx2134253.');
    ...
    populateScreenshots: function (bwErrorOrSuggestionId, bwWorkflowAppId, quill) {
        try {
            console.log('In bwMonitoringTools2.js.populateScreenshots(). bwErrorOrSuggestionId: ' + bwErrorOrSuggestionId);
            var thiz = this;
            ...
            console.log('>>>In bwMonitoringTools2.js.populateScreenshots(). bwWorkflowAppId: ' + bwWorkflowAppId);
    ...
    adminViewErrorOrSuggestion: function (bwParticipantId, bwParticipantFriendlyName, bwParticipantEmail, bwErrorOrSuggestionId, bwWorkflowAppId) {
        try {
            ...
            console.log('In bwMonitoringTools2.js.adminViewErrorOrSuggestion(). bwWorkflowAppId: ' + bwWorkflowAppId);
    ...
    cmdDisplayWebsiteErrorThreats: function (bwWorkflowAppId) {
        try {
            console.log('In bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreats(' + bwWorkflowAppId + ').');
            //alert('In bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreats(' + bwWorkflowAppId + ').');
            var thiz = this;
            ...
            if (element) {
                ...
                console.log('In bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreats(). Calling websiteerrorthreatsummary(). clientException: ' + clientException);
                //alert('In bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreats(). Calling websiteerrorthreatsummary(). clientException: ' + clientException);
            }
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    try {
                                        ...
                                        html += '    <td>';
                                        html += '      <span style="color:white;background-color:#009933;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails" >';
                                        html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'verbose\', \'' + bwWorkflowAppId + '\');">Verbose: ' + allErrorThreats.length + '</span>';
                                        if (allErrorThreats.length > 0) {
                                            html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'verbose\', \'' + bwWorkflowAppId + '\');">';
                                        }
                                        html += '      </span>';
                                        html += '    </td>';
                                        ...
                                        html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'severe\', \'' + bwWorkflowAppId + '\');">Severe: ' + severeErrorThreats.length + '</span>';
                                        if (severeErrorThreats.length > 0) {
                                            html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'severe\', \'' + bwWorkflowAppId + '\');">';
                                        }
                                        html += '      </span>';
                                        html += '    </td>';
                                        ...
                                        html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'high\', \'' + bwWorkflowAppId + '\');">High: ' + highLevelErrorThreats.length + '</span>';
                                        if (highLevelErrorThreats.length > 0) {
                                            html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'high\', \'' + bwWorkflowAppId + '\');">';
                                        }
                                        html += '      </span>';
                                        html += '    </td>';
                                        ...
                                        html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'elevated\', \'' + bwWorkflowAppId + '\');">Elevated (client display): ' + elevatedErrorThreats.length + '</span>';
                                        if (elevatedErrorThreats.length > 0) {
                                            html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'elevated\', \'' + bwWorkflowAppId + '\');">';
                                        }
                                        html += '      </span>';
                                        html += '    </td>';
                                        ...
                                        html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'guarded\', \'' + bwWorkflowAppId + '\');">Guarded: ' + guardedErrorThreats.length + '</span>';
                                        if (guardedErrorThreats.length) {
                                            html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'guarded\', \'' + bwWorkflowAppId + '\');">';
                                        }
                                        html += '      </span>';
                                        html += '    </td>';
                                        ...
                                        html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'low\', \'' + bwWorkflowAppId + '\');">Low: ' + lowErrorThreats.length + '</span>';
                                        if (lowErrorThreats.length) {
                                            html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'low\', \'' + bwWorkflowAppId + '\');">';
                                        }
                                        html += '      </span>';
                                        html += '    </td>';
                                        ...
                                        html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'email\', \'' + bwWorkflowAppId + '\');">Email: ' + emailErrorThreats.length + '</span>';
                                        if (emailErrorThreats.length) {
                                            html += '           <img title="xDelete" style="cursor:pointer;" src="images/trash-can.png" onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDeleteAllExceptionLogs\', \'email\', \'' + bwWorkflowAppId + '\');">';
                                        }
                                        html += '      </span>';
                                        html += '    </td>';
    ...
    cmdDisplayWebsiteErrorThreatDetails: function (threatLevel, bwWorkflowAppId) {
        try {
            console.log('In bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreatDetails(' + threatLevel + ').');
            //alert('In bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreatDetails(' + threatLevel + ').');
            var thiz = this;
            ...
            if (element) {
                ...
                //alert('In bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreatDetails(). Calling websiteerrorthreatsummary(). clientException: ' + clientException);
                console.log('In bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreatDetails(). Calling websiteerrorthreatsummary(). clientException: ' + clientException);
            }
                ...
                success: function (results) {
                    try {
                        ...
                        if (results.status != 'SUCCESS') {
                            ...
                            displayAlertDialog('Error in bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreatDetails(). ' + results.status + ': ' + results.message);

                        } else {

                            //displayAlertDialog('In bwMonitoringTools2.js.cmdDisplayWebsiteErrorThreatDetails(). results.result: ' + JSON.stringify(results.result));
    ...
    //                        html += '</span>';
    //                        html += '<br />';
    //                        html += '<select onchange="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'selectOrganizationThreats_OnChange\', this);" class="xdComboBox xdBehavior_Select" style="border-color: whitesmoke; color: rgb(38, 38, 38); font-family: \'Segoe UI Light\',\'Segoe UI\',\'Segoe\',Tahoma,Helvetica,Arial,sans-serif; color: gray;font-size: 20pt;font-weight:bold;cursor: pointer;">';
    ...
    //                                    html += '    <td>';
    //                                    html += '      <span style="color:white;background-color:#ff0000;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails" >';
    //                                    html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'severe\', \'' + bwWorkflowAppId + '\');">Severe: ' + threatCounts.severe + '</span>';
    ...
    //                                    html += '    <td>';
    //                                    html += '      <span style="color:white;background-color:#ff9900;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails">';
    //                                    html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'high\', \'' + bwWorkflowAppId + '\');">High: ' + threatCounts.high + '</span>';
    ...
    //                                    html += '    <td>';
    //                                    html += '      <span style="color:#ff9900;background-color:#ffff00;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails">';
    //                                    html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'elevated\', \'' + bwWorkflowAppId + '\');">Elevated (client display): ' + threatCounts.elevated + '</span>';
    ...
    //                                    html += '    <td>';
    //                                    html += '      <span style="color:white;background-color:#0066ff;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails">';
    //                                    html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'guarded\', \'' + bwWorkflowAppId + '\');">Guarded: ' + threatCounts.guarded + '</span>';
    ...
    //                                    html += '    <td>';
    //                                    html += '      <span style="color:white;background-color:#009933;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails">';
    //                                    html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'low\', \'' + bwWorkflowAppId + '\');">Low: ' + threatCounts.low + '</span>';
    ...
    //                                    html += '    <td>';
    //                                    html += '      <span style="color:white;background-color:#009933;font-size:xx-large;font-weight:bold;cursor:pointer;padding:0 15px 4px 15px;white-space:nowrap;" class="bwMonitoringTools_cmdDisplayWebsiteErrorThreatDetails">';
    //                                    html += '           <span onclick="$(\'.bwMonitoringTools2\').bwMonitoringTools2(\'cmdDisplayWebsiteErrorThreatDetails\', \'email\', \'' + bwWorkflowAppId + '\');">Email: ' + threatCounts.email + '</span>';
