console.log('Starting fileservices xcx998546.');

const path = require('node:path');
var express = require('express');
var router = express.Router();

var app_fileservices = express();
var routes = require(path.join(__dirname, 'fileservices/routes/start'));
app_fileservices.use('/', routes);
app_fileservices.set('port', process.env.PORT || 3001);
var server = app_fileservices.listen(app_fileservices.get('port'), function () {
    console.log('File services listening on port ' + server.address().port);
});
...
try {
    ...
    console.log('');
    console.log('=================================');
    console.log('ATTEMPTING TO CONNECT TO MONGODB from fileservices.js.');
    console.log('=================================');
    console.log('');
